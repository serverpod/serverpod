...
/// expression is treated as EWKT/WKT and wrapped with `ST_GeomFromEWKT(...)`.
...
class GeometryDistanceExpression<T> extends ColumnExpression<T> {
  ...
  String toString() {
    var otherStr = other.toString();
    if (otherIsWkt) otherStr = 'ST_GeomFromEWKT($otherStr)';
...
class _BoundingBoxExpression<T> extends ColumnExpression<T> {
  ...
  @override
  String toString() {
    var bbox = 'ST_MakeEnvelope($minLon, $minLat, $maxLon, $maxLat, 4326)';
