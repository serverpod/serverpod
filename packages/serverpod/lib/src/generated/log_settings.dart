...
abstract class LogSettings
  ...
  factory LogSettings.fromJson(Map<String, dynamic> jsonSerialization) {
    return LogSettings(
      ...
      logAllSessions: _is.BoolJsonExtension.fromJson(
        jsonSerialization['logAllSessions'],
      ),
      logAllQueries: _is.BoolJsonExtension.fromJson(
        jsonSerialization['logAllQueries'],
      ),
      logSlowSessions: _is.BoolJsonExtension.fromJson(
        jsonSerialization['logSlowSessions'],
      ),
      logStreamingSessionsContinuously: _is.BoolJsonExtension.fromJson(
        jsonSerialization['logStreamingSessionsContinuously'],
      ),
      logSlowQueries: _is.BoolJsonExtension.fromJson(
        jsonSerialization['logSlowQueries'],
      ),
      logFailedSessions: _is.BoolJsonExtension.fromJson(
        jsonSerialization['logFailedSessions'],
      ),
      logFailedQueries: _is.BoolJsonExtension.fromJson(
