...
class CloudStorageDirectDownloadEntryRepository {
  ...
  /// Emits [CloudStorageDirectDownloadEntry]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `CloudStorageDirectDownloadEntry.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<CloudStorageDirectDownloadEntry>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<CloudStorageDirectDownloadEntryTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<CloudStorageDirectDownloadEntry>(
      where: where?.call(CloudStorageDirectDownloadEntry.t),
      orderBy: orderBy?.call(CloudStorageDirectDownloadEntry.t),
      orderByList: orderByList?.call(CloudStorageDirectDownloadEntry.t),
      limit: limit,
