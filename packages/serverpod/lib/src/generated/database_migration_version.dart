...
abstract class DatabaseMigrationVersion
  ...
  DatabaseMigrationVersion copyWith({
    ...
    String? module,
    String? version,
    DateTime? timestamp = const _is.$UndefinedDateTime(),
  });
  @override
...
class _DatabaseMigrationVersionImpl extends DatabaseMigrationVersion {
  ...
  DatabaseMigrationVersion copyWith({
    ...
    return DatabaseMigrationVersion(
      ...
      timestamp: timestamp is _is.UndefinedSentinel
          ? this.timestamp
          : timestamp,
    );
  }
...
class DatabaseMigrationVersionRepository {
  ...
  /// Emits [DatabaseMigrationVersion]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `DatabaseMigrationVersion.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<DatabaseMigrationVersion>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<DatabaseMigrationVersionTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<DatabaseMigrationVersion>(
      where: where?.call(DatabaseMigrationVersion.t),
      orderBy: orderBy?.call(DatabaseMigrationVersion.t),
      orderByList: orderByList?.call(DatabaseMigrationVersion.t),
      limit: limit,
