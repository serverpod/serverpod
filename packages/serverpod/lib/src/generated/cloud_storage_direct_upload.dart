...
class CloudStorageDirectUploadEntryRepository {
  ...
  /// Emits [CloudStorageDirectUploadEntry]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `CloudStorageDirectUploadEntry.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<CloudStorageDirectUploadEntry>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<CloudStorageDirectUploadEntryTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<CloudStorageDirectUploadEntry>(
      where: where?.call(CloudStorageDirectUploadEntry.t),
      orderBy: orderBy?.call(CloudStorageDirectUploadEntry.t),
      orderByList: orderByList?.call(CloudStorageDirectUploadEntry.t),
      limit: limit,
