...
abstract class CloudStorageEntry
  ...
  CloudStorageEntry copyWith({
    ...
    String? path,
    DateTime? addedTime,
    DateTime? expiration = const _is.$UndefinedDateTime(),
    _idt.ByteData? byteData,
    bool? verified,
    String? contentType,
    String? cacheControl,
...
class _CloudStorageEntryImpl extends CloudStorageEntry {
  ...
  CloudStorageEntry copyWith({
    ...
    return CloudStorageEntry(
      ...
      expiration: expiration is _is.UndefinedSentinel
          ? this.expiration
          : expiration,
...
class CloudStorageEntryRepository {
  ...
  /// Emits [CloudStorageEntry]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `CloudStorageEntry.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<CloudStorageEntry>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<CloudStorageEntryTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<CloudStorageEntry>(
      where: where?.call(CloudStorageEntry.t),
      orderBy: orderBy?.call(CloudStorageEntry.t),
      orderByList: orderByList?.call(CloudStorageEntry.t),
      limit: limit,
