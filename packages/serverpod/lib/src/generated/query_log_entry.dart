...
class QueryLogEntryRepository {
  ...
  /// Find a list of [QueryLogEntry]s from a table, using the provided [where]
  ...
  /// Find a single [QueryLogEntry] from a table, using the provided [where]
  ...
  /// Find a single [QueryLogEntry] by its [id] or null if no such row exists.
  ...
  /// Update all [QueryLogEntry]s in the list and returns the updated rows. If
