...
class ServerHealthConnectionInfoRepository {
  ...
  /// Emits [ServerHealthConnectionInfo]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ServerHealthConnectionInfo.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ServerHealthConnectionInfo>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ServerHealthConnectionInfoTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ServerHealthConnectionInfo>(
      where: where?.call(ServerHealthConnectionInfo.t),
      orderBy: orderBy?.call(ServerHealthConnectionInfo.t),
      orderByList: orderByList?.call(ServerHealthConnectionInfo.t),
      limit: limit,
