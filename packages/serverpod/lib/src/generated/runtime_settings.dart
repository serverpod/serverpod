...
class RuntimeSettingsRepository {
  ...
  /// Emits [RuntimeSettings]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `RuntimeSettings.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<RuntimeSettings>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<RuntimeSettingsTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<RuntimeSettings>(
      where: where?.call(RuntimeSettings.t),
      orderBy: orderBy?.call(RuntimeSettings.t),
      orderByList: orderByList?.call(RuntimeSettings.t),
      limit: limit,
