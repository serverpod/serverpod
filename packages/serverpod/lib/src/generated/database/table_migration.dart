...
abstract class TableMigration
  ...
  factory TableMigration.fromJson(Map<String, dynamic> jsonSerialization) {
    return TableMigration(
      ...
      addColumns:
          (jsonSerialization['addColumns'] as List)
              .map(
                (e) =>
                    _i2.ColumnDefinition.fromJson((e as Map<String, dynamic>)),
              )
              .toList(),
      deleteColumns:
          (jsonSerialization['deleteColumns'] as List)
              .map((e) => e as String)
              .toList(),
      modifyColumns:
          (jsonSerialization['modifyColumns'] as List)
              .map(
                (e) =>
                    _i3.ColumnMigration.fromJson((e as Map<String, dynamic>)),
              )
              .toList(),
      addIndexes:
          (jsonSerialization['addIndexes'] as List)
              .map(
                (e) =>
                    _i4.IndexDefinition.fromJson((e as Map<String, dynamic>)),
              )
              .toList(),
      deleteIndexes:
          (jsonSerialization['deleteIndexes'] as List)
              .map((e) => e as String)
              .toList(),
      addForeignKeys:
          (jsonSerialization['addForeignKeys'] as List)
              .map(
                (e) => _i5.ForeignKeyDefinition.fromJson(
                  (e as Map<String, dynamic>),
                ),
              )
              .toList(),
      deleteForeignKeys:
          (jsonSerialization['deleteForeignKeys'] as List)
              .map((e) => e as String)
              .toList(),
      warnings:
          (jsonSerialization['warnings'] as List)
              .map(
