...
class ServerHealthMetricUpdateTable
  ...
  _i1.ColumnValue<bool, bool> isHealthy(bool value) =>
      _i1.ColumnValue(table.isHealthy, value);

  _i1.ColumnValue<double, double> value(double value) =>
...
class ServerHealthMetricTable extends _i1.Table<int?> {
  ServerHealthMetricTable({super.tableRelation})
    ...
    isHealthy = _i1.ColumnBool('isHealthy', this);
    value = _i1.ColumnDouble('value', this);
