...
class LogManager {
  ...
  Future<void> logEntry(
    ...
    await session.logManager.logEntry(
      session,
      messageId: messageId,
      level: level,
      message: message,
  ...
  Future<void> logQuery(
    ...
    await session.logManager.logQuery(
      session,
      query: query,
      duration: duration,
  ...
  Future<void> logMessage(
    ...
    await session.logManager.logMessage(
      session,
  ...
  Future<int?> finalizeSessionLog(
    ...
    return await session.logManager.finalizeSessionLog(
      session,
      authenticatedUserId: authenticatedUserId,
      exception: exception,
      stackTrace: stackTrace,
