...
abstract class MessageCentralServerpodChannels {
  ...
  /// The user ID should be the [AuthenticationInfo.user] for the concerned
  /// user.
  static String revokedAuthentication(Object user) =>
      '_serverpod_revoked_authentication_$user';
}
