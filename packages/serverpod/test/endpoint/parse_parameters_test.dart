...
void main() {
  test(
    ...
    () {
      expect(parseParameters({}, {}, Protocol()), {});
    },
  );

  group('Given single non nullable parameter description', () {
    var parameterDescriptions = {
      'arg1': ParameterDescription(name: 'arg1', type: int, nullable: false),
    };

    test('when parsing valid input then parameter is parsed.', () {
      expect(parseParameters({'arg1': 42}, parameterDescriptions, Protocol()), {
        'arg1': 42,
      });
    });
    ...
    test(
      ...
      () {
        expect(
          () =>
              parseParameters({'arg2': 42}, parameterDescriptions, Protocol()),
  ...
  group('Given single nullable parameter description', () {
    var parameterDescriptions = {
      'arg1': ParameterDescription(name: 'arg1', type: int, nullable: true),
    };
    ...
    test(
      ...
      () {
        expect(parseParameters({}, parameterDescriptions, Protocol()), {});
      },
    );
  });
  ...
  group('Given multiple non nullable parameter descriptions', () {
    var parameterDescriptions = {
      'arg1': ParameterDescription(name: 'arg1', type: int, nullable: false),
      'arg2': ParameterDescription(name: 'arg2', type: String, nullable: false),
    };
    ...
    test(
      ...
      () {
        expect(
          () =>
              parseParameters({'arg1': 42}, parameterDescriptions, Protocol()),
          throwsA(isA<Exception>()),
        );
      },
    );
