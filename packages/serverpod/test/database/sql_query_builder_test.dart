...
class _TableWithManyRelation extends Table<int?> {
  ...
  ManyRelation<_TableWithManyRelation> get manyRelation {
    ...
    var relationTable = createRelationTable(
      ...
      createTable:
          (foreignTableRelation) => _TableWithManyRelation(
...
void main() {
  ...
  group('Given SelectQueryBuilder', () {
    ...
    test(
      ...
      () {
        ...
        var query =
            SelectQueryBuilder(table: citizenTable)
                .withWhere(
                  ColumnString('name', nestedRelationTable).equals('Alex'),
                )
                .build();
    ...
    test(
      ...
      () {
        ...
        var queryBuilder = SelectQueryBuilder(
          table: citizenTable,
        ).withOrderBy([Order(column: countColumn)]);
  ...
  group('Given CountQueryBuilder', () {
    ...
    test(
      ...
      () {
        var query =
            CountQueryBuilder(table: citizenTable).withLimit(10).build();
    ...
    test(
      ...
      () {
        ...
        var query =
            CountQueryBuilder(table: citizenTable)
                .withWhere(
  ...
  test(
    ...
    () {
      ...
      var query =
          SelectQueryBuilder(table: citizenTable)
              .withWhere(ColumnString('name', citizenTable).equals('Serverpod'))
