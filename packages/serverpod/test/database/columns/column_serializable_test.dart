...
void main() {
  ...
  group('Given a ColumnSerializable containing a List<String>', () {
    var columnName = 'configuration';
    var column = ColumnSerializable<List<String>>(
      columnName,
      Table<int?>(tableName: 'test'),
    );
    ...
    test('when type is called then List<String> is returned.', () {
      expect(column.type, List<String>);
    });
  });
}
