...
void main() {
  ...
  test(
    'Given a domain with a leading dot '
    'when building a set-cookie header '
    'then the dot is stripped (host-only).',
    () {
  ...
  test(
    'Given a domain without a leading dot '
    'when building a set-cookie header '
