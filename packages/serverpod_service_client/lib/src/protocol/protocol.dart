...
import 'database/partition_method.dart' as _i33;
import 'database/table_definition.dart' as _i34;
import 'database/table_migration.dart' as _i35;
import 'database/vector_distance_function.dart' as _i36;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i33.PartitionMethod) {
      return _i33.PartitionMethod.fromJson(data) as T;
    }
    ...
    if (t == _i36.VectorDistanceFunction) {
      return _i36.VectorDistanceFunction.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i33.PartitionMethod?>()) {
      return (data != null ? _i33.PartitionMethod.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i36.VectorDistanceFunction?>()) {
      return (data != null ? _i36.VectorDistanceFunction.fromJson(data) : null)
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i33.PartitionMethod => 'PartitionMethod',
      _i34.TableDefinition => 'TableDefinition',
      _i35.TableMigration => 'TableMigration',
      _i36.VectorDistanceFunction => 'VectorDistanceFunction',
      _i37.DistributedCacheEntry => 'DistributedCacheEntry',
      _i38.AccessDeniedException => 'AccessDeniedException',
      _i39.FileNotFoundException => 'FileNotFoundException',
      _i40.FutureCallEntry => 'FutureCallEntry',
      _i41.LogEntry => 'LogEntry',
      _i42.LogLevel => 'LogLevel',
      _i43.LogResult => 'LogResult',
      _i44.LogSettings => 'LogSettings',
      _i45.LogSettingsOverride => 'LogSettingsOverride',
      _i46.MessageLogEntry => 'MessageLogEntry',
      _i47.MethodInfo => 'MethodInfo',
      _i48.QueryLogEntry => 'QueryLogEntry',
      _i49.ReadWriteTestEntry => 'ReadWriteTestEntry',
      _i50.RuntimeSettings => 'RuntimeSettings',
      _i51.ServerHealthConnectionInfo => 'ServerHealthConnectionInfo',
      _i52.ServerHealthMetric => 'ServerHealthMetric',
      _i53.ServerHealthResult => 'ServerHealthResult',
      _i54.ServerpodSqlException => 'ServerpodSqlException',
      _i55.SessionLogEntry => 'SessionLogEntry',
      _i56.SessionLogFilter => 'SessionLogFilter',
      _i57.SessionLogInfo => 'SessionLogInfo',
      _i58.SessionLogResult => 'SessionLogResult',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i33.PartitionMethod():
        return 'PartitionMethod';
      case _i34.TableDefinition():
        return 'TableDefinition';
      case _i35.TableMigration():
        return 'TableMigration';
      case _i36.VectorDistanceFunction():
        return 'VectorDistanceFunction';
      case _i37.DistributedCacheEntry():
        return 'DistributedCacheEntry';
      case _i38.AccessDeniedException():
        return 'AccessDeniedException';
      case _i39.FileNotFoundException():
      ...
      case _i43.LogResult():
        return 'LogResult';
      case _i44.LogSettings():
        return 'LogSettings';
      case _i45.LogSettingsOverride():
      ...
      case _i53.ServerHealthResult():
        return 'ServerHealthResult';
      case _i54.ServerpodSqlException():
        return 'ServerpodSqlException';
      case _i55.SessionLogEntry():
        return 'SessionLogEntry';
      case _i56.SessionLogFilter():
        return 'SessionLogFilter';
      case _i57.SessionLogInfo():
        return 'SessionLogInfo';
      case _i58.SessionLogResult():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'PartitionMethod') {
      return deserialize<_i33.PartitionMethod>(data['data']);
    }
    ...
    if (dataClassName == 'VectorDistanceFunction') {
      return deserialize<_i36.VectorDistanceFunction>(data['data']);
    }
