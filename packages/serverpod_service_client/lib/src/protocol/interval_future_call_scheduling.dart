...
abstract class IntervalFutureCallScheduling
  ...
  factory IntervalFutureCallScheduling.fromJson(
    ...
    return IntervalFutureCallScheduling(
      interval: _isc.DurationJsonExtension.fromJson(
        jsonSerialization['interval'],
      ),
      start: jsonSerialization['start'] == null
          ? null
          : _isc.DateTimeJsonExtension.fromJson(jsonSerialization['start']),
    );
  }
  ...
  IntervalFutureCallScheduling copyWith({
    Duration? interval,
    DateTime? start = const _issu.$UndefinedDateTime(),
  });
  @override
...
class _IntervalFutureCallSchedulingImpl extends IntervalFutureCallScheduling {
  ...
  IntervalFutureCallScheduling copyWith({
    ...
    return IntervalFutureCallScheduling(
      ...
      start: start is _issu.UndefinedSentinel ? this.start : start,
    );
  }
}
