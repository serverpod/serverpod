  ...
  group(
    ...
    () {
      ...
      test('when first open method stream connection succeeds '
        ...
        serverResponses = [OpenMethodStreamResponseType.success];
      ...
      test(
        ...
        () async {
          serverResponses = [OpenMethodStreamResponseType.authenticationFailed];
      ...
      test(
        ...
        'then no retry is attempted.',
        () async {
          serverResponses = [OpenMethodStreamResponseType.endpointNotFound];
