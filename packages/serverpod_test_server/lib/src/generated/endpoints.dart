    ...
    connectors['asyncTasks'] = EndpointConnector(
      ...
      methodConnectors: {
        'insertRowToSimpleDataAfterDelay': MethodConnector(
          ...
          params: {
            'num': ParameterDescription(name: 'num', type: int),
            'seconds': ParameterDescription(name: 'seconds', type: int),
          },
          call: (Session session, Map<String, dynamic> params) async {
    ...
    connectors['transactionsDatabase'] = EndpointConnector(
      ...
      methodConnectors: {
        ...
        'updateInsertDelete': MethodConnector(
          ...
          params: {
            'numUpdate': ParameterDescription(name: 'numUpdate', type: int),
            'numInsert': ParameterDescription(name: 'numInsert', type: int),
            'numDelete': ParameterDescription(name: 'numDelete', type: int),
          },
          call: (Session session, Map<String, dynamic> params) async {
