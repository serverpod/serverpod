...
void main() {
  ...
  test(
    ...
    'then returns correct binary representation.',
    () {
  ...
  test(
    'Given valid binary string, '
    'when creating Bit from string, '
    'then creates correct Bit vector.',
    () {
  ...
  test(
    'Given Bit with known number of booleans, '
  ...
  test(
    'Given Bit vector with at least one true bit, '
    'when calling any, '
    'then returns true.',
    () {
  ...
  test(
    'Given Bit vector with all false bits, '
    'when calling any, '
    'then returns false.',
    () {
  ...
  test(
    'Given Bit vector with all true bits, '
    'when calling every, '
    'then returns true.',
    () {
  ...
  test(
    'Given Bit vector with at least one false bit, '
    'when calling every, '
    'then returns false.',
    () {
