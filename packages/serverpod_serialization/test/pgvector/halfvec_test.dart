...
void main() {
  test(
    'Given HalfVector with values, '
    'when created, '
    'then toString and toList work correctly.',
    () {
  ...
  test(
    'Given HalfVector, '
    'when converted to binary and back, '
  ...
  test(
    ...
    'then binary format structure is correct.',
    () {
  ...
  test(
    'Given empty HalfVector, '
    'when converted to binary, '
    'then binary contains only header.',
    () {
  ...
  test(
    'Given HalfVector with special floating-point values, '
    'when converted to binary, '
  ...
  test(
    'Given HalfVector with extreme float16 range values, '
    'when converted to binary, '
    'then values are within expected precision.',
    () {
  ...
  test(
    'Given HalfVector with known number of elements, '
    'when accessing length, '
    'then returns that count.',
    () {
  ...
  test(
    'Given HalfVector, '
    'when accessing individual indices, '
  ...
  test(
    'Given HalfVector, '
    'when accessing index equal to length, '
  ...
  test(
    'Given HalfVector with a matching element, '
    'when calling any, '
    'then returns true.',
    () {
  ...
  test(
    'Given HalfVector where all elements match, '
    'when calling every, '
    'then returns true.',
    () {
  ...
  test(
    'Given HalfVector with various numeric values, '
    'when converted to binary, '
    'then precision is maintained within float16 limits.',
    () {
      final values = [
        0.5,
        1.0,
