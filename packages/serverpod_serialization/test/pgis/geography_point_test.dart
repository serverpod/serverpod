...
void main() {
  ...
  test('Given two GeographyPoints when comparing then equality works correctly.', () {
  ...
  test('Given GeographyPoint when converted to json then round-trip works.', () {
  ...
  test('Given WKT string when parsing then GeographyPoint is created correctly.', () {
  ...
  test('Given GeographyPoint with custom SRID when converted then SRID is included.', () {
    var point = GeographyPoint(1.5, 2.5, srid: 3857);
