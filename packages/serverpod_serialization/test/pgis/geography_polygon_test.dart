...
void main() {
  ...
  test('Given two GeographyPolygons when comparing then equality works correctly.', () {
  ...
  test('Given GeographyPolygon when converted to json then round-trip works.', () {
  ...
  test('Given WKT string when parsing then GeographyPolygon is created correctly.', () {
    var polygon = GeographyPolygon.fromWkt('POLYGON((0 0, 1 0, 1 1, 0 1, 0 0))');
  ...
  test(
    ...
    () {
      var polygon = GeographyPolygon.fromWkt('SRID=4326;POLYGON((0 0, 1 0, 1 1, 0 1, 0 0))');
      expect(polygon.rings.length, equals(1));
      expect(polygon.srid, equals(4326));
    },
  );

  test('Given GeographyPolygon with custom SRID when converted then SRID is included.', () {
    var polygon = GeographyPolygon(
      [
        [
          const GeographyPoint(0, 0),
