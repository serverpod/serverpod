...
void main() {
  test(
    ...
    () {
      ...
      expect(
        ...
        equals('MULTIPOLYGON(((0 0, 1 0, 1 1, 0 1, 0 0)),((2 2, 3 2, 3 3, 2 3, 2 2)))'),
      );
      expect(
        multiPolygon.toWkt(),
        equals('MULTIPOLYGON(((0 0, 1 0, 1 1, 0 1, 0 0)),((2 2, 3 2, 3 3, 2 3, 2 2)))'),
  ...
  test('Given two GeographyMultiPolygons when comparing then equality works correctly.', () {
  ...
  test('Given GeographyMultiPolygon when converted to json then round-trip works.', () {
  ...
  test('Given WKT string when parsing then GeographyMultiPolygon is created correctly.', () {
    var multiPolygon =
        GeographyMultiPolygon.fromWkt('MULTIPOLYGON(((0 0, 1 0, 1 1, 0 1, 0 0)))');
  ...
  test('Given GeographyMultiPolygon with custom SRID when converted then SRID is included.', () {
    var multiPolygon = GeographyMultiPolygon(
      [
        GeographyPolygon([
          [
