      ...
      expect(
        ...
        throwsA(
          isA<PasswordMissingException>()
              .having((e) => e.passwordName, 'passwordName', equals('database'))
              .having(
                (e) => e.envVarName,
                'envVarName',
...
''';
      ...
      expect(
        () => ServerpodConfig.loadFromMap(runMode, serverId, {
          ...passwords,
          'database': 'password',
        }, loadYaml(serverpodConfig)),
        throwsA(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        {...passwords, 'database': 'password'},
        {
          ...
          'database': {'port': 5432, 'name': 'serverpod'},
        },
        environment: {
          'SERVERPOD_DATABASE_HOST': 'localhost',
          'SERVERPOD_DATABASE_USER': 'admin',
...
''';
      ...
      var config = ServerpodConfig.loadFromMap(
        ...
        {...passwords, 'database': 'password'},
        loadYaml(serverpodConfig),
        environment: {'SERVERPOD_DATABASE_SEARCH_PATHS': 'env_path'},
      );
