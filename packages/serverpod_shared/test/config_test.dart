...
''';
      ...
      var config = ServerpodConfig.loadFromMap(runMode, serverId, {
        ...passwords,
        'redis': 'password',
      }, loadYaml(serverpodConfig));
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        passwords,
        {
          'apiServer': {'publicPort': 8080, 'publicScheme': 'http'},
        },
        environment: {
          'SERVERPOD_API_SERVER_PORT': '8080',
          'SERVERPOD_API_SERVER_PUBLIC_HOST': 'localhost',
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_MAX_REQUEST_SIZE': '1048576'},
      );
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        passwords,
        {
          ...
          'webServer': {'publicPort': 8081, 'publicScheme': 'http'},
        },
        environment: {
          'SERVERPOD_WEB_SERVER_PORT': '8081',
          'SERVERPOD_WEB_SERVER_PUBLIC_HOST': 'localhost',
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        passwords,
        {
          ...
          'insightsServer': {'publicPort': 8081, 'publicScheme': 'http'},
        },
        environment: {
          'SERVERPOD_INSIGHTS_SERVER_PORT': '8081',
          'SERVERPOD_INSIGHTS_SERVER_PUBLIC_HOST': 'localhost',
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        {...passwords, 'redis': 'password'},
        {
          ...
          'redis': {'host': 'localhost', 'port': 6379, 'user': 'default'},
        },
        environment: {
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_REDIS_ENABLED': 'true'},
      );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_SERVER_ID': 'testServer1'},
      );
...
''';
      ...
      var config = ServerpodConfig.loadFromMap(
        ...
        passwords,
        loadYaml(serverpodConfig),
        environment: {'SERVERPOD_SERVER_ID': 'testServerIdFromEnv'},
      );
...
''';
      ...
      var config = ServerpodConfig.loadFromMap(
        ...
        passwords,
        loadYaml(serverpodConfig),
        environment: {'SERVERPOD_FUTURE_CALL_EXECUTION_ENABLED': 'false'},
      );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_SERVER_ROLE': 'serverless'},
      );
    ...
    () {
      expect(
        () => ServerpodConfig.loadFromMap(
          ...
          environment: {'SERVERPOD_SERVER_ROLE': 'invalid_role'},
        ),
        throwsA(
    ...
    () {
      ...
      for (int i = 0; i < validRoles.length; i++) {
        var config = ServerpodConfig.loadFromMap(
          ...
          environment: {'SERVERPOD_SERVER_ROLE': validRoles[i]},
        );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_LOGGING_MODE': 'verbose'},
      );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_LOGGING_MODE': 'verbose'},
        commandLineArgs: {'loggingMode': ServerpodLoggingMode.normal},
      );
    ...
    () {
      expect(
        () => ServerpodConfig.loadFromMap(
          ...
          environment: {'SERVERPOD_LOGGING_MODE': 'invalid_logging'},
        ),
        throwsA(
          isA<ArgumentError>().having(
            (e) => e.toString(),
    ...
    () {
      ...
      for (int i = 0; i < validLoggingModes.length; i++) {
        var config = ServerpodConfig.loadFromMap(
          ...
          environment: {'SERVERPOD_LOGGING_MODE': validLoggingModes[i]},
        );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_APPLY_MIGRATIONS': 'true'},
      );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_APPLY_MIGRATIONS': 'false'},
      );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_APPLY_MIGRATIONS': 'false'},
        commandLineArgs: {'applyMigrations': true},
      );
    ...
    () {
      expect(
        () => ServerpodConfig.loadFromMap(
          ...
          environment: {'SERVERPOD_APPLY_MIGRATIONS': 'invalid_value'},
        ),
        throwsA(
          isA<ArgumentError>().having(
            (e) => e.toString(),
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_APPLY_REPAIR_MIGRATION': 'true'},
      );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_APPLY_REPAIR_MIGRATION': 'false'},
      );
  ...
  test(
    ...
    () {
      var config = ServerpodConfig.loadFromMap(
        ...
        environment: {'SERVERPOD_APPLY_REPAIR_MIGRATION': 'false'},
        commandLineArgs: {'applyRepairMigration': true},
      );
    ...
    () {
      expect(
        () => ServerpodConfig.loadFromMap(
          ...
          environment: {'SERVERPOD_APPLY_REPAIR_MIGRATION': 'invalid_value'},
        ),
        throwsA(
          isA<ArgumentError>().having(
            (e) => e.toString(),
...
''';
      ...
      var config = ServerpodConfig.loadFromMap(
        ...
        passwords,
        loadYaml(serverpodConfig),
        environment: {'SERVERPOD_SERVER_ID': 'envServerId'},
      );
