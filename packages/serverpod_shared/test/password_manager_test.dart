...
''';
    ...
    expect(
      () => passwordManager.loadPasswordsFromMap(loadYaml(passwordsContent)),
  ...
  test(
    ...
    () {
      ...
      var passwords = passwordManager.mergePasswords(
        ...
        {},
        environment: {'CUSTOM_PASSWORD_1': 'password1'},
      );
...
'''),
        environment: {'SERVERPOD_PASSWORD_CUSTOM_1': 'env_value'},
      );
