...
void main() {
  ...
  group('Given a ColumnDouble,', () {
    var columnName = 'age';
    late var column = ColumnDouble(columnName, Table<int?>(tableName: 'test'));
    ...
    group('with _ColumnDefaultOperations mixin,', () {
      ...
      test(
        'when equals compared to double value, '
      ...
      test(
        'when NOT equals compared to double value, '
        ...
        () {
          ...
          expect(
            ...
            '$column IS DISTINCT FROM 10.0',
          );
        },
      );

      test(
        'when checking if expression is between double values, '
        ...
        () {
          ...
          expect(
            comparisonExpression.toString(),
            '$column BETWEEN 10.0 AND 20.0',
          );
        },
      );

      test(
        'when checking if expression is NOT between double value, '
