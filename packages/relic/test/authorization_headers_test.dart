...
void main() {
  group('BearerAuthorizationHeader', () {
    ...
    test(
        'Given an empty token in the authorization header, it throws an ArgumentError',
        () {
    ...
    test(
        'Given an invalid token value without the Bearer prefix in the authorization header, it throws an ArgumentError',
        () {
      var httpRequest = HttpRequestMock()
  ...
  group('BasicAuthorizationHeader', () {
    ...
    test(
        'Given an invalid Basic authorization header, it throws an FormatException',
        () {
    ...
    test(
        'Given a Basic authorization header without the Basic prefix, it throws an ArgumentError',
        () {
    ...
    test(
        'Given a valid Base64-encoded token without a colon, it throws an ArgumentError',
        () {
