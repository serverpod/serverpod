      ...
      (library) {
        library.body.add(
          Class((c) {
            c.abstract = true;
            c.name = className;
            c.docs.addAll(classDefinition.documentation ?? []);
            c.extend = refer('SerializableEntity', serverpodUrl(serverCode));

            if (classDefinition.isException) {
              c.implements = ListBuilder([
            ...
            if (tableName != null && serverCode) {
              ...
              c.extend = refer('TableRow', 'package:serverpod/serverpod.dart');
              c.fields.add(
                Field(
                  (f) => f
                    ..static = true
            ...
            for (var field in fields) {
              if (field.shouldIncludeField(serverCode) &&
                ...
                c.methods.add(Method((m) {
                  ...
                  m.returns = field.type.reference(
                    serverCode,
                    subDirParts: classDefinition.subDirParts,
                    config: config,
                  );
                  ...
                  m.name = field.name;
                  m.docs.addAll(field.documentation ?? []);
                }));
              }
            }
            ...
            c.constructors.add(Constructor((constructor) {
              ...
              constructor.constant = true;
              constructor.redirect = refer('_$className');
              // c.constant = true;

              for (var field in fields) {
                if (field.shouldIncludeField(serverCode)) {
                  if (field.name == 'id' && serverCode && tableName != null) {
                    constructor.optionalParameters.add(Parameter((p) {
                      p.named = true;
                      p.name = 'id';
            ...
            c.constructors.add(Constructor((constructor) {
              ...
              constructor.body = refer(className)
                  .call([], {
                    for (var field in fields)
                      if (field.shouldIncludeField(serverCode))
        ...
        library.body.add(Class((classBuilder) {
          ...
          if (serverCode && tableName != null) {
            classBuilder.extend = refer(className);
          ...
          classBuilder.constructors.add(Constructor((c) {
            c.constant = true;
            c.initializers.add(refer('super._').call([], {}).code);
          ...
          if (true) {
            ...
            if (fields.any((element) => element.type.nullable)) {
              library.body.add(
                Class((classBuilder) {
