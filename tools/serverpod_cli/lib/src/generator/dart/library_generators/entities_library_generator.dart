    ...
    var library = Library((library) {
      library.body.add(
        Enum((e) {
          ...
          if (enumDefinition.serializedAsName) {
            e.fields.add(Field(
              (f) => f
                ..name = '_nameToValue'
                ..static = true
          ...
          e.methods.add(Method((m) => m
            ...
            ..name = 'fromJson'
            ..requiredParameters.add(Parameter((p) => p
              ..name = enumDefinition.serializedAsName ? 'name' : 'index'
              ..type =
                  refer(enumDefinition.serializedAsName ? 'String' : 'int')))
            ..body = enumDefinition.serializedAsName
          ...
          e.methods.add(Method((m) => m
            ...
            ..name = 'toJson'
            ..lambda = true
            ..body = refer(enumDefinition.serializedAsName ? 'name' : 'index')
                .code));
        }),
      );
    });
