...
class ServerTestToolsGenerator {
  ...
  Method _buildEndpointMethod(
    ...
    return Method((methodBuilder) {
      ...
      methodBuilder.body =
          returnsStream || hasStreamParameter
                              ...
                              Method(
                                (methodBuilder) =>
                                    methodBuilder
                                      ...
                                      ..body =
                                          refer('_localUniqueSession').code,
                              ).closure,
          ...
          (methodBuilder) =>
              methodBuilder
                ...
                ..body = Block.of([
                  ...
                  refer('var _localCallContext')
                      .assign(
                        refer('_endpointDispatch').awaited
                              ...
                              'arguments': literalMap({
                                for (var parameter in parameters)
                                  literalString(parameter.name): parameter
                                      .methodArgumentSerializationCode(
                                        config: config,
                                      ),
                              }),
