...
abstract interface class RunnerApi {
  ...
  /// Recovers from a degraded start by regenerating, compiling and booting the
  /// server.
  ///
...
abstract interface class InProcessRunnerApi implements RunnerApi {
  ...
  /// An event for every change of [vmServiceUri], which happens on restart and
  /// on crash recovery but not on hot reload.
...
/// that needs the stack reports this until then. [RunnerApi.stop] works
/// throughout.
