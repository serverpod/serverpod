...
enum GeneratePubspecsOption<V> implements OptionDefinition<V> {
  version(StringOption(argName: 'version', mandatory: true)),
  dartVersion(StringOption(argName: 'dart-version', mandatory: true)),
  flutterVersion(StringOption(argName: 'flutter-version', mandatory: true)),
  mode(
    StringOption(
      argName: 'mode',
