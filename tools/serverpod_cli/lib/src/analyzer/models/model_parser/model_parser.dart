...
class ModelParser {
  ...
  static List<SerializableModelIndexDefinition> _parseIndexes(
    ...
    var manualIndexes = <SerializableModelIndexDefinition>[];
    ...
    var autoGeneratedIndexes = <SerializableModelIndexDefinition>[];
    var tableName = documentContents.nodes[Keyword.table]?.value;
    ...
    return [...manualIndexes, ...autoGeneratedIndexes];
  }
