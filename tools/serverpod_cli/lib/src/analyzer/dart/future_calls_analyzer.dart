...
/// Analyzes dart files for FutureCall definitions.
class FutureCallsAnalyzer {
  final AnalysisContextCollection collection;
  final String absoluteIncludedPaths;

  /// Create a new [FutureCallsAnalyzer].
  ...
  Future<List<FutureCallDefinition>> analyze({
    ...
    // Remove future calls from external packages
  ...
  Iterable<ClassElement> _getFutureCallClasses(ResolvedLibraryResult library) {
    return library.element.classes
        .where(FutureCallClassAnalyzer.isFutureCallClass);
  }
