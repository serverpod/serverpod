    ...
    test(
      ...
      () async {
        ...
        previousPreMigration.writeAsStringSync(
          'CREATE INDEX idx_pre ON test_table(field);',
        );
        previousPostMigration.writeAsStringSync(
          'CREATE INDEX idx_post ON test_table(field2);',
        );
        ...
        expect(
          preContent,
          contains('CREATE INDEX idx_pre ON test_table(field)'),
          reason:
              'pre_database_setup.sql should accumulate pre_migration.sql from previous version',
        );
        expect(
          postContent,
          contains('CREATE INDEX idx_post ON test_table(field2)'),
          reason:
