...
void main() {
  ...
  Future<Directory> createMockServerpodProject({
    ...
    var protocolDir = Directory(path.join(serverDir.path, 'lib', 'src', 'protocol'));
    ...
    var packageConfigFile = File(path.join(dartToolDir.path, 'package_config.json'));
...
''');
    ...
    var clientLibDir = Directory(path.join(clientDir.path, 'lib', 'src', 'protocol'));
