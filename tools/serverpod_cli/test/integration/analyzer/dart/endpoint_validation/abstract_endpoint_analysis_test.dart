...
''');
    ...
    test('then both abstract and concrete endpoint definitions are created.',
        () {
      expect(
...
''');
    ...
    late var concrete = endpointDefinitions
        .firstWhere((e) => e.className == 'ConcreteImplementationEndpoint');

    test('then concrete endpoint does not inherit from hidden base endpoint.',
        () {
