...
void main() {
  ...
  test(
    'Given a model with unique field '
    'when database definition is created '
    'then unique index is included.',
    () {
      var models = [
  ...
  test(
    'Given a model with both unique field and manual index '
    'when database definition is created '
    'then both indexes are included.',
    () {
      var models = [
        ModelSourceBuilder().withYaml(
          '''
