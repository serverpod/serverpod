    ...
    () async {
      ...
      var ProjectDependencyContext(:packageConfig, :projectPubspec) =
          await ProjectDependencyStructureFactory()
              ...
              .addModuleProject(
                ModuleProjectBuilder().withName(moduleName).build(),
              )
          ...
          await ProjectDependencyStructureFactory()
              ...
              .withModuleProjects([
                ModuleProjectBuilder()
                    .withName(moduleName)
                    .withPubspecDependencies([transitiveModuleName])
                    .build(),
      ...
      var ProjectDependencyContext(:packageConfig, :projectPubspec) =
          await ProjectDependencyStructureFactory()
              ...
              .withModuleProjects([
                ModuleProjectBuilder()
                    .withName(moduleName)
                    .withPubspecDependencies([firstTransitiveModuleName])
                    .build(),
                ModuleProjectBuilder()
                    ...
                    .build(),
                ModuleProjectBuilder()
                    .withName(secondTransitiveModuleName)
                    .build(),
              ])
              .addPackageToPackageConfig(moduleName)
