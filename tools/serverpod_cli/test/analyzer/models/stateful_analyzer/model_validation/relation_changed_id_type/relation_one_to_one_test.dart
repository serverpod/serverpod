  ...
  for (var idType in TypeDefinition.validIdTypes) {
    ...
    group(
      ...
      group('then the address field has a relation', () {
        ...
        test('has the nullableRelation set to false', () {
          expect(
              (relation as ObjectRelationDefinition).nullableRelation, false);
    ...
    group(
      ...
      var models = [
        ...
        table: address
        fields:
          userId: $idClassName, relation(parent=user, name=user_address)
        indexes:
          user_id_index_idx:
            fields: userId
            unique: true
