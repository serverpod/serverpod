...
void main() {
  ...
  group('Given a class with "database: sync"', () {
    ...
    test(
      'when validating with the databaseSync experimental feature disabled '
      'then an error is generated.',
      () {
        var collector = CodeGenerationCollector();
        StatefulAnalyzer(
    ...
    test(
      'when validating with the databaseSync experimental feature enabled '
      'then no error is generated.',
      () {
    ...
    test(
      'when validating with all experimental features enabled '
      'then no error is generated.',
      () {
        var config = GeneratorConfigBuilder().withEnabledExperimentalFeatures([
