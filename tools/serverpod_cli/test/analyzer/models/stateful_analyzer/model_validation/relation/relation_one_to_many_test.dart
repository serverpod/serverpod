...
void main() {
  ...
  group('Given a class with a one to many relation', () {
    ...
    test(
      'then the foreign field name is set on the list relation.',
      () {
        expect(relation.runtimeType, ListRelationDefinition);
        expect(
    ...
    test(
      'then the foreign container field field is set on the list relation.',
      () {
        expect(
    ...
    test(
      'then has the nullableRelation set to false',
      () {
    ...
    test(
      'then has the foreign container field set on the object relation.',
      () {
        var objectRelationField = employeeDefinition.findField('company');

        var relation =
            objectRelationField?.relation as ObjectRelationDefinition;
  ...
  group(
    ...
    () {
      ...
      group('then two independent relations are created', () {
        ...
        test(
          'with the relation field created with scope none on employee side.',
          () {
            var field = employeeDefinition.findField(
              '_companyEmployeesCompanyId',
            );
        ...
        test(
          'with the companyId relation field created on the employee side.',
          () {
  ...
  group(
    ...
    () {
      ...
      test(
        'then the error messages says the value must be a string.',
        () {
          expect(errors.first.message, 'The property must be a String.');
        },
        skip: errors.isEmpty,
      );
    },
  ...
  group('Given an implicit one to many relation', () {
    ...
    test(
      'has the nullableRelation set to true',
      () {
  ...
  group(
    ...
    () {
      ...
      test('then orders is list relation', () {
        expect(
          classDefinition.findField('orders')?.relation.runtimeType,
          ListRelationDefinition,
        );
      });

      test(
        'then the list relation is NOT linked with the customerId field',
        () {
          var relation =
              classDefinition.findField('orders')?.relation
