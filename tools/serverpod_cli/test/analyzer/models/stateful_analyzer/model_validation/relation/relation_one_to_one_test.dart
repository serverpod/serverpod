...
void main() {
  ...
  group(
    ...
    () {
      ...
      group('then a relation is defined on the addressId', () {
        ...
        test(
          'and has the foreignFieldName set to "id"',
          () {
        ...
        test(
          'and the parent table is set to address',
          () {
            var foreignRelation = relation as ForeignRelationDefinition;
        ...
        test(
          'and the foreignContainerField is null.',
          () {
            var foreignRelation = relation as ForeignRelationDefinition;
        ...
        test(
          'and the containerField is null.',
          () {
            var foreignRelation = relation as ForeignRelationDefinition;
  ...
  group(
    ...
    () {
      ...
      group('then the address field has a relation', () {
        ...
        test(
          'has the nullableRelation set to false',
          () {
            expect(
        ...
        test(
          'without a name for the relation',
          () {
        ...
        test(
          'with the foreignContainerField set to null.',
          () {
  ...
  group(
    ...
    () {
      ...
      group('then a relation is defined on the addressId', () {
        ...
        test(
          'and has the containerField set.',
          () {
            var foreignRelation = relation as ForeignRelationDefinition;
  ...
  group(
    ...
    () {
      ...
      group('then a relation is defined on the addressId', () {
        ...
        test(
          'and has the foreignContainerField set.',
          () {
            var foreignRelation = relation as ForeignRelationDefinition;
      ...
      group('then the user relation', () {
        ...
        test(
          'has the fieldName defined to the primary key on this side.',
          () {
            var validateRelation = relation as ObjectRelationDefinition;
  ...
  group(
    ...
    () {
      ...
      group('then the user relation', () {
        ...
        test(
          'with the foreignContainerField set.',
          () {
            var relationObject = relation as ObjectRelationDefinition;
      ...
      group('then a relation is defined on the addressId', () {
        ...
        test(
          'and the relation name is set to the user defined relation name.',
          () {
            var foreignRelation = relation as ForeignRelationDefinition;
  ...
  test('Given I have an object relation and the child is serverOnly and the relation is optional, '
       'when analyzing, '
  ...
  test('Given I have an object relation and the child is serverOnly and the relation is not optional, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an object relation and the child is not serverOnly and the relation is optional, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an object relation and the child is not serverOnly and the relation is optional  and the field scope is serverOnly, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an object relation and the child is not serverOnly and the relation is not optional, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an object relation and the child is not serverOnly and the relation is not optional  and the field scope is serverOnly, '
       'when analyzing, '
  ...
  test('Given I have an id relation and the child is serverOnly and the relation is nullable, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an id relation and the child is serverOnly and the relation is not nullable, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an id relation and the child is not serverOnly and the relation is nullable, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an id relation and the child is not serverOnly and the relation is nullable  and the field scope is serverOnly, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an id relation and the child is not serverOnly and the relation not is nullable, '
       'when analyzing, '
       'then no errors are collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
  ...
  test('Given I have an id relation and the child is not serverOnly and the relation is not nullable  and the field scope is serverOnly, '
       'when analyzing, '
       'then an error is collected', () {
    var models = [
      (ModelSourceBuilder().withFileName('parent').withYaml(
