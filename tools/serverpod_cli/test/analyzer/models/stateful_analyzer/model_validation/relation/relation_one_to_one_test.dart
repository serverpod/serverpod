      ...
      group('then a relation is defined on the addressId', () {
        ...
        test(
          ...
          () {
            ...
            expect(foreignRelation.parentTable, 'address');
          },
          skip: relation is! ForeignRelationDefinition,
        );
        ...
        test(
          ...
          () {
            ...
            expect(foreignRelation.foreignContainerField, isNull);
          },
          skip: relation is! ForeignRelationDefinition,
        );
        ...
        test(
          ...
          () {
            ...
            expect(foreignRelation.containerField, isNull);
          },
          skip: relation is! ForeignRelationDefinition,
        );
      });
      ...
      group('then a relation is defined on the addressId', () {
        ...
        test(
          ...
          () {
            ...
            expect(foreignRelation.containerField?.name, 'address');
          },
          skip: relation is! ForeignRelationDefinition,
        );
      });
      ...
      group('then a relation is defined on the addressId', () {
        ...
        test(
          ...
          () {
            ...
            expect(foreignRelation.containerField, containerField);
          },
          skip: relation is! ForeignRelationDefinition,
        );
      });
      ...
      group('then a relation is defined on the addressId', () {
        ...
        test(
          ...
          () {
            ...
            expect(foreignRelation.foreignContainerField, foreignField);
          },
          skip: relation is! ForeignRelationDefinition,
        );
  ...
  group(
    ...
    () {
      ...
      test('then the defined addressId field exists.', () {
        expect(userDefinition.findField('addressId'), isNotNull);
      }, skip: errors.isNotEmpty);
