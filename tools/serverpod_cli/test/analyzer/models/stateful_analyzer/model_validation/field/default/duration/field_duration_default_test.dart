...
void main() {
  ...
  group('Given a class with fields with a "default" keyword for Duration type,', () {
    test(
      'when the field is of type Duration and the default is set to "1d 2h 10min 30s 100ms", '
    ...
    test(
      'when the field is of type Duration and the default is empty, '
    ...
    test(
      'when the field is of type Duration with an invalid default value "INVALID_DURATION", '
      'then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
    ...
    test(
      'when the field is of type Duration with an invalid default value containing an incorrect format, '
      'then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
