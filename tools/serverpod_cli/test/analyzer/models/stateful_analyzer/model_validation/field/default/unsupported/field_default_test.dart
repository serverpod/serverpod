...
void main() {
  ...
  group('Given a class with fields with a "default" keyword,', () {
    test(
      'when the field is of an unsupported type ByteData with a default value, '
    ...
    test(
      'when the field is of an unsupported type Map with a default value, '
      'then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
    ...
    test(
      'when the field is of an unsupported type List with a default value, '
      'then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
    ...
    test(
      'when the field is of an unsupported type Example with a default value, '
      'then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
