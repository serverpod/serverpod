...
void main() {
  ...
  group('Given a class with fields with a "defaultPersist" keyword', () {
    test(
      'when the field is of type BigInt and the defaultPersist is set to "10", then the field should have a "default persist" value',
      () {
        var models = [
    ...
    test(
      'when the field is of type BigInt and the defaultPersist is set to 20, then the field should have a "default persist" value',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
            '''
          ...
          table: example
          fields:
            bigIntType: BigInt?, defaultPersist=20
          ''',
          ).build()
        ];
    ...
    test(
      'when the field is of type BigInt and the defaultPersist is set to "99999999999999999999999", then the field should have a "default persist" value',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
            '''
          ...
          table: example
          fields:
            bigIntType: BigInt?, defaultPersist="99999999999999999999999"
          ''',
          ).build()
        ];
    ...
    test(
      'when the field is of type BigInt and the defaultPersist is set to an unquoted larger than 64 bit integer, then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
            '''
    ...
    test(
      'when the field is of type BigInt with an invalid defaultPersist value, then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
            '''
          ...
          table: example
          fields:
            bigIntInvalid: BigInt?, defaultPersist=test
          ''',
          ).build()
        ];
