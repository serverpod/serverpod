...
void main() {
  ...
  group('Given a class with fields with a "defaultPersist" keyword,', () {
    test(
      'when the field is of type bool and the defaultPersist is set to "true", '
    ...
    test(
      'when the field is of type bool and the defaultPersist is set to "false", '
      'then the field should have a "default persist" value',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
    ...
    test(
      'when the field is of type bool and the defaultPersist is empty, '
    ...
    test(
      'when the field is of type bool with an invalid defaultPersist value "TRUE", '
      'then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
    ...
    test(
      'when the field is of type bool with an invalid defaultPersist value, '
      'then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
    ...
    test(
      'when the field is of type bool non-nullable type, '
      'then an error is generated',
      () {
        var models = [
          ModelSourceBuilder().withYaml(
