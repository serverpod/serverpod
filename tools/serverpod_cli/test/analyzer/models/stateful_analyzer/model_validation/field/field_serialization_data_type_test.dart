...
void main() {
  ...
  test(
    'Given a serializable field with no `serializationDataType` key, '
    'when validating, '
    'then the field `serializationDataType` is null.',
    () {
      var models = [
  ...
  test(
    'Given a serializable field with `serializationDataType` set to jsonb, '
    'when validating, '
  ...
  test(
    'Given a serializable field with `serializationDataType` set to json, '
    'when validating, '
  ...
  test(
    'Given a serializable field with `serializationDataType` set to an invalid value, '
    'when validating, '
  ...
  test(
    'Given a non-serializable field with `serializationDataType` set, '
    'when validating, '
    'then an error about the invalid field type is reported.',
    () {
      var models = [
        ModelSourceBuilder().withYaml('''
        class: Example
