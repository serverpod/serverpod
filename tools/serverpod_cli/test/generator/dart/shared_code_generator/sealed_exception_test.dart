...
void main() {
  ...
  var serverpodImportPath =
      'package:serverpod_serialization/serverpod_serialization.dart';

  group(
    'Given a hierarchy with a sealed parent exception and a normal child, when generating shared code',
    () {
  ...
  group(
    'Given a hierarchy with a sealed parent exception and two normal children with nullable fields when generating shared code',
    () {
      var parent = ExceptionClassDefinitionBuilder()
  ...
  group(
    'Given a hierarchy with a sealed parent exception with a nullable field and a child with no nullable fields when generating shared code',
    () {
      var parent = ExceptionClassDefinitionBuilder()
  ...
  group(
    'Given a hierarchy with a normal parent exception, a sealed child and a normal grandchild when generating shared code',
    () {
  ...
  group(
    'Given a sealed parent exception when generating shared code',
    () {
      var parent = ExceptionClassDefinitionBuilder()
          .withClassName('AppException')
          .withFileName('app_exception')
  ...
  group(
    'Given a model with a sealed exception as a field type when generating shared code',
    () {
