  ...
  group(
    ...
    () {
      ...
      group('then the UuidDefault has a private constructor', () {
        ...
        test('with uuidDefaultRandom default value set correctly', () {
        ...
        test('with uuidDefaultRandomV7 default value set correctly', () {
          var initializer = privateConstructor?.initializers.firstWhere(
        ...
        test('with uuidDefaultStr default value set correctly', () {
          var initializer = privateConstructor?.initializers.firstWhere(
        ...
        test('with uuidDefaultStrNull default value set correctly', () {
          var initializer = privateConstructor?.initializers.firstWhere(
