      ...
      group('with a deserialize method', () {
        ...
        test('that returns $childClassName.fromJson with the top nodes alias',
          ...
          expect(
            deserializeMethod!
                .toSource()
                .contains('return _i3.$childClassName.fromJson'),
            isTrue,
          );
        });
        ...
        test(
          ...
          expect(
            deserializeMethod!
                .toSource()
                .contains('return _i3.$grandchildClassName.fromJson'),
            isTrue,
          );
        });
      });
      ...
      group('with a deserializeByClassName method', () {
        ...
        test('that returns the $childClassName with the top node alias', () {
          expect(
            deserializeByClassNameMethod!
                .toSource()
                .contains('return deserialize<_i3.ChildExample>'),
            isTrue,
          );
        });
        ...
        test('that returns the $grandchildClassName with the top node alias',
          ...
          expect(
            deserializeByClassNameMethod!
                .toSource()
                .contains('return deserialize<_i3.GrandChildExample>'),
            isTrue,
          );
        });
      });
