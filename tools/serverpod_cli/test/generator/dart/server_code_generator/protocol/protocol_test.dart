...
void main() {
  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () {
          expect(codeMap[expectedFileName], contains(modelName.pascalCase));
        },
      );
    },
  );
  ...
  group(
    ...
    () {
      ...
      test('then the protocol.dart does not contain import to itself.', () {
        expect(
  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () {
          expect(codeMap[expectedFileName], contains('wrapWithClassName'));
        },
      );
    },
  );
        ...
        ModelClassDefinitionBuilder()
            ...
            .withIndexesFromDefinitions([
              ...
              IndexDefinitionBuilder()
                  ...
                  .withParameters({'m': '64', 'ef_construction': '200'})
                  .withElements([
                    IndexElementDefinition(
