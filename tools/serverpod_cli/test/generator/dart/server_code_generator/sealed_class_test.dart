...
void main() {
  String getExpectedFilePath(String fileName, {List<String>? subDirParts}) =>
      p.joinAll(['lib', 'src', 'generated', ...?subDirParts, '$fileName.dart']);
    ...
    () {
      ...
      group('Then the ${parent.className}', () {
        ...
        test('has a part directive with ${child.className} uri', () {
          ...
          expect(partDirective?.uri.stringValue, '${child.fileName}.dart');
        });
      ...
      group('Then the ${child.className}', () {
        ...
        test('has a part-of directive with ${parent.className} uri', () {
          ...
          expect(partDirectives?.uri?.stringValue, '${parent.fileName}.dart');
        });
  ...
  group(
    ...
    () {
      ...
      var models = [parent, child1, child2];
  ...
  group(
    ...
    () {
      ...
      var models = [grandparent, parent, child];
  ...
  group(
    ...
    () {
      ...
      var models = [greatGrandparent, grandparent, parent, child];
      ...
      var greatGrandparentCompilationUnit =
          parseString(
      ...
      group('then ${greatGrandparent.className}', () {
        test('has part directives for all children', () {
          ...
          expect(partDirective?.uri.stringValue, '${parent.fileName}.dart');
  ...
  group(
    ...
    () {
      ...
      var parentCompilationUnit =
          parseString(content: codeMap[parentPath]!).unit;
      ...
      group('then ${grandparent.className}', () {
        test('has a part directive with ${parent.className} uri', () {
          ...
          expect(partDirective, isNotNull);
        });
      ...
      group('then ${parent.className}', () {
        test('has a part-of directive with ${grandparent.className} uri', () {
          ...
          expect(partOfDirective, isNotNull);
        });
      });
