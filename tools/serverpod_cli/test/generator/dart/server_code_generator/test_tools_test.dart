  ...
  group(
    ...
    () {
      ...
      test('then configuration options header is present', () async {
        expect(testToolsFile, contains('**Configuration options**'));
      });

      test(
        'then doc comments with correct spacing exist for each configurable parameter',
        () async {
          expect(testToolsFile, contains('\n///\n/// [applyMigrations] '));
  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () async {
          expect(testToolsFile, isNot(contains('/// [applyMigrations]')));
          expect(testToolsFile, isNot(contains('/// [rollbackDatabase]')));
        },
      );
    },
  );
