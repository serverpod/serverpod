...
void main() {
  ...
  group(
    ...
    () {
      ...
      test('then a class is generated with that class variable.', () {
        expect(
          CompilationUnitHelpers.hasFieldDeclaration(
            maybeClassNamedExample!,
            name: 'title',
  ...
  group(
    ...
    () {
      ...
      test('then a class is NOT generated with that class variable.', () {
        expect(
          CompilationUnitHelpers.hasFieldDeclaration(
            maybeClassNamedExample!,
            name: 'title',
  ...
  group('Given exception class when generating code', () {
    ...
    test('then class implements SerializableException.', () {
      expect(
        CompilationUnitHelpers.hasImplementsClause(
          maybeClassNamedExample!,
      ...
      group('then class', () {
        ...
        test('has a toJson that uses hidden class variable.', () {
          ...
          expect(
            ...
            reason: 'Missing use of hidden class variable in setColumn method.',
          );
        });
