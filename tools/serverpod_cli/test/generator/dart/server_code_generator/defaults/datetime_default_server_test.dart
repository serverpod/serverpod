  ...
  group(
    ...
    () {
      ...
      group('then the DateTimeDefault has a private constructor', () {
        ...
        test('with dateTimeDefaultNow default value set correctly', () {
        ...
        test('with dateTimeDefaultStr default value set correctly', () {
          var initializer = privateConstructor?.initializers.firstWhere(
        ...
        test('with dateTimeDefaultStrNull default value set correctly', () {
          var initializer = privateConstructor?.initializers.firstWhere(
