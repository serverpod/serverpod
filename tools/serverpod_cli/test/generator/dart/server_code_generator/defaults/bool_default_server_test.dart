  ...
  group(
    ...
    () {
      ...
      group('then the BoolDefault has a private constructor', () {
        ...
        test('with boolDefaultTrue default value set correctly', () {
        ...
        test('with boolDefaultFalse default value set correctly', () {
          var initializer = privateConstructor?.initializers.firstWhere(
        ...
        test('with boolDefaultNullFalse default value set correctly', () {
          var initializer = privateConstructor?.initializers.firstWhere(
