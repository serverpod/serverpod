...
void main() {
  ...
  group(
      'Given a class with a field with an explicit column name '
    ...
    group('then the class named ${testClassName}Table', () {
      test(
          'has the columnName for the field set to the explicit '
        ...
        expect(
          ...
          reason: 'columnName for $fieldName set to $columnName not found '
              'in constructor.',
        );
      });
    });
