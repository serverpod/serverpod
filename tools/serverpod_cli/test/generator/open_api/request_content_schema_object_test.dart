...
void main() {
  ...
  group('Serializes OpenAPIRequestContentSchema.', () {
    ...
    test(
        'Given the parameters (Example example) when converting to json then the type is set to object and properties contains example which references Example.',
        () {
      OpenAPIRequestContentSchema object = OpenAPIRequestContentSchema(
        params: [
          ParameterDefinition(
              name: 'example', type: exampleType, required: true),
        ],
      );
    ...
    test(
        'Given the parameters (int id,Example example) when converting to json then the type is set to object and properties contains  id(integer) and example which references Example.',
        () {
      OpenAPIRequestContentSchema object = OpenAPIRequestContentSchema(
        params: [
          ParameterDefinition(name: 'id', type: intType, required: true),
    ...
    test(
        'Given the parameters (int id,List<Example> examples) when converting to json then the type is set to object and properties contains  id (integer) and examples (array) which references Example',
        () {
      OpenAPIRequestContentSchema object = OpenAPIRequestContentSchema(
        params: [
          ParameterDefinition(name: 'id', type: intType, required: true),
    ...
    test(
        'Given the parameters (int id,Map<String,dynamic> map) when converting to json then the type is set to object and properties contains id (integer) and map with additionalProperties which references AnyValue.',
        () {
      OpenAPIRequestContentSchema object = OpenAPIRequestContentSchema(
        params: [
          ParameterDefinition(name: 'id', type: intType, required: true),
