...
void main() {
  group(
    ...
    test(
        ...
        () {
      var matcher = containsClass('User')
          .withUnnamedConstructor()
          .withSuperInitializer()
          .withArgument('5') as Matcher;
  ...
  group(
    ...
    test(
      ...
      var matcher = containsClass('User')
          .withUnnamedConstructor()
          .withSuperInitializer()
          .withNamedArgument('name', 'name') as Matcher;
      var description = StringDescription();
      matcher.describeMismatch(compilationUnit, description, {}, false);
  ...
  group(
    ...
    test(
      ...
      var matcher = containsClass('User')
          .withUnnamedConstructor()
          .withSuperInitializer()
          .withNamedArgument('name', 'surname') as Matcher;
      var description = StringDescription();
      matcher.describeMismatch(compilationUnit, description, {}, false);
    ...
    test(
      ...
      var matcher = containsClass('User')
          .withUnnamedConstructor()
          .withSuperInitializer()
          .withPositionalArgument('name') as Matcher;
      var description = StringDescription();
      matcher.describeMismatch(compilationUnit, description, {}, false);
