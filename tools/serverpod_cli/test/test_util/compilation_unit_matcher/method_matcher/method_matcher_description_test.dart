...
void main() {
  ...
  test(
    ...
    final matcher = containsClass('User')
        .withMethod('methodName', isOverride: true) as Matcher;
    final description = StringDescription();
    matcher.describe(description);
  ...
  test(
      ...
      () {
    final matcher = containsClass('User')
        .withMethod('methodName', isOverride: false) as Matcher;
    final description = StringDescription();
    matcher.describe(description);
  ...
  test(
      ...
      () {
    final matcher = containsClass('User')
        .withMethod('methodName', returnType: 'String') as Matcher;
    final description = StringDescription();
    matcher.describe(description);
  ...
  test(
      ...
      () {
    final matcher = containsClass('User').withMethod('methodName',
        isOverride: true, returnType: 'String') as Matcher;
    final description = StringDescription();
    matcher.describe(description);
