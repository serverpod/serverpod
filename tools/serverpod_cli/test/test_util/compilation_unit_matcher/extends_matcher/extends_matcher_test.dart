...
void main() {
    ...
    () {
      ...
      test(
        ...
        () {
          ...
          expect(description.toString(), equals('does not extend any class'));
        },
      );
    },
  );
  ...
  group('Given compilation unit with class that extends another class', () {
    ...
    test('when matching class and extention then test passes', () {
      expect(compilationUnit, containsClass('User').thatExtends('Parent'));
    });
    ...
    test(
      ...
      () {
        ...
        expect(description.toString(), equals('extends the class "Parent"'));
      },
    );
  });
  ...
  test(
    ...
    () {
      ...
      expect(
        ...
        equals(
          'a CompilationUnit containing class "User" that extends "Parent"',
        ),
      );
    },
  );
