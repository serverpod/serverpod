...
void main() {
  ...
  test(
      ...
      () {
    final matcher = containsClass('User').withNamedConstructor('_') as Matcher;
    final description = StringDescription();
    matcher.describe(description);
  ...
  test(
    ...
    final matcher = containsClass('User')
        .withUnnamedConstructor(isFactory: true) as Matcher;
    final description = StringDescription();
    matcher.describe(description);
  ...
  test(
      ...
      () {
    final matcher = containsClass('User')
        .withNamedConstructor('_', isFactory: true) as Matcher;
    final description = StringDescription();
    matcher.describe(description);
