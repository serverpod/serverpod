...
void main() {
  ...
  group('Given compilation unit with class and unnamed constructor', () {
    ...
    test('when matching class and unnamed constructor then test passes', () {
      expect(compilationUnit, containsClass('User').withUnnamedConstructor());
    });
  ...
  group('Given compilation unit with class and named factory constructor', () {
    ...
    test('when matching class and named constructor then test passes', () {
      expect(
        compilationUnit,
        containsClass('User').withNamedConstructor('namedFactory'),
      );
    });
    ...
    test(
      ...
      () {
        expect(
          ...
          containsClass(
            'User',
          ).withNamedConstructor('namedFactory', isFactory: true),
        );
      },
    );
      ...
      () {
        expect(
          ...
          isNot(
            containsClass(
              'User',
            ).withNamedConstructor('namedFactory', isFactory: false),
          ),
        );
      },
    );
