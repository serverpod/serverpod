  ...
  group('Given compilation unit with class and constructor', () {
    ...
    ''',
      ...
      test(
        ...
        final matcher = containsClass('User')
            ...
            .withParameter('nonExistent') as Matcher;
      ...
      test(
        ...
        final matcher = containsClass('User')
            .withUnnamedConstructor()
            .withInitializerParameter('name', Initializer.super_) as Matcher;
        final description = StringDescription();
        matcher.describeMismatch(compilationUnit, description, {}, false);

        expect(
          description.toString(),
          equals('contains parameter "name" but it is initialized with "this"'),
        );
      });
    });
    ...
    ''',
      ...
      test(
        ...
        final matcher = containsClass('User')
            .withUnnamedConstructor()
            .withInitializerParameter('name', Initializer.this_) as Matcher;
        final description = StringDescription();
        matcher.describeMismatch(compilationUnit, description, {}, false);
    ...
    ''',
      ...
      test(
        ...
        final matcher = containsClass('User')
            .withUnnamedConstructor()
            .withTypedParameter('name', 'int') as Matcher;
        final description = StringDescription();
        matcher.describeMismatch(compilationUnit, description, {}, false);
    ...
    ''',
      ...
      test(
        ...
        final matcher = containsClass('User')
            .withUnnamedConstructor()
            .withParameter('name', isRequired: false) as Matcher;
        final description = StringDescription();
        matcher.describeMismatch(compilationUnit, description, {}, false);
