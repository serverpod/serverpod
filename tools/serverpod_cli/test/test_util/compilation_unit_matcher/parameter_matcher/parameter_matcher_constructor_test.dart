...
void main() {
  group('Given compilation unit with class and constructor with no parameters',
      () {
    ...
    test(
      ...
      expect(
        ...
        isNot(containsClass('User')
            ...
            .withParameter('nonExistentParameter')),
      );
    });
  });
  ...
  group('Given compilation unit with class and constructor with parameter', () {
    ...
    test('when matching class and constructor with parameter then test passes',
        () {
      expect(
        compilationUnit,
  ...
  group(
    ...
    test(
      ...
      expect(
        ...
        containsClass('User')
            .withUnnamedConstructor()
            .withTypedParameter('name', 'String'),
      );
    });
  ...
  group(
    ...
    test(
      ...
      expect(
        ...
        containsClass('User')
            .withUnnamedConstructor()
            .withParameter('name', isRequired: true),
      );
    });
    ...
    test(
      ...
      expect(
        ...
        isNot(containsClass('User')
            .withUnnamedConstructor()
            .withParameter('name', isRequired: false)),
      );
    });
    ...
    test(
      ...
      expect(
        compilationUnit,
        containsClass('User').withUnnamedConstructor().withInitializerParameter(
              'name',
              Initializer.this_,
              isRequired: true,
            ),
