...
void main() {
  ...
  test(
    ...
    final matcher = containsClass('User')
        .withUnnamedConstructor()
        .withParameter('name', isRequired: true) as Matcher;
    final description = StringDescription();
    matcher.describe(description);
  ...
  test(
    ...
    final matcher = containsClass('User')
        .withUnnamedConstructor()
        .withTypedParameter('name', 'String') as Matcher;
    final description = StringDescription();
    matcher.describe(description);
  ...
  test(
    ...
    final matcher = containsClass('User')
        .withUnnamedConstructor()
        .withTypedParameter('name', 'String', isRequired: true) as Matcher;
    final description = StringDescription();
    matcher.describe(description);
