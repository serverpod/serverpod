  ...
  group('Given a class with an extends clause that has no generics', () {
    ...
    test(
      ...
      () {
        ...
        expect(description.toString(), equals('does not have any generics'));
      },
    );
  });
    ...
    test(
      ...
      () {
        ...
        expect(
          ...
          equals('does not have the generic "X". Found generics: [T]'),
        );
      },
    );
  });
  ...
  group('Given a class with an extends clause that with multiple generics', () {
    ...
    test(
      ...
      () {
        ...
        expect(
          description.toString(),
          equals('does not have the generic "X". Found generics: [T, V]'),
        );
      },
    );
  });
