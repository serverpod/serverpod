...
final _serverpodHome = p.normalize(p.join(_cliRoot, '..', '..'));

/// Path to the compiled serverpod executable.
late final String _serverpodExe;
...
void main() {
  setUpAll(() async {
    ...
    _serverpodExe = p.join(d.sandbox, 'serverpod_cli_test');
    final result = await Process.run(
      'dart',
      ['compile', 'exe', 'bin/serverpod_cli.dart', '-o', _serverpodExe],
