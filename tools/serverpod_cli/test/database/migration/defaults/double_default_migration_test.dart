...
void main() {
  group('Given a database table definition with a double column,', () {
    test(
      'when generating SQL with a specific double default value (10.5), '
    ...
    test(
      'when generating SQL with a specific double default value (20.5), '
      'then the table should have the correct default value.',
      () {
        var databaseDefinition = DatabaseDefinitionBuilder()
            .withTable(
    ...
    test(
      ...
      'then the table should not have a default value for the double field.',
      () {
        var databaseDefinition = DatabaseDefinitionBuilder()
            .withTable(
              TableDefinitionBuilder()
    ...
    test(
      'when generating SQL with nullable double field and columnDefault (10.5), '
    ...
    test(
      'when generating SQL with nullable double field and no columnDefault, '
  ...
  group('Given a SQLite database table definition with a double column,', () {
    ...
    test(
      'when generating SQL with no columnDefault, '
      'then the double column has no DEFAULT.',
      () {
        var databaseDefinition = DatabaseDefinitionBuilder()
            .withDefaultModules()
            .withTable(
