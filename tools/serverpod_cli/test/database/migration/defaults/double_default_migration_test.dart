  ...
  group('Given a database table definition with a double column', () {
    test(
      ...
      () {
        ...
        expect(
          sql,
          contains('"doubleDefault" double precision NOT NULL DEFAULT 10.5'),
        );
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(
          sql,
          contains('"doubleDefault" double precision NOT NULL DEFAULT 20.5'),
        );
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"doubleDefault" double precision NOT NULL'));
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"doubleDefault" double precision DEFAULT 10.5'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"doubleDefault" double precision'));
        expect(sql, isNot(contains('DEFAULT')));
      },
    );
  });
