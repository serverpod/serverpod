  ...
  group('Given a database table definition with a boolean column', () {
    test(
      ...
      () {
        ...
        expect(sql, contains('"boolDefault" boolean NOT NULL DEFAULT true'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"boolDefault" boolean NOT NULL DEFAULT false'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"boolDefault" boolean NOT NULL'));
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"boolDefault" boolean DEFAULT true'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"boolDefault" boolean DEFAULT false'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"boolDefault" boolean'));
        expect(sql, isNot(contains('DEFAULT')));
      },
    );
  });
