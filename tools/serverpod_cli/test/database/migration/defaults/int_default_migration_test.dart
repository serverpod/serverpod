  ...
  group('Given a database table definition with an integer column', () {
    test(
      ...
      () {
        ...
        expect(sql, contains('"intDefault" integer NOT NULL DEFAULT 10'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"intDefault" integer NOT NULL DEFAULT 20'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"intDefault" integer DEFAULT 10'));
      },
    );
