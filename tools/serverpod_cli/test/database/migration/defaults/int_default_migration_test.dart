...
void main() {
  ...
  group('Given a SQLite database table definition with an integer column ', () {
    test(
      'when generating SQL with a specific integer default value (10), then INTEGER has numeric default.',
      () {
        var databaseDefinition = DatabaseDefinitionBuilder()
            .withDefaultModules()
            .withTable(
    ...
    test(
      'when generating SQL with a specific integer default value (20), then INTEGER has numeric default.',
      () {
        var databaseDefinition = DatabaseDefinitionBuilder()
            .withDefaultModules()
            .withTable(
    ...
    test(
      'when generating SQL with no columnDefault, then the integer column has no DEFAULT.',
      () {
        var databaseDefinition = DatabaseDefinitionBuilder()
            .withDefaultModules()
            .withTable(
        ...
        expect(sql, contains('"intDefault" INTEGER NOT NULL'));
        expect(
          sql,
          isNot(contains('"intDefault" INTEGER NOT NULL DEFAULT')),
        );
      },
    );

    test(
      'when generating SQL with nullable integer field and columnDefault (10), then the column is nullable with default.',
      () {
        var databaseDefinition = DatabaseDefinitionBuilder()
            .withDefaultModules()
            .withTable(
    ...
    test(
      'when generating SQL with nullable integer field and no columnDefault, then the column has no DEFAULT.',
      () {
        var databaseDefinition = DatabaseDefinitionBuilder()
            .withDefaultModules()
            .withTable(
        ...
        expect(sql, contains('"intDefault" INTEGER\n'));
        expect(sql, isNot(contains('"intDefault" INTEGER DEFAULT')));
      },
    );
  });
}
