  ...
  group('Given a database table definition with a UUID column', () {
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"uuid" uuid NOT NULL'));
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"uuid" uuid NOT NULL DEFAULT gen_random_uuid()'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(
          sql,
          contains('"uuid" uuid NOT NULL DEFAULT gen_random_uuid_v7()'),
        );
      },
    );
