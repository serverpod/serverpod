  ...
  group('Given a database table definition with a Duration column', () {
    test(
      ...
      () {
        ...
        expect(
          sql,
          contains('"durationDefault" bigint NOT NULL DEFAULT 94230100'),
        );
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(
          sql,
          contains('"durationDefault" bigint NOT NULL DEFAULT 177640100'),
        );
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"durationDefault" bigint NOT NULL'));
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"durationDefault" bigint DEFAULT 94230100'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(sql, contains('"durationDefault" bigint'));
        expect(sql, isNot(contains('DEFAULT')));
      },
    );
  });
