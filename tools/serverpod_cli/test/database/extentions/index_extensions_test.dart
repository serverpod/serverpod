  ...
  group('Given vector index definitions', () {
    ...
    test(
      ...
      () {
        ...
        var index2 = index1.copyWith(vectorDistanceFunction: null);
  ...
  group('Given vector index types', () {
    test(
      ...
      () {
        ...
        var index2 = index1.copyWith(type: 'ivfflat');
    ...
    test(
      ...
      () {
        ...
        var index2 = index1.copyWith(type: 'btree');
  ...
  group('Given vector index parameters', () {
    ...
    test(
      ...
      () {
        ...
        var index2 = index1.copyWith(parameters: {'ef.construction': '100'});
  ...
  group('Given vector index column types', () {
    test(
      ...
      () {
        ...
        var index2 = index1.copyWith(vectorColumnType: ColumnType.halfvec);
