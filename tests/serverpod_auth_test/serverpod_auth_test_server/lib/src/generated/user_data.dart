...
class UserDataRepository {
  ...
  /// Emits [UserData]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `UserData.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<UserData>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<UserDataTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<UserData>(
      where: where?.call(UserData.t),
      orderBy: orderBy?.call(UserData.t),
      orderByList: orderByList?.call(UserData.t),
      limit: limit,
