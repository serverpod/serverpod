...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_test', '20260914131959773', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260914131959773', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_bridge', '20260914131754522', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260914131754522', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20260914131839558', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260914131839558', "timestamp" = now();
