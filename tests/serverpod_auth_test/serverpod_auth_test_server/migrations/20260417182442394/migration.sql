...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_test', '20260417182442394', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417182442394', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_bridge', '20260417182322544', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417182322544', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20260417182335976', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417182335976', "timestamp" = now();
