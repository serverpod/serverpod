  ...
  factory Order.fromJson(Map<String, dynamic> jsonSerialization) {
    return Order(
      ...
      customer: jsonSerialization['customer'] == null
          ? null
          : _i0ntutnq.Protocol().deserialize<_i3fqgdb1.Customer>(
              jsonSerialization['customer'],
            ),
      comments: jsonSerialization['comments'] == null
          ? null
          : _i0ntutnq.Protocol().deserialize<List<_ij3ynzrj.Comment>>(
...
class OrderUpdateTable extends _isd.UpdateTable<OrderTable> {
  ...
  _isd.ColumnValue<int, int> customerId(int value) => _isd.ColumnValue(
    table.customerId,
    value,
  );
}

class OrderTable extends _isd.Table<int?> {
  ...
  _ij3ynzrj.CommentTable get __comments {
    ...
    ___comments = _isd.createRelationTable(
  ...
  _isd.ManyRelation<_ij3ynzrj.CommentTable> get comments {
    ...
    _comments = _isd.ManyRelation<_ij3ynzrj.CommentTable>(
...
final class OrderInclude extends _isd.IncludeObject
    implements OrderJsonInclude, _isd.FullModelInclude {
  OrderInclude._({
    _i3fqgdb1.CustomerInclude? customer,
    _ij3ynzrj.CommentIncludeList? comments,
  }) {
  ...
  @override
  _isd.Table<int?> get table => Order.t;
}
...
final class _OrderJsonInclude extends _isd.IncludeObject
...
class OrderRepository {
  ...
  Future<List<Order>> upsert(
    _isd.DatabaseSession session,
    List<Order> rows, {
    required _isd.ColumnSelections<OrderTable> conflictColumns,
    _isd.ColumnSelections<OrderTable>? updateColumns,
    _isd.WhereExpressionBuilder<OrderTable>? updateWhere,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<Order>> update(
    _isd.DatabaseSession session,
    List<Order> rows, {
    _isd.ColumnSelections<OrderTable>? columns,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<Order?> updateById(
    _isd.DatabaseSession session,
    int id, {
    required _isd.ColumnValueListBuilder<OrderUpdateTable> columnValues,
    _isd.Transaction? transaction,
  }) async {
  ...
  Future<List<Order>> updateWhere(
    _isd.DatabaseSession session, {
    required _isd.ColumnValueListBuilder<OrderUpdateTable> columnValues,
    required _isd.WhereExpressionBuilder<OrderTable> where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<OrderTable>? orderBy,
    _isd.OrderByListBuilder<OrderTable>? orderByList,
