...
abstract class City implements _isd.TableRow<int?>, _isc.ProtocolSerialization {
  City._({
    this.id,
    required this.name,
    this.citizens,
  ...
  factory City.fromJson(Map<String, dynamic> jsonSerialization) {
    return City(
      ...
      organizations: jsonSerialization['organizations'] == null
          ? null
          : _i0ntutnq.Protocol().deserialize<List<_i0ptycc3.Organization>>(
  ...
  /// Builds a complete [CityInclude] object for this table, fetching all columns.
  ...
  /// Builds a complete [CityIncludeList] object for this table, fetching all columns.
  /// Used for typed queries (e.g. `find`, `findFirstRow`, `findById`).
  ...
  /// Builds a JSON-compatible [CityJsonInclude] object for this table.
  ///
  /// Use [select] to specify which columns to include in the query.
  /// Note: If [select] is specified here on a root include, it will take precedence
  /// over any `select` parameter passed to `findAsJson`.

  static CityJsonInclude includeJson({
    _ijqkgw0m.PersonJsonIncludeList? citizens,
    _i0ptycc3.OrganizationJsonIncludeList? organizations,
    _isd.SelectColumnsBuilder<CityTable>? select,
  }) {
    return _CityJsonInclude._(
      citizens: citizens,
      organizations: organizations,
  ...
  /// Builds a JSON-compatible [CityJsonIncludeList] object for this table.
  ///
  /// Use [select] to specify which columns to include in the query.
  /// When nested in other includes or used with `findAsJson`, only the selected
  /// columns will be fetched.

  static CityJsonIncludeList includeJsonList({
    _isd.WhereExpressionBuilder<CityTable>? where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<CityTable>? orderBy,
    _isd.OrderByListBuilder<CityTable>? orderByList,
    CityJsonInclude? include,
    _isd.SelectColumnsBuilder<CityTable>? select,
  }) {
...
class CityUpdateTable extends _isd.UpdateTable<CityTable> {
...
class CityTable extends _isd.Table<int?> {
  ...
  _isd.ManyRelation<_ijqkgw0m.PersonTable>? _citizens;

  _i0ptycc3.OrganizationTable? ___organizations;

  _isd.ManyRelation<_i0ptycc3.OrganizationTable>? _organizations;
  ...
  _i0ptycc3.OrganizationTable get __organizations {
    ...
    ___organizations = _isd.createRelationTable(
  ...
  _isd.ManyRelation<_ijqkgw0m.PersonTable> get citizens {
    ...
    _citizens = _isd.ManyRelation<_ijqkgw0m.PersonTable>(
  ...
  _isd.ManyRelation<_i0ptycc3.OrganizationTable> get organizations {
    ...
    _organizations = _isd.ManyRelation<_i0ptycc3.OrganizationTable>(
      tableWithRelations: relationTable,
...
abstract interface class CityJsonInclude
    implements _isd.JsonCompatibleInclude {}

abstract interface class CityJsonIncludeList
    implements _isd.JsonCompatibleInclude {}

final class CityInclude extends _isd.IncludeObject
    implements CityJsonInclude, _isd.FullModelInclude {
  CityInclude._({
    _ijqkgw0m.PersonIncludeList? citizens,
    _i0ptycc3.OrganizationIncludeList? organizations,
  }) {
  ...
  @override
  _isd.Table<int?> get table => City.t;
}

final class CityIncludeList extends _isd.IncludeList
    implements CityJsonIncludeList, _isd.FullModelInclude {
  CityIncludeList._({
    super.where,
    super.limit,
    super.offset,
...
final class _CityJsonInclude extends _isd.IncludeObject
    implements CityJsonInclude {
  _CityJsonInclude._({
    _ijqkgw0m.PersonJsonIncludeList? citizens,
    _i0ptycc3.OrganizationJsonIncludeList? organizations,
  ...
  _ijqkgw0m.PersonJsonIncludeList? _citizens;

  _i0ptycc3.OrganizationJsonIncludeList? _organizations;
...
final class _CityJsonIncludeList extends _isd.IncludeList
...
class CityRepository {
  ...
  Future<List<City>> upsert(
    _isd.DatabaseSession session,
    List<City> rows, {
    required _isd.ColumnSelections<CityTable> conflictColumns,
    _isd.ColumnSelections<CityTable>? updateColumns,
    _isd.WhereExpressionBuilder<CityTable>? updateWhere,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<City>> update(
    _isd.DatabaseSession session,
    List<City> rows, {
    _isd.ColumnSelections<CityTable>? columns,
    _isd.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<City?> updateById(
    _isd.DatabaseSession session,
    int id, {
    required _isd.ColumnValueListBuilder<CityUpdateTable> columnValues,
    _isd.Transaction? transaction,
  }) async {
  ...
  Future<List<City>> updateWhere(
    _isd.DatabaseSession session, {
    required _isd.ColumnValueListBuilder<CityUpdateTable> columnValues,
    required _isd.WhereExpressionBuilder<CityTable> where,
    int? limit,
    int? offset,
    _isd.OrderByBuilder<CityTable>? orderBy,
    _isd.OrderByListBuilder<CityTable>? orderByList,
