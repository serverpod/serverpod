...
class _Migration20260711023021788 implements MigrationVersionSql {
  @override
  String get version => '20260711023021788';
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_sqlite', '20260711023021788', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260711023021788', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
