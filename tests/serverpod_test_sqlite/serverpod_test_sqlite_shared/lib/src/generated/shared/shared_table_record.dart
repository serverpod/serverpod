...
abstract class SharedTableRecord
  ...
  factory SharedTableRecord({
    ...
    required _iqfgygbv.SharedEnum sharedEnum,
    _iqfgygbv.SharedSubclass? sharedSubclass,
    int? itemCount,
  ...
  factory SharedTableRecord.fromJson(Map<String, dynamic> jsonSerialization) {
    return SharedTableRecord(
      ...
      sharedEnum: _iqfgygbv.SharedEnum.fromJson(
        (jsonSerialization['sharedEnum'] as String),
      ),
      sharedSubclass: jsonSerialization['sharedSubclass'] == null
          ? null
          : _iqfgygbv.Protocol().deserialize<_iqfgygbv.SharedSubclass>(
  ...
  _iqfgygbv.SharedEnum sharedEnum;
...
class _SharedTableRecordImpl extends SharedTableRecord {
  ...
  SharedTableRecord copyWith({
    ...
    return SharedTableRecord(
      ...
      sharedSubclass: sharedSubclass is _iqfgygbv.SharedSubclass?
          ? sharedSubclass
...
class SharedTableRecordUpdateTable
  ...
  _isd.ColumnValue<_iqfgygbv.SharedEnum, _iqfgygbv.SharedEnum> sharedEnum(
    _iqfgygbv.SharedEnum value,
  ) => _isd.ColumnValue(
    table.sharedEnum,
    value,
  );

  _isd.ColumnValue<_iqfgygbv.SharedSubclass, _iqfgygbv.SharedSubclass>
  sharedSubclass(_iqfgygbv.SharedSubclass? value) => _isd.ColumnValue(
...
class SharedTableRecordTable extends _isd.Table<int?> {
  SharedTableRecordTable({super.tableRelation})
    ...
    sharedSubclass = _isd.ColumnSerializable<_iqfgygbv.SharedSubclass>(
      'sharedSubclass',
      this,
    );
  ...
  late final _isd.ColumnEnum<_iqfgygbv.SharedEnum> sharedEnum;

  late final _isd.ColumnSerializable<_iqfgygbv.SharedSubclass> sharedSubclass;
...
class SharedTableRecordRepository {
  ...
  /// Emits [SharedTableRecord]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `SharedTableRecord.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<SharedTableRecord>> watch(
    _isd.DatabaseSession session, {
    _isd.WhereExpressionBuilder<SharedTableRecordTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<SharedTableRecord>(
      where: where?.call(SharedTableRecord.t),
      orderBy: orderBy?.call(SharedTableRecord.t),
      orderByList: orderByList?.call(SharedTableRecord.t),
      limit: limit,
