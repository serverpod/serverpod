...
// The client-side counterpart of `shared_module_dynamic_field_server_test.dart`.
// Kept in its own file so that only the client consumer protocol is registered
// on the shared package's protocol singleton for this isolate, which keeps the
// deserialization of module-prefixed class names unambiguous.
