...
abstract class ObjectWithMaps
  ...
  factory ObjectWithMaps({
    ...
    required Map<String, _is.UuidValue> uuidMap,
    ...
    required Map<String, _is.UuidValue?> nullableUuidMap,
    required Map<int, int> intIntMap,
  }) = _ObjectWithMapsImpl;

  factory ObjectWithMaps.fromJson(Map<String, dynamic> jsonSerialization) {
    return ObjectWithMaps(
      dataMap: _i08l111i.Protocol()
          .deserialize<Map<String, _i0zisc0t.SimpleData>>(
            jsonSerialization['dataMap'],
          ),
      intMap: _i08l111i.Protocol().deserialize<Map<String, int>>(
        jsonSerialization['intMap'],
      ),
      stringMap: _i08l111i.Protocol().deserialize<Map<String, String>>(
        jsonSerialization['stringMap'],
      ),
      dateTimeMap: _i08l111i.Protocol().deserialize<Map<String, DateTime>>(
        jsonSerialization['dateTimeMap'],
      ),
      byteDataMap: _i08l111i.Protocol().deserialize<Map<String, _idt.ByteData>>(
        jsonSerialization['byteDataMap'],
      ),
      durationMap: _i08l111i.Protocol().deserialize<Map<String, Duration>>(
        jsonSerialization['durationMap'],
      ),
      uuidMap: _i08l111i.Protocol().deserialize<Map<String, _is.UuidValue>>(
        jsonSerialization['uuidMap'],
      ),
      nullableDataMap: _i08l111i.Protocol()
          .deserialize<Map<String, _i0zisc0t.SimpleData?>>(
            jsonSerialization['nullableDataMap'],
          ),
      nullableIntMap: _i08l111i.Protocol().deserialize<Map<String, int?>>(
        jsonSerialization['nullableIntMap'],
      ),
      nullableStringMap: _i08l111i.Protocol().deserialize<Map<String, String?>>(
        jsonSerialization['nullableStringMap'],
      ),
      nullableDateTimeMap: _i08l111i.Protocol()
          .deserialize<Map<String, DateTime?>>(
            jsonSerialization['nullableDateTimeMap'],
          ),
      nullableByteDataMap: _i08l111i.Protocol()
          .deserialize<Map<String, _idt.ByteData?>>(
            jsonSerialization['nullableByteDataMap'],
          ),
      nullableDurationMap: _i08l111i.Protocol()
          .deserialize<Map<String, Duration?>>(
            jsonSerialization['nullableDurationMap'],
          ),
      nullableUuidMap: _i08l111i.Protocol()
          .deserialize<Map<String, _is.UuidValue?>>(
            jsonSerialization['nullableUuidMap'],
          ),
      intIntMap: _i08l111i.Protocol().deserialize<Map<int, int>>(
  ...
  Map<String, _is.UuidValue> uuidMap;
  ...
  Map<String, _is.UuidValue?> nullableUuidMap;
