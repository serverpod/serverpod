...
class ObjectWithJsonbRepository {
  ...
  /// Emits [ObjectWithJsonb]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithJsonb.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithJsonb>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithJsonbTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectWithJsonb>(
      where: where?.call(ObjectWithJsonb.t),
      orderBy: orderBy?.call(ObjectWithJsonb.t),
      orderByList: orderByList?.call(ObjectWithJsonb.t),
      limit: limit,
