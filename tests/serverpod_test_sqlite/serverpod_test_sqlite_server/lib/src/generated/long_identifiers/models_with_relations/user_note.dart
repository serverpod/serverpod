...
class UserNoteRepository {
  ...
  /// Emits [UserNote]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `UserNote.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<UserNote>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<UserNoteTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<UserNote>(
      where: where?.call(UserNote.t),
      orderBy: orderBy?.call(UserNote.t),
      orderByList: orderByList?.call(UserNote.t),
      limit: limit,
