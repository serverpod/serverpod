...
class LongImplicitIdFieldRepository {
  ...
  /// Emits [LongImplicitIdField]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `LongImplicitIdField.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<LongImplicitIdField>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<LongImplicitIdFieldTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<LongImplicitIdField>(
      where: where?.call(LongImplicitIdField.t),
      orderBy: orderBy?.call(LongImplicitIdField.t),
      orderByList: orderByList?.call(LongImplicitIdField.t),
      limit: limit,
