...
class ObjectWithParentRepository {
  ...
  /// Emits [ObjectWithParent]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithParent.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithParent>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithParentTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectWithParent>(
      where: where?.call(ObjectWithParent.t),
      orderBy: orderBy?.call(ObjectWithParent.t),
      orderByList: orderByList?.call(ObjectWithParent.t),
      limit: limit,
