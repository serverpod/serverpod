...
class ObjectWithDurationRepository {
  ...
  /// Emits [ObjectWithDuration]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithDuration.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithDuration>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithDurationTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectWithDuration>(
      where: where?.call(ObjectWithDuration.t),
      orderBy: orderBy?.call(ObjectWithDuration.t),
      orderByList: orderByList?.call(ObjectWithDuration.t),
      limit: limit,
