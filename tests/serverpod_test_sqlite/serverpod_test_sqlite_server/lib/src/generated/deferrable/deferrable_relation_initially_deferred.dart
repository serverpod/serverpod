...
class DeferrableRelationInitiallyDeferredRepository {
  ...
  /// Emits [DeferrableRelationInitiallyDeferred]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `DeferrableRelationInitiallyDeferred.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<DeferrableRelationInitiallyDeferred>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<DeferrableRelationInitiallyDeferredTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<DeferrableRelationInitiallyDeferred>(
      where: where?.call(DeferrableRelationInitiallyDeferred.t),
      orderBy: orderBy?.call(DeferrableRelationInitiallyDeferred.t),
      orderByList: orderByList?.call(DeferrableRelationInitiallyDeferred.t),
      limit: limit,
