...
class DeferrableRelationInitiallyImmediateRepository {
  ...
  /// Emits [DeferrableRelationInitiallyImmediate]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `DeferrableRelationInitiallyImmediate.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<DeferrableRelationInitiallyImmediate>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<DeferrableRelationInitiallyImmediateTable>?
    where,
    int? limit,
    ...
    return session.db.watch<DeferrableRelationInitiallyImmediate>(
      where: where?.call(DeferrableRelationInitiallyImmediate.t),
      orderBy: orderBy?.call(DeferrableRelationInitiallyImmediate.t),
      orderByList: orderByList?.call(DeferrableRelationInitiallyImmediate.t),
      limit: limit,
