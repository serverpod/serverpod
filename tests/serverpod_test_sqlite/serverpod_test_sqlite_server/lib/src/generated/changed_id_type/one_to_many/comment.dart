  ...
  factory CommentInt.fromJson(Map<String, dynamic> jsonSerialization) {
    return CommentInt(
      ...
      order: jsonSerialization['order'] == null
          ? null
          : _i08l111i.Protocol().deserialize<_ivss21qh.OrderUuid>(
...
class CommentIntRepository {
  ...
  /// Emits [CommentInt]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `CommentInt.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<CommentInt>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<CommentIntTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<CommentInt>(
      where: where?.call(CommentInt.t),
      orderBy: orderBy?.call(CommentInt.t),
      orderByList: orderByList?.call(CommentInt.t),
      limit: limit,
