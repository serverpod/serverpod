  ...
  factory Comment.fromJson(Map<String, dynamic> jsonSerialization) {
    return Comment(
      ...
      order: jsonSerialization['order'] == null
          ? null
          : _i08l111i.Protocol().deserialize<_ig920ya2.Order>(
...
class CommentUpdateTable extends _is.UpdateTable<CommentTable> {
  ...
  _is.ColumnValue<int, int> orderId(int value) => _is.ColumnValue(
    table.orderId,
    value,
  );
}
...
class CommentTable extends _is.Table<int?> {
  ...
  late final _is.ColumnInt orderId;
...
final class CommentInclude extends _is.IncludeObject
    implements CommentJsonInclude, _is.FullModelInclude {
...
final class CommentIncludeList extends _is.IncludeList
    implements CommentJsonIncludeList, _is.FullModelInclude {
...
final class _CommentJsonInclude extends _is.IncludeObject
...
final class _CommentJsonIncludeList extends _is.IncludeList
