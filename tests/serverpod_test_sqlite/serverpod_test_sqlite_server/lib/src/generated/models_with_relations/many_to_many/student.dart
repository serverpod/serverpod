...
class StudentRepository {
  ...
  /// Emits [Student]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `Student.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<Student>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<StudentTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<Student>(
      where: where?.call(Student.t),
      orderBy: orderBy?.call(Student.t),
      orderByList: orderByList?.call(Student.t),
      limit: limit,
