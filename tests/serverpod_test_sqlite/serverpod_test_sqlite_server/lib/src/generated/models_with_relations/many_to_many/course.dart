...
abstract class Course implements _is.TableRow<int?>, _is.ProtocolSerialization {
  Course._({
    this.id,
    required this.name,
    this.enrollments,
  ...
  factory Course.fromJson(Map<String, dynamic> jsonSerialization) {
    return Course(
      ...
      enrollments: jsonSerialization['enrollments'] == null
          ? null
          : _i08l111i.Protocol().deserialize<List<_im07rq0v.Enrollment>>(
...
class CourseTable extends _is.Table<int?> {
  ...
  _is.ManyRelation<_im07rq0v.EnrollmentTable>? _enrollments;
  ...
  _is.ManyRelation<_im07rq0v.EnrollmentTable> get enrollments {
    ...
    _enrollments = _is.ManyRelation<_im07rq0v.EnrollmentTable>(
...
final class CourseInclude extends _is.IncludeObject
    implements CourseJsonInclude, _is.FullModelInclude {
  ...
  @override
  _is.Table<int?> get table => Course.t;
}

final class CourseIncludeList extends _is.IncludeList
    implements CourseJsonIncludeList, _is.FullModelInclude {
  CourseIncludeList._({
    _is.WhereExpressionBuilder<CourseTable>? where,
    super.limit,
    super.offset,
...
final class _CourseJsonInclude extends _is.IncludeObject
...
final class _CourseJsonIncludeList extends _is.IncludeList
