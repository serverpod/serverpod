  ...
  factory Member.fromJson(Map<String, dynamic> jsonSerialization) {
    return Member(
      ...
      blocking: jsonSerialization['blocking'] == null
          ? null
          : _i08l111i.Protocol().deserialize<List<_iv5rlvod.Blocking>>(
...
class MemberRepository {
  ...
  /// Emits [Member]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `Member.t`.
  ///
  ...
  _ida.Stream<List<Member>> watch(
    ...
    return session.db.watch<Member>(
      where: where?.call(Member.t),
      orderBy: orderBy?.call(Member.t),
      orderByList: orderByList?.call(Member.t),
      limit: limit,
