...
class TableWithExplicitColumnNameRepository {
  ...
  /// Emits [TableWithExplicitColumnName]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `TableWithExplicitColumnName.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<TableWithExplicitColumnName>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<TableWithExplicitColumnNameTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<TableWithExplicitColumnName>(
      where: where?.call(TableWithExplicitColumnName.t),
      orderBy: orderBy?.call(TableWithExplicitColumnName.t),
      orderByList: orderByList?.call(TableWithExplicitColumnName.t),
      limit: limit,
