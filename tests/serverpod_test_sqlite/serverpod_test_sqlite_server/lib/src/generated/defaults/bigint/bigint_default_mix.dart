...
class BigIntDefaultMixRepository {
  ...
  /// Emits [BigIntDefaultMix]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `BigIntDefaultMix.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<BigIntDefaultMix>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<BigIntDefaultMixTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<BigIntDefaultMix>(
      where: where?.call(BigIntDefaultMix.t),
      orderBy: orderBy?.call(BigIntDefaultMix.t),
      orderByList: orderByList?.call(BigIntDefaultMix.t),
      limit: limit,
