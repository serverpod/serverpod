...
class IntDefaultMixRepository {
  ...
  /// Emits [IntDefaultMix]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `IntDefaultMix.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<IntDefaultMix>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<IntDefaultMixTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<IntDefaultMix>(
      where: where?.call(IntDefaultMix.t),
      orderBy: orderBy?.call(IntDefaultMix.t),
      orderByList: orderByList?.call(IntDefaultMix.t),
      limit: limit,
