...
abstract class UriDefaultModel
  ...
  UriDefaultModel copyWith({
    int? id,
    Uri? uriDefaultModel,
    Uri? uriDefaultModelNull = const _is.$UndefinedUri(),
  });
  @override
...
class _UriDefaultModelImpl extends UriDefaultModel {
  ...
  UriDefaultModel copyWith({
    ...
    return UriDefaultModel(
      ...
      uriDefaultModelNull: uriDefaultModelNull is _is.UndefinedSentinel
...
class UriDefaultModelRepository {
  ...
  /// Emits [UriDefaultModel]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `UriDefaultModel.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<UriDefaultModel>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<UriDefaultModelTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<UriDefaultModel>(
      where: where?.call(UriDefaultModel.t),
      orderBy: orderBy?.call(UriDefaultModel.t),
      orderByList: orderByList?.call(UriDefaultModel.t),
      limit: limit,
