...
abstract class UuidDefaultModel
  ...
  /// Builds a complete [UuidDefaultModelInclude] object for this table, fetching all columns.
  ...
  /// Builds a complete [UuidDefaultModelIncludeList] object for this table, fetching all columns.
  /// Used for typed queries (e.g. `find`, `findFirstRow`, `findById`).
  ...
  /// Builds a JSON-compatible [UuidDefaultModelJsonInclude] object for this table.
  ///
  /// Use [select] to specify which columns to include in the query.
  /// Note: If [select] is specified here on a root include, it will take precedence
  /// over any `select` parameter passed to `findAsJson`.

  static UuidDefaultModelJsonInclude includeJson({
    _is.SelectColumnsBuilder<UuidDefaultModelTable>? select,
  }) {
    return _UuidDefaultModelJsonInclude._(
      selectedColumns: select?.call(UuidDefaultModel.t),
    );
  }

  /// Builds a JSON-compatible [UuidDefaultModelJsonIncludeList] object for this table.
  ///
  /// Use [select] to specify which columns to include in the query.
  /// When nested in other includes or used with `findAsJson`, only the selected
  /// columns will be fetched.

  static UuidDefaultModelJsonIncludeList includeJsonList({
    _is.WhereExpressionBuilder<UuidDefaultModelTable>? where,
    int? limit,
    int? offset,
    _is.OrderByBuilder<UuidDefaultModelTable>? orderBy,
    _is.OrderByListBuilder<UuidDefaultModelTable>? orderByList,
    UuidDefaultModelJsonInclude? include,
    _is.SelectColumnsBuilder<UuidDefaultModelTable>? select,
  }) {
...
abstract interface class UuidDefaultModelJsonInclude
    implements _is.JsonCompatibleInclude {}

abstract interface class UuidDefaultModelJsonIncludeList
    implements _is.JsonCompatibleInclude {}

final class UuidDefaultModelInclude extends _is.IncludeObject
    implements UuidDefaultModelJsonInclude, _is.FullModelInclude {
...
final class _UuidDefaultModelJsonInclude extends _is.IncludeObject
    implements UuidDefaultModelJsonInclude {
  _UuidDefaultModelJsonInclude._({this.selectedColumns});
