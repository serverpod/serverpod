...
class DoubleDefaultModelRepository {
  ...
  /// Emits [DoubleDefaultModel]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `DoubleDefaultModel.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<DoubleDefaultModel>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<DoubleDefaultModelTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<DoubleDefaultModel>(
      where: where?.call(DoubleDefaultModel.t),
      orderBy: orderBy?.call(DoubleDefaultModel.t),
      orderByList: orderByList?.call(DoubleDefaultModel.t),
      limit: limit,
