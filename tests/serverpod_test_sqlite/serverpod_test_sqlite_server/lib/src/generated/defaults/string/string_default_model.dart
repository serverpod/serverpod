...
class StringDefaultModelRepository {
  ...
  /// Emits [StringDefaultModel]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `StringDefaultModel.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<StringDefaultModel>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<StringDefaultModelTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<StringDefaultModel>(
      where: where?.call(StringDefaultModel.t),
      orderBy: orderBy?.call(StringDefaultModel.t),
      orderByList: orderByList?.call(StringDefaultModel.t),
      limit: limit,
