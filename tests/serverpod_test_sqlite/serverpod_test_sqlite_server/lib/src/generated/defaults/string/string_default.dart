...
class StringDefaultRepository {
  ...
  /// Emits [StringDefault]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `StringDefault.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<StringDefault>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<StringDefaultTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<StringDefault>(
      where: where?.call(StringDefault.t),
      orderBy: orderBy?.call(StringDefault.t),
      orderByList: orderByList?.call(StringDefault.t),
      limit: limit,
