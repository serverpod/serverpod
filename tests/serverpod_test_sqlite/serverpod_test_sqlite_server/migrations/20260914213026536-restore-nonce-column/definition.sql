...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_sqlite', '20260914213026536-restore-nonce-column', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260914213026536-restore-nonce-column', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp', '20260914212829194-restore-nonce-column', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260914212829194-restore-nonce-column', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
