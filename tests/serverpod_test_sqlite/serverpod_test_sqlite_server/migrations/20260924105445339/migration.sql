...
-- ACTION ALTER TABLE
--
CREATE TABLE "new_serverpod_auth_core_profile" (
...
INSERT INTO "new_serverpod_auth_core_profile" ("id", "authUserId", "userName", "fullName", "email", "createdAt", "imageId") SELECT "id", "authUserId", "userName", "fullName", "email", "createdAt", "imageId" FROM "serverpod_auth_core_profile";
DROP TABLE "serverpod_auth_core_profile";
ALTER TABLE "new_serverpod_auth_core_profile" RENAME TO "serverpod_auth_core_profile";
