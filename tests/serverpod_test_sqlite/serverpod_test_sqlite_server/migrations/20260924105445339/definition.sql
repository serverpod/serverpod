...
CREATE TABLE "deferrable_relation_initially_deferred" (
    ...
    CONSTRAINT "deferrable_relation_initially_deferred_fk_0" FOREIGN KEY ("parentId") REFERENCES "deferrable_relation_parent" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED
) STRICT;
...
CREATE TABLE "deferrable_relation_initially_immediate" (
    "id" INTEGER PRIMARY KEY,
    "parentId" INTEGER NOT NULL,
    CONSTRAINT "deferrable_relation_initially_immediate_fk_0" FOREIGN KEY ("parentId") REFERENCES "deferrable_relation_parent" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY IMMEDIATE
) STRICT;
...
--
-- Class NullsDistinctData as table nulls_distinct_data
--
...
-- Indexes
CREATE UNIQUE INDEX "nulls_distinct_data_unique_idx" ON "nulls_distinct_data" ("tenantId", "category", "archivedAt");
...
CREATE TABLE "serverpod_auth_core_profile" (
    ...
    CONSTRAINT "serverpod_auth_core_profile_fk_1" FOREIGN KEY ("imageId") REFERENCES "serverpod_auth_core_profile_image" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED
) STRICT;
...
-- Indexes
CREATE INDEX "serverpod_auth_idp_rate_limited_request_attempt_composite" ON "serverpod_auth_idp_rate_limited_request_attempt" ("domain", "source", "key", "attemptedAt");
...
--
-- Class SharedModuleTable as table shared_module_table
--
...
INSERT INTO "serverpod_sqlite_schema" VALUES
    ...
    ('shared_module_table', 'data', 'json', NULL);

--
-- MIGRATION VERSION FOR serverpod_test_sqlite
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_sqlite', '20260924105445339', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260924105445339', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_core', '20260924105232991', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260924105232991', "timestamp" = (unixepoch('now', 'subsecond') * 1000);

--
-- MIGRATION VERSION FOR serverpod_auth_idp
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp', '20260924105404509', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260924105404509', "timestamp" = (unixepoch('now', 'subsecond') * 1000);

--
-- MIGRATION VERSION FOR serverpod_test_shared_module
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_shared_module', '20260824182514685', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260824182514685', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
