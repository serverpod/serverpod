...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test', '20250701070135302', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250701070135302', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth', '20250701070119767', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250701070119767', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod', '20250701070114448', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250701070114448', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_test_module
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_module', '20250701070129946', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250701070129946', "timestamp" = now();
