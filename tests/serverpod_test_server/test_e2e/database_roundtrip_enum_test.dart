...
void main() {
  ...
  test(
    ...
    () async {
      var object =
          ObjectWithEnumBuilder().witheEumList([
            TestEnum.one,
            TestEnum.two,
            TestEnum.three,
          ]).build();
  ...
  test(
    ...
    () async {
      var object =
          ObjectWithEnumBuilder().withNullableEnumList([
            TestEnum.one,
            null,
            TestEnum.three,
          ]).build();
  ...
  test(
    ...
    () async {
      var object =
          ObjectWithEnumBuilder().withEnumListList([
      ...
      expect(result.enumListList.first, equals([TestEnum.one, TestEnum.two]));
      expect(result.enumListList.last, equals([TestEnum.two, TestEnum.one]));
    },
  );
}
