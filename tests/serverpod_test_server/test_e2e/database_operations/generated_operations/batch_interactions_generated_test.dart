...
void main() {
  ...
  tearDown(() async => await client.databaseBatchGenerated.deleteAll());
  group('Given an empty database', () {
    ...
    test(
      ...
      var inserted = await client.databaseBatchGenerated.batchInsert(data);

      expect(inserted, hasLength(2));

      var simpleList = await client.databaseBatchGenerated.findAll();
    ...
    test(
      ...
      expect(
        client.databaseBatchGenerated.batchInsert(data),
        throwsA(isA<ServerpodClientException>()),
      );

      var first =
          await client.databaseBatchGenerated.findByEmail('info@serverpod.dev');
      expect(first, isNull);

      var second =
          await client.databaseBatchGenerated.findByEmail('dev@serverpod.dev');
  ...
  group('Given two entries in the database when batch updating them.', () {
    ...
    setUp(() async =>
        inserted = await client.databaseBatchGenerated.batchInsert(data));
    ...
    test('then the returned values contains the updates', () async {
      ...
      var updated = await client.databaseBatchGenerated.batchUpdate(inserted);
    ...
    test('then the database contains the updated values.', () async {
      ...
      await client.databaseBatchGenerated.batchUpdate(inserted);

      var first =
          await client.databaseBatchGenerated.findById(inserted.first.id!);
      var last =
          await client.databaseBatchGenerated.findById(inserted.last.id!);
  ...
  test(
    ...
    expect(
      client.databaseBatchGenerated.batchUpdate(toUpdate),
      throwsA(isA<ServerpodClientException>()),
    );
  });
  ...
  test(
    ...
    var first =
        await client.databaseBatchGenerated.findById(inserted.first.id!);
    var last = await client.databaseBatchGenerated.findById(inserted.last.id!);
  ...
  group('Given a typed entry in the database', () {
    ...
    setUp(() async {
      var inserted = await client.databaseBatchGenerated.batchInsertTypes(data);
      type = inserted.first;
    });
    ...
    test(
      ...
      var updated =
          await client.databaseBatchGenerated.batchUpdateTypes(toUpdate);
  ...
  test(
    ...
    var deletedIds = await client.databaseBatchGenerated.batchDelete(inserted);
  ...
  test(
    ...
    await client.databaseBatchGenerated.batchDelete(inserted);
  ...
  test(
    ...
    await client.databaseBatchGenerated.insertRelatedUniqueData(relationalData);

    expect(
      client.databaseBatchGenerated.batchDelete(inserted),
      throwsA(isA<ServerpodClientException>()),
    );
  ...
  test(
    ...
    await client.databaseBatchGenerated.batchDelete([inserted.first]);
