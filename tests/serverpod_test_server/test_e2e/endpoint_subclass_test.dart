...
void main() {
  ...
  group(
    ...
    test(
        ...
        () async {
      var response = await client.moduleEndpointSubclass.echoString('hello');
    ...
    test(
        ...
        () async {
      var response =
          await client.moduleEndpointSubclass.echoRecord((5, BigInt.from(100)));
    ...
    test(
        ...
        () async {
      var response =
          await client.moduleEndpointSubclass.echoContainer({1, 2, 3});
  ...
  group('Given an endpoint which overrides a few methods of the base class, ',
    ...
    test(
        ...
        () async {
      var response =
          await client.moduleEndpointAdaptation.echoContainer({1, 2, 3});
  ...
  group(
      ...
      () {
    test('when calling `greet`, then the input is returned as expected.',
        () async {
      var response = await client.moduleEndpointExtension.greet('Serverpod');
