...
void main() {
  ...
  group('Record with multiple positional fields', () {
    ...
    test(
      ...
      () async {
        var result = await client.recordParameters
            .returnNonStringKeyedMapRecord(({123: 456},));
  ...
  group('Record with multiple named fields', () {
    ...
    test(
      ...
      () async {
        var result = await client.recordParameters
            .returnNamedNonStringKeyedMapRecord((intIntMap: {}));
  ...
  group('List of records', () {
    ...
    test(
      ...
      () async {
        ...
        expect(result, [isNull, isNot(isNull), isNull, isNot(isNull), isNull]);
  ...
  group('Record nested inside another record', () {
    ...
    test(
      ...
      () async {
        var record = ((1, '2'), namedSubRecord: (SimpleData(num: 3), 4.5));
  ...
  test(
    ...
    () async {
      ...
      expect(result.aNestedRecord, (
        (1, 'hello'),
        namedNestedRecord: (2, 'world'),
      ));
    },
  );
  ...
  test(
    ...
    () async {
      var model = ModuleClass(data: 1, name: '', record: (true,));
  ...
  test(
    ...
    () async {
      var records =
          <List<((int, String), {(SimpleData, double) namedSubRecord})?>?>[
            [null, ((1, '2'), namedSubRecord: (SimpleData(num: 3), 4.5)), null],
          ];
        ...
        emitsInOrder([
          ...
          equals([
            ...
            isA<((int, String), {(SimpleData, double) namedSubRecord})>()
                .having((r) => r.$1, 'first positional', (1, '2'))
                .having(
  ...
  test(
    ...
    () async {
      var models = [
        null,
        ModuleClass(data: 1, name: '', record: (true,)),
        null,
      ];
      ...
      expect(
        ...
        emitsInOrder([
          isNull,
          isA<ModuleClass>().having((m) => m.record, 'record', (true,)),
          isNull,
        ]),
      );
    },
  ...
  test(
    ...
    () async {
      var result = await client.recordParameters
          .recordParametersWithCustomNames((1,), namedRecord: (2,));
