...
void main() {
  ...
  test(
    ...
    () async {
      final result = await client.methodSignaturePermutations
          .echoPositionalAndNamedArgs('PositionalArg', string2: 'NamedArg');
  ...
  test(
    ...
    () async {
      final result = await client.methodSignaturePermutations
          .echoPositionalAndNullableNamedArgs('PositionalArg');
  ...
  test(
    ...
    () async {
      final result = await client.methodSignaturePermutations
          .echoPositionalAndOptionalArgs('PositionalArg', 'OptionalArg');
  ...
  test(
    ...
    () async {
      final result = await client.methodSignaturePermutations
          .echoPositionalAndOptionalArgs('PositionalArg');
  ...
  test(
    ...
    () async {
      final result =
          await client.methodSignaturePermutations
              .echoNamedArgStream(strings: Stream.fromIterable(['NamedArg']))
              .toList();
  ...
  test(
    ...
    () async {
      final result =
          await client.methodSignaturePermutations
              .echoPositionalArgStream(Stream.fromIterable(['PositionalArg']))
              .toList();
  ...
  test(
    ...
    () async {
      final result = await client.methodSignaturePermutations
          .echoPositionalArgStreamAsFuture(Stream.fromIterable(['NamedArg']));
