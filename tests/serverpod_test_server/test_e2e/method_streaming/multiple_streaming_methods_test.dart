...
void main() {
  ...
  test(
    ...
    var keepAliveStream =
        client.methodStreaming.intEchoStream(keepAliveInputStream.stream);
    var closeStreamInputStream = StreamController<int>();
    var closeStream =
        client.methodStreaming.intEchoStream(closeStreamInputStream.stream);

    closeStream.listen((event) {
      // Do nothing
    }, onDone: () {
