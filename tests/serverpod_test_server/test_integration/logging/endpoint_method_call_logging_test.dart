  ...
  group('Database logger -', () {
    ...
    test(
      ...
      () async {
        var settings =
            RuntimeSettingsBuilder()
                .withLogSettings(LogSettingsBuilder().build())
                .build();
    ...
    test(
      ...
      () async {
        ...
        await client.logging.log(
          'message',
          toLogLevelInts([LogLevel.debug, LogLevel.info, LogLevel.warning]),
        );
      ...
      () {
        ...
        test(
          ...
          () {
            expect(
              record.output,
              containsCount('${'METHOD'.padRight(14)} logging.emptyMethod', 1),
            );
          },
        );
      },
