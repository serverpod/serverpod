      ...
      group('Testing POSTGIS Delete Operations', () {
        ...
        test(
          ...
          () async {
            ...
            var found1 = await ObjectWithPostgis.db.findById(session, inserted1.id!);
            var found2 = await ObjectWithPostgis.db.findById(session, inserted2.id!);
      ...
      group('Testing POSTGIS Bulk Operations', () {
        ...
        test(
          ...
          () async {
            ...
            expect(
              fetched
                  .where((o) => o.id == inserted[0].id || o.id == inserted[1].id)
