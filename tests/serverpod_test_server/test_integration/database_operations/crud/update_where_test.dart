    ...
    (sessionBuilder, endpoints) {
      ...
      group('Given Types entries with null values', () {
        ...
        test(
          ...
          expect(notUpdatedRows.any((r) => r.aString == 'top_two_updated'),
              isFalse);
        ...
        test(
          ...
          expect(
              notUpdatedRows.any((r) => r.aString == 'offset_update'), isFalse);

          // Clean up additional test data
          await Types.db.deleteWhere(
            session,
            where: (t) =>
                t.anInt.equals(3) | t.anInt.equals(4) | t.anInt.equals(5),
          );
        });
        ...
        test(
          ...
          var notUpdatedRows = await Types.db.find(
            session,
            where: (t) =>
                t.anInt.equals(1) | t.anInt.equals(5) | t.anInt.equals(6),
          );
          expect(
              notUpdatedRows.any((r) => r.aString == 'window_update'), isFalse);
        ...
        test(
            'when using all parameters together then correct subset is updated',
            () async {
