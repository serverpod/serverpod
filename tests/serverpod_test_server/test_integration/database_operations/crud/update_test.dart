...
void main() async {
  ...
  test(
    ...
    () async {
      ...
      expect(
        UniqueData.db.update(session, toUpdate),
  ...
  group('Given a typed entry in the database', () {
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, anInt: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aBool: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aDouble: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aString: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aDateTime: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aByteData: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aDuration: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aUuid: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aUri: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aBigInt: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aVector: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aHalfVector: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aSparseVector: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aBit: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, anEnum: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aStringifiedEnum: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aList: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aMap: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aSet: null);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aRecord: null);
  ...
  group('Given a typed entry in the database', () {
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, anInt: 1);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aBool: true);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aDouble: 1.0);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aString: 'string');
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aDateTime: now);
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aByteData: byteData);
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aDuration: duration);
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aUuid: uuidValue);
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aUri: uri);
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aBigInt: bigInt);
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aVector: vector);
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aHalfVector: halfVector);
    ...
    test(
      ...
      () async {
        ...
        var value = Types(id: type.id, aSparseVector: sparseVector);
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, aBit: Bit([true, false, true]));
    ...
    test(
      ...
      () async {
        var value = Types(id: type.id, anEnum: TestEnum.one);
    ...
    test(
      ...
      () async {
        var list = [4, 5, 6];
        var value = Types(id: type.id, aList: list);
    ...
    test(
      ...
      () async {
        var map = {3: 30, 4: 40};
        var value = Types(id: type.id, aMap: map);
    ...
    test(
      ...
      () async {
        var set = {4, 5, 6};
        var value = Types(id: type.id, aSet: set);
  ...
  group('Given a typed entry in the database', () {
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, anInt: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aBool: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aDouble: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aString: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aDateTime: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aByteData: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aDuration: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aUuid: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aUri: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aBigInt: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aVector: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aHalfVector: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aSparseVector: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aBit: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, anEnum: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aStringifiedEnum: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aList: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aMap: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aSet: null)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aRecord: null)];
  ...
  group('Given a typed entry in the database', () {
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, anInt: 1)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aBool: true)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aDouble: 1.0)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, aString: 'string')];
    ...
    test(
      ...
      () async {
        var now = DateTime.now().toUtc();
        var toUpdate = <Types>[Types(id: type.id, aDateTime: now)];
    ...
    test(
      ...
      () async {
        var byteData = ByteData.view(Uint8List(8).buffer);
        var toUpdate = <Types>[Types(id: type.id, aByteData: byteData)];
    ...
    test(
      ...
      () async {
        var duration = Duration(milliseconds: 1000);
        var toUpdate = <Types>[Types(id: type.id, aDuration: duration)];
    ...
    test(
      ...
      () async {
        var uuidValue = UuidValue.fromString(Uuid().v4());
        var toUpdate = <Types>[Types(id: type.id, aUuid: uuidValue)];
    ...
    test(
      ...
      () async {
        var uri = Uri.parse('https://example.com');
        var toUpdate = <Types>[Types(id: type.id, aUri: uri)];
    ...
    test(
      ...
      () async {
        var bigInt = BigInt.from(987654321);
        var toUpdate = <Types>[Types(id: type.id, aBigInt: bigInt)];
    ...
    test(
      ...
      () async {
        var vector = Vector([4.0, 5.0, 6.0]);
        var toUpdate = <Types>[Types(id: type.id, aVector: vector)];
    ...
    test(
      ...
      () async {
        var halfVector = HalfVector([4.0, 5.0, 6.0]);
        var toUpdate = <Types>[Types(id: type.id, aHalfVector: halfVector)];
    ...
    test(
      ...
      () async {
        var sparseVector = SparseVector([0.0, 4.0, 5.0]);
        var toUpdate = <Types>[Types(id: type.id, aSparseVector: sparseVector)];
    ...
    test(
      ...
      () async {
        ...
        var toUpdate = <Types>[Types(id: type.id, aBit: bit)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[Types(id: type.id, anEnum: TestEnum.one)];
    ...
    test(
      ...
      () async {
        var toUpdate = <Types>[
          Types(id: type.id, aStringifiedEnum: TestEnumStringified.two),
        ];
    ...
    test(
      ...
      () async {
        var list = [4, 5, 6];
        var toUpdate = <Types>[Types(id: type.id, aList: list)];
    ...
    test(
      ...
      () async {
        var map = {3: 30, 4: 40};
        var toUpdate = <Types>[Types(id: type.id, aMap: map)];
    ...
    test(
      ...
      () async {
        var set = {4, 5, 6};
        var toUpdate = <Types>[Types(id: type.id, aSet: set)];
  ...
  group('Given empty model in database', () {
    ...
    test('when model is updated then update completes', () async {
      expect(EmptyModelWithTable.db.updateRow(session, model), completes);
    });
