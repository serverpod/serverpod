...
void main() async {
  ...
  group('Given an empty database', () {
    ...
    test(
      ...
      () async {
        ...
        var first =
            inserted.where((e) => e.email == 'info@serverpod.dev').single;
        var second =
            inserted.where((e) => e.email == 'dev@serverpod.dev').single;
  ...
  group('Given an object data without an id when calling insertRow', () {
    ...
    setUp(() async {
      ...
      inserted = await SimpleData.db.insertRow(session, simpleData);
    });
    tearDown(() async {
  ...
  group('Given a model without fields when inserting it', () {
    ...
    setUp(() async {
      ...
      inserted = await EmptyModelWithTable.db.insertRow(session, emptyModel);
    });
