...
void main() async {
  ...
  group('Given an empty database', () {
    test(
      ...
      () {
        expect(
          SimpleData.db.deleteRow(session, SimpleData(id: 1, num: 1)),
    ...
    test(
      ...
      () {
        expect(
          SimpleData.db.delete(session, [SimpleData(id: 1, num: 1)]),
  ...
  group(' ', () {
    ...
    test(
      ...
      () async {
        ...
        var deleted = await await SimpleData.db.deleteRow(session, inserted);
