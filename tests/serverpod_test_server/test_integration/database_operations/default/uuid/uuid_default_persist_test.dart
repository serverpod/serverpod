  ...
  group('Given a class with "defaultPersist" UUID fields,', () {
    ...
    test(
      ...
      () async {
        ...
        var specificObject = UuidDefaultPersist(uuidDefaultPersistRandom: uuid);
        var specificDatabaseObject = await UuidDefaultPersist.db.insertRow(
          session,
          specificObject,
        );
        expect(specificDatabaseObject.uuidDefaultPersistRandom, uuid);
      },
    );
    ...
    test(
      ...
      () async {
        ...
        expect(specificDatabaseObject.uuidDefaultPersistRandomV7, uuid);
      },
    );
    ...
    test(
      ...
      () async {
        ...
        var specificObject = UuidDefaultPersist(uuidDefaultPersistStr: uuid);
        var specificDatabaseObject = await UuidDefaultPersist.db.insertRow(
          session,
          specificObject,
        );
        expect(specificDatabaseObject.uuidDefaultPersistStr, uuid);
      },
    );
  });
}
