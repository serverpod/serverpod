  ...
  group('Given a class with "default" fields,', () {
    ...
    test(
      ...
      () async {
        ...
        var databaseObject = await DoubleDefault.db.insertRow(session, object);
        expect(databaseObject.doubleDefault, equals(10.5));
      },
    );
    ...
    test(
      ...
      () async {
        var object = DoubleDefault();
        var databaseObject = await DoubleDefault.db.insertRow(session, object);
        expect(databaseObject.doubleDefaultNull, equals(20.5));
      },
    );
    ...
    test(
      ...
      () async {
        var specificObject = DoubleDefault(doubleDefault: 30.5);
        var specificDatabaseObject = await DoubleDefault.db.insertRow(
          session,
          specificObject,
        );
        expect(specificDatabaseObject.doubleDefault, equals(30.5));
      },
    );
    ...
    test(
      ...
      () async {
        var specificObject = DoubleDefault(doubleDefaultNull: 40.5);
        var specificDatabaseObject = await DoubleDefault.db.insertRow(
          session,
          specificObject,
        );
        expect(specificDatabaseObject.doubleDefaultNull, equals(40.5));
      },
    );
  });
}
