  ...
  group('Given a class with "default" fields,', () {
    ...
    test(
      ...
      () async {
        ...
        var databaseObject = await BoolDefault.db.insertRow(session, object);
        expect(databaseObject.boolDefaultTrue, isTrue);
      },
    );
    ...
    test(
      ...
      () async {
        var object = BoolDefault();
        var databaseObject = await BoolDefault.db.insertRow(session, object);
        expect(databaseObject.boolDefaultFalse, isFalse);
      },
    );
    ...
    test(
      ...
      () async {
        var object = BoolDefault();
        var databaseObject = await BoolDefault.db.insertRow(session, object);
        expect(databaseObject.boolDefaultNullFalse, isFalse);
      },
    );
    ...
    test(
      ...
      () async {
        var specificObject = BoolDefault(boolDefaultTrue: false);
        var specificDatabaseObject = await BoolDefault.db.insertRow(
          session,
          specificObject,
        );
        expect(specificDatabaseObject.boolDefaultTrue, isFalse);
      },
    );
    ...
    test(
      ...
      () async {
        var specificObject = BoolDefault(boolDefaultFalse: true);
        var specificDatabaseObject = await BoolDefault.db.insertRow(
          session,
          specificObject,
        );
        expect(specificDatabaseObject.boolDefaultFalse, isTrue);
      },
    );
    ...
    test(
      ...
      () async {
        var specificObject = BoolDefault(boolDefaultNullFalse: true);
        var specificDatabaseObject = await BoolDefault.db.insertRow(
          session,
          specificObject,
        );
        expect(specificDatabaseObject.boolDefaultNullFalse, isTrue);
      },
    );
  });
}
