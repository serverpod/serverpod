  ...
  group('Given a class with "default" fields,', () {
    ...
    test(
      ...
      () async {
        ...
        var databaseObject = await StringDefault.db.insertRow(session, object);
        expect(databaseObject.stringDefault, equals('This is a default value'));
      },
    );
    ...
    test(
      ...
      () async {
        var specificObject = StringDefault(stringDefault: 'A specific value');
