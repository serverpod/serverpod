...
void main() async {
  group('Given a non-test `Session` implementation,', () {
    ...
    test(
        ...
        () async {
      await session.transactionOrSavepoint(
    ...
    test(
        ...
        () async {
      await session.transactionOrSavepoint((final transaction1) async {
        await session.transactionOrSavepoint((final transaction2) async {
          await SimpleData.db.insertRow(
            session,
            SimpleData(num: 1),
