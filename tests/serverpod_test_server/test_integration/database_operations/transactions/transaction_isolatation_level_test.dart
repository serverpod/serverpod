      ...
      group(
        ...
        () {
          ...
          test('when row is modified after first statement in transaction '
            ...
            var c1 = Completer();
            var c2 = Completer();
            var transactionFuture = session.db.transaction((t) async {
            ...
            await c1.future;
            await SimpleData.db.updateRow(session, testData.copyWith(num: 2));
            c2.complete();
  ...
  withServerpod(
    ...
    (sessionBuilder, _) {
      ...
      test('when row is modified after first statement in transaction '
        ...
        var c2 = Completer();
        var transactionFuture = session.db.transaction((t) async {
          await SimpleData.db.findById(session, testData.id!, transaction: t);
      ...
      test('when read row is concurrently modified by other transaction '
        ...
        var transaction1 = session.db.transaction((t) async {
        ...
        var transaction2 = session.db.transaction((t) async {
