...
void main() async {
  ...
  test(
    ...
    () async {
      ...
      var people = await Person.db.insertRow(session, Person(name: 'John Doe'));
      ...
      expect(
        ...
        contains(jsonEncode(people.copyWith(organizationId: org.id).toJson())),
      );
    },
  );
    ...
    () async {
      ...
      expect(
        ...
        allOf(
          ...
          isNot(contains(jsonEncode(updatedPerson2?.toJson()))),
        ),
      );
    },
  );
