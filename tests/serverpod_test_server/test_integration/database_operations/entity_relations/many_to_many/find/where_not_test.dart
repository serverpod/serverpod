...
// SQL that referenced the relation alias outside of its CTE, causing the
// Postgres error 42P01 "missing FROM-clause entry". These verify the negated
// filters now execute and return the exact set-complement of the un-negated
// filter.
void main() async {
