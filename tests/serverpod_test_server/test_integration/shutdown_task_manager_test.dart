...
void main() {
  test('Given a registered shutdown task '
    ...
    serverpod.experimental.shutdownTasks.addTask(#testTask, () async {
      called = true;
    });
  ...
  test('Given added and then removed shutdown task '
    ...
    const id = #testTask;
    var serverpod = IntegrationTestServer.create();
    serverpod.experimental.shutdownTasks.addTask(id, () async {
      called = true;
    });
  ...
  test('Given multiple shutdown tasks that throw errors '
    ...
    var serverpod = IntegrationTestServer.create();
    serverpod.experimental.shutdownTasks.addTask(#testTask1, () async {
      throw exception1;
    });
    serverpod.experimental.shutdownTasks.addTask(#testTask2, () async {
  ...
  test('Given multiple shutdown tasks '
    ...
    var serverpod = IntegrationTestServer.create();
    serverpod.experimental.shutdownTasks.addTask(#task1, () async {
      completer1.complete();
      await completer2.future;
    });
    serverpod.experimental.shutdownTasks.addTask(#task2, () async {
