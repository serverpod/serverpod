...
void main() {
  withServerpod('Given TestToolsEndpoint', (sessionBuilder, endpoints) {
    ...
    test('when calling echoSimpleDatas then should echo the object', () async {
      final data1 = SimpleData(num: 1);
      final data2 = SimpleData(num: 2);
      var result = await endpoints.testTools.echoSimpleDatas(sessionBuilder, [
        data1,
        data2,
      ]);
    ...
    test(
      ...
      () async {
        ...
        var result = await endpoints.testTools.echoTypes(sessionBuilder, types);

        expect(result.aRecord, ('hello', optionalUri: Uri.parse('world://')));
      },
    );
    ...
    test('when calling echoModuleClass then should return the model', () async {
    ...
    test('when calling echoRecord then should return the record', () async {
      ...
      var result = await endpoints.testTools.echoRecord(sessionBuilder, record);
      expect(result, record);
    });

    test('when calling echoRecords then should return the records', () async {
      final records = [('hello', (2, true)), ('world', (4, false))];
        ...
        expect(
          ...
          emitsInOrder([
            isA<
                ...
                >()
                .having((r) => r.$1, 'first positional', 'hello')
                .having(
                  (r) => r.$2,
                  'second positional',
                  isA<(Map<String, int>, {bool flag, SimpleData simpleData})>()
                      .having((r) => r.$1, 'first positional', {'world': 1})
            ...
            isA<
                ...
                >()
                .having((r) => r.$1, 'first positional', 'hi')
                .having(
                  (r) => r.$2,
                  'second positional',
                  isA<(Map<String, int>, {bool flag, SimpleData simpleData})>()
                      .having((r) => r.$1, 'first positional', {'world': 3})
                      .having((r) => r.flag, 'flag', isTrue)
                      .having(
                        (r) => r.simpleData,
                        'simpleData',
    ...
    test(
      ...
      () async {
        ...
        expect(result, emitsInOrder(lists));
      },
    );
    ...
    test(
      ...
      () async {
        ...
        expect(result, emitsInOrder([isNull, isNull]));
      },
    );
