...
void main() {
  withServerpod('Given TestToolsEndpoint', (sessionBuilder, endpoints) {
    ...
    test('when calling method with named arg then echoes the value', () async {
      final result = await endpoints.methodSignaturePermutations.echoNamedArg(
        sessionBuilder,
        string: 'NamedArg',
      );
    ...
    test(
      ...
      () async {
        final result = await endpoints.methodSignaturePermutations
            .echoPositionalAndOptionalArgs(sessionBuilder, 'PositionalArg');
    ...
    test(
      ...
      () async {
        final result =
            await endpoints.methodSignaturePermutations
                .echoNamedArgStream(
                  sessionBuilder,
