...
void main() {
  withServerpod('Given call to MethodStreamingEndpoint', (
    sessionBuilder,
    endpoints,
  ) {
    test(
    ...
    test(
      ...
      () async {
        ...
        var stream = endpoints.methodStreaming.getBroadcastStream(
          sessionBuilder,
        );
        ...
        await expectLater(wasStreamCancelled, completion(true));
      },
    );
    ...
    test(
      ...
      () async {
        ...
        await expectLater(wasSessionWillCloseListenerCalled, completion(true));
      },
    );
  });
}
