...
void main() {
  group('Given a web server with widget routes', () {
    ...
    test(
      ...
      () async {
        var response = await http.get(
          Uri.parse('${IntegrationTestServer.webUrl(serverpod)}html-route'),
        );
    ...
    test(
      ...
      () async {
        var response = await http.get(
          Uri.parse('${IntegrationTestServer.webUrl(serverpod)}json-route'),
        );
    ...
    test(
      ...
      () async {
        ...
        var request = http.Request(
          'GET',
          Uri.parse('${IntegrationTestServer.webUrl(serverpod)}redirect-route'),
        );
