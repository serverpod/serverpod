...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(typesMap.aBigIntKey?.entries.first.key, BigInt.two);
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(typesMap.aBigIntValue?['2'], BigInt.two);
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(typesMap.anEnumKey?.entries.first.key, TestEnum.one);
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(typesMap.aMapKey?.entries.first.key.entries.first.key.anInt, 123);
    },
  );
  ...
  test(
    ...
    () {
      ...
      expect(typesMap.aListKey?.entries.first.key.first.anInt, 1);
    },
  );
    ...
    () {
      ...
      expect(
        ...
        isA<Map<String, dynamic>>()
            ...
            .having((m) => m['bar'], 'bar entry', isNull),
      );
  ...
  test(
    ...
    () {
      var jsonList = mapContainerToJson([null, (1, SimpleData(num: 2))]);

      expect(
        jsonList,
        isA<List>()
            .having((m) => m.length, 'length', 2)
            .having((m) => m.first, 'first entry', isNull)
