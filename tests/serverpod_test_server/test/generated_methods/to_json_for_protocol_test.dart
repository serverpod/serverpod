...
void main() {
  ...
  test(
    ...
    () {
      ...
      var object = TypesList(aByteData: [ByteData.view(intList.buffer)]);
  ...
  test(
    ...
    () {
      var object = TypesList(aDuration: [Duration(seconds: 1)]);
  ...
  test(
    ...
    () {
      var object = TypesList(aUri: [Uri.parse('https://serverpod.dev')]);
  ...
  test(
    ...
    () {
      var object = TypesList(aBigInt: [BigInt.one]);
  ...
  test(
    ...
    () {
      var object = TypesList(anEnum: [TestEnum.one]);
  ...
  test(
    ...
    () {
      var object = TypesList(aStringifiedEnum: [TestEnumStringified.one]);
  ...
  group('Set', () {
    ...
    test(
      ...
      () {
        ...
        var object = TypesSet(aByteData: {ByteData.view(intList.buffer)});
    ...
    test(
      ...
      () {
        var object = TypesSet(aDuration: {Duration(seconds: 1)});
    ...
    test(
      ...
      () {
        var object = TypesSet(aBigInt: {BigInt.one});
    ...
    test(
      ...
      () {
        var object = TypesSet(anEnum: {TestEnum.one});
    ...
    test(
      ...
      () {
        var object = TypesSet(aStringifiedEnum: {TestEnumStringified.one});
  ...
  group('Map value -', () {
    ...
    test(
      ...
      () {
        var object = TypesMap(aDurationValue: {'key': Duration(seconds: 1)});
    ...
    test(
      ...
      () {
        var object = TypesMap(aBigIntValue: {'key': BigInt.one});
    ...
    test(
      ...
      () {
        var object = TypesMap(anEnumValue: {'key': TestEnum.one});
  ...
  group('Map key -', () {
    ...
    test(
      'Given a class with a Map with a nested Duration when calling toJsonForProtocol the entire nested structure is converted.',
      () {
        var object = TypesMap(aDurationKey: {Duration(seconds: 1): 'value'});
    ...
    test(
      'Given a class with a Map with a nested BigInt when calling toJsonForProtocol the entire nested structure is converted.',
      () {
        var object = TypesMap(aBigIntKey: {BigInt.one: 'value'});
    ...
    test(
      'Given a class with a Map with a nested enum serialized by index when calling toJsonForProtocol the entire nested structure is converted.',
      () {
        var object = TypesMap(anEnumKey: {TestEnum.one: 'value'});
  ...
  group("Given an object with server only field, ", () {
    test('then the serialized json should not contain server-only field.', () {
      var object = ScopeServerOnlyField(serverOnlyScope: Types(anInt: 2));
  ...
  test('Given an object from a server only class with changed id type '
    ...
    var object = ServerOnlyChangedIdFieldClass(id: Uuid().v4obj());
