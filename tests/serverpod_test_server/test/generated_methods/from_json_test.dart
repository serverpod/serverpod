...
void main() {
  group('Given a a class with non-nullable field, ', () {
    ...
    test(
      ...
      () {
        expect(() => SimpleData.fromJson({}), throwsA(isA<TypeError>()));
      },
    );
  });
  ...
  group('Given a class with a nullable integer field, ', () {
    test(
      ...
      () {
        expect(Types.fromJson({'anInt': 1}).anInt, 1);
      },
    );
    ...
    test(
      ...
      () {
        expect(Types.fromJson({'anInt': null}).anInt, isNull);
      },
    );
  });
  ...
  group('Given a class with a nullable double field, ', () {
    test(
      'when deserializing from JSON with a correct value, then the result matches the expected value',
      () {
        expect(Types.fromJson({'aDouble': 20.20}).aDouble, 20.20);
      },
    );
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'aDouble': null}).aDouble, isNull);
      },
    );
    ...
    test(
      ...
      () {
        expect(Types.fromJson({'aDouble': 1}).aDouble, 1.0);
      },
    );
  });
  ...
  group('Given a class with a nullable boolean field, ', () {
    test(
      'when deserializing from JSON with a correct value, then the result matches the expected value',
      () {
        expect(Types.fromJson({'aBool': true}).aBool, true);
      },
    );
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'aBool': null}).aBool, isNull);
      },
    );
  });
  ...
  group('Given a class with a nullable string field, ', () {
    test(
      'when deserializing from JSON with a correct value, then the result matches the expected value',
      () {
        expect(Types.fromJson({'aString': 'test'}).aString, 'test');
      },
    );
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'aString': null}).aString, isNull);
      },
    );
  });
  ...
  group('Given a class with a nullable DateTime field, ', () {
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'aDateTime': null}).aDateTime, isNull);
      },
    );
  });
  ...
  group('Given a class with nullable UuidValue field, ', () {
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'aUuid': null}).aUuid?.uuid, isNull);
      },
    );
  });
  ...
  group('Given a class with nullable Uri field, ', () {
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'aUri': null}).aUri, isNull);
      },
    );
  });
  ...
  group('Given a class with nullable BigInt field, ', () {
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'aBigInt': null}).aBigInt, isNull);
      },
    );
  });
  ...
  group('Given a class with a nullable ByteData field, ', () {
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'aByteData': null}).aByteData, isNull);
      },
    );
  });
  ...
  group('Given a class with a nullable Enum field serialized as int, ', () {
    test(
      ...
      () {
        ...
        expect(types.anEnum, TestEnum.one);
      },
    );
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(Types.fromJson({'anEnum': null}).anEnum, isNull);
      },
    );
  });
  ...
  group('Given a class with a nullable Enum field serialized as String, ', () {
    test(
      ...
      () {
        ...
        expect(types.aStringifiedEnum, TestEnumStringified.one);
      },
    );
  ...
  group('Given a class with a nullable List field, ', () {
    ...
    test(
      'when deserializing from JSON with a null value, then the field is correctly set to null',
      () {
        expect(TypesList.fromJson({'anInt': null}).anInt, isNull);
      },
    );
  });
  ...
  group('Given a class with a nullable Set and nested objects, ', () {
    test(
      ...
      () {
        ...
        expect(typeList.anObject?.first, isA<Types>());
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(typeList.aDateTime, isNull);
      },
    );
