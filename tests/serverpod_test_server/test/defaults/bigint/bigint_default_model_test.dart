...
void main() async {
  group("Given a class with 'defaultModel' BigInt fields", () {
    test(
    ...
    test(
      ...
      () {
        ...
        var object = BigIntDefaultModel(bigIntDefaultModelStr: bigInt);
        expect(object.bigIntDefaultModelStr, bigInt);
      },
    );
    ...
    test(
      ...
      () {
        var bigInt = BigInt.one;
        var object = BigIntDefaultModel(bigIntDefaultModelStrNull: bigInt);
        expect(object.bigIntDefaultModelStrNull, bigInt);
      },
    );
  });
}
