...
void main() async {
  group("Given a class with 'defaultPersist' BigInt fields", () {
    test(
    ...
    test(
      ...
      () {
        ...
        var object = BigIntDefaultPersist(bigIntDefaultPersistStr: bigInt);
        expect(object.bigIntDefaultPersistStr, bigInt);
      },
    );
  });
}
