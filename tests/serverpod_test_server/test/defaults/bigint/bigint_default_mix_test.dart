...
void main() async {
  group("Given a class with mixed BigInt fields defaults", () {
    test(
      ...
      () {
        ...
        expect(object.bigIntDefaultAndDefaultModel, BigInt.two);
      },
    );
    ...
    test(
      ...
      () {
        ...
        var object = BigIntDefaultMix(bigIntDefaultAndDefaultModel: bigInt);
        expect(object.bigIntDefaultAndDefaultModel, bigInt);
      },
    );
    ...
    test(
      ...
      () {
        var bigInt = BigInt.parse('18446744073709551615');
        var object = BigIntDefaultMix(bigIntDefaultAndDefaultPersist: bigInt);
        expect(object.bigIntDefaultAndDefaultPersist, bigInt);
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.bigIntDefaultModelAndDefaultPersist, bigInt);
      },
    );
  });
}
