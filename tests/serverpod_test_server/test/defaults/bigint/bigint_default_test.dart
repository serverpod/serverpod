...
void main() async {
  group("Given a class with 'default' BigInt fields", () {
    test(
    ...
    test(
      ...
      () {
        ...
        ;
        var object = BigIntDefault(bigintDefaultStr: bigInt);
        expect(object.bigintDefaultStr, bigInt);
      },
    );
    ...
    test(
      ...
      () {
        var bigInt = BigInt.one;
        var object = BigIntDefault(bigintDefaultStrNull: bigInt);
        expect(object.bigintDefaultStrNull, bigInt);
      },
    );
  });
}
