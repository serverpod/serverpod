...
void main() async {
  group("Given a class with mixed fields defaults", () {
    test(
    ...
    test(
      ...
      () {
        ...
        var object = UriDefaultMix(uriDefaultAndDefaultModel: uri);
        expect(object.uriDefaultAndDefaultModel, equals(uri));
      },
    );
    ...
    test(
      ...
      () {
        var uri = Uri.parse('https://example.com');
        var object = UriDefaultMix(uriDefaultAndDefaultPersist: uri);
        expect(object.uriDefaultAndDefaultPersist, equals(uri));
      },
    );
    ...
    test(
      ...
      () {
        var uri = Uri.parse('https://example.com');
        var object = UriDefaultMix(uriDefaultModelAndDefaultPersist: uri);
        expect(object.uriDefaultModelAndDefaultPersist, equals(uri));
      },
    );
  });
}
