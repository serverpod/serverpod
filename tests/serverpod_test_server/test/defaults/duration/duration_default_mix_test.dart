  ...
  group("Given a class with mixed fields defaults", () {
    ...
    test(
      ...
      () {
        ...
        expect(object.durationDefaultAndDefaultModel, equals(duration));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.durationDefaultAndDefaultPersist, equals(duration));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.durationDefaultModelAndDefaultPersist, equals(duration));
      },
    );
  });
}
