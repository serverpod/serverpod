  ...
  group("Given a class with 'defaultPersist' enum fields", () {
    test(
      ...
      () {
        ...
        expect(object.byNameEnumDefaultPersist, isNull);
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefaultPersist();
        expect(object.byIndexEnumDefaultPersist, isNull);
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.byNameEnumDefaultPersist, equals(ByNameEnum.byName2));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.byIndexEnumDefaultPersist, equals(ByIndexEnum.byIndex2));
      },
    );
  });
}
