  ...
  group("Given a class with 'default' enum fields", () {
    test(
      ...
      () {
        ...
        expect(object.byNameEnumDefault, equals(ByNameEnum.byName1));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefault();
        expect(object.byNameEnumDefaultNull, equals(ByNameEnum.byName2));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefault();
        expect(object.byIndexEnumDefault, equals(ByIndexEnum.byIndex1));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefault();
        expect(object.byIndexEnumDefaultNull, equals(ByIndexEnum.byIndex2));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefault(byNameEnumDefault: ByNameEnum.byName2);
        expect(object.byNameEnumDefault, equals(ByNameEnum.byName2));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefault(byNameEnumDefaultNull: ByNameEnum.byName1);
        expect(object.byNameEnumDefaultNull, equals(ByNameEnum.byName1));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefault(byIndexEnumDefault: ByIndexEnum.byIndex2);
        expect(object.byIndexEnumDefault, equals(ByIndexEnum.byIndex2));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefault(byIndexEnumDefaultNull: ByIndexEnum.byIndex1);
        expect(object.byIndexEnumDefaultNull, equals(ByIndexEnum.byIndex1));
      },
    );
  });
}
