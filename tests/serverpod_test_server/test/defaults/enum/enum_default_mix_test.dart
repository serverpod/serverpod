...
void main() async {
  group(
    ...
    () {
      ...
      test(
        'when an object of the class is created with a value for "byNameEnumDefaultAndDefaultModel", '
      ...
      test(
        'when an object of the class is created with a value for "byNameEnumDefaultAndDefaultPersist", '
        'then the field value should match the provided value',
        () {
          var object = EnumDefaultMix(
      ...
      test(
        'when an object of the class is created with a value for "byNameEnumDefaultModelAndDefaultPersist", '
        'then the field value should match the provided value',
        () {
          var object = EnumDefaultMix(
