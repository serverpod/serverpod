  ...
  group("Given a class with 'defaultModel' enum fields", () {
    test(
      ...
      () {
        ...
        expect(object.byNameEnumDefaultModel, equals(ByNameEnum.byName1));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefaultModel();
        expect(object.byNameEnumDefaultModelNull, equals(ByNameEnum.byName2));
      },
    );
    ...
    test(
      ...
      () {
        var object = EnumDefaultModel();
        expect(object.byIndexEnumDefaultModel, equals(ByIndexEnum.byIndex1));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.byNameEnumDefaultModel, equals(ByNameEnum.byName2));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.byNameEnumDefaultModelNull, equals(ByNameEnum.byName1));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.byIndexEnumDefaultModel, equals(ByIndexEnum.byIndex2));
      },
    );
