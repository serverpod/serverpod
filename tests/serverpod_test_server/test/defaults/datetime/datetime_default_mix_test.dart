  ...
  group("Given a class with mixed fields defaults", () {
    ...
    test(
      ...
      () {
        ...
        var object = DateTimeDefaultMix(dateTimeDefaultAndDefaultModel: date);
        expect(object.dateTimeDefaultAndDefaultModel, date);
      },
    );
    ...
    test(
      ...
      () {
        var date = DateTime.parse('2024-05-05T22:00:00.000Z');
        var object = DateTimeDefaultMix(dateTimeDefaultAndDefaultPersist: date);
        expect(object.dateTimeDefaultAndDefaultPersist, date);
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(object.dateTimeDefaultModelAndDefaultPersist, date);
      },
    );
  });
}
