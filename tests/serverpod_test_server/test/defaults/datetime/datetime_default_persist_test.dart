  ...
  group(
    ...
    () {
      test(
        ...
        'then the "defaultPersist=now" field should be null',
        () {
      ...
      test(
        'when an object of the class is created, '
        'then the "defaultPersist" field with UTC string should be null',
        () {
          var object = DateTimeDefaultPersist();
      ...
      test(
        'when an object of the class is created with a specific value for "dateTimeDefaultPersistNow", '
      ...
      test(
        'when an object of the class is created with a specific value for "dateTimeDefaultPersistStr", '
        'then the field value should match the provided value',
        () {
          var date = DateTime.parse('2024-05-01T22:00:00.000Z');
          var object = DateTimeDefaultPersist(
