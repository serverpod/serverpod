  ...
  group("Given a class with 'defaultPersist' fields", () {
    ...
    test(
      ...
      () {
        ...
        var object = DateTimeDefaultPersist(dateTimeDefaultPersistNow: date);
        expect(object.dateTimeDefaultPersistNow, date);
      },
    );
    ...
    test(
      ...
      () {
        var date = DateTime.parse('2024-05-01T22:00:00.000Z');
        var object = DateTimeDefaultPersist(dateTimeDefaultPersistStr: date);
        expect(object.dateTimeDefaultPersistStr, date);
      },
    );
  });
}
