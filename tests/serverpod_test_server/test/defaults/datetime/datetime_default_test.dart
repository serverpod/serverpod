  ...
  group("Given a class with 'default' fields", () {
    ...
    test(
      ...
      () {
        ...
        var object = DateTimeDefault(dateTimeDefaultNow: date);
        expect(object.dateTimeDefaultNow, date);
      },
    );
    ...
    test(
      ...
      () {
        var date = DateTime.parse('2024-05-05T22:00:00.000Z');
        var object = DateTimeDefault(dateTimeDefaultStr: date);
        expect(object.dateTimeDefaultStr, date);
      },
    );
    ...
    test(
      ...
      () {
        var date = DateTime.parse('2024-05-05T22:00:00.000Z');
        var object = DateTimeDefault(dateTimeDefaultStrNull: date);
        expect(object.dateTimeDefaultStrNull, date);
      },
    );
  });
}
