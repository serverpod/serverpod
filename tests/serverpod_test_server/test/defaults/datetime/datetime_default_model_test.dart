  ...
  group("Given a class with 'defaultModel' fields", () {
    ...
    test(
      ...
      () {
        ...
        var object = DateTimeDefaultModel(dateTimeDefaultModelNow: date);
        expect(object.dateTimeDefaultModelNow, date);
      },
    );
    ...
    test(
      ...
      () {
        ...
        var object = DateTimeDefaultModel(dateTimeDefaultModelStr: date);
        expect(object.dateTimeDefaultModelStr, date);
      },
    );
    ...
    test(
      ...
      () {
        var date = DateTime.parse('2024-05-05T22:00:00.000Z');
        var object = DateTimeDefaultModel(dateTimeDefaultModelStrNull: date);
        expect(object.dateTimeDefaultModelStrNull, date);
      },
    );
  });
}
