...
void main() async {
  group(
    ...
    () {
      ...
      test(
        'when an object of the class is created with a value for "doubleDefaultAndDefaultModel", '
      ...
      test(
        'when an object of the class is created with a value for "doubleDefaultAndDefaultPersist", '
        'then the field value should match the provided value',
        () {
      ...
      test(
        'when an object of the class is created with a value for "doubleDefaultModelAndDefaultPersist", '
        'then the field value should match the provided value',
        () {
          var object = DoubleDefaultMix(
