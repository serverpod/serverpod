  ...
  group(
    ...
    () {
      test(
        ...
        'then the "doubleDefaultModel" field should match the default value',
        () {
      ...
      test(
        'when an object of the class is created, '
        'then the "doubleDefaultModelNull" field should match the default value',
        () {
          var object = DoubleDefaultModel();
      ...
      test(
        'when an object of the class is created with a specific value for "doubleDefaultModel", '
      ...
      test(
        'when an object of the class is created with a specific value for "doubleDefaultModelNull", '
        'then the field value should match the provided value',
        () {
