...
void main() async {
  group("Given a class with serverOnly scoped fields with default values", () {
    test(
      ...
      () {
        var serverObject = ServerOnlyDefault(normalField: 'test value');
    ...
    test(
      ...
      () {
        var original = ServerOnlyDefault(normalField: 'original');

        var copied = original.copyWith(normalField: 'updated');
