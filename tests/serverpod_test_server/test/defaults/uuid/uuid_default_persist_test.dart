  ...
  group(
    ...
    () {
      test(
        ...
        'then the "defaultPersist=random" UUID field should be null',
        () {
      ...
      test(
        'when an object of the class is created, '
        'then the "defaultPersist=random_v7" UUID field should be null',
        () {
          var object = UuidDefaultPersist();
      ...
      test(
        'when an object of the class is created, '
        'then the "defaultPersist" UUID field with a string should be null',
        () {
          var object = UuidDefaultPersist();
      ...
      test(
        'when an object of the class is created with a specific value for "uuidDefaultPersistRandom", '
      ...
      test(
        'when an object of the class is created with a specific value for "uuidDefaultPersistRandomV7", '
        'then the field value should match the provided value',
        () {
          var uuid = UuidValue.fromString(
            '3f2504e0-4f89-11d3-9a0c-0305e82c3301',
      ...
      test(
        'when an object of the class is created with a specific value for "uuidDefaultPersistStr", '
        'then the field value should match the provided value',
        () {
          var uuid = UuidValue.fromString(
