  ...
  group("Given a class with 'defaultPersist' UUID fields", () {
    ...
    test(
      ...
      () {
        ...
        var object = UuidDefaultPersist(uuidDefaultPersistRandom: uuid);
        expect(object.uuidDefaultPersistRandom, uuid);
      },
    );
    ...
    test(
      ...
      () {
        var uuid = UuidValue.fromString('3f2504e0-4f89-11d3-9a0c-0305e82c3301');
        var object = UuidDefaultPersist(uuidDefaultPersistRandomV7: uuid);
        expect(object.uuidDefaultPersistRandomV7, uuid);
      },
    );
    ...
    test(
      ...
      () {
        ...
        var object = UuidDefaultPersist(uuidDefaultPersistStr: uuid);
        expect(object.uuidDefaultPersistStr, uuid);
      },
    );
  });
}
