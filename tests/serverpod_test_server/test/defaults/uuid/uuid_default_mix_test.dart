...
void main() async {
  group("Given a class with mixed UUID fields defaults", () {
    test(
    ...
    test(
      ...
      () {
        ...
        var object = UuidDefaultMix(uuidDefaultAndDefaultModel: uuid);
        expect(object.uuidDefaultAndDefaultModel, uuid);
      },
    );
    ...
    test(
      ...
      () {
        var uuid = UuidValue.fromString('3f2504e0-4f89-11d3-9a0c-0305e82c3301');
        var object = UuidDefaultMix(uuidDefaultAndDefaultPersist: uuid);
        expect(object.uuidDefaultAndDefaultPersist, uuid);
      },
    );
    ...
    test(
      ...
      () {
        var uuid = UuidValue.fromString('3f2504e0-4f89-11d3-9a0c-0305e82c3301');
        var object = UuidDefaultMix(uuidDefaultModelAndDefaultPersist: uuid);
        expect(object.uuidDefaultModelAndDefaultPersist, uuid);
      },
    );
  });
}
