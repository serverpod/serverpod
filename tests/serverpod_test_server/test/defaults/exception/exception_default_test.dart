...
void main() async {
  group("Given an exception with 'default' fields", () {
    ...
    test(
      ...
      () {
        var exception = DefaultException();
        expect(exception.defaultDouble, equals(10.5));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException();
        expect(exception.defaultEnum, equals(ByNameEnum.byName1));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException();
        expect(exception.defaultInteger, equals(10));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException();
        expect(exception.defaultString, equals('Default error message'));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException();
        expect(exception.defaultUuid, isNotNull);
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException();
        expect(exception.defaultModelField, equals('Model specific message'));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException();
        expect(exception.defaultMixField, equals('Model specific mix message'));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException(defaultBoolean: false);
        expect(exception.defaultBoolean, equals(false));
      },
    );
    ...
    test(
      ...
      () {
        ...
        var exception = DefaultException(defaultDateTime: dateTime);
        expect(exception.defaultDateTime, equals(dateTime));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException(defaultDouble: 20.5);
        expect(exception.defaultDouble, equals(20.5));
      },
    );
    ...
    test(
      ...
      () {
        ...
        var exception = DefaultException(defaultDuration: duration);
        expect(exception.defaultDuration, equals(duration));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException(defaultEnum: ByNameEnum.byName2);
        expect(exception.defaultEnum, equals(ByNameEnum.byName2));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException(defaultInteger: 25);
        expect(exception.defaultInteger, equals(25));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException(defaultString: 'Custom error message');
        expect(exception.defaultString, equals('Custom error message'));
      },
    );
    ...
    test(
      ...
      () {
        ...
        var exception = DefaultException(defaultUuid: uuid);
        expect(exception.defaultUuid, equals(uuid));
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(exception.defaultModelField, equals('Custom model message'));
      },
    );
    ...
    test(
      ...
      () {
        var exception = DefaultException(defaultMixField: 'Custom mix message');
        expect(exception.defaultMixField, equals('Custom mix message'));
      },
    );
  });
}
