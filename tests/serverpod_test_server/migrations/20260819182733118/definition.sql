...
--
-- Class ObjectWithProjection as table object_with_projection
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test', '20260819182733118', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260819182733118', "timestamp" = now();
