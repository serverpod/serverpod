...
--
-- Class FkRelationCompany as table fk_relation_company
--
...
--
-- Class FkRelationEmployee as table fk_relation_employee
--
...
--
-- Class FkRelationOffice as table fk_relation_office
--
...
--
-- Foreign relations for "fk_relation_employee" table
--
...
--
-- Foreign relations for "fk_relation_office" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test', '20260825183519927', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260825183519927', "timestamp" = now();
