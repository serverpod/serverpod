...
--
-- Class ProjectedAddress as table projected_address
--
CREATE TABLE "projected_address" (
    "id" bigserial PRIMARY KEY,
    "street" text NOT NULL,
    "state" text NOT NULL,
...
ALTER TABLE ONLY "projected_user"
    ...
    REFERENCES "projected_address"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test', '20260721195343036', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260721195343036', "timestamp" = now();
