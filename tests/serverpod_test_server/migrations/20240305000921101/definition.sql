...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test', '20240305000921101', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240305000921101', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_module', '20240305000912478', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240305000912478', "timestamp" = now();
