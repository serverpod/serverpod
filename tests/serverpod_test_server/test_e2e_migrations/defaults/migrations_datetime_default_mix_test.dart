  ...
  group(
    ...
    () {
      ...
      test(
        ...
        'then the database contains the new table with the correct "defaultModel" and "defaultPersist" values for "dateTimeDefaultNow".',
        () async {
      ...
      test(
        'when creating and applying migration, '
        'then the database contains the new table with the correct "defaultModel" and "defaultPersist" values for "dateTimeDefaultStr".',
        () async {
          var tableName = 'migrated_table';
          var tag = 'add-table';
          var targetStateProtocols = {
