...
''',
      ...
      await MigrationTestUtils.createInitialState(
        migrationProtocols: [firstMigrationProtocols],
      );
    });
    ...
    test(
      ...
      () async {
        ...
        expect(exitCode, 0, reason: 'Should create a repair migration.');
...
''',
      ...
      await MigrationTestUtils.createInitialState(
        migrationProtocols: [firstMigrationProtocols, secondMigrationProtocols],
      );
    });
