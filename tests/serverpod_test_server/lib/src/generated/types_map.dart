...
class _TypesMapImpl extends TypesMap {
  ...
  TypesMap copyWith({
    ...
    return TypesMap(
      ...
      anObjectKey:
          anObjectKey is Map<_i5.Types, String>?
              ? anObjectKey
              : this.anObjectKey?.map(
                (key0, value0) => MapEntry(key0.copyWith(), value0),
              ),
      aMapKey:
          aMapKey is Map<Map<_i5.Types, String>, String>?
              ? aMapKey
              : this.aMapKey?.map(
      ...
      aListKey:
          aListKey is Map<List<_i5.Types>, String>?
              ? aListKey
              : this.aListKey?.map(
                (key0, value0) =>
      ...
      anObjectValue:
          anObjectValue is Map<String, _i5.Types>?
              ? anObjectValue
              : this.anObjectValue?.map(
                (key0, value0) => MapEntry(key0, value0.copyWith()),
              ),
      aMapValue:
          aMapValue is Map<String, Map<String, _i5.Types>>?
              ? aMapValue
              : this.aMapValue?.map(
                (key0, value0) => MapEntry(
                  key0,
      ...
      aListValue:
          aListValue is Map<String, List<_i5.Types>>?
              ? aListValue
              : this.aListValue?.map(
                (key0, value0) =>
      ...
      aNullableRecordKey:
          aNullableRecordKey is Map<(String,)?, String>?
              ? aNullableRecordKey
