  ...
  factory UuidDefault.fromJson(Map<String, dynamic> jsonSerialization) {
    return UuidDefault(
      ...
      uuidDefaultRandomNull:
          jsonSerialization['uuidDefaultRandomNull'] == null
              ? null
      ...
      uuidDefaultStrNull:
          jsonSerialization['uuidDefaultStrNull'] == null
              ? null
              : _i1.UuidValueJsonExtension.fromJson(
...
class UuidDefaultTable extends _i1.Table<int?> {
  UuidDefaultTable({super.tableRelation}) : super(tableName: 'uuid_default') {
    ...
    uuidDefaultStr = _i1.ColumnUuid('uuidDefaultStr', this, hasDefault: true);
...
class UuidDefaultRepository {
  ...
  Future<UuidDefault?> findById(
    ...
    return session.db.findById<UuidDefault>(id, transaction: transaction);
  }
  ...
  Future<List<UuidDefault>> insert(
    ...
    return session.db.insert<UuidDefault>(rows, transaction: transaction);
  }
  ...
  Future<UuidDefault> insertRow(
    ...
    return session.db.insertRow<UuidDefault>(row, transaction: transaction);
  }
  ...
  Future<List<UuidDefault>> delete(
    ...
    return session.db.delete<UuidDefault>(rows, transaction: transaction);
  }
  ...
  Future<UuidDefault> deleteRow(
    ...
    return session.db.deleteRow<UuidDefault>(row, transaction: transaction);
  }
