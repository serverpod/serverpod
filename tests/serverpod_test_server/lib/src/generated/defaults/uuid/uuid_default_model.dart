...
class UuidDefaultModelTable extends _i1.Table<int?> {
  UuidDefaultModelTable({super.tableRelation})
    ...
    uuidDefaultModelRandom = _i1.ColumnUuid('uuidDefaultModelRandom', this);
    uuidDefaultModelRandomV7 = _i1.ColumnUuid('uuidDefaultModelRandomV7', this);
    uuidDefaultModelRandomNull = _i1.ColumnUuid(
      'uuidDefaultModelRandomNull',
      this,
    );
    uuidDefaultModelStr = _i1.ColumnUuid('uuidDefaultModelStr', this);
    uuidDefaultModelStrNull = _i1.ColumnUuid('uuidDefaultModelStrNull', this);
  }
...
class UuidDefaultModelRepository {
  ...
  Future<UuidDefaultModel?> findById(
    ...
    return session.db.findById<UuidDefaultModel>(id, transaction: transaction);
  }
  ...
  Future<List<UuidDefaultModel>> insert(
    ...
    return session.db.insert<UuidDefaultModel>(rows, transaction: transaction);
  }
  ...
  Future<List<UuidDefaultModel>> delete(
    ...
    return session.db.delete<UuidDefaultModel>(rows, transaction: transaction);
  }
