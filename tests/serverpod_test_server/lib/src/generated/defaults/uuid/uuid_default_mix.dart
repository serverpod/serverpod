...
class UuidDefaultMixUpdateTable extends _i1.UpdateTable<UuidDefaultMixTable> {
  ...
  _i1.ColumnValue<_i1.UuidValue, _i1.UuidValue> uuidDefaultAndDefaultModel(
    _i1.UuidValue value,
  ) => _i1.ColumnValue(table.uuidDefaultAndDefaultModel, value);

  _i1.ColumnValue<_i1.UuidValue, _i1.UuidValue> uuidDefaultAndDefaultPersist(
    _i1.UuidValue value,
  ) => _i1.ColumnValue(table.uuidDefaultAndDefaultPersist, value);

  _i1.ColumnValue<_i1.UuidValue, _i1.UuidValue>
  uuidDefaultModelAndDefaultPersist(_i1.UuidValue value) =>
      _i1.ColumnValue(table.uuidDefaultModelAndDefaultPersist, value);
}
...
class UuidDefaultMixRepository {
  ...
  Future<UuidDefaultMix?> findById(
    ...
    return session.db.findById<UuidDefaultMix>(id, transaction: transaction);
  }
  ...
  Future<List<UuidDefaultMix>> insert(
    ...
    return session.db.insert<UuidDefaultMix>(rows, transaction: transaction);
  }
  ...
  Future<UuidDefaultMix> insertRow(
    ...
    return session.db.insertRow<UuidDefaultMix>(row, transaction: transaction);
  }
  ...
  Future<List<UuidDefaultMix>> delete(
    ...
    return session.db.delete<UuidDefaultMix>(rows, transaction: transaction);
  }
  ...
  Future<UuidDefaultMix> deleteRow(
    ...
    return session.db.deleteRow<UuidDefaultMix>(row, transaction: transaction);
  }
