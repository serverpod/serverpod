...
class UuidDefaultPersistRepository {
  ...
  /// Find a list of [UuidDefaultPersist]s from a table, using the provided [where]
  ...
  /// Find a single [UuidDefaultPersist] from a table, using the provided [where]
  ...
  /// Find a single [UuidDefaultPersist] by its [id] or null if no such row exists.
  ...
  /// Update all [UuidDefaultPersist]s in the list and returns the updated rows. If
