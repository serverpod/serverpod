...
class BoolDefaultPersistRepository {
  ...
  /// Find a list of [BoolDefaultPersist]s from a table, using the provided [where]
  ...
  /// Find a single [BoolDefaultPersist] from a table, using the provided [where]
  ...
  /// Find a single [BoolDefaultPersist] by its [id] or null if no such row exists.
  ...
  /// Update all [BoolDefaultPersist]s in the list and returns the updated rows. If
