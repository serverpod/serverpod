...
class DoubleDefaultMixRepository {
  ...
  /// Find a list of [DoubleDefaultMix]s from a table, using the provided [where]
  ...
  /// Find a single [DoubleDefaultMix] from a table, using the provided [where]
  ...
  /// Find a single [DoubleDefaultMix] by its [id] or null if no such row exists.
  ...
  /// Update all [DoubleDefaultMix]s in the list and returns the updated rows. If
