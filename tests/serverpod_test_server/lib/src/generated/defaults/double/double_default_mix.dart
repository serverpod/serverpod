...
class DoubleDefaultMixUpdateTable
  ...
  _i1.ColumnValue<double, double> doubleDefaultAndDefaultModel(double value) =>
      _i1.ColumnValue(table.doubleDefaultAndDefaultModel, value);

  _i1.ColumnValue<double, double> doubleDefaultAndDefaultPersist(
    double value,
  ) => _i1.ColumnValue(table.doubleDefaultAndDefaultPersist, value);

  _i1.ColumnValue<double, double> doubleDefaultModelAndDefaultPersist(
    double value,
  ) => _i1.ColumnValue(table.doubleDefaultModelAndDefaultPersist, value);
}
...
class DoubleDefaultMixRepository {
  ...
  Future<DoubleDefaultMix?> findById(
    ...
    return session.db.findById<DoubleDefaultMix>(id, transaction: transaction);
  }
  ...
  Future<List<DoubleDefaultMix>> insert(
    ...
    return session.db.insert<DoubleDefaultMix>(rows, transaction: transaction);
  }
  ...
  Future<List<DoubleDefaultMix>> delete(
    ...
    return session.db.delete<DoubleDefaultMix>(rows, transaction: transaction);
  }
