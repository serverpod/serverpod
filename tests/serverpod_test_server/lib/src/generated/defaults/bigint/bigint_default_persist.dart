...
class BigIntDefaultPersistRepository {
  ...
  /// Emits [BigIntDefaultPersist]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `BigIntDefaultPersist.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<BigIntDefaultPersist>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<BigIntDefaultPersistTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<BigIntDefaultPersist>(
      where: where?.call(BigIntDefaultPersist.t),
      orderBy: orderBy?.call(BigIntDefaultPersist.t),
      orderByList: orderByList?.call(BigIntDefaultPersist.t),
      limit: limit,
