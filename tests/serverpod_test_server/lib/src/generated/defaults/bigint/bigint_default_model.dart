...
class BigIntDefaultModelRepository {
  ...
  /// Emits [BigIntDefaultModel]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `BigIntDefaultModel.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<BigIntDefaultModel>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<BigIntDefaultModelTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<BigIntDefaultModel>(
      where: where?.call(BigIntDefaultModel.t),
      orderBy: orderBy?.call(BigIntDefaultModel.t),
      orderByList: orderByList?.call(BigIntDefaultModel.t),
      limit: limit,
