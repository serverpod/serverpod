...
class DateTimeDefaultModelRepository {
  ...
  /// Emits [DateTimeDefaultModel]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `DateTimeDefaultModel.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<DateTimeDefaultModel>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<DateTimeDefaultModelTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<DateTimeDefaultModel>(
      where: where?.call(DateTimeDefaultModel.t),
      orderBy: orderBy?.call(DateTimeDefaultModel.t),
      orderByList: orderByList?.call(DateTimeDefaultModel.t),
      limit: limit,
