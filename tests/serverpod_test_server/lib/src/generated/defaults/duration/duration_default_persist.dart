...
class DurationDefaultPersistRepository {
  ...
  /// Emits [DurationDefaultPersist]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `DurationDefaultPersist.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<DurationDefaultPersist>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<DurationDefaultPersistTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<DurationDefaultPersist>(
      where: where?.call(DurationDefaultPersist.t),
      orderBy: orderBy?.call(DurationDefaultPersist.t),
      orderByList: orderByList?.call(DurationDefaultPersist.t),
      limit: limit,
