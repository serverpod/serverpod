...
class EnumDefaultMixRepository {
  ...
  /// Emits [EnumDefaultMix]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `EnumDefaultMix.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<EnumDefaultMix>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<EnumDefaultMixTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<EnumDefaultMix>(
      where: where?.call(EnumDefaultMix.t),
      orderBy: orderBy?.call(EnumDefaultMix.t),
      orderByList: orderByList?.call(EnumDefaultMix.t),
      limit: limit,
