...
class EnumDefaultModelRepository {
  ...
  /// Emits [EnumDefaultModel]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `EnumDefaultModel.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<EnumDefaultModel>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<EnumDefaultModelTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<EnumDefaultModel>(
      where: where?.call(EnumDefaultModel.t),
      orderBy: orderBy?.call(EnumDefaultModel.t),
      orderByList: orderByList?.call(EnumDefaultModel.t),
      limit: limit,
