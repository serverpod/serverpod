...
class EnumDefaultModelRepository {
  ...
  Future<EnumDefaultModel?> findById(
    ...
    return session.db.findById<EnumDefaultModel>(id, transaction: transaction);
  }
  ...
  Future<List<EnumDefaultModel>> insert(
    ...
    return session.db.insert<EnumDefaultModel>(rows, transaction: transaction);
  }
  ...
  Future<List<EnumDefaultModel>> delete(
    ...
    return session.db.delete<EnumDefaultModel>(rows, transaction: transaction);
  }
