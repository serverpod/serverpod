...
class StringDefaultMixRepository {
  ...
  /// Emits [StringDefaultMix]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `StringDefaultMix.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<StringDefaultMix>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<StringDefaultMixTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<StringDefaultMix>(
      where: where?.call(StringDefaultMix.t),
      orderBy: orderBy?.call(StringDefaultMix.t),
      orderByList: orderByList?.call(StringDefaultMix.t),
      limit: limit,
