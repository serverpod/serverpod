...
class ObjectWithGeographyGeometryCollectionUpdateTable
  ...
  _i1.ColumnValue<_i1.GeographyGeometryCollection, _i1.GeographyGeometryCollection>
  collection(_i1.GeographyGeometryCollection value) => _i1.ColumnValue(
    table.collection,
    value,
  );

  _i1.ColumnValue<_i1.GeographyGeometryCollection, _i1.GeographyGeometryCollection>
  collectionNullable(_i1.GeographyGeometryCollection? value) => _i1.ColumnValue(
    table.collectionNullable,
    value,
  );
}
...
class ObjectWithGeographyGeometryCollectionTable extends _i1.Table<int?> {
  ObjectWithGeographyGeometryCollectionTable({super.tableRelation})
    ...
    collection = _i1.ColumnGeographyGeometryCollection(
      'collection',
      this,
    );
    collectionNullable = _i1.ColumnGeographyGeometryCollection(
      'collectionNullable',
      this,
    );
  }
  ...
  late final _i1.ColumnGeographyGeometryCollection collection;

  late final _i1.ColumnGeographyGeometryCollection collectionNullable;
