...
class ObjectWithGeographyGeometryCollectionRepository {
  ...
  /// Emits [ObjectWithGeographyGeometryCollection]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithGeographyGeometryCollection.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithGeographyGeometryCollection>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithGeographyGeometryCollectionTable>?
    where,
    int? limit,
    ...
    return session.db.watch<ObjectWithGeographyGeometryCollection>(
      where: where?.call(ObjectWithGeographyGeometryCollection.t),
      orderBy: orderBy?.call(ObjectWithGeographyGeometryCollection.t),
      orderByList: orderByList?.call(ObjectWithGeographyGeometryCollection.t),
      limit: limit,
