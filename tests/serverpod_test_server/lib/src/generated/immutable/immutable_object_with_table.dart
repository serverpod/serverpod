...
class ImmutableObjectWithTableRepository {
  ...
  /// Emits [ImmutableObjectWithTable]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ImmutableObjectWithTable.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ImmutableObjectWithTable>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ImmutableObjectWithTableTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ImmutableObjectWithTable>(
      where: where?.call(ImmutableObjectWithTable.t),
      orderBy: orderBy?.call(ImmutableObjectWithTable.t),
      orderByList: orderByList?.call(ImmutableObjectWithTable.t),
      limit: limit,
