...
class ObjectWithGeographyPointRepository {
  ...
  /// Emits [ObjectWithGeographyPoint]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithGeographyPoint.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithGeographyPoint>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithGeographyPointTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectWithGeographyPoint>(
      where: where?.call(ObjectWithGeographyPoint.t),
      orderBy: orderBy?.call(ObjectWithGeographyPoint.t),
      orderByList: orderByList?.call(ObjectWithGeographyPoint.t),
      limit: limit,
