    ...
    return TypesList(
      ...
      aUuid:
          (jsonSerialization['aUuid'] as List?)
              ...
              .toList(),
      aUri:
          (jsonSerialization['aUri'] as List?)
      ...
      aNullableRecord:
          (jsonSerialization['aNullableRecord'] as List?)
              ...
              .toList(),
      anEnumRecord:
          (jsonSerialization['anEnumRecord'] as List?)
              ?.map(
              ...
              .toList(),
      anEnum2Record:
          (jsonSerialization['anEnum2Record'] as List?)
              ?.map(
...
class _TypesListImpl extends TypesList {
  ...
  TypesList copyWith({
    ...
    return TypesList(
      ...
      aNullableRecord:
          aNullableRecord is List<(int,)?>?
              ? aNullableRecord
              : this.aNullableRecord
                  ?.map((e0) => e0 == null ? null : (e0.$1,))
                  .toList(),
      anEnumRecord:
          anEnumRecord is List<(_i3.TestEnum,)>?
              ? anEnumRecord
              : this.anEnumRecord?.map((e0) => (e0.$1,)).toList(),
      anEnum2Record:
          anEnum2Record is List<(_i4.TestEnumStringified,)>?
              ? anEnum2Record
