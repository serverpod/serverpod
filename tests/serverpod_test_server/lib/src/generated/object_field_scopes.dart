...
class ObjectFieldScopesRepository {
  ...
  /// Emits [ObjectFieldScopes]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectFieldScopes.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectFieldScopes>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectFieldScopesTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectFieldScopes>(
      where: where?.call(ObjectFieldScopes.t),
      orderBy: orderBy?.call(ObjectFieldScopes.t),
      orderByList: orderByList?.call(ObjectFieldScopes.t),
      limit: limit,
