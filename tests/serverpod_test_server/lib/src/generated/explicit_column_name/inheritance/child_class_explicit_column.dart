...
class ChildClassExplicitColumnRepository {
  ...
  /// Emits [ChildClassExplicitColumn]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ChildClassExplicitColumn.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ChildClassExplicitColumn>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ChildClassExplicitColumnTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ChildClassExplicitColumn>(
      where: where?.call(ChildClassExplicitColumn.t),
      orderBy: orderBy?.call(ChildClassExplicitColumn.t),
      orderByList: orderByList?.call(ChildClassExplicitColumn.t),
      limit: limit,
