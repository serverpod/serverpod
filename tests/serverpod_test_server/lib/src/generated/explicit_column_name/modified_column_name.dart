...
class ModifiedColumnNameRepository {
  ...
  /// Emits [ModifiedColumnName]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ModifiedColumnName.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ModifiedColumnName>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ModifiedColumnNameTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ModifiedColumnName>(
      where: where?.call(ModifiedColumnName.t),
      orderBy: orderBy?.call(ModifiedColumnName.t),
      orderByList: orderByList?.call(ModifiedColumnName.t),
      limit: limit,
