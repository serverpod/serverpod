...
class DeferrableRelationParentRepository {
  ...
  /// Emits [DeferrableRelationParent]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `DeferrableRelationParent.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<DeferrableRelationParent>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<DeferrableRelationParentTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<DeferrableRelationParent>(
      where: where?.call(DeferrableRelationParent.t),
      orderBy: orderBy?.call(DeferrableRelationParent.t),
      orderByList: orderByList?.call(DeferrableRelationParent.t),
      limit: limit,
