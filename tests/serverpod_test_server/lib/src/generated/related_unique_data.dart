...
class _UndefinedRelatedUniqueData$uniqueData extends _is.UndefinedSentinel
...
class _RelatedUniqueDataImpl extends RelatedUniqueData {
  ...
  RelatedUniqueData copyWith({
    ...
    return RelatedUniqueData(
      ...
      uniqueData: uniqueData is _is.UndefinedSentinel
...
class RelatedUniqueDataRepository {
  ...
  /// Emits [RelatedUniqueData]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `RelatedUniqueData.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<RelatedUniqueData>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<RelatedUniqueDataTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<RelatedUniqueData>(
      where: where?.call(RelatedUniqueData.t),
      orderBy: orderBy?.call(RelatedUniqueData.t),
      orderByList: orderByList?.call(RelatedUniqueData.t),
      limit: limit,
