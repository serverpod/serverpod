...
import 'package:serverpod_test_module_server/serverpod_test_module_server.dart'
    as _i61;
import 'package:serverpod_test_server/src/generated/types_record.dart' as _i62;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      'asyncTasks':
          _i2.AsyncTasksEndpoint()..initialize(server, 'asyncTasks', null),
      'authentication':
          _i3.AuthenticationEndpoint()
            ..initialize(server, 'authentication', null),
      'basicTypes':
          _i4.BasicTypesEndpoint()..initialize(server, 'basicTypes', null),
      'basicTypesStreaming':
          _i5.BasicTypesStreamingEndpoint()
            ..initialize(server, 'basicTypesStreaming', null),
      'cloudStorage':
          _i6.CloudStorageEndpoint()..initialize(server, 'cloudStorage', null),
      's3CloudStorage':
          _i7.S3CloudStorageEndpoint()
            ..initialize(server, 's3CloudStorage', null),
      'customClassProtocol':
          _i8.CustomClassProtocolEndpoint()
            ..initialize(server, 'customClassProtocol', null),
      'customTypes':
          _i9.CustomTypesEndpoint()..initialize(server, 'customTypes', null),
      'basicDatabase':
          _i10.BasicDatabase()..initialize(server, 'basicDatabase', null),
      'transactionsDatabase':
          _i11.TransactionsDatabaseEndpoint()
            ..initialize(server, 'transactionsDatabase', null),
      'deprecation':
          _i12.DeprecationEndpoint()..initialize(server, 'deprecation', null),
      'diagnosticEventTest':
          _i13.DiagnosticEventTestEndpoint()
            ..initialize(server, 'diagnosticEventTest', null),
      'echoRequest':
          _i14.EchoRequestEndpoint()..initialize(server, 'echoRequest', null),
      'echoRequiredField':
          _i15.EchoRequiredFieldEndpoint()
            ..initialize(server, 'echoRequiredField', null),
      'emailAuthTestMethods':
          _i16.EmailAuthTestMethods()
            ..initialize(server, 'emailAuthTestMethods', null),
      'concreteBase':
          _i17.ConcreteBaseEndpoint()..initialize(server, 'concreteBase', null),
      'concreteSubClass':
          _i17.ConcreteSubClassEndpoint()
            ..initialize(server, 'concreteSubClass', null),
      'independent':
          _i17.IndependentEndpoint()..initialize(server, 'independent', null),
      'concreteFromModuleAbstractBase':
          _i17.ConcreteFromModuleAbstractBaseEndpoint()
            ..initialize(server, 'concreteFromModuleAbstractBase', null),
      'concreteModuleBase':
          _i17.ConcreteModuleBaseEndpoint()
            ..initialize(server, 'concreteModuleBase', null),
      'loggedIn': _i18.LoggedInEndpoint()..initialize(server, 'loggedIn', null),
      'myLoggedIn':
          _i18.MyLoggedInEndpoint()..initialize(server, 'myLoggedIn', null),
      'admin': _i18.AdminEndpoint()..initialize(server, 'admin', null),
      'myAdmin': _i18.MyAdminEndpoint()..initialize(server, 'myAdmin', null),
      'myConcreteAdmin':
          _i18.MyConcreteAdminEndpoint()
            ..initialize(server, 'myConcreteAdmin', null),
      'exceptionTest':
          _i19.ExceptionTestEndpoint()
            ..initialize(server, 'exceptionTest', null),
      'failedCalls':
          _i20.FailedCallsEndpoint()..initialize(server, 'failedCalls', null),
      'fieldScopes':
          _i21.FieldScopesEndpoint()..initialize(server, 'fieldScopes', null),
      'futureCalls':
          _i22.FutureCallsEndpoint()..initialize(server, 'futureCalls', null),
      'listParameters':
          _i23.ListParametersEndpoint()
            ..initialize(server, 'listParameters', null),
      'logging': _i24.LoggingEndpoint()..initialize(server, 'logging', null),
      'streamLogging':
          _i24.StreamLogging()..initialize(server, 'streamLogging', null),
      'streamQueryLogging':
          _i24.StreamQueryLogging()
            ..initialize(server, 'streamQueryLogging', null),
      'loggingDisabled':
          _i25.LoggingDisabledEndpoint()
            ..initialize(server, 'loggingDisabled', null),
      'mapParameters':
          _i26.MapParametersEndpoint()
            ..initialize(server, 'mapParameters', null),
      'methodSignaturePermutations':
          _i27.MethodSignaturePermutationsEndpoint()
            ..initialize(server, 'methodSignaturePermutations', null),
      'methodStreaming':
          _i28.MethodStreaming()..initialize(server, 'methodStreaming', null),
      'authenticatedMethodStreaming':
          _i28.AuthenticatedMethodStreaming()
            ..initialize(server, 'authenticatedMethodStreaming', null),
      'moduleEndpointSubclass':
          _i29.ModuleEndpointSubclass()
            ..initialize(server, 'moduleEndpointSubclass', null),
      'moduleEndpointAdaptation':
          _i29.ModuleEndpointAdaptation()
            ..initialize(server, 'moduleEndpointAdaptation', null),
      'moduleEndpointReduction':
          _i29.ModuleEndpointReduction()
            ..initialize(server, 'moduleEndpointReduction', null),
      'moduleEndpointExtension':
          _i29.ModuleEndpointExtension()
            ..initialize(server, 'moduleEndpointExtension', null),
      'moduleSerialization':
          _i30.ModuleSerializationEndpoint()
            ..initialize(server, 'moduleSerialization', null),
      'namedParameters':
          _i31.NamedParametersEndpoint()
            ..initialize(server, 'namedParameters', null),
      'optionalParameters':
          _i32.OptionalParametersEndpoint()
            ..initialize(server, 'optionalParameters', null),
      'recordParameters':
          _i33.RecordParametersEndpoint()
            ..initialize(server, 'recordParameters', null),
      'redis': _i34.RedisEndpoint()..initialize(server, 'redis', null),
      'serverOnlyScopedFieldModel':
          _i35.ServerOnlyScopedFieldModelEndpoint()
            ..initialize(server, 'serverOnlyScopedFieldModel', null),
      'serverOnlyScopedFieldChildModel':
          _i36.ServerOnlyScopedFieldChildModelEndpoint()
            ..initialize(server, 'serverOnlyScopedFieldChildModel', null),
      'setParameters':
          _i37.SetParametersEndpoint()
            ..initialize(server, 'setParameters', null),
      'signInRequired':
          _i38.SignInRequiredEndpoint()
            ..initialize(server, 'signInRequired', null),
      'adminScopeRequired':
          _i38.AdminScopeRequiredEndpoint()
            ..initialize(server, 'adminScopeRequired', null),
      'simple': _i39.SimpleEndpoint()..initialize(server, 'simple', null),
      'streaming':
          _i40.StreamingEndpoint()..initialize(server, 'streaming', null),
      'streamingLogging':
          _i41.StreamingLoggingEndpoint()
            ..initialize(server, 'streamingLogging', null),
      'subSubDirTest':
          _i42.SubSubDirTestEndpoint()
            ..initialize(server, 'subSubDirTest', null),
      'subDirTest':
          _i43.SubDirTestEndpoint()..initialize(server, 'subDirTest', null),
      'testTools':
          _i44.TestToolsEndpoint()..initialize(server, 'testTools', null),
      'authenticatedTestTools':
          _i44.AuthenticatedTestToolsEndpoint()
            ..initialize(server, 'authenticatedTestTools', null),
      'unauthenticated':
          _i45.UnauthenticatedEndpoint()
            ..initialize(server, 'unauthenticated', null),
      'partiallyUnauthenticated':
          _i45.PartiallyUnauthenticatedEndpoint()
            ..initialize(server, 'partiallyUnauthenticated', null),
      'unauthenticatedRequireLogin':
          _i45.UnauthenticatedRequireLoginEndpoint()
            ..initialize(server, 'unauthenticatedRequireLogin', null),
      'requireLogin':
          _i45.RequireLoginEndpoint()..initialize(server, 'requireLogin', null),
      'upload': _i46.UploadEndpoint()..initialize(server, 'upload', null),
      'myFeature':
          _i47.MyFeatureEndpoint()..initialize(server, 'myFeature', null),
    };
      ...
      methodConnectors: {
        ...
        'throwExceptionAfterDelay': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['asyncTasks'] as _i2.AsyncTasksEndpoint)
                      .throwExceptionAfterDelay(session, params['seconds']),
        ),
      },
    );
      ...
      methodConnectors: {
        ...
        'createUser': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['authentication'] as _i3.AuthenticationEndpoint)
                      .createUser(session, params['email'], params['password']),
        ),
    ...
    connectors['basicTypes'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'testDouble': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicTypes'] as _i4.BasicTypesEndpoint)
                      .testDouble(session, params['value']),
        ),
        ...
        'testDateTime': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicTypes'] as _i4.BasicTypesEndpoint)
                      .testDateTime(session, params['dateTime']),
        ),
        'testString': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicTypes'] as _i4.BasicTypesEndpoint)
                      .testString(session, params['value']),
        ),
        'testByteData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicTypes'] as _i4.BasicTypesEndpoint)
                      .testByteData(session, params['value']),
        ),
        'testDuration': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicTypes'] as _i4.BasicTypesEndpoint)
                      .testDuration(session, params['value']),
        ),
        ...
        'testBigInt': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicTypes'] as _i4.BasicTypesEndpoint)
                      .testBigInt(session, params['value']),
        ),
      },
    );
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .testInt(session, streamParams['value']!.cast<int?>()),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                      ...
                      as _i5.BasicTypesStreamingEndpoint)
                  .testDouble(session, streamParams['value']!.cast<double?>()),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                      ...
                      as _i5.BasicTypesStreamingEndpoint)
                  .testBool(session, streamParams['value']!.cast<bool?>()),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                      ...
                      as _i5.BasicTypesStreamingEndpoint)
                  .testString(session, streamParams['value']!.cast<String?>()),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                      ...
                      as _i5.BasicTypesStreamingEndpoint)
                  .testUri(session, streamParams['value']!.cast<Uri?>()),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                      ...
                      as _i5.BasicTypesStreamingEndpoint)
                  .testBigInt(session, streamParams['value']!.cast<BigInt?>()),
        ),
      },
    );
    connectors['cloudStorage'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'reset': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['cloudStorage'] as _i6.CloudStorageEndpoint).reset(
                    session,
                  ),
        ),
        ...
        'retrievePublicFile': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['cloudStorage'] as _i6.CloudStorageEndpoint)
                      .retrievePublicFile(session, params['path']),
        ),
        'existsPublicFile': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['cloudStorage'] as _i6.CloudStorageEndpoint)
                      .existsPublicFile(session, params['path']),
        ),
        'deletePublicFile': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['cloudStorage'] as _i6.CloudStorageEndpoint)
                      .deletePublicFile(session, params['path']),
        ),
        'getPublicUrlForFile': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['cloudStorage'] as _i6.CloudStorageEndpoint)
                      .getPublicUrlForFile(session, params['path']),
        ),
        'getDirectFilePostUrl': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['cloudStorage'] as _i6.CloudStorageEndpoint)
                      .getDirectFilePostUrl(session, params['path']),
        ),
        'verifyDirectFileUpload': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['cloudStorage'] as _i6.CloudStorageEndpoint)
                      .verifyDirectFileUpload(session, params['path']),
        ),
      },
    );
      ...
      methodConnectors: {
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['customTypes'] as _i9.CustomTypesEndpoint)
                      .returnCustomClass(session, params['data']),
        ),
        'returnCustomClassNullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['customTypes'] as _i9.CustomTypesEndpoint)
                      .returnCustomClassNullable(session, params['data']),
        ),
        'returnCustomClass2': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['customTypes'] as _i9.CustomTypesEndpoint)
                      .returnCustomClass2(session, params['data']),
        ),
        'returnCustomClass2Nullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['customTypes'] as _i9.CustomTypesEndpoint)
                      .returnCustomClass2Nullable(session, params['data']),
        ),
        'returnExternalCustomClass': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['customTypes'] as _i9.CustomTypesEndpoint)
                      .returnExternalCustomClass(session, params['data']),
        ),
        ...
        'returnFreezedCustomClass': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['customTypes'] as _i9.CustomTypesEndpoint)
                      .returnFreezedCustomClass(session, params['data']),
        ),
          ...
          params: {
            'data': _i1.ParameterDescription(
              ...
              type:
                  _i1
                      .getType<
                        _i49.CustomClassWithProtocolSerializationMethod
                      >(),
              nullable: false,
            ),
          },
      ...
      methodConnectors: {
        ...
        'deleteSimpleTestDataLessThan': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .deleteSimpleTestDataLessThan(session, params['num']),
        ),
        'findAndDeleteSimpleTestData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .findAndDeleteSimpleTestData(session, params['num']),
        ),
        'createSimpleTestData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .createSimpleTestData(session, params['numRows']),
        ),
        ...
        'findFirstRowSimpleData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .findFirstRowSimpleData(session, params['num']),
        ),
        'findByIdSimpleData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .findByIdSimpleData(session, params['id']),
        ),
        ...
        'insertRowSimpleData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .insertRowSimpleData(session, params['simpleData']),
        ),
        'updateRowSimpleData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .updateRowSimpleData(session, params['simpleData']),
        ),
        'deleteRowSimpleData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .deleteRowSimpleData(session, params['simpleData']),
        ),
        ...
        'insertTypes': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .insertTypes(session, params['value']),
        ),
        'updateTypes': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .updateTypes(session, params['value']),
        ),
        ...
        'getTypesRawQuery': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .getTypesRawQuery(session, params['id']),
        ),
        'storeObjectWithEnum': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .storeObjectWithEnum(session, params['object']),
        ),
        'getObjectWithEnum': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .getObjectWithEnum(session, params['id']),
        ),
        'storeObjectWithObject': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .storeObjectWithObject(session, params['object']),
        ),
        'getObjectWithObject': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase)
                      .getObjectWithObject(session, params['id']),
        ),
        'deleteAll': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['basicDatabase'] as _i10.BasicDatabase).deleteAll(
                    session,
                  ),
        ),
        ...
        'setGlobalDouble': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  ...
                  setGlobalDouble(session, params['value']),
        ),
      ...
      methodConnectors: {
        ...
        'echoHttpHeader': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['echoRequest'] as _i14.EchoRequestEndpoint)
                      .echoHttpHeader(session, params['headerName']),
        ),
      },
    );
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['echoRequiredField']
                      ...
                      .echoModel(session, params['model']),
        ),
        ...
        'findResetCode': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['emailAuthTestMethods']
                          as _i16.EmailAuthTestMethods)
                      .findResetCode(session, params['email']),
        ),
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['fieldScopes'] as _i21.FieldScopesEndpoint)
                      .storeObject(session, params['object']),
        ),
      ...
      methodConnectors: {
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['futureCalls'] as _i22.FutureCallsEndpoint)
                      .makeFutureCall(session, params['data']),
        ),
        'makeFutureCallThatThrows': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['futureCalls'] as _i22.FutureCallsEndpoint)
                      .makeFutureCallThatThrows(session, params['data']),
        ),
      },
    );
      ...
      methodConnectors: {
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnIntList(session, params['list']),
        ),
        'returnIntListList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnIntListList(session, params['list']),
        ),
        'returnIntListNullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnIntListNullable(session, params['list']),
        ),
        'returnIntListNullableList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnIntListNullableList(session, params['list']),
        ),
        'returnIntListListNullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnIntListListNullable(session, params['list']),
        ),
        'returnIntListNullableInts': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnIntListNullableInts(session, params['list']),
        ),
        ...
        'returnDoubleList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnDoubleList(session, params['list']),
        ),
        'returnDoubleListNullableDoubles': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnDoubleListNullableDoubles(session, params['list']),
        ),
        'returnBoolList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnBoolList(session, params['list']),
        ),
        'returnBoolListNullableBools': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnBoolListNullableBools(session, params['list']),
        ),
        'returnStringList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnStringList(session, params['list']),
        ),
        'returnStringListNullableStrings': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnStringListNullableStrings(session, params['list']),
        ),
        'returnDateTimeList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnDateTimeList(session, params['list']),
        ),
        ...
        'returnByteDataList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnByteDataList(session, params['list']),
        ),
        ...
        'returnSimpleDataList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnSimpleDataList(session, params['list']),
        ),
        ...
        'returnSimpleDataListNullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnSimpleDataListNullable(session, params['list']),
        ),
        ...
        'returnDurationList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['listParameters'] as _i23.ListParametersEndpoint)
                      .returnDurationList(session, params['list']),
        ),
    ...
    connectors['logging'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['logging'] as _i24.LoggingEndpoint)
                      .slowQueryMethod(session, params['seconds']),
        ),
        ...
        'failingMethod': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['logging'] as _i24.LoggingEndpoint).failingMethod(
                    session,
                  ),
        ),
        'emptyMethod': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['logging'] as _i24.LoggingEndpoint).emptyMethod(
                    session,
                  ),
        ),
        ...
        'twoQueries': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['logging'] as _i24.LoggingEndpoint).twoQueries(
                    session,
                  ),
        ),
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['loggingDisabled'] as _i25.LoggingDisabledEndpoint)
                      .logInfo(session, params['message']),
        ),
      },
    );
      ...
      methodConnectors: {
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnIntMap(session, params['map']),
        ),
        'returnIntMapNullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnIntMapNullable(session, params['map']),
        ),
        'returnNestedIntMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnNestedIntMap(session, params['map']),
        ),
        'returnIntMapNullableInts': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnIntMapNullableInts(session, params['map']),
        ),
        'returnNullableIntMapNullableInts': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnNullableIntMapNullableInts(session, params['map']),
        ),
        'returnIntIntMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnIntIntMap(session, params['map'])
        ...
        'returnNestedIntIntMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnNestedIntIntMap(session, params['map'])
                      .then((container) => _i58.mapContainerToJson(container)),
        ),
        'returnEnumIntMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnEnumIntMap(session, params['map'])
                      .then((container) => _i58.mapContainerToJson(container)),
        ),
        'returnEnumMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnEnumMap(session, params['map']),
        ),
        'returnDoubleMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnDoubleMap(session, params['map']),
        ),
        'returnDoubleMapNullableDoubles': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnDoubleMapNullableDoubles(session, params['map']),
        ),
        'returnBoolMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnBoolMap(session, params['map']),
        ),
        'returnBoolMapNullableBools': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnBoolMapNullableBools(session, params['map']),
        ),
        'returnStringMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnStringMap(session, params['map']),
        ),
        'returnStringMapNullableStrings': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnStringMapNullableStrings(session, params['map']),
        ),
        'returnDateTimeMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnDateTimeMap(session, params['map']),
        ),
        ...
        'returnByteDataMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnByteDataMap(session, params['map']),
        ),
        ...
        'returnSimpleDataMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnSimpleDataMap(session, params['map']),
        ),
        ...
        'returnSimpleDataMapNullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnSimpleDataMapNullable(session, params['map']),
        ),
        ...
        'returnDurationMap': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['mapParameters'] as _i26.MapParametersEndpoint)
                      .returnDurationMap(session, params['map']),
        ),
            ...
            _i1.MethodConnector(
              ...
              call:
                  (
                    _i1.Session session,
                    Map<String, dynamic> params,
                  ) async => (endpoints['mapParameters']
                          as _i26.MapParametersEndpoint)
                      .returnDeeplyNestedNonStringKeyedMapInsideRecordInsideMap(
                        session,
                        params['map'],
                      )
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['methodSignaturePermutations']
                      ...
                      .echoPositionalArg(session, params['string']),
        ),
        'echoNamedArg': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['methodSignaturePermutations']
                          as _i27.MethodSignaturePermutationsEndpoint)
                      .echoNamedArg(session, string: params['string']),
        ),
        'echoNullableNamedArg': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['methodSignaturePermutations']
                          as _i27.MethodSignaturePermutationsEndpoint)
                      .echoNullableNamedArg(session, string: params['string']),
        ),
        'echoOptionalArg': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['methodSignaturePermutations']
                          as _i27.MethodSignaturePermutationsEndpoint)
                      .echoOptionalArg(session, params['string']),
        ),
      ...
      methodConnectors: {
        ...
        'intParameter': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['methodStreaming'] as _i28.MethodStreaming)
                      .intParameter(session, params['value']),
        ),
        'doubleInputValue': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['methodStreaming'] as _i28.MethodStreaming)
                      .doubleInputValue(session, params['value']),
        ),
        'delayedResponse': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['methodStreaming'] as _i28.MethodStreaming)
                      .delayedResponse(session, params['delay']),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .intStreamFromValue(session, params['value']),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .intEchoStream(session, streamParams['stream']!.cast<int>()),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .simpleStreamWithParameter(session, params['value']),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .simpleDataStream(session, params['value']),
        ),
        'simpleInOutDataStream': _i1.MethodStreamConnector(
          name: 'simpleInOutDataStream',
          params: {},
          streamParams: {
            'simpleDataStream': _i1.StreamParameterDescription<_i52.SimpleData>(
              name: 'simpleDataStream',
              nullable: false,
            ),
          },
              ...
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .simpleInOutDataStream(
                    session,
                    streamParams['simpleDataStream']!.cast<_i52.SimpleData>(),
                  ),
        ),
        ...
        'simpleListInOutDataStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'simpleDataListStream':
                _i1.StreamParameterDescription<List<_i52.SimpleData>>(
                  name: 'simpleDataListStream',
                  nullable: false,
                ),
          },
        ...
        'simpleListInOutOtherModuleTypeStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'userInfoListStream':
                _i1.StreamParameterDescription<List<_i60.UserInfo>>(
        ...
        'simpleSetInOutDataStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'simpleDataSetStream':
                _i1.StreamParameterDescription<Set<_i52.SimpleData>>(
                  name: 'simpleDataSetStream',
                  nullable: false,
                ),
          },
        ...
        'nestedSetInListInOutDataStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'simpleDataSetStream':
                _i1.StreamParameterDescription<List<Set<_i52.SimpleData>>>(
                  name: 'simpleDataSetStream',
                  nullable: false,
                ),
          },
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .delayedStreamResponse(session, params['delay']),
        ),
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['moduleEndpointSubclass']
                      ...
                      .echoString(session, params['value']),
        ),
        'echoRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['moduleEndpointSubclass']
                          as _i29.ModuleEndpointSubclass)
                      .echoRecord(session, params['value'])
        ...
        'echoContainer': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['moduleEndpointSubclass']
                          as _i29.ModuleEndpointSubclass)
                      .echoContainer(session, params['value']),
        ),
        'echoModel': _i1.MethodConnector(
          name: 'echoModel',
          params: {
            'value': _i1.ParameterDescription(
              name: 'value',
              type: _i1.getType<_i61.ModuleClass>(),
              nullable: false,
            ),
          },
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['moduleEndpointSubclass']
                          as _i29.ModuleEndpointSubclass)
                      .echoModel(session, params['value']),
        ),
      },
    );
        ...
        'modifyModuleObject': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['moduleSerialization']
                          as _i30.ModuleSerializationEndpoint)
                      .modifyModuleObject(session, params['object']),
        ),
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['optionalParameters']
                      ...
                      .returnOptionalInt(session, params['optionalInt']),
        ),
      },
    );
      ...
      methodConnectors: {
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                      ...
                      .returnRecordOfInt(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        'returnNullableRecordOfInt': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnNullableRecordOfInt(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        'returnRecordOfNullableInt': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnRecordOfNullableInt(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        ...
        'returnIntStringRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnIntStringRecord(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        'returnNullableIntStringRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnNullableIntStringRecord(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        'returnIntSimpleDataRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnIntSimpleDataRecord(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        ...
        'returnStringKeyedMapRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnStringKeyedMapRecord(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        'returnNonStringKeyedMapRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnNonStringKeyedMapRecord(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        ...
        'returnNamedIntStringRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnNamedIntStringRecord(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
            ...
            _i1.MethodConnector(
              ...
              params: {
                'map': _i1.ParameterDescription(
                  name: 'map',
                  type:
                      _i1.getType<(Map<(Map<int, String>, String), String>,)>(),
                  nullable: false,
                ),
              },
              call:
                  (
                    _i1.Session session,
                    Map<String, dynamic> params,
                  ) async => (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnNestedNonStringKeyedMapInsideRecordInsideMapInsideRecord(
                        session,
                        params['map'],
        ...
        'returnRecordTypedef': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnRecordTypedef(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        'returnNullableRecordTypedef': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnNullableRecordTypedef(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        ...
        'returnStringMapOfListOfRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnStringMapOfListOfRecord(session, params['input'])
                      .then((container) => _i58.mapContainerToJson(container)),
        ),
        'returnNestedNamedRecord': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .returnNestedNamedRecord(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        'returnNestedNullableNamedRecord': _i1.MethodConnector(
          ...
          params: {
            'record': _i1.ParameterDescription(
              name: 'record',
              type:
                  _i1.getType<({(_i52.SimpleData, double)? namedSubRecord})>(),
              nullable: false,
            ),
          },
          call:
        ...
        'echoModelClassWithRecordField': _i1.MethodConnector(
          ...
          params: {
            'value': _i1.ParameterDescription(
              name: 'value',
              type: _i1.getType<_i62.TypesRecord>(),
              nullable: false,
            ),
          },
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['recordParameters']
                          as _i33.RecordParametersEndpoint)
                      .echoModelClassWithRecordField(session, params['value']),
        ),
        ...
        'streamOfModelClassWithRecordField': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'values': _i1.StreamParameterDescription<_i62.TypesRecord>(
              name: 'values',
              nullable: false,
            ),
          },
              ...
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .streamOfModelClassWithRecordField(
                    session,
                    params['initialValue'],
                    streamParams['values']!.cast<_i62.TypesRecord>(),
                  ),
        ),
        ...
        'streamOfNullableModelClassWithRecordFieldFromExternalModule':
            _i1.MethodStreamConnector(
              ...
              streamParams: {
                'values': _i1.StreamParameterDescription<_i61.ModuleClass?>(
                  name: 'values',
                  nullable: false,
                ),
              },
                  ...
                  (
                    ...
                    Map<String, Stream> streamParams,
                      ...
                      .streamOfNullableModelClassWithRecordFieldFromExternalModule(
                        session,
                        params['initialValue'],
                        streamParams['values']!.cast<_i61.ModuleClass?>(),
                      ),
            ),
      },
    );
      ...
      methodConnectors: {
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnIntSet(session, params['set']),
        ),
        'returnIntSetSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnIntSetSet(session, params['set']),
        ),
        'returnIntListSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnIntListSet(session, params['set']),
        ),
        'returnIntSetNullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnIntSetNullable(session, params['set']),
        ),
        'returnIntSetNullableSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnIntSetNullableSet(session, params['set']),
        ),
        'returnIntSetSetNullable': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnIntSetSetNullable(session, params['set']),
        ),
        'returnIntSetNullableInts': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnIntSetNullableInts(session, params['set']),
        ),
        'returnNullableIntSetNullableInts': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnNullableIntSetNullableInts(session, params['set']),
        ),
        'returnDoubleSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnDoubleSet(session, params['set']),
        ),
        'returnDoubleSetNullableDoubles': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnDoubleSetNullableDoubles(session, params['set']),
        ),
        'returnBoolSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnBoolSet(session, params['set']),
        ),
        'returnBoolSetNullableBools': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnBoolSetNullableBools(session, params['set']),
        ),
        'returnStringSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnStringSet(session, params['set']),
        ),
        'returnStringSetNullableStrings': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnStringSetNullableStrings(session, params['set']),
        ),
        'returnDateTimeSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnDateTimeSet(session, params['set']),
        ),
        ...
        'returnByteDataSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnByteDataSet(session, params['set']),
        ),
        ...
        'returnSimpleDataSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnSimpleDataSet(session, params['set']),
        ),
        ...
        'returnDurationSet': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['setParameters'] as _i37.SetParametersEndpoint)
                      .returnDurationSet(session, params['set']),
        ),
    ...
    connectors['simple'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'addToGlobalInt': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['simple'] as _i39.SimpleEndpoint).addToGlobalInt(
                    session,
                  ),
        ),
        'getGlobalInt': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['simple'] as _i39.SimpleEndpoint).getGlobalInt(
                    session,
                  ),
        ),
        'hello': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['simple'] as _i39.SimpleEndpoint).hello(
                    session,
                    params['name'],
                  ),
        ),
    ...
    connectors['subDirTest'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'testMethod': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['subDirTest'] as _i43.SubDirTestEndpoint)
                      .testMethod(session),
        ),
      },
    );
      ...
      methodConnectors: {
        ...
        'returnsString': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .returnsString(session, params['string']),
        ),
        'postNumberToSharedStream': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .postNumberToSharedStream(session, params['number']),
        ),
        'createSimpleData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .createSimpleData(session, params['data']),
        ),
        ...
        'echoSimpleData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .echoSimpleData(session, params['simpleData']),
        ),
        'echoSimpleDatas': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .echoSimpleDatas(session, params['simpleDatas']),
        ),
        ...
        'echoTypesList': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .echoTypesList(session, params['typesList']),
        ),
        'echoModuleDatatype': _i1.MethodConnector(
          ...
          params: {
            'moduleDatatype': _i1.ParameterDescription(
              name: 'moduleDatatype',
              type: _i1.getType<_i63.ModuleDatatype>(),
              nullable: false,
            ),
          },
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .echoModuleDatatype(session, params['moduleDatatype']),
        ),
        'echoModuleClass': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .echoModuleClass(session, params['moduleClass']),
        ),
        'echoRecord': _i1.MethodConnector(
          name: 'echoRecord',
          params: {
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .echoRecord(session, params['record'])
                      .then((record) => _i58.mapRecordToJson(record)),
        ),
        'echoRecords': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .echoRecords(session, params['records'])
                      .then((container) => _i58.mapContainerToJson(container)),
        ),
        ...
        'putInLocalCache': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .putInLocalCache(session, params['key'], params['data']),
        ),
        'getFromLocalCache': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .getFromLocalCache(session, params['key']),
        ),
        ...
        'getFromLocalPrioCache': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .getFromLocalPrioCache(session, params['key']),
        ),
        'putInQueryCache': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .putInQueryCache(session, params['key'], params['data']),
        ),
        'getFromQueryCache': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['testTools'] as _i44.TestToolsEndpoint)
                      .getFromQueryCache(session, params['key']),
        ),
          ...
          call:
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .returnsStream(session, params['n']),
        ),
        ...
        'streamModuleDatatype': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'values': _i1.StreamParameterDescription<_i63.ModuleDatatype?>(
              name: 'values',
              nullable: false,
            ),
          },
              ...
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .streamModuleDatatype(
                    session,
                    params['initialValue'],
                    streamParams['values']!.cast<_i63.ModuleDatatype?>(),
                  ),
        ),
        ...
        'modelWithRecordsEchoStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'stream': _i1.StreamParameterDescription<_i62.TypesRecord?>(
              name: 'stream',
              nullable: false,
            ),
          },
              ...
              (
                ...
                Map<String, Stream> streamParams,
                  ...
                  .modelWithRecordsEchoStream(
                    session,
                    params['initialValue'],
                    streamParams['stream']!.cast<_i62.TypesRecord?>(),
                  ),
        ),
    ...
    connectors['myFeature'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'myFeatureMethod': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['myFeature'] as _i47.MyFeatureEndpoint)
    ...
    modules['serverpod_test_module'] =
        _i61.Endpoints()..initializeEndpoints(server);
  }
}
