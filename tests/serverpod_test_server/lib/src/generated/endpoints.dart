...
import '../endpoints/method_signature_permutations.dart' as _i24;
import '../endpoints/method_streaming.dart' as _i25;
...
import '../endpoints/record_parameters.dart' as _i30;
import '../endpoints/redis.dart' as _i31;
import '../endpoints/server_only_scoped_field_model.dart' as _i32;
import '../endpoints/server_only_scoped_field_model_child.dart' as _i33;
import '../endpoints/set_parameters.dart' as _i34;
import '../endpoints/signin_required.dart' as _i35;
import '../endpoints/simple.dart' as _i36;
import '../endpoints/streaming.dart' as _i37;
import '../endpoints/streaming_logging.dart' as _i38;
import '../endpoints/subDir/subSubDir/subsubdir_test_endpoint.dart' as _i39;
import '../endpoints/subDir/subdir_test_endpoint.dart' as _i40;
import '../endpoints/test_tools.dart' as _i41;
import '../endpoints/upload_too_large.dart' as _i42;
import '../my_feature/endpoints/my_feature_endpoint.dart' as _i43;
import 'dart:typed_data' as _i44;
import 'package:uuid/uuid_value.dart' as _i45;
import 'package:serverpod_test_shared/src/custom_classes.dart' as _i46;
...
import 'package:serverpod_test_server/src/generated/object_field_scopes.dart'
    as _i53;
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i54;
...
import 'package:serverpod_test_module_server/serverpod_test_module_server.dart'
    as _i57;
import 'package:serverpod_test_server/src/generated/types_record.dart' as _i58;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'streamLogging': _i21.StreamLogging()
        ..initialize(
          server,
          'streamLogging',
          null,
        ),
      'streamQueryLogging': _i21.StreamQueryLogging()
        ..initialize(
          server,
          'streamQueryLogging',
          null,
      ...
      'methodSignaturePermutations': _i24.MethodSignaturePermutationsEndpoint()
        ..initialize(
          server,
          'methodSignaturePermutations',
          null,
        ),
      'methodStreaming': _i25.MethodStreaming()
        ..initialize(
          server,
          'methodStreaming',
          null,
        ),
      'authenticatedMethodStreaming': _i25.AuthenticatedMethodStreaming()
        ..initialize(
          server,
      ...
      'recordParameters': _i30.RecordParametersEndpoint()
        ..initialize(
          server,
          'recordParameters',
          null,
        ),
      'redis': _i31.RedisEndpoint()
        ..initialize(
          server,
          'redis',
          null,
        ),
      'serverOnlyScopedFieldModel': _i32.ServerOnlyScopedFieldModelEndpoint()
        ..initialize(
          server,
      ...
      'serverOnlyScopedFieldChildModel':
          _i33.ServerOnlyScopedFieldChildModelEndpoint()
            ..initialize(
              server,
              'serverOnlyScopedFieldChildModel',
              null,
            ),
      'setParameters': _i34.SetParametersEndpoint()
        ..initialize(
          server,
          'setParameters',
          null,
        ),
      'signInRequired': _i35.SignInRequiredEndpoint()
        ..initialize(
          server,
          'signInRequired',
          null,
        ),
      'adminScopeRequired': _i35.AdminScopeRequiredEndpoint()
        ..initialize(
          server,
          'adminScopeRequired',
          null,
        ),
      'simple': _i36.SimpleEndpoint()
        ..initialize(
          server,
          'simple',
          null,
        ),
      'streaming': _i37.StreamingEndpoint()
        ..initialize(
          server,
          'streaming',
          null,
        ),
      'streamingLogging': _i38.StreamingLoggingEndpoint()
        ..initialize(
          server,
          'streamingLogging',
          null,
        ),
      'subSubDirTest': _i39.SubSubDirTestEndpoint()
        ..initialize(
          server,
          'subSubDirTest',
          null,
        ),
      'subDirTest': _i40.SubDirTestEndpoint()
        ..initialize(
          server,
          'subDirTest',
          null,
        ),
      'testTools': _i41.TestToolsEndpoint()
        ..initialize(
          server,
          'testTools',
          null,
        ),
      'authenticatedTestTools': _i41.AuthenticatedTestToolsEndpoint()
        ..initialize(
          server,
          'authenticatedTestTools',
          null,
        ),
      'upload': _i42.UploadEndpoint()
        ..initialize(
          server,
          'upload',
          null,
        ),
      'myFeature': _i43.MyFeatureEndpoint()
        ..initialize(
          server,
          'myFeature',
          null,
    ...
    connectors['basicTypesStreaming'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'testByteData': _i1.MethodStreamConnector(
          ...
          params: {},
          streamParams: {
            'value': _i1.StreamParameterDescription<_i44.ByteData?>(
              name: 'value',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['basicTypesStreaming']
                  ...
                  .testByteData(
            session,
            streamParams['value']!.cast<_i44.ByteData?>(),
          ),
        ),
        ...
        'testUuid': _i1.MethodStreamConnector(
          ...
          params: {},
          streamParams: {
            'value': _i1.StreamParameterDescription<_i45.UuidValue?>(
              name: 'value',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['basicTypesStreaming']
                  ...
                  .testUuid(
            session,
            streamParams['value']!.cast<_i45.UuidValue?>(),
          ),
        ),
      ...
      methodConnectors: {
        ...
        'returnCustomClassWithoutProtocolSerialization': _i1.MethodConnector(
          ...
          params: {
            'data': _i1.ParameterDescription(
              name: 'data',
              type: _i1.getType<_i46.CustomClassWithoutProtocolSerialization>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnCustomClassWithProtocolSerialization': _i1.MethodConnector(
          ...
          params: {
            'data': _i1.ParameterDescription(
              name: 'data',
              type: _i1.getType<_i46.CustomClassWithProtocolSerialization>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnCustomClassWithProtocolSerializationMethod': _i1.MethodConnector(
          ...
          params: {
            'data': _i1.ParameterDescription(
              name: 'data',
              type: _i1
                  .getType<_i46.CustomClassWithProtocolSerializationMethod>(),
              nullable: false,
            )
          },
          call: (
      ...
      methodConnectors: {
        'storeObject': _i1.MethodConnector(
          ...
          params: {
            'object': _i1.ParameterDescription(
              name: 'object',
              type: _i1.getType<_i53.ObjectFieldScopes>(),
              nullable: false,
            )
          },
          call: (
        ...
        'slowQueryMethod': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['logging'] as _i21.LoggingEndpoint).slowQueryMethod(
            session,
            params['seconds'],
          ),
        ),
        'queryMethod': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['logging'] as _i21.LoggingEndpoint).queryMethod(
            session,
            params['queries'],
          ),
        ),
        ...
        'slowMethod': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['logging'] as _i21.LoggingEndpoint).slowMethod(
            session,
            params['delayMillis'],
          ),
        ),
        ...
        'log': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['logging'] as _i21.LoggingEndpoint).log(
            session,
            params['message'],
            params['logLevels'],
          ),
        ...
        'streamEmpty': _i1.MethodStreamConnector(
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['logging'] as _i21.LoggingEndpoint).streamEmpty(
            session,
        ...
        'streamLogging': _i1.MethodStreamConnector(
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['logging'] as _i21.LoggingEndpoint).streamLogging(
            session,
            streamParams['input']!.cast<int>(),
          ),
        ),
        'streamQueryLogging': _i1.MethodStreamConnector(
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['logging'] as _i21.LoggingEndpoint).streamQueryLogging(
            session,
            streamParams['input']!.cast<int>(),
          ),
        ),
      ...
      methodConnectors: {
        ...
        'returnEnumIntMap': _i1.MethodConnector(
          ...
          params: {
            'map': _i1.ParameterDescription(
              name: 'map',
              type: _i1.getType<Map<_i54.TestEnum, int>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnEnumMap': _i1.MethodConnector(
          ...
          params: {
            'map': _i1.ParameterDescription(
              name: 'map',
              type: _i1.getType<Map<String, _i54.TestEnum>>(),
              nullable: false,
            )
          },
          call: (
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['methodSignaturePermutations']
                      as _i24.MethodSignaturePermutationsEndpoint)
                  .echoPositionalArg(
            session,
            params['string'],
          ),
    ...
    connectors['methodStreaming'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'methodCallEndpoint': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['methodStreaming'] as _i25.MethodStreaming)
        ...
        'simpleInOutDataStream': _i1.MethodStreamConnector(
          ...
          params: {},
          streamParams: {
            'simpleDataStream': _i1.StreamParameterDescription<_i49.SimpleData>(
              name: 'simpleDataStream',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            session,
            streamParams['simpleDataStream']!.cast<_i49.SimpleData>(),
          ),
        ),
        ...
        'simpleListInOutDataStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'simpleDataListStream':
                _i1.StreamParameterDescription<List<_i49.SimpleData>>(
              name: 'simpleDataListStream',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            session,
            streamParams['simpleDataListStream']!.cast<List<_i49.SimpleData>>(),
          ),
        ),
        'simpleListInOutOtherModuleTypeStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'userInfoListStream':
                _i1.StreamParameterDescription<List<_i55.UserInfo>>(
          ...
          call: (
            ...
            session,
            streamParams['userInfoListStream']!.cast<List<_i55.UserInfo>>(),
          ),
        ),
        ...
        'simpleSetInOutDataStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'simpleDataSetStream':
                _i1.StreamParameterDescription<Set<_i49.SimpleData>>(
              name: 'simpleDataSetStream',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            session,
            streamParams['simpleDataSetStream']!.cast<Set<_i49.SimpleData>>(),
          ),
        ),
        'nestedSetInListInOutDataStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'simpleDataSetStream':
                _i1.StreamParameterDescription<List<Set<_i49.SimpleData>>>(
              name: 'simpleDataSetStream',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['authenticatedMethodStreaming']
                      as _i25.AuthenticatedMethodStreaming)
                  .simpleStream(session),
        ),
        'intEchoStream': _i1.MethodStreamConnector(
          name: 'intEchoStream',
      ...
      methodConnectors: {
        'returnRecordOfInt': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['recordParameters'] as _i30.RecordParametersEndpoint)
                  .returnRecordOfInt(
                    session,
                    params['record'],
                  )
        ...
        'returnIntSimpleDataRecord': _i1.MethodConnector(
          ...
          params: {
            'record': _i1.ParameterDescription(
              name: 'record',
              type: _i1.getType<(int, _i49.SimpleData)>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnRecordOfNamedIntAndObject': _i1.MethodConnector(
          ...
          params: {
            'record': _i1.ParameterDescription(
              name: 'record',
              type: _i1.getType<({_i49.SimpleData data, int number})>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnRecordTypedef': _i1.MethodConnector(
          ...
          params: {
            'record': _i1.ParameterDescription(
              name: 'record',
              type: _i1.getType<(int, {_i49.SimpleData data})>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnListOfIntSimpleDataRecord': _i1.MethodConnector(
          ...
          params: {
            'recordList': _i1.ParameterDescription(
              name: 'recordList',
              type: _i1.getType<List<(int, _i49.SimpleData)>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnSetOfIntSimpleDataRecord': _i1.MethodConnector(
          ...
          params: {
            'recordSet': _i1.ParameterDescription(
              name: 'recordSet',
              type: _i1.getType<Set<(int, _i49.SimpleData)>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnStringMapOfIntSimpleDataRecord': _i1.MethodConnector(
          ...
          params: {
            'map': _i1.ParameterDescription(
              name: 'map',
              type: _i1.getType<Map<String, (int, _i49.SimpleData)>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnRecordMapOfIntSimpleDataRecord': _i1.MethodConnector(
          ...
          params: {
            'map': _i1.ParameterDescription(
              name: 'map',
              type: _i1.getType<Map<(String, int), (int, _i49.SimpleData)>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnNestedNamedRecord': _i1.MethodConnector(
          ...
          params: {
            'record': _i1.ParameterDescription(
              name: 'record',
              type: _i1.getType<({(_i49.SimpleData, double) namedSubRecord})>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnNestedNullableNamedRecord': _i1.MethodConnector(
          ...
          params: {
            'record': _i1.ParameterDescription(
              name: 'record',
              type:
                  _i1.getType<({(_i49.SimpleData, double)? namedSubRecord})>(),
              nullable: false,
            )
          },
          call: (
          ...
          params: {
            'record': _i1.ParameterDescription(
              ...
              type: _i1.getType<
                  (
                    (int, String), {
                    (_i49.SimpleData, double) namedSubRecord
                  })>(),
              nullable: false,
            )
          },
        ...
        'echoModelClassWithRecordField': _i1.MethodConnector(
          ...
          params: {
            'value': _i1.ParameterDescription(
              name: 'value',
              type: _i1.getType<_i58.TypesRecord>(),
              nullable: false,
            )
          },
          call: (
        ...
        'streamOfModelClassWithRecordField': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'values': _i1.StreamParameterDescription<_i58.TypesRecord>(
              name: 'values',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            session,
            params['initialValue'],
            streamParams['values']!.cast<_i58.TypesRecord>(),
          ),
        ),
        ...
        'streamOfNullableModelClassWithRecordFieldFromExternalModule':
          ...
          streamParams: {
            'values': _i1.StreamParameterDescription<_i57.ModuleClass?>(
              name: 'values',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            session,
            params['initialValue'],
            streamParams['values']!.cast<_i57.ModuleClass?>(),
          ),
        ),
      },
    );
        ...
        'setSimpleData': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['redis'] as _i31.RedisEndpoint).setSimpleData(
            session,
            params['key'],
            params['data'],
          ),
        ...
        'setSimpleDataWithLifetime': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['redis'] as _i31.RedisEndpoint)
        ...
        'getSimpleData': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['redis'] as _i31.RedisEndpoint).getSimpleData(
            session,
            params['key'],
          ),
        ),
        'deleteSimpleData': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['redis'] as _i31.RedisEndpoint).deleteSimpleData(
            session,
            params['key'],
          ),
        ),
        ...
        'listenToChannel': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['redis'] as _i31.RedisEndpoint).listenToChannel(
            session,
            params['channel'],
          ),
        ),
        'postToChannel': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['redis'] as _i31.RedisEndpoint).postToChannel(
            session,
            params['channel'],
            params['data'],
          ),
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['serverOnlyScopedFieldModel']
                      as _i32.ServerOnlyScopedFieldModelEndpoint)
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['serverOnlyScopedFieldChildModel']
                      as _i33.ServerOnlyScopedFieldChildModelEndpoint)
                  .getProtocolField(session),
        )
      },
    );
      ...
      methodConnectors: {
        'returnIntSet': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['setParameters'] as _i34.SetParametersEndpoint)
                  .returnIntSet(
            session,
            params['set'],
          ),
        ...
        'returnByteDataSet': _i1.MethodConnector(
          ...
          params: {
            'set': _i1.ParameterDescription(
              name: 'set',
              type: _i1.getType<Set<_i44.ByteData>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnSimpleDataSet': _i1.MethodConnector(
          ...
          params: {
            'set': _i1.ParameterDescription(
              name: 'set',
              type: _i1.getType<Set<_i49.SimpleData>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'testMethod': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['signInRequired'] as _i35.SignInRequiredEndpoint)
                  .testMethod(session),
        )
      },
    );
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['adminScopeRequired']
                      as _i35.AdminScopeRequiredEndpoint)
                  .testMethod(session),
        )
      },
    );
        ...
        'setGlobalInt': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['simple'] as _i36.SimpleEndpoint).setGlobalInt(
            session,
            params['value'],
            params['secondValue'],
          ),
        ...
        'addToGlobalInt': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['simple'] as _i36.SimpleEndpoint)
        ...
        'hello': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['simple'] as _i36.SimpleEndpoint).hello(
            session,
            params['name'],
          ),
        ),
        ...
        'testMethod': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['subSubDirTest'] as _i39.SubSubDirTestEndpoint)
                  .testMethod(session),
        )
      },
    );
        ...
        'testMethod': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['subDirTest'] as _i40.SubDirTestEndpoint)
                  .testMethod(session),
        )
      },
    );
    connectors['testTools'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'returnsSessionId': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['testTools'] as _i41.TestToolsEndpoint)
        ...
        'returnsString': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['testTools'] as _i41.TestToolsEndpoint).returnsString(
            session,
            params['string'],
          ),
        ),
        ...
        'echoSimpleData': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['testTools'] as _i41.TestToolsEndpoint).echoSimpleData(
            session,
            params['simpleData'],
          ),
        ),
        ...
        'echoTypes': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['testTools'] as _i41.TestToolsEndpoint).echoTypes(
            session,
            params['typesModel'],
          ),
        ),
        'echoTypesList': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['testTools'] as _i41.TestToolsEndpoint).echoTypesList(
            session,
            params['typesList'],
          ),
        ),
        'echoModuleDatatype': _i1.MethodConnector(
          ...
          params: {
            'moduleDatatype': _i1.ParameterDescription(
              name: 'moduleDatatype',
              type: _i1.getType<_i59.ModuleDatatype>(),
              nullable: false,
            )
          },
          call: (
        ...
        'returnsStream': _i1.MethodStreamConnector(
          ...
          call: (
            ...
            Map<String, Stream> streamParams,
              ...
              (endpoints['testTools'] as _i41.TestToolsEndpoint).returnsStream(
            session,
            params['n'],
          ),
        ),
        ...
        'returnsSimpleDataListFromInputStream': _i1.MethodStreamConnector(
          ...
          params: {},
          streamParams: {
            'simpleDatas': _i1.StreamParameterDescription<_i49.SimpleData>(
              name: 'simpleDatas',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            session,
            streamParams['simpleDatas']!.cast<_i49.SimpleData>(),
          ),
        ),
        ...
        'streamModuleDatatype': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'values': _i1.StreamParameterDescription<_i59.ModuleDatatype?>(
              name: 'values',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            session,
            params['initialValue'],
            streamParams['values']!.cast<_i59.ModuleDatatype?>(),
          ),
        ),
          ...
          params: {
            'initialValue': _i1.ParameterDescription(
              ...
              type: _i1.getType<
                  (
                    String,
                    (Map<String, int>, {bool flag, _i49.SimpleData simpleData})
                  )>(),
              nullable: false,
            )
          },
        ...
        'modelWithRecordsEchoStream': _i1.MethodStreamConnector(
          ...
          streamParams: {
            'stream': _i1.StreamParameterDescription<_i58.TypesRecord?>(
              name: 'stream',
              nullable: false,
            )
          },
          ...
          call: (
            ...
            session,
            params['initialValue'],
            streamParams['stream']!.cast<_i58.TypesRecord?>(),
          ),
        ),
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['authenticatedTestTools']
                      as _i41.AuthenticatedTestToolsEndpoint)
                  .returnsString(
            session,
            params['string'],
          ),
        ...
        'uploadByteData': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['upload'] as _i42.UploadEndpoint).uploadByteData(
            session,
            params['path'],
            params['data'],
          ),
        ...
        'myFeatureMethod': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['myFeature'] as _i43.MyFeatureEndpoint)
