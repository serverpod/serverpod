...
class ObjectWithByteDataRepository {
  ...
  /// Emits [ObjectWithByteData]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithByteData.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithByteData>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithByteDataTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectWithByteData>(
      where: where?.call(ObjectWithByteData.t),
      orderBy: orderBy?.call(ObjectWithByteData.t),
      orderByList: orderByList?.call(ObjectWithByteData.t),
      limit: limit,
