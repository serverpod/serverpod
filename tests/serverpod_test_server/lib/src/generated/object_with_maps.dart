...
abstract class ObjectWithMaps
  ...
  factory ObjectWithMaps.fromJson(Map<String, dynamic> jsonSerialization) {
    return ObjectWithMaps(
      dataMap: _igqrxdcj.Protocol()
          .deserialize<Map<String, _i0zisc0t.SimpleData>>(
            jsonSerialization['dataMap'],
          ),
      intMap: _igqrxdcj.Protocol().deserialize<Map<String, int>>(
        jsonSerialization['intMap'],
      ),
      stringMap: _igqrxdcj.Protocol().deserialize<Map<String, String>>(
        jsonSerialization['stringMap'],
      ),
      dateTimeMap: _igqrxdcj.Protocol().deserialize<Map<String, DateTime>>(
        jsonSerialization['dateTimeMap'],
      ),
      byteDataMap: _igqrxdcj.Protocol().deserialize<Map<String, _idt.ByteData>>(
        jsonSerialization['byteDataMap'],
      ),
      durationMap: _igqrxdcj.Protocol().deserialize<Map<String, Duration>>(
        jsonSerialization['durationMap'],
      ),
      uuidMap: _igqrxdcj.Protocol().deserialize<Map<String, _is.UuidValue>>(
        jsonSerialization['uuidMap'],
      ),
      nullableDataMap: _igqrxdcj.Protocol()
          .deserialize<Map<String, _i0zisc0t.SimpleData?>>(
            jsonSerialization['nullableDataMap'],
          ),
      nullableIntMap: _igqrxdcj.Protocol().deserialize<Map<String, int?>>(
        jsonSerialization['nullableIntMap'],
      ),
      nullableStringMap: _igqrxdcj.Protocol().deserialize<Map<String, String?>>(
        jsonSerialization['nullableStringMap'],
      ),
      nullableDateTimeMap: _igqrxdcj.Protocol()
          .deserialize<Map<String, DateTime?>>(
            jsonSerialization['nullableDateTimeMap'],
          ),
      nullableByteDataMap: _igqrxdcj.Protocol()
          .deserialize<Map<String, _idt.ByteData?>>(
            jsonSerialization['nullableByteDataMap'],
          ),
      nullableDurationMap: _igqrxdcj.Protocol()
          .deserialize<Map<String, Duration?>>(
            jsonSerialization['nullableDurationMap'],
          ),
      nullableUuidMap: _igqrxdcj.Protocol()
          .deserialize<Map<String, _is.UuidValue?>>(
            jsonSerialization['nullableUuidMap'],
          ),
      intIntMap: _igqrxdcj.Protocol().deserialize<Map<int, int>>(
