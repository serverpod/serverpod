...
class ArenaUuidRepository {
  ...
  /// Updates a single [ArenaUuid] by its [id] with the specified [columns].
  /// Returns the updated row or null if no row with the given id exists.
  Future<ArenaUuid?> updateById(
    _i1.Session session,
    _i1.UuidValue id,
    _i1.ColumnValueListBuilder<ArenaUuidTable> columns, {
    _i1.Transaction? transaction,
  }) async {
  ...
  /// Updates all [ArenaUuid]s matching the [where] expression with the specified [columns].
