...
class ServerOnlyChangedIdFieldClassRepository {
  ...
  /// Emits [ServerOnlyChangedIdFieldClass]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ServerOnlyChangedIdFieldClass.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ServerOnlyChangedIdFieldClass>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ServerOnlyChangedIdFieldClassTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ServerOnlyChangedIdFieldClass>(
      where: where?.call(ServerOnlyChangedIdFieldClass.t),
      orderBy: orderBy?.call(ServerOnlyChangedIdFieldClass.t),
      orderByList: orderByList?.call(ServerOnlyChangedIdFieldClass.t),
      limit: limit,
