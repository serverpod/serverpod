...
abstract class ObjectWithObject
  ...
  factory ObjectWithObject.fromJson(Map<String, dynamic> jsonSerialization) {
    return ObjectWithObject(
      ...
      dataList:
          (jsonSerialization['dataList'] as List)
              .map((e) => _i2.SimpleData.fromJson((e as Map<String, dynamic>)))
              .toList(),
      nullableDataList:
          (jsonSerialization['nullableDataList'] as List?)
              ?.map((e) => _i2.SimpleData.fromJson((e as Map<String, dynamic>)))
              .toList(),
      listWithNullableData:
          (jsonSerialization['listWithNullableData'] as List)
              .map(
                (e) =>
                    e == null
                        ? null
      ...
      nullableListWithNullableData:
          (jsonSerialization['nullableListWithNullableData'] as List?)
              ...
              .toList(),
      nestedDataList:
          (jsonSerialization['nestedDataList'] as List?)
              ?.map(
                (e) =>
                    (e as List)
                        .map(
                          (e) => _i2.SimpleData.fromJson(
          ...
          valueToJson:
              (v) => v.toJson(
                valueToJson:
                    (v) => v?.toJson(
                      valueToJson:
                          (v) => v.toJson(valueToJson: (v) => v.toJson()),
                    ),
              ),
        ),
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      if (nestedDataList != null)
        'nestedDataList': nestedDataList?.toJson(
          valueToJson:
              (v) => v.toJson(valueToJson: (v) => v.toJsonForProtocol()),
        ),
      if (nestedDataListInMap != null)
        'nestedDataListInMap': nestedDataListInMap?.toJson(
          valueToJson:
...
class _ObjectWithObjectImpl extends ObjectWithObject {
  ...
  ObjectWithObject copyWith({
    ...
    return ObjectWithObject(
      ...
      nullableListWithNullableData:
          nullableListWithNullableData is List<_i2.SimpleData?>?
              ...
              : this.nullableListWithNullableData
                  ...
                  .toList(),
      nestedDataList:
          nestedDataList is List<List<_i2.SimpleData>>?
              ? nestedDataList
              : this.nestedDataList
      ...
      nestedDataMap:
          nestedDataMap is Map<String, Map<int, _i2.SimpleData>>?
              ? nestedDataMap
...
class ObjectWithObjectUpdateTable
  ...
  ) => _i1.ColumnValue(table.nullableData, value);

  _i1.ColumnValue<List<_i2.SimpleData>, List<_i2.SimpleData>> dataList(
    List<_i2.SimpleData> value,
  ) => _i1.ColumnValue(table.dataList, value);

  _i1.ColumnValue<List<_i2.SimpleData>, List<_i2.SimpleData>> nullableDataList(
    List<_i2.SimpleData>? value,
  ) => _i1.ColumnValue(table.nullableDataList, value);

  _i1.ColumnValue<List<_i2.SimpleData?>, List<_i2.SimpleData?>>
  listWithNullableData(List<_i2.SimpleData?> value) =>
      _i1.ColumnValue(table.listWithNullableData, value);

  _i1.ColumnValue<List<_i2.SimpleData?>, List<_i2.SimpleData?>>
  nullableListWithNullableData(List<_i2.SimpleData?>? value) =>
      _i1.ColumnValue(table.nullableListWithNullableData, value);

  _i1.ColumnValue<List<List<_i2.SimpleData>>, List<List<_i2.SimpleData>>>
  nestedDataList(List<List<_i2.SimpleData>>? value) =>
      _i1.ColumnValue(table.nestedDataList, value);
  ...
  ) => _i1.ColumnValue(table.nestedDataListInMap, value);
  ...
  nestedDataMap(Map<String, Map<int, _i2.SimpleData>>? value) =>
      _i1.ColumnValue(table.nestedDataMap, value);
}
...
class ObjectWithObjectTable extends _i1.Table<int?> {
  ObjectWithObjectTable({super.tableRelation})
    ...
    data = _i1.ColumnSerializable<_i2.SimpleData>('data', this);
    nullableData = _i1.ColumnSerializable<_i2.SimpleData>('nullableData', this);
    dataList = _i1.ColumnSerializable<List<_i2.SimpleData>>('dataList', this);
...
class ObjectWithObjectRepository {
  ...
  Future<ObjectWithObject?> findById(
    ...
    return session.db.findById<ObjectWithObject>(id, transaction: transaction);
  }
  ...
  Future<List<ObjectWithObject>> insert(
    ...
    return session.db.insert<ObjectWithObject>(rows, transaction: transaction);
  }
  ...
  Future<List<ObjectWithObject>> delete(
    ...
    return session.db.delete<ObjectWithObject>(rows, transaction: transaction);
  }
