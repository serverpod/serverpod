...
class MultipleMaxFieldNameRepository {
  ...
  /// Find a list of [MultipleMaxFieldName]s from a table, using the provided [where]
  ...
  /// Find a single [MultipleMaxFieldName] from a table, using the provided [where]
  ...
  /// Find a single [MultipleMaxFieldName] by its [id] or null if no such row exists.
  ...
  /// Update all [MultipleMaxFieldName]s in the list and returns the updated rows. If
