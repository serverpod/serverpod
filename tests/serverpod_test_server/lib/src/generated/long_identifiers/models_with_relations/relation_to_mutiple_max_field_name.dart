...
class RelationToMultipleMaxFieldNameRepository {
  ...
  /// Emits [RelationToMultipleMaxFieldName]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `RelationToMultipleMaxFieldName.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<RelationToMultipleMaxFieldName>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<RelationToMultipleMaxFieldNameTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<RelationToMultipleMaxFieldName>(
      where: where?.call(RelationToMultipleMaxFieldName.t),
      orderBy: orderBy?.call(RelationToMultipleMaxFieldName.t),
      orderByList: orderByList?.call(RelationToMultipleMaxFieldName.t),
      limit: limit,
