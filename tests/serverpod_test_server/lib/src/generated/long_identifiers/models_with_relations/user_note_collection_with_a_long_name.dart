...
class UserNoteCollectionWithALongNameRepository {
  ...
  /// Updates a single [UserNoteCollectionWithALongName] by its [id] with the specified [columns].
  /// Returns the updated row or null if no row with the given id exists.
  Future<UserNoteCollectionWithALongName?> updateById(
    _i1.Session session,
    int id,
    _i1.ColumnValueListBuilder<UserNoteCollectionWithALongNameTable> columns, {
    _i1.Transaction? transaction,
  }) async {
    return session.db.updateById<UserNoteCollectionWithALongName>(
      id,
      columns(UserNoteCollectionWithALongName.t),
      transaction: transaction,
    );
  }

  /// Updates all [UserNoteCollectionWithALongName]s matching the [where] expression with the specified [columns].
