  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'customClassWithoutProtocolSerialization':
          ...
          customClassWithoutProtocolSerialization is _is.ProtocolSerialization
          ? (customClassWithoutProtocolSerialization
                    as _is.ProtocolSerialization)
                .toJsonForProtocol()
          :
            // ignore: dead_code
            customClassWithoutProtocolSerialization.toJson(),
      'customClassWithProtocolSerialization':
          // ignore: unnecessary_type_check
          customClassWithProtocolSerialization is _is.ProtocolSerialization
          ? (customClassWithProtocolSerialization as _is.ProtocolSerialization)
                .toJsonForProtocol()
          :
            // ignore: dead_code
            customClassWithProtocolSerialization.toJson(),
