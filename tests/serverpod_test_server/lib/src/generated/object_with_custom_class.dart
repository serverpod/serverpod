...
abstract class ObjectWithCustomClass
  ...
  factory ObjectWithCustomClass.fromJson(
    ...
    return ObjectWithCustomClass(
      customClassWithoutProtocolSerialization: _i2
          .CustomClassWithoutProtocolSerialization.fromJson(
        jsonSerialization['customClassWithoutProtocolSerialization'],
      ),
      customClassWithProtocolSerialization: _i2
          .CustomClassWithProtocolSerialization.fromJson(
        jsonSerialization['customClassWithProtocolSerialization'],
      ),
      customClassWithProtocolSerializationMethod: _i2
          .CustomClassWithProtocolSerializationMethod.fromJson(
