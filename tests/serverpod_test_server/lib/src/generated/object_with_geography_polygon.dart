...
class ObjectWithGeographyPolygonRepository {
  ...
  /// Emits [ObjectWithGeographyPolygon]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithGeographyPolygon.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithGeographyPolygon>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithGeographyPolygonTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectWithGeographyPolygon>(
      where: where?.call(ObjectWithGeographyPolygon.t),
      orderBy: orderBy?.call(ObjectWithGeographyPolygon.t),
      orderByList: orderByList?.call(ObjectWithGeographyPolygon.t),
      limit: limit,
