...
import 'package:serverpod_test_server/src/generated/simple_data.dart' as _i208;
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i209;
import 'package:serverpod_test_server/src/generated/inheritance/polymorphism/parent.dart'
    as _i210;
import 'package:serverpod_test_server/src/generated/types.dart' as _i211;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<(String, _i210.PolymorphicParent)>()) {
      return (
            deserialize<String>(((data as Map)['p'] as List)[0]),
            deserialize<_i210.PolymorphicParent>(data['p'][1]),
          )
          as T;
    }
    if (t == _i1.getType<(int,)>()) {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is (String, _i210.PolymorphicParent)) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == '(String,PolymorphicParent)') {
      return deserialize<(String, _i210.PolymorphicParent)>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i199.Types:
        return _i199.Types.t;
      case _i205.UniqueData:
        return _i205.UniqueData.t;
    }
    return null;
  }
...
Map<String, dynamic>? mapRecordToJson(Record? record) {
  ...
  if (record is (String, _i210.PolymorphicParent)) {
    return {
      "p": [
        record.$1,
        record.$2.toJson(),
  ...
  if (record is ((int, String), {(_i208.SimpleData, double) namedSubRecord})) {
    return {
      "p": [
  ...
  if (record is (Map<String, int>, {bool flag, _i208.SimpleData simpleData})) {
    return {
      "p": [
        record.$1.toJson(),
      ],
