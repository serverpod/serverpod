...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<(_i135.SimpleData?, (int, _i135.SimpleData?))>()) {
      return (
        ((data as Map)['p'] as List)[0] == null
            ? null
            : deserialize<_i135.SimpleData>(data['p'][0]),
        deserialize<(int, _i135.SimpleData?)>(data['p'][1]),
      ) as T;
    }
    if (t == _i1.getType<(int, _i135.SimpleData?)>()) {
      return (
  ...
  static Map<String, dynamic>? mapRecordToJson(Record? record) {
    ...
    if (record is (_i135.SimpleData?, (int, _i135.SimpleData?))) {
      return {
        "p": [
          record.$1,
