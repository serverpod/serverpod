...
import 'serverOnly/server_only_class.dart' as _i31;
import 'serverOnly/server_only_enum.dart' as _i32;
import 'simple_data.dart' as _i33;
import 'simple_data_list.dart' as _i34;
import 'simple_data_map.dart' as _i35;
import 'simple_date_time.dart' as _i36;
import 'test_enum.dart' as _i37;
import 'types.dart' as _i38;
import 'unique_data.dart' as _i39;
...
import 'package:uuid/uuid.dart' as _i44;
import 'package:serverpod_test_server/src/generated/simple_data.dart' as _i45;
import 'package:serverpod_test_server/src/generated/unique_data.dart' as _i46;
...
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i52;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i31.ServerOnlyClass) {
      return _i31.ServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i32.ServerOnlyEnum) {
      return _i32.ServerOnlyEnum.fromJson(data) as T;
    }
    if (t == _i33.SimpleData) {
      return _i33.SimpleData.fromJson(data, this) as T;
    }
    if (t == _i34.SimpleDataList) {
      return _i34.SimpleDataList.fromJson(data, this) as T;
    }
    if (t == _i35.SimpleDataMap) {
      return _i35.SimpleDataMap.fromJson(data, this) as T;
    }
    if (t == _i36.SimpleDateTime) {
      return _i36.SimpleDateTime.fromJson(data, this) as T;
    }
    if (t == _i37.TestEnum) {
      return _i37.TestEnum.fromJson(data) as T;
    }
    if (t == _i38.Types) {
      return _i38.Types.fromJson(data, this) as T;
    }
    if (t == _i39.UniqueData) {
      return _i39.UniqueData.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i31.ServerOnlyClass?>()) {
      return (data != null ? _i31.ServerOnlyClass.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i32.ServerOnlyEnum?>()) {
      return (data != null ? _i32.ServerOnlyEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i33.SimpleData?>()) {
      return (data != null ? _i33.SimpleData.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i34.SimpleDataList?>()) {
      return (data != null ? _i34.SimpleDataList.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i35.SimpleDataMap?>()) {
      return (data != null ? _i35.SimpleDataMap.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i36.SimpleDateTime?>()) {
      return (data != null ? _i36.SimpleDateTime.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i37.TestEnum?>()) {
      return (data != null ? _i37.TestEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i38.Types?>()) {
      return (data != null ? _i38.Types.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i39.UniqueData?>()) {
      return (data != null ? _i39.UniqueData.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<List<_i40.Order>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i40.Order>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i40.Comment>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i40.Comment>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i41.ByteData>) {
      return (data as List).map((e) => deserialize<_i41.ByteData>(e)).toList()
          as dynamic;
    }
    if (t == _i1.getType<List<_i41.ByteData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i41.ByteData>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<_i41.ByteData?>) {
      return (data as List).map((e) => deserialize<_i41.ByteData?>(e)).toList()
    ...
    if (t == List<List<_i40.TestEnum>>) {
      return (data as List)
          .map((e) => deserialize<List<_i40.TestEnum>>(e))
          .toList() as dynamic;
    }
    ...
    if (t == Map<String, _i41.ByteData>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i41.ByteData>(v)))
          as dynamic;
    }
    ...
    if (t == List<_i42.Types>) {
      return (data as List).map((e) => deserialize<_i42.Types>(e)).toList()
          as dynamic;
    }
    if (t == List<bool>) {
    ...
    if (t == List<_i44.UuidValue>) {
      return (data as List).map((e) => deserialize<_i44.UuidValue>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i46.UniqueData>) {
      return (data as List).map((e) => deserialize<_i46.UniqueData>(e)).toList()
          as dynamic;
    }
    if (t == List<_i47.Citizen>) {
      return (data as List).map((e) => deserialize<_i47.Citizen>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i49.Post>) {
      return (data as List).map((e) => deserialize<_i49.Post>(e)).toList()
          as dynamic;
    }
    if (t == List<_i50.Company>) {
      return (data as List).map((e) => deserialize<_i50.Company>(e)).toList()
          as dynamic;
    }
    if (t == List<List<int>>) {
    ...
    if (t == Map<_i43.TestEnum, int>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
              deserialize<_i43.TestEnum>(e['k']), deserialize<int>(e['v']))))
          as dynamic;
    }
    if (t == Map<String, _i43.TestEnum>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i43.TestEnum>(v)))
          as dynamic;
    }
    ...
    if (t == _i1.getType<Map<String, _i45.SimpleData>?>()) {
      return (data != null
          ? (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i45.SimpleData>(v)))
          : null) as dynamic;
    ...
    if (t == _i1.getType<Map<String, _i45.SimpleData?>?>()) {
      return (data != null
          ? (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<_i45.SimpleData?>(v)))
          : null) as dynamic;
    }
    if (t == _i1.getType<Map<String, _i45.SimpleData?>?>()) {
      return (data != null
    ...
    if (t == _i51.CustomClass) {
      return _i51.CustomClass.fromJson(data, this) as T;
    }
    if (t == _i52.ExternalCustomClass) {
      return _i52.ExternalCustomClass.fromJson(data, this) as T;
    }
    if (t == _i52.FreezedCustomClass) {
      return _i52.FreezedCustomClass.fromJson(data, this) as T;
    }
    if (t == _i1.getType<_i51.CustomClass?>()) {
      return (data != null ? _i51.CustomClass.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i52.ExternalCustomClass?>()) {
      return (data != null
          ? _i52.ExternalCustomClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i52.FreezedCustomClass?>()) {
      return (data != null
          ? _i52.FreezedCustomClass.fromJson(data, this)
          : null) as T;
    }
    try {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i51.CustomClass) {
      return 'CustomClass';
    }
    if (data is _i52.ExternalCustomClass) {
      return 'ExternalCustomClass';
    }
    if (data is _i52.FreezedCustomClass) {
    ...
    if (data is _i31.ServerOnlyClass) {
      return 'ServerOnlyClass';
    }
    if (data is _i32.ServerOnlyEnum) {
      return 'ServerOnlyEnum';
    }
    if (data is _i33.SimpleData) {
      return 'SimpleData';
    }
    if (data is _i34.SimpleDataList) {
      return 'SimpleDataList';
    }
    if (data is _i35.SimpleDataMap) {
      return 'SimpleDataMap';
    }
    if (data is _i36.SimpleDateTime) {
      return 'SimpleDateTime';
    }
    if (data is _i37.TestEnum) {
      return 'TestEnum';
    }
    if (data is _i38.Types) {
      return 'Types';
    }
    if (data is _i39.UniqueData) {
      return 'UniqueData';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'CustomClass') {
      return deserialize<_i51.CustomClass>(data['data']);
    }
    if (data['className'] == 'ExternalCustomClass') {
      return deserialize<_i52.ExternalCustomClass>(data['data']);
    }
    if (data['className'] == 'FreezedCustomClass') {
      return deserialize<_i52.FreezedCustomClass>(data['data']);
    }
    ...
    if (data['className'] == 'ServerOnlyClass') {
      return deserialize<_i31.ServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'ServerOnlyEnum') {
      return deserialize<_i32.ServerOnlyEnum>(data['data']);
    }
    if (data['className'] == 'SimpleData') {
      return deserialize<_i33.SimpleData>(data['data']);
    }
    if (data['className'] == 'SimpleDataList') {
      return deserialize<_i34.SimpleDataList>(data['data']);
    }
    if (data['className'] == 'SimpleDataMap') {
      return deserialize<_i35.SimpleDataMap>(data['data']);
    }
    if (data['className'] == 'SimpleDateTime') {
      return deserialize<_i36.SimpleDateTime>(data['data']);
    }
    if (data['className'] == 'TestEnum') {
      return deserialize<_i37.TestEnum>(data['data']);
    }
    if (data['className'] == 'Types') {
      return deserialize<_i38.Types>(data['data']);
    }
    if (data['className'] == 'UniqueData') {
      return deserialize<_i39.UniqueData>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i9.Citizen:
        return _i9.Citizen.t;
      case _i10.Company:
        return _i10.Company.t;
      case _i11.Town:
        return _i11.Town.t;
      case _i12.Post:
        return _i12.Post.t;
      ...
      case _i26.RelatedUniqueData:
        return _i26.RelatedUniqueData.t;
      case _i33.SimpleData:
        return _i33.SimpleData.t;
      case _i36.SimpleDateTime:
        return _i36.SimpleDateTime.t;
      case _i38.Types:
        return _i38.Types.t;
      case _i39.UniqueData:
        return _i39.UniqueData.t;
    }
    return null;
  }
