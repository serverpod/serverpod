...
import 'serverOnly/server_only_class.dart' as _i37;
import 'serverOnly/server_only_enum.dart' as _i38;
import 'simple_data.dart' as _i39;
import 'simple_data_list.dart' as _i40;
import 'simple_data_map.dart' as _i41;
import 'simple_date_time.dart' as _i42;
import 'test_enum.dart' as _i43;
import 'types.dart' as _i44;
import 'unique_data.dart' as _i45;
...
import 'package:serverpod_test_server/src/generated/entities_with_relations/one_to_one/company.dart'
    as _i60;
import 'package:serverpod_test_server/src/custom_classes.dart' as _i61;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i37.ServerOnlyClass) {
      return _i37.ServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i38.ServerOnlyEnum) {
      return _i38.ServerOnlyEnum.fromJson(data) as T;
    }
    if (t == _i39.SimpleData) {
      return _i39.SimpleData.fromJson(data, this) as T;
    }
    if (t == _i40.SimpleDataList) {
      return _i40.SimpleDataList.fromJson(data, this) as T;
    }
    if (t == _i41.SimpleDataMap) {
      return _i41.SimpleDataMap.fromJson(data, this) as T;
    }
    if (t == _i42.SimpleDateTime) {
      return _i42.SimpleDateTime.fromJson(data, this) as T;
    }
    if (t == _i43.TestEnum) {
      return _i43.TestEnum.fromJson(data) as T;
    }
    if (t == _i44.Types) {
      return _i44.Types.fromJson(data, this) as T;
    }
    if (t == _i45.UniqueData) {
      return _i45.UniqueData.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i37.ServerOnlyClass?>()) {
      return (data != null ? _i37.ServerOnlyClass.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i38.ServerOnlyEnum?>()) {
      return (data != null ? _i38.ServerOnlyEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i39.SimpleData?>()) {
      return (data != null ? _i39.SimpleData.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i40.SimpleDataList?>()) {
      return (data != null ? _i40.SimpleDataList.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i41.SimpleDataMap?>()) {
      return (data != null ? _i41.SimpleDataMap.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i42.SimpleDateTime?>()) {
      return (data != null ? _i42.SimpleDateTime.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i43.TestEnum?>()) {
      return (data != null ? _i43.TestEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i44.Types?>()) {
      return (data != null ? _i44.Types.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i45.UniqueData?>()) {
      return (data != null ? _i45.UniqueData.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<List<_i46.Person>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i46.Person>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i46.Organization>?>()) {
      return (data != null
          ? (data as List)
    ...
    if (t == _i1.getType<List<_i46.Player>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i46.Player>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i46.Order>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i46.Order>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i46.Comment>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i46.Comment>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<String>) {
    ...
    if (t == List<List<_i46.TestEnum>>) {
      return (data as List)
          .map((e) => deserialize<List<_i46.TestEnum>>(e))
          .toList() as dynamic;
    }
    ...
    if (t == Map<_i50.TestEnum, int>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
              deserialize<_i50.TestEnum>(e['k']), deserialize<int>(e['v']))))
          as dynamic;
    }
    if (t == Map<String, _i50.TestEnum>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i50.TestEnum>(v)))
          as dynamic;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i37.ServerOnlyClass) {
      return 'ServerOnlyClass';
    }
    if (data is _i38.ServerOnlyEnum) {
      return 'ServerOnlyEnum';
    }
    if (data is _i39.SimpleData) {
      return 'SimpleData';
    }
    if (data is _i40.SimpleDataList) {
      return 'SimpleDataList';
    }
    if (data is _i41.SimpleDataMap) {
      return 'SimpleDataMap';
    }
    if (data is _i42.SimpleDateTime) {
      return 'SimpleDateTime';
    }
    if (data is _i43.TestEnum) {
      return 'TestEnum';
    }
    if (data is _i44.Types) {
      return 'Types';
    }
    if (data is _i45.UniqueData) {
      return 'UniqueData';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'ServerOnlyClass') {
      return deserialize<_i37.ServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'ServerOnlyEnum') {
      return deserialize<_i38.ServerOnlyEnum>(data['data']);
    }
    if (data['className'] == 'SimpleData') {
      return deserialize<_i39.SimpleData>(data['data']);
    }
    if (data['className'] == 'SimpleDataList') {
      return deserialize<_i40.SimpleDataList>(data['data']);
    }
    if (data['className'] == 'SimpleDataMap') {
      return deserialize<_i41.SimpleDataMap>(data['data']);
    }
    if (data['className'] == 'SimpleDateTime') {
      return deserialize<_i42.SimpleDateTime>(data['data']);
    }
    if (data['className'] == 'TestEnum') {
      return deserialize<_i43.TestEnum>(data['data']);
    }
    if (data['className'] == 'Types') {
      return deserialize<_i44.Types>(data['data']);
    }
    if (data['className'] == 'UniqueData') {
      return deserialize<_i45.UniqueData>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i13.Order:
        return _i13.Order.t;
      case _i14.Address:
        return _i14.Address.t;
      case _i15.Citizen:
        return _i15.Citizen.t;
      case _i16.Company:
      ...
      case _i18.Post:
        return _i18.Post.t;
      case _i22.ObjectFieldScopes:
        return _i22.ObjectFieldScopes.t;
      case _i23.ObjectWithByteData:
        return _i23.ObjectWithByteData.t;
      case _i24.ObjectWithDuration:
        return _i24.ObjectWithDuration.t;
      case _i25.ObjectWithEnum:
        return _i25.ObjectWithEnum.t;
      case _i26.ObjectWithIndex:
        return _i26.ObjectWithIndex.t;
      case _i28.ObjectWithObject:
        return _i28.ObjectWithObject.t;
      case _i29.ObjectWithParent:
        return _i29.ObjectWithParent.t;
      case _i30.ObjectWithSelfParent:
        return _i30.ObjectWithSelfParent.t;
      case _i31.ObjectWithUuid:
        return _i31.ObjectWithUuid.t;
      case _i32.RelatedUniqueData:
        return _i32.RelatedUniqueData.t;
      case _i39.SimpleData:
        return _i39.SimpleData.t;
      case _i42.SimpleDateTime:
        return _i42.SimpleDateTime.t;
      case _i44.Types:
        return _i44.Types.t;
      case _i45.UniqueData:
        return _i45.UniqueData.t;
    }
    return null;
  }
