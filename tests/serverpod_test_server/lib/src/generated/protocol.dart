...
import 'extra_data_simple.dart' as _i6;
...
import 'test_enum.dart' as _i26;
import 'types.dart' as _i27;
import 'protocol.dart' as _i28;
import 'dart:typed_data' as _i29;
import 'package:serverpod_test_server/src/generated/simple_data.dart' as _i30;
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i31;
import 'package:serverpod_test_server/src/custom_classes.dart' as _i32;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i6.ExtraDataSimple) {
      return _i6.ExtraDataSimple.fromJson(data, this) as T;
    }
    ...
    if (t == _i26.TestEnum) {
      return _i26.TestEnum.fromJson(data) as T;
    }
    if (t == _i27.Types) {
      return _i27.Types.fromJson(data, this) as T;
    }
    if (t == _i1.getType<_i5.ExceptionWithData?>()) {
      return (data != null ? _i5.ExceptionWithData.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i6.ExtraDataSimple?>()) {
      return (data != null ? _i6.ExtraDataSimple.fromJson(data, this) : null)
          as T;
    }
    ...
    if (t == _i1.getType<_i26.TestEnum?>()) {
      return (data != null ? _i26.TestEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i27.Types?>()) {
      return (data != null ? _i27.Types.fromJson(data, this) : null) as T;
    }
    if (t == List<String>) {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i6.ExtraDataSimple) {
    ...
    if (data is _i26.TestEnum) {
      return 'TestEnum';
    }
    if (data is _i27.Types) {
      return 'Types';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'ExtraDataSimple') {
      return deserialize<_i6.ExtraDataSimple>(data['data']);
    }
    ...
    if (data['className'] == 'TestEnum') {
      return deserialize<_i26.TestEnum>(data['data']);
    }
    if (data['className'] == 'Types') {
      return deserialize<_i27.Types>(data['data']);
    }
