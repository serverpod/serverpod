...
import 'serverOnly/server_only_class.dart' as _i14;
import 'serverOnly/server_only_enum.dart' as _i15;
...
import 'package:serverpod_test_server/src/generated/simple_data.dart' as _i22;
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i23;
import 'package:serverpod_test_server/src/custom_classes.dart' as _i24;
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i25;
import 'package:serverpod_test_module_server/module.dart' as _i26;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i14.ServerOnlyClass) {
      return _i14.ServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i15.ServerOnlyEnum) {
      return _i15.ServerOnlyEnum.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i14.ServerOnlyClass?>()) {
      return (data != null ? _i14.ServerOnlyClass.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i15.ServerOnlyEnum?>()) {
      return (data != null ? _i15.ServerOnlyEnum.fromJson(data) : null) as T;
    }
    ...
    if (t == Map<_i23.TestEnum, int>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
              deserialize<_i23.TestEnum>(e['k']), deserialize<int>(e['v']))))
          as dynamic;
    }
    if (t == Map<String, _i23.TestEnum>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i23.TestEnum>(v)))
          as dynamic;
    }
    ...
    if (t == _i1.getType<Map<String, _i22.SimpleData>?>()) {
      return (data != null
          ? (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i22.SimpleData>(v)))
          : null) as dynamic;
    ...
    if (t == _i1.getType<Map<String, _i22.SimpleData?>?>()) {
      return (data != null
          ? (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<_i22.SimpleData?>(v)))
          : null) as dynamic;
    }
    if (t == _i1.getType<Map<String, _i22.SimpleData?>?>()) {
      return (data != null
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i14.ServerOnlyClass) {
      return 'ServerOnlyClass';
    }
    if (data is _i15.ServerOnlyEnum) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'ServerOnlyClass') {
      return deserialize<_i14.ServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'ServerOnlyEnum') {
      return deserialize<_i15.ServerOnlyEnum>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i16.SimpleData:
        return _i16.SimpleData.t;
      case _i19.Types:
        return _i19.Types.t;
    }
    return null;
