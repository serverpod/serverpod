...
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i158;
import 'package:serverpod_test_server/src/generated/simple_data.dart' as _i159;
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i160;
import 'package:serverpod_test_server/src/generated/types.dart' as _i161;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i157.ByteData>) {
      return (data as List).map((e) => deserialize<_i157.ByteData>(e)).toList()
          as T;
    }
    if (t == _i1.getType<List<_i157.ByteData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i157.ByteData>(e)).toList()
          : null) as T;
    }
    if (t == List<_i157.ByteData?>) {
      return (data as List).map((e) => deserialize<_i157.ByteData?>(e)).toList()
    ...
    if (t == _i158.CustomClassWithoutProtocolSerialization) {
      return _i158.CustomClassWithoutProtocolSerialization.fromJson(data) as T;
    }
    if (t == _i158.CustomClassWithProtocolSerialization) {
      return _i158.CustomClassWithProtocolSerialization.fromJson(data) as T;
    }
    if (t == _i158.CustomClassWithProtocolSerializationMethod) {
      return _i158.CustomClassWithProtocolSerializationMethod.fromJson(data)
          as T;
    }
    ...
    if (t == Map<String, _i157.ByteData>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i157.ByteData>(v)))
          as T;
    }
    ...
    if (t == _i1.getType<Map<_i157.ByteData, String>?>()) {
      return (data != null
          ? Map.fromEntries((data as List).map((e) => MapEntry(
              deserialize<_i157.ByteData>(e['k']),
    ...
    if (t == _i1.getType<Map<String, _i157.ByteData>?>()) {
      return (data != null
          ? (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i157.ByteData>(v)))
          : null) as T;
    ...
    if (t == _i1.getType<(_i157.ByteData,)?>()) {
      return (data == null)
          ? null as T
          : (deserialize<_i157.ByteData>(((data as Map)['p'] as List)[0]),)
              as T;
    }
    ...
    if (t == _i1.getType<Set<_i157.ByteData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i157.ByteData>(e)).toSet()
          : null) as T;
    }
    ...
    if (t == List<_i159.SimpleData>) {
      return (data as List)
          .map((e) => deserialize<_i159.SimpleData>(e))
          .toList() as T;
    }
    if (t == List<int>) {
      return (data as List).map((e) => deserialize<int>(e)).toList() as T;
    ...
    if (t == _i1.getType<List<_i159.SimpleData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i159.SimpleData>(e)).toList()
          : null) as T;
    }
    if (t == _i1.getType<List<_i159.SimpleData?>?>()) {
      return (data != null
    ...
    if (t == Map<_i160.TestEnum, int>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
          deserialize<_i160.TestEnum>(e['k']), deserialize<int>(e['v'])))) as T;
    }
    if (t == Map<String, _i160.TestEnum>) {
      return (data as Map).map((k, v) =>
    ...
    if (t == Map<String, _i159.SimpleData>) {
      return (data as Map).map((k, v) => MapEntry(
          deserialize<String>(k), deserialize<_i159.SimpleData>(v))) as T;
    }
    if (t == Map<String, _i159.SimpleData?>) {
      return (data as Map).map((k, v) => MapEntry(
          deserialize<String>(k), deserialize<_i159.SimpleData?>(v))) as T;
    }
    if (t == _i1.getType<Map<String, _i159.SimpleData>?>()) {
      return (data != null
          ? (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<_i159.SimpleData>(v)))
          : null) as T;
    }
    if (t == _i1.getType<Map<String, _i159.SimpleData?>?>()) {
      return (data != null
    ...
    if (t == Set<_i159.SimpleData>) {
      return (data as List).map((e) => deserialize<_i159.SimpleData>(e)).toSet()
          as T;
    }
    if (t == List<Set<_i159.SimpleData>>) {
      return (data as List)
          .map((e) => deserialize<Set<_i159.SimpleData>>(e))
          .toList() as T;
    }
    ...
    if (t == _i1.getType<(int, _i159.SimpleData)>()) {
      return (
        deserialize<int>(((data as Map)['p'] as List)[0]),
        deserialize<_i159.SimpleData>(data['p'][1]),
      ) as T;
    }
    if (t == _i1.getType<(int, _i159.SimpleData)?>()) {
      return (data == null)
    ...
    if (t == _i1.getType<({_i159.SimpleData data, int number})>()) {
      return (
        data:
            deserialize<_i159.SimpleData>(((data as Map)['n'] as Map)['data']),
    ...
    if (t == _i1.getType<({_i159.SimpleData data, int number})?>()) {
      return (data == null)
          ? null as T
          : (
              data: deserialize<_i159.SimpleData>(
    ...
    if (t == _i1.getType<({_i159.SimpleData? data, int? number})>()) {
      return (
        data: ((data as Map)['n'] as Map)['data'] == null
            ? null
            : deserialize<_i159.SimpleData>(data['n']['data']),
        number: ((data)['n'] as Map)['number'] == null
            ? null
            : deserialize<int>(data['n']['number']),
      ) as T;
    }
    if (t == _i1.getType<(int, {_i159.SimpleData data})>()) {
      return (
        deserialize<int>(((data as Map)['p'] as List)[0]),
        data: deserialize<_i159.SimpleData>(data['n']['data']),
      ) as T;
    }
    if (t == _i1.getType<(int, {_i159.SimpleData data})?>()) {
      return (data == null)
    ...
    if (t == List<(int, _i159.SimpleData)>) {
      return (data as List)
          .map((e) => deserialize<(int, _i159.SimpleData)>(e))
          .toList() as T;
    }
    if (t == _i1.getType<(int, _i159.SimpleData)>()) {
      return (
    ...
    if (t == _i1.getType<Set<(int, _i159.SimpleData)>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<(int, _i159.SimpleData)>(e))
              .toSet()
    ...
    if (t == Map<String, (int, _i159.SimpleData)>) {
      return (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<(int, _i159.SimpleData)>(v)))
          as T;
    }
    if (t == _i1.getType<(int, _i159.SimpleData)>()) {
      return (
    ...
    if (t == Map<(String, int), (int, _i159.SimpleData)>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
          deserialize<(String, int)>(e['k']),
          deserialize<(int, _i159.SimpleData)>(e['v'])))) as T;
    }
    ...
    if (t == _i1.getType<({(_i159.SimpleData, double) namedSubRecord})>()) {
      return (
        namedSubRecord: deserialize<(_i159.SimpleData, double)>(
            ((data as Map)['n'] as Map)['namedSubRecord']),
      ) as T;
    }
    if (t == _i1.getType<(_i159.SimpleData, double)>()) {
      return (
        deserialize<_i159.SimpleData>(((data as Map)['p'] as List)[0]),
    ...
    if (t == _i1.getType<({(_i159.SimpleData, double)? namedSubRecord})>()) {
      return (
        namedSubRecord: ((data as Map)['n'] as Map)['namedSubRecord'] == null
            ? null
            : deserialize<(_i159.SimpleData, double)>(
    ...
    if (t ==
        _i1.getType<
            ((int, String), {(_i159.SimpleData, double) namedSubRecord})>()) {
      return (
        deserialize<(int, String)>(((data as Map)['p'] as List)[0]),
        namedSubRecord: deserialize<(_i159.SimpleData, double)>(
            data['n']['namedSubRecord']),
    ...
    if (t ==
        List<((int, String), {(_i159.SimpleData, double) namedSubRecord})>) {
      return (data as List)
          .map((e) => deserialize<
              ((int, String), {(_i159.SimpleData, double) namedSubRecord})>(e))
          .toList() as T;
    }
    if (t ==
        _i1.getType<
    ...
    if (t ==
        _i1.getType<
            List<
                (
                  (int, String), {
                  (_i159.SimpleData, double) namedSubRecord
                })?>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<
    ...
    if (t == Set<_i157.ByteData>) {
      return (data as List).map((e) => deserialize<_i157.ByteData>(e)).toSet()
          as T;
    }
    if (t == Set<_i157.ByteData?>) {
      return (data as List).map((e) => deserialize<_i157.ByteData?>(e)).toSet()
    ...
    if (t ==
        _i1.getType<
            (
              String,
              (Map<String, int>, {bool flag, _i159.SimpleData simpleData})
            )>()) {
      return (
        deserialize<String>(((data as Map)['p'] as List)[0]),
        deserialize<
    ...
    if (t ==
      ...
      return (
        ...
        simpleData: deserialize<_i159.SimpleData>(data['n']['simpleData']),
      ) as T;
    }
    ...
    if (t == _i158.CustomClass) {
      return _i158.CustomClass.fromJson(data) as T;
    }
    if (t == _i158.CustomClass2) {
      return _i158.CustomClass2.fromJson(data) as T;
    }
    if (t == _i158.ProtocolCustomClass) {
      return _i158.ProtocolCustomClass.fromJson(data) as T;
    }
    if (t == _i158.ExternalCustomClass) {
      return _i158.ExternalCustomClass.fromJson(data) as T;
    }
    if (t == _i158.FreezedCustomClass) {
      return _i158.FreezedCustomClass.fromJson(data) as T;
    }
    if (t == _i1.getType<_i158.CustomClass?>()) {
      return (data != null ? _i158.CustomClass.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i158.CustomClass2?>()) {
      return (data != null ? _i158.CustomClass2.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i158.CustomClassWithoutProtocolSerialization?>()) {
      return (data != null
          ? _i158.CustomClassWithoutProtocolSerialization.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i158.CustomClassWithProtocolSerialization?>()) {
      return (data != null
          ? _i158.CustomClassWithProtocolSerialization.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i158.CustomClassWithProtocolSerializationMethod?>()) {
      return (data != null
          ? _i158.CustomClassWithProtocolSerializationMethod.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i158.ProtocolCustomClass?>()) {
      return (data != null ? _i158.ProtocolCustomClass.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i158.ExternalCustomClass?>()) {
      return (data != null ? _i158.ExternalCustomClass.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i158.FreezedCustomClass?>()) {
      return (data != null ? _i158.FreezedCustomClass.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<List<_i159.SimpleData>?>()) {
      return (data != null
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i158.CustomClass) {
      return 'CustomClass';
    }
    if (data is _i158.CustomClass2) {
      return 'CustomClass2';
    }
    if (data is _i158.CustomClassWithoutProtocolSerialization) {
      return 'CustomClassWithoutProtocolSerialization';
    }
    if (data is _i158.CustomClassWithProtocolSerialization) {
      return 'CustomClassWithProtocolSerialization';
    }
    if (data is _i158.CustomClassWithProtocolSerializationMethod) {
      return 'CustomClassWithProtocolSerializationMethod';
    }
    if (data is _i158.ProtocolCustomClass) {
      return 'ProtocolCustomClass';
    }
    if (data is _i158.ExternalCustomClass) {
      return 'ExternalCustomClass';
    }
    if (data is _i158.FreezedCustomClass) {
    ...
    if (data is List<_i159.SimpleData>) {
    ...
    if (data is Set<_i159.SimpleData>) {
      return 'Set<SimpleData>';
    }
    if (data is List<Set<_i159.SimpleData>>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'CustomClass') {
      return deserialize<_i158.CustomClass>(data['data']);
    }
    if (dataClassName == 'CustomClass2') {
      return deserialize<_i158.CustomClass2>(data['data']);
    }
    if (dataClassName == 'CustomClassWithoutProtocolSerialization') {
      return deserialize<_i158.CustomClassWithoutProtocolSerialization>(
          data['data']);
    }
    if (dataClassName == 'CustomClassWithProtocolSerialization') {
      return deserialize<_i158.CustomClassWithProtocolSerialization>(
          data['data']);
    }
    if (dataClassName == 'CustomClassWithProtocolSerializationMethod') {
      return deserialize<_i158.CustomClassWithProtocolSerializationMethod>(
          data['data']);
    }
    if (dataClassName == 'ProtocolCustomClass') {
      return deserialize<_i158.ProtocolCustomClass>(data['data']);
    }
    if (dataClassName == 'ExternalCustomClass') {
      return deserialize<_i158.ExternalCustomClass>(data['data']);
    }
    if (dataClassName == 'FreezedCustomClass') {
      return deserialize<_i158.FreezedCustomClass>(data['data']);
    }
    ...
    if (dataClassName == 'List<SimpleData>') {
      return deserialize<List<_i159.SimpleData>>(data['data']);
    }
    ...
    if (dataClassName == 'Set<SimpleData>') {
      return deserialize<Set<_i159.SimpleData>>(data['data']);
    }
    if (dataClassName == 'List<Set<SimpleData>>') {
      return deserialize<List<Set<_i159.SimpleData>>>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i149.Types:
        return _i149.Types.t;
      case _i155.UniqueData:
        return _i155.UniqueData.t;
    }
    return null;
  }
...
Map<String, dynamic>? mapRecordToJson(Record? record) {
  ...
  if (record is (int, _i159.SimpleData)) {
    return {
      "p": [
        record.$1,
        record.$2,
  ...
  if (record is ({_i159.SimpleData data, int number})) {
    return {
      "n": {
        "data": record.data,
        "number": record.number,
  ...
  if (record is (int, {_i159.SimpleData data})) {
    return {
      "p": [
        record.$1,
      ],
  ...
  if (record is ({(_i159.SimpleData, double) namedSubRecord})) {
    return {
      "n": {
  ...
  if (record is (_i159.SimpleData, double)) {
    return {
      "p": [
        record.$1,
        record.$2,
  ...
  if (record is ((int, String), {(_i159.SimpleData, double) namedSubRecord})) {
    return {
      "p": [
  ...
  if (record is (Map<String, int>, {bool flag, _i159.SimpleData simpleData})) {
    return {
      "p": [
        record.$1,
      ],
