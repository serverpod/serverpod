...
import 'package:serverpod_test_server/src/generated/simple_data.dart' as _i131;
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i132;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == Map<_i132.TestEnum, int>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
              deserialize<_i132.TestEnum>(e['k']), deserialize<int>(e['v']))))
          as dynamic;
    }
    ...
    if (t == Map<String, _i131.SimpleData>) {
      return (data as Map).map((k, v) => MapEntry(
          deserialize<String>(k), deserialize<_i131.SimpleData>(v))) as dynamic;
    }
    if (t == Map<String, _i131.SimpleData?>) {
      return (data as Map).map((k, v) => MapEntry(
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i127.UniqueData:
        return _i127.UniqueData.t;
    }
    return null;
  }
