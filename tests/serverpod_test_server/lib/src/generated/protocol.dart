...
import 'parent_data.dart' as _i10;
import 'sample_view.dart' as _i11;
import 'sample_view_list.dart' as _i12;
...
import 'package:serverpod_test_server/src/generated/simple_data.dart' as _i19;
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i20;
import 'package:serverpod_test_server/src/custom_classes.dart' as _i21;
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i22;
import 'package:serverpod_test_module_server/module.dart' as _i23;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i10.ParentData) {
      return _i10.ParentData.fromJson(data, this) as T;
    }
    if (t == _i11.SampleView) {
      return _i11.SampleView.fromJson(data, this) as T;
    }
    if (t == _i12.SampleViewList) {
      return _i12.SampleViewList.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i10.ParentData?>()) {
      return (data != null ? _i10.ParentData.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i11.SampleView?>()) {
      return (data != null ? _i11.SampleView.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i12.SampleViewList?>()) {
      return (data != null ? _i12.SampleViewList.fromJson(data, this) : null)
          as T;
    }
    ...
    if (t == List<_i17.SampleView>) {
      return (data as List).map((e) => deserialize<_i17.SampleView>(e)).toList()
          as dynamic;
    }
    if (t == List<int>) {
      return (data as List).map((e) => deserialize<int>(e)).toList() as dynamic;
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i10.ParentData) {
      return 'ParentData';
    }
    if (data is _i11.SampleView) {
      return 'SampleView';
    }
    if (data is _i12.SampleViewList) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'ParentData') {
      return deserialize<_i10.ParentData>(data['data']);
    }
    if (data['className'] == 'SampleView') {
      return deserialize<_i11.SampleView>(data['data']);
    }
    if (data['className'] == 'SampleViewList') {
      return deserialize<_i12.SampleViewList>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    {
      var table = _i24.Protocol().getTableForType(t);
      if (table != null) {
        return table;
      }
    }
    ...
    switch (t) {
      ...
      case _i10.ParentData:
        return _i10.ParentData.t;
      case _i11.SampleView:
        return _i11.SampleView.t;
      case _i13.SimpleData:
        return _i13.SimpleData.t;
      case _i16.Types:
        return _i16.Types.t;
    }
    return null;
