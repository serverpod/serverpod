...
class Protocol extends _is.DatabaseSerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _is.getType<_ivhidcz8.ProjectedOrderSummary?>()) {
      return (data != null
    ...
    if (t == _is.getType<_ilsqfnzb.ProjectedUserOrderSummary?>()) {
      return (data != null
    ...
    if (t == _is.getType<List<_ivhidcz8.ProjectedOrderSummary>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_ivhidcz8.ProjectedOrderSummary>(e))
                    .toList()
