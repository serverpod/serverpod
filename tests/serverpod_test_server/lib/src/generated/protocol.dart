...
import 'scopes/serverOnly/server_only_class.dart' as _i100;
import 'scopes/serverOnly/server_only_enum.dart' as _i101;
...
import 'package:serverpod_test_server/src/generated/simple_data.dart' as _i117;
import 'package:serverpod_test_server/src/generated/test_enum.dart' as _i118;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i100.ServerOnlyClass) {
      return _i100.ServerOnlyClass.fromJson(data) as T;
    }
    if (t == _i101.ServerOnlyEnum) {
      return _i101.ServerOnlyEnum.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i100.ServerOnlyClass?>()) {
      return (data != null ? _i100.ServerOnlyClass.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i101.ServerOnlyEnum?>()) {
      return (data != null ? _i101.ServerOnlyEnum.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<List<_i114.ServerOnlyClass>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i114.ServerOnlyClass>(e))
              .toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<Map<String, _i114.ServerOnlyClass>?>()) {
      return (data != null
          ? (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<_i114.ServerOnlyClass>(v)))
          : null) as dynamic;
    }
    if (t == _i1.getType<List<int>?>()) {
      return (data != null
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i100.ServerOnlyClass) {
      return 'ServerOnlyClass';
    }
    if (data is _i101.ServerOnlyEnum) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'ServerOnlyClass') {
      return deserialize<_i100.ServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'ServerOnlyEnum') {
      return deserialize<_i101.ServerOnlyEnum>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i78.Post:
        return _i78.Post.t;
      case _i81.ObjectFieldPersist:
        return _i81.ObjectFieldPersist.t;
      case _i82.ObjectFieldScopes:
        return _i82.ObjectFieldScopes.t;
      case _i83.ObjectWithByteData:
        return _i83.ObjectWithByteData.t;
      case _i85.ObjectWithDuration:
        return _i85.ObjectWithDuration.t;
      case _i86.ObjectWithEnum:
        return _i86.ObjectWithEnum.t;
      case _i87.ObjectWithIndex:
        return _i87.ObjectWithIndex.t;
      case _i89.ObjectWithObject:
        return _i89.ObjectWithObject.t;
      case _i90.ObjectWithParent:
        return _i90.ObjectWithParent.t;
      case _i91.ObjectWithSelfParent:
        return _i91.ObjectWithSelfParent.t;
      case _i92.ObjectWithUuid:
        return _i92.ObjectWithUuid.t;
      case _i93.RelatedUniqueData:
        return _i93.RelatedUniqueData.t;
      case _i94.ScopeNoneFields:
        return _i94.ScopeNoneFields.t;
      case _i103.SimpleData:
        return _i103.SimpleData.t;
      case _i107.SimpleDateTime:
        return _i107.SimpleDateTime.t;
      case _i110.Types:
        return _i110.Types.t;
      case _i113.UniqueData:
        return _i113.UniqueData.t;
    }
    return null;
  }
