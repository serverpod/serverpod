...
import 'entities_with_relations/many_to_many/1_blocked.dart' as _i8;
import 'entities_with_relations/many_to_many/2_author.dart' as _i9;
import 'entities_with_relations/many_to_many/3_posts.dart' as _i10;
import 'entities_with_relations/named_relation/post.dart' as _i11;
import 'entities_with_relations/named_relation/town.dart' as _i12;
import 'entities_with_relations/one_to_many/1_comment.dart' as _i13;
import 'entities_with_relations/one_to_many/2_order.dart' as _i14;
import 'entities_with_relations/one_to_many/3_customer.dart' as _i15;
...
import 'serverOnly/default_server_only_class.dart' as _i29;
import 'serverOnly/default_server_only_enum.dart' as _i30;
import 'serverOnly/not_server_only_class.dart' as _i31;
import 'serverOnly/not_server_only_enum.dart' as _i32;
import 'serverOnly/server_only_class.dart' as _i33;
import 'serverOnly/server_only_enum.dart' as _i34;
import 'simple_data.dart' as _i35;
import 'simple_data_list.dart' as _i36;
import 'simple_data_map.dart' as _i37;
import 'simple_date_time.dart' as _i38;
import 'test_enum.dart' as _i39;
import 'types.dart' as _i40;
...
import 'package:serverpod_test_server/src/generated/entities_with_relations/many_to_many/3_posts.dart'
    as _i51;
...
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i54;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  static final targetDatabaseDefinition = _i2.DatabaseDefinition(tables: [
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'author_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'name',
          columnType: _i2.ColumnType.text,
    ...
    _i2.TableDefinition(
      ...
      indexes: [
        ...
        _i2.IndexDefinition(
          indexName: 'blocked_blocker_blockee_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
  ...
  T deserialize<T>(
    ...
    if (t == _i8.Blocked) {
      return _i8.Blocked.fromJson(data, this) as T;
    }
    if (t == _i9.Author) {
      return _i9.Author.fromJson(data, this) as T;
    }
    if (t == _i10.Posts) {
      return _i10.Posts.fromJson(data, this) as T;
    }
    if (t == _i11.Post) {
      return _i11.Post.fromJson(data, this) as T;
    }
    if (t == _i12.Town) {
      return _i12.Town.fromJson(data, this) as T;
    }
    if (t == _i13.Comment) {
    ...
    if (t == _i29.DefaultServerOnlyClass) {
      return _i29.DefaultServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i30.DefaultServerOnlyEnum) {
      return _i30.DefaultServerOnlyEnum.fromJson(data) as T;
    }
    if (t == _i31.NotServerOnlyClass) {
      return _i31.NotServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i32.NotServerOnlyEnum) {
      return _i32.NotServerOnlyEnum.fromJson(data) as T;
    }
    if (t == _i33.ServerOnlyClass) {
      return _i33.ServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i34.ServerOnlyEnum) {
      return _i34.ServerOnlyEnum.fromJson(data) as T;
    }
    if (t == _i35.SimpleData) {
      return _i35.SimpleData.fromJson(data, this) as T;
    }
    if (t == _i36.SimpleDataList) {
      return _i36.SimpleDataList.fromJson(data, this) as T;
    }
    if (t == _i37.SimpleDataMap) {
      return _i37.SimpleDataMap.fromJson(data, this) as T;
    }
    if (t == _i38.SimpleDateTime) {
      return _i38.SimpleDateTime.fromJson(data, this) as T;
    }
    if (t == _i39.TestEnum) {
      return _i39.TestEnum.fromJson(data) as T;
    }
    if (t == _i40.Types) {
      return _i40.Types.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i8.Blocked?>()) {
      return (data != null ? _i8.Blocked.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i9.Author?>()) {
      return (data != null ? _i9.Author.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i10.Posts?>()) {
      return (data != null ? _i10.Posts.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i11.Post?>()) {
      return (data != null ? _i11.Post.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i12.Town?>()) {
      return (data != null ? _i12.Town.fromJson(data, this) : null) as T;
    }
    ...
    if (t == _i1.getType<_i29.DefaultServerOnlyClass?>()) {
      return (data != null
          ? _i29.DefaultServerOnlyClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i30.DefaultServerOnlyEnum?>()) {
      return (data != null ? _i30.DefaultServerOnlyEnum.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i31.NotServerOnlyClass?>()) {
      return (data != null
          ? _i31.NotServerOnlyClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i32.NotServerOnlyEnum?>()) {
      return (data != null ? _i32.NotServerOnlyEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i33.ServerOnlyClass?>()) {
      return (data != null ? _i33.ServerOnlyClass.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i34.ServerOnlyEnum?>()) {
      return (data != null ? _i34.ServerOnlyEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i35.SimpleData?>()) {
      return (data != null ? _i35.SimpleData.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i36.SimpleDataList?>()) {
      return (data != null ? _i36.SimpleDataList.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i37.SimpleDataMap?>()) {
      return (data != null ? _i37.SimpleDataMap.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i38.SimpleDateTime?>()) {
      return (data != null ? _i38.SimpleDateTime.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i39.TestEnum?>()) {
      return (data != null ? _i39.TestEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i40.Types?>()) {
      return (data != null ? _i40.Types.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<List<_i41.Citizen>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i41.Citizen>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i41.Blocked>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i41.Blocked>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i41.Blocked>?>()) {
      return (data != null
    ...
    if (t == List<_i42.ByteData>) {
      return (data as List).map((e) => deserialize<_i42.ByteData>(e)).toList()
          as dynamic;
    }
    if (t == _i1.getType<List<_i42.ByteData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i42.ByteData>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<_i42.ByteData?>) {
      return (data as List).map((e) => deserialize<_i42.ByteData?>(e)).toList()
    ...
    if (t == Map<String, _i42.ByteData>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i42.ByteData>(v)))
          as dynamic;
    }
    ...
    if (t == List<_i43.Types>) {
      return (data as List).map((e) => deserialize<_i43.Types>(e)).toList()
          as dynamic;
    }
    if (t == List<bool>) {
    ...
    if (t == List<_i46.Citizen>) {
      return (data as List).map((e) => deserialize<_i46.Citizen>(e)).toList()
          as dynamic;
    }
    if (t == List<_i47.Address>) {
      return (data as List).map((e) => deserialize<_i47.Address>(e)).toList()
          as dynamic;
    }
    if (t == List<_i48.Post>) {
      return (data as List).map((e) => deserialize<_i48.Post>(e)).toList()
          as dynamic;
    }
    if (t == List<_i49.Company>) {
      return (data as List).map((e) => deserialize<_i49.Company>(e)).toList()
          as dynamic;
    }
    if (t == List<List<int>>) {
    ...
    if (t == List<_i51.Posts>) {
      return (data as List).map((e) => deserialize<_i51.Posts>(e)).toList()
          as dynamic;
    }
    if (t == Map<String, int>) {
      return (data as Map).map(
    ...
    if (t == Map<_i44.TestEnum, int>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
              deserialize<_i44.TestEnum>(e['k']), deserialize<int>(e['v']))))
          as dynamic;
    }
    if (t == Map<String, _i44.TestEnum>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i44.TestEnum>(v)))
          as dynamic;
    }
    ...
    if (t == _i53.CustomClass) {
      return _i53.CustomClass.fromJson(data, this) as T;
    }
    if (t == _i54.ExternalCustomClass) {
      return _i54.ExternalCustomClass.fromJson(data, this) as T;
    }
    if (t == _i54.FreezedCustomClass) {
      return _i54.FreezedCustomClass.fromJson(data, this) as T;
    }
    if (t == _i1.getType<_i53.CustomClass?>()) {
      return (data != null ? _i53.CustomClass.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i54.ExternalCustomClass?>()) {
      return (data != null
          ? _i54.ExternalCustomClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i54.FreezedCustomClass?>()) {
      return (data != null
          ? _i54.FreezedCustomClass.fromJson(data, this)
          : null) as T;
    }
    try {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i53.CustomClass) {
      return 'CustomClass';
    }
    if (data is _i54.ExternalCustomClass) {
      return 'ExternalCustomClass';
    }
    if (data is _i54.FreezedCustomClass) {
    ...
    if (data is _i8.Blocked) {
      return 'Blocked';
    }
    if (data is _i9.Author) {
      return 'Author';
    }
    if (data is _i10.Posts) {
      return 'Posts';
    }
    if (data is _i11.Post) {
      return 'Post';
    }
    if (data is _i12.Town) {
      return 'Town';
    }
    ...
    if (data is _i29.DefaultServerOnlyClass) {
      return 'DefaultServerOnlyClass';
    }
    if (data is _i30.DefaultServerOnlyEnum) {
      return 'DefaultServerOnlyEnum';
    }
    if (data is _i31.NotServerOnlyClass) {
      return 'NotServerOnlyClass';
    }
    if (data is _i32.NotServerOnlyEnum) {
      return 'NotServerOnlyEnum';
    }
    if (data is _i33.ServerOnlyClass) {
      return 'ServerOnlyClass';
    }
    if (data is _i34.ServerOnlyEnum) {
      return 'ServerOnlyEnum';
    }
    if (data is _i35.SimpleData) {
      return 'SimpleData';
    }
    if (data is _i36.SimpleDataList) {
      return 'SimpleDataList';
    }
    if (data is _i37.SimpleDataMap) {
      return 'SimpleDataMap';
    }
    if (data is _i38.SimpleDateTime) {
      return 'SimpleDateTime';
    }
    if (data is _i39.TestEnum) {
      return 'TestEnum';
    }
    if (data is _i40.Types) {
      return 'Types';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'CustomClass') {
      return deserialize<_i53.CustomClass>(data['data']);
    }
    if (data['className'] == 'ExternalCustomClass') {
      return deserialize<_i54.ExternalCustomClass>(data['data']);
    }
    if (data['className'] == 'FreezedCustomClass') {
      return deserialize<_i54.FreezedCustomClass>(data['data']);
    }
    ...
    if (data['className'] == 'Blocked') {
      return deserialize<_i8.Blocked>(data['data']);
    }
    if (data['className'] == 'Author') {
      return deserialize<_i9.Author>(data['data']);
    }
    if (data['className'] == 'Posts') {
      return deserialize<_i10.Posts>(data['data']);
    }
    if (data['className'] == 'Post') {
      return deserialize<_i11.Post>(data['data']);
    }
    if (data['className'] == 'Town') {
      return deserialize<_i12.Town>(data['data']);
    }
    ...
    if (data['className'] == 'DefaultServerOnlyClass') {
      return deserialize<_i29.DefaultServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'DefaultServerOnlyEnum') {
      return deserialize<_i30.DefaultServerOnlyEnum>(data['data']);
    }
    if (data['className'] == 'NotServerOnlyClass') {
      return deserialize<_i31.NotServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'NotServerOnlyEnum') {
      return deserialize<_i32.NotServerOnlyEnum>(data['data']);
    }
    if (data['className'] == 'ServerOnlyClass') {
      return deserialize<_i33.ServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'ServerOnlyEnum') {
      return deserialize<_i34.ServerOnlyEnum>(data['data']);
    }
    if (data['className'] == 'SimpleData') {
      return deserialize<_i35.SimpleData>(data['data']);
    }
    if (data['className'] == 'SimpleDataList') {
      return deserialize<_i36.SimpleDataList>(data['data']);
    }
    if (data['className'] == 'SimpleDataMap') {
      return deserialize<_i37.SimpleDataMap>(data['data']);
    }
    if (data['className'] == 'SimpleDateTime') {
      return deserialize<_i38.SimpleDateTime>(data['data']);
    }
    if (data['className'] == 'TestEnum') {
      return deserialize<_i39.TestEnum>(data['data']);
    }
    if (data['className'] == 'Types') {
      return deserialize<_i40.Types>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i35.SimpleData:
        return _i35.SimpleData.t;
      case _i38.SimpleDateTime:
        return _i38.SimpleDateTime.t;
      case _i40.Types:
        return _i40.Types.t;
    }
    return null;
