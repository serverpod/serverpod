...
class ObjectWithIndexRepository {
  ...
  /// Find a list of [ObjectWithIndex]s from a table, using the provided [where]
  ...
  /// Find a single [ObjectWithIndex] from a table, using the provided [where]
  ...
  /// Find a single [ObjectWithIndex] by its [id] or null if no such row exists.
  ...
  /// Update all [ObjectWithIndex]s in the list and returns the updated rows. If
