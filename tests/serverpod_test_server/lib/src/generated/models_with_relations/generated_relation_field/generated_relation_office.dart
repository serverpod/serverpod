...
class GeneratedRelationOfficeRepository {
  ...
  /// Emits [GeneratedRelationOffice]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `GeneratedRelationOffice.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<GeneratedRelationOffice>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<GeneratedRelationOfficeTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<GeneratedRelationOffice>(
      where: where?.call(GeneratedRelationOffice.t),
      orderBy: orderBy?.call(GeneratedRelationOffice.t),
      orderByList: orderByList?.call(GeneratedRelationOffice.t),
      limit: limit,
