...
class OrderRepository {
  ...
  /// Updates a single [Order] by its [id] with the specified [columns].
  /// Returns the updated row or null if no row with the given id exists.
  Future<Order?> updateById(
    _i1.Session session,
    int id,
    _i1.ColumnValueListBuilder<OrderTable> columns, {
    _i1.Transaction? transaction,
  }) async {
  ...
  /// Updates all [Order]s matching the [where] expression with the specified [columns].
