...
class FkRelationOfficeRepository {
  ...
  /// Emits [FkRelationOffice]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `FkRelationOffice.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<FkRelationOffice>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<FkRelationOfficeTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<FkRelationOffice>(
      where: where?.call(FkRelationOffice.t),
      orderBy: orderBy?.call(FkRelationOffice.t),
      orderByList: orderByList?.call(FkRelationOffice.t),
      limit: limit,
