...
class FkRelationCompanyRepository {
  ...
  /// Emits [FkRelationCompany]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `FkRelationCompany.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<FkRelationCompany>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<FkRelationCompanyTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<FkRelationCompany>(
      where: where?.call(FkRelationCompany.t),
      orderBy: orderBy?.call(FkRelationCompany.t),
      orderByList: orderByList?.call(FkRelationCompany.t),
      limit: limit,
