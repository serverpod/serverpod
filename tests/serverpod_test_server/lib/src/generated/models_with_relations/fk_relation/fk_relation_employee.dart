...
abstract class FkRelationEmployee
  ...
  static FkRelationEmployeeInclude include({
    ...
    _i2.FkRelationCompanyInclude? previousCompany,
  }) {
  ...
  static FkRelationEmployeeIncludeList includeList({
    _i1.WhereExpressionBuilder<FkRelationEmployeeTable>? where,
    int? limit,
    int? offset,
    _i1.OrderByBuilder<FkRelationEmployeeTable>? orderBy,
    _i1.OrderByListBuilder<FkRelationEmployeeTable>? orderByList,
...
class FkRelationEmployeeUpdateTable
    extends _i1.UpdateTable<FkRelationEmployeeTable> {
  ...
  _i1.ColumnValue<int, int> previousCompanyId(int? value) => _i1.ColumnValue(
    table.previousCompanyId,
    value,
  );
}

class FkRelationEmployeeTable extends _i1.Table<int?> {
  FkRelationEmployeeTable({super.tableRelation})
    ...
    previousCompanyId = _i1.ColumnInt(
      'previousCompanyId',
      this,
    );
  }
  ...
  late final _i1.ColumnInt previousCompanyId;

  _i2.FkRelationCompanyTable? _previousCompany;
  ...
  _i2.FkRelationCompanyTable get previousCompany {
...
class FkRelationEmployeeInclude extends _i1.IncludeObject {
  ...
  _i2.FkRelationCompanyInclude? _previousCompany;
  ...
  @override
  _i1.Table<int?> get table => FkRelationEmployee.t;
}

class FkRelationEmployeeIncludeList extends _i1.IncludeList {
...
class FkRelationEmployeeRepository {
  ...
  Future<List<FkRelationEmployee>> upsert(
    _i1.DatabaseSession session,
    List<FkRelationEmployee> rows, {
    required _i1.ColumnSelections<FkRelationEmployeeTable> conflictColumns,
    _i1.ColumnSelections<FkRelationEmployeeTable>? updateColumns,
    _i1.WhereExpressionBuilder<FkRelationEmployeeTable>? updateWhere,
    _i1.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<List<FkRelationEmployee>> update(
    _i1.DatabaseSession session,
    List<FkRelationEmployee> rows, {
    _i1.ColumnSelections<FkRelationEmployeeTable>? columns,
    _i1.Transaction? transaction,
    bool noReturn = false,
  }) async {
  ...
  Future<FkRelationEmployee?> updateById(
    _i1.DatabaseSession session,
    int id, {
    required _i1.ColumnValueListBuilder<FkRelationEmployeeUpdateTable>
    columnValues,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<List<FkRelationEmployee>> updateWhere(
    ...
    required _i1.ColumnValueListBuilder<FkRelationEmployeeUpdateTable>
    columnValues,
    required _i1.WhereExpressionBuilder<FkRelationEmployeeTable> where,
    int? limit,
    int? offset,
    _i1.OrderByBuilder<FkRelationEmployeeTable>? orderBy,
    _i1.OrderByListBuilder<FkRelationEmployeeTable>? orderByList,
