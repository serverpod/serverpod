...
class EmptyModelRelationItemRepository {
  ...
  /// Emits [EmptyModelRelationItem]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `EmptyModelRelationItem.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<EmptyModelRelationItem>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<EmptyModelRelationItemTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<EmptyModelRelationItem>(
      where: where?.call(EmptyModelRelationItem.t),
      orderBy: orderBy?.call(EmptyModelRelationItem.t),
      orderByList: orderByList?.call(EmptyModelRelationItem.t),
      limit: limit,
