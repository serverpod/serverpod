...
class ObjectWithGeographyLineStringRepository {
  ...
  /// Emits [ObjectWithGeographyLineString]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithGeographyLineString.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithGeographyLineString>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithGeographyLineStringTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectWithGeographyLineString>(
      where: where?.call(ObjectWithGeographyLineString.t),
      orderBy: orderBy?.call(ObjectWithGeographyLineString.t),
      orderByList: orderByList?.call(ObjectWithGeographyLineString.t),
      limit: limit,
