...
class ObjectWithEnumEnhancedRepository {
  ...
  /// Emits [ObjectWithEnumEnhanced]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `ObjectWithEnumEnhanced.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<ObjectWithEnumEnhanced>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<ObjectWithEnumEnhancedTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<ObjectWithEnumEnhanced>(
      where: where?.call(ObjectWithEnumEnhanced.t),
      orderBy: orderBy?.call(ObjectWithEnumEnhanced.t),
      orderByList: orderByList?.call(ObjectWithEnumEnhanced.t),
      limit: limit,
