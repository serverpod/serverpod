...
class TypesRepository {
  ...
  /// Returns a list of [Types]s with distances matching the given query parameters.
  ///
  ...
  /// );
  /// ```
  Future<List<_i1.RowWithDistance<Types>>> findWithDistance(
    _i1.Session session, {
    required _i1.DistanceBuilder<TypesTable> distance,
    _i1.WhereExpressionBuilder<TypesTable>? where,
    int? limit,
    int? offset,
    _i1.OrderByBuilder<TypesTable>? orderBy,
    ...
    return session.db.findWithDistance<Types>(
      distance: distance(Types.t),
      where: where?.call(Types.t),
      orderBy: orderBy?.call(Types.t),
      orderByList: orderByList?.call(Types.t),
      orderDescending: orderDescending,
