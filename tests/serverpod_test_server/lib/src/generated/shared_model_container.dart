...
abstract class SharedModelContainer
  ...
  SharedModelContainer copyWith({
    ...
    _ilwf0zl1.SharedModel? nonPersistedSharedModel =
        const _UndefinedSharedModelContainer$nonPersistedSharedModel(),
    _ilwf0zl1.SharedModel? serverOnlySharedModel =
        const _UndefinedSharedModelContainer$serverOnlySharedModel(),
    _ilwf0zl1.SharedSubclass? sharedSubclass,
    _ilwf0zl1.SharedSubclass? sharedSubclassNullable =
...
class _UndefinedSharedModelContainer$nonPersistedSharedModel
    extends _is.UndefinedSentinel
    implements _ilwf0zl1.SharedModel {
  const _UndefinedSharedModelContainer$nonPersistedSharedModel();
}

class _UndefinedSharedModelContainer$serverOnlySharedModel
    extends _is.UndefinedSentinel
    implements _ilwf0zl1.SharedModel {
  const _UndefinedSharedModelContainer$serverOnlySharedModel();
}
...
class SharedModelContainerRepository {
  ...
  /// Emits [SharedModelContainer]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `SharedModelContainer.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<SharedModelContainer>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<SharedModelContainerTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<SharedModelContainer>(
      where: where?.call(SharedModelContainer.t),
      orderBy: orderBy?.call(SharedModelContainer.t),
      orderByList: orderByList?.call(SharedModelContainer.t),
      limit: limit,
