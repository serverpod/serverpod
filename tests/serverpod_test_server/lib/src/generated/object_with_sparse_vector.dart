...
class ObjectWithSparseVectorTable extends _i1.Table<int?> {
  ObjectWithSparseVectorTable({super.tableRelation})
    ...
    sparseVector = _i1.ColumnSparseVector('sparseVector', this, dimension: 512);
