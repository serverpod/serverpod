...
/app/tests/docker/tests_e2e_migrations/wait-for-it.sh serverpod_test_sqlite_server:8080 -t 60 -- echo "### Server main is UP"
/app/tests/docker/tests_e2e_migrations/wait-for-it.sh serverpod_test_sqlite_server:8081 -t 60 -- echo "### Server insights is UP"
echo ""
