  ...
  T deserialize<T>(
    ...
    if (t ==
        _i1.getType<
            List<
                (
                  (int, String), {
                  (_i145.SimpleData, double) namedSubRecord
                })?>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<
    ...
    if (t ==
        _i1.getType<
            (
              String,
              (Map<String, int>, {bool flag, _i145.SimpleData simpleData})
            )>()) {
      return (
        deserialize<String>(((data as Map)['p'] as List)[0]),
        deserialize<
    ...
    if (t ==
      ...
      return (
        ...
        simpleData: deserialize<_i145.SimpleData>(data['n']['simpleData']),
      ) as T;
    }
...
Map<String, dynamic>? mapRecordToJson(Record? record) {
  ...
  if (record is (Map<String, int>, {bool flag, _i145.SimpleData simpleData})) {
    return {
      "p": [
        record.$1,
      ],
