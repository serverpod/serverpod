...
import 'package:serverpod_test_client/src/protocol/inheritance/polymorphism/parent.dart'
    as _i189;
import 'package:serverpod_test_client/src/protocol/types.dart' as _i190;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<(String, _i189.PolymorphicParent)>()) {
      return (
            deserialize<String>(((data as Map)['p'] as List)[0]),
            deserialize<_i189.PolymorphicParent>(data['p'][1]),
          )
          as T;
    }
    if (t == _i1.getType<(int,)>()) {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is (String, _i189.PolymorphicParent)) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == '(String,PolymorphicParent)') {
      return deserialize<(String, _i189.PolymorphicParent)>(data['data']);
    }
...
Map<String, dynamic>? mapRecordToJson(Record? record) {
  ...
  if (record is (String, _i189.PolymorphicParent)) {
    return {
      "p": [
        record.$1,
        record.$2.toJson(),
