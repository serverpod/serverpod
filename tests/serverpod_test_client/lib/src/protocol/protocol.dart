...
import 'entities_with_relations/one_to_many/1_comment.dart' as _i7;
import 'entities_with_relations/one_to_many/2_order.dart' as _i8;
import 'entities_with_relations/one_to_many/3_customer.dart' as _i9;
...
import 'simple_data_map.dart' as _i29;
import 'simple_date_time.dart' as _i30;
import 'test_enum.dart' as _i31;
import 'types.dart' as _i32;
import 'protocol.dart' as _i33;
import 'package:serverpod_test_module_client/module.dart' as _i34;
import 'dart:typed_data' as _i35;
import 'package:serverpod_test_client/src/protocol/types.dart' as _i36;
import 'package:serverpod_test_client/src/protocol/test_enum.dart' as _i37;
...
import 'package:serverpod_test_client/src/protocol/entities_with_relations/deep_nested_relation/company.dart'
    as _i42;
import 'package:serverpod_test_client/src/protocol/simple_data.dart' as _i43;
import 'package:serverpod_test_client/src/protocol/entities_with_relations/one_to_many/3_customer.dart'
    as _i44;
import 'package:serverpod_test_client/src/custom_classes.dart' as _i45;
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i46;
import 'package:serverpod_auth_client/module.dart' as _i47;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.Order) {
      return _i8.Order.fromJson(data, this) as T;
    }
    if (t == _i9.Customer) {
    ...
    if (t == _i29.SimpleDataMap) {
      return _i29.SimpleDataMap.fromJson(data, this) as T;
    }
    if (t == _i30.SimpleDateTime) {
      return _i30.SimpleDateTime.fromJson(data, this) as T;
    }
    if (t == _i31.TestEnum) {
      return _i31.TestEnum.fromJson(data) as T;
    }
    if (t == _i32.Types) {
      return _i32.Types.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i8.Order?>()) {
      return (data != null ? _i8.Order.fromJson(data, this) : null) as T;
    }
    ...
    if (t == _i1.getType<_i29.SimpleDataMap?>()) {
      return (data != null ? _i29.SimpleDataMap.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i30.SimpleDateTime?>()) {
      return (data != null ? _i30.SimpleDateTime.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i31.TestEnum?>()) {
      return (data != null ? _i31.TestEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i32.Types?>()) {
      return (data != null ? _i32.Types.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<List<_i33.Citizen>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i33.Citizen>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i33.Comment>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i33.Comment>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i33.Order>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i33.Order>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i34.ModuleClass>) {
      return (data as List)
          .map((e) => deserialize<_i34.ModuleClass>(e))
          .toList() as dynamic;
    }
    if (t == Map<String, _i34.ModuleClass>) {
      return (data as Map).map((k, v) => MapEntry(
          deserialize<String>(k), deserialize<_i34.ModuleClass>(v))) as dynamic;
    }
    if (t == List<int>) {
    ...
    if (t == _i1.getType<List<_i35.ByteData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i35.ByteData>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<_i35.ByteData?>) {
      return (data as List).map((e) => deserialize<_i35.ByteData?>(e)).toList()
    ...
    if (t == List<_i33.TestEnum>) {
      return (data as List).map((e) => deserialize<_i33.TestEnum>(e)).toList()
          as dynamic;
    }
    if (t == List<_i33.TestEnum?>) {
      return (data as List).map((e) => deserialize<_i33.TestEnum?>(e)).toList()
    ...
    if (t == List<List<_i33.TestEnum>>) {
      return (data as List)
          .map((e) => deserialize<List<_i33.TestEnum>>(e))
          .toList() as dynamic;
    }
    ...
    if (t == Map<String, _i35.ByteData>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i35.ByteData>(v)))
          as dynamic;
    }
    ...
    if (t == List<_i36.Types>) {
      return (data as List).map((e) => deserialize<_i36.Types>(e)).toList()
          as dynamic;
    }
    if (t == List<bool>) {
    ...
    if (t == List<_i37.TestEnum>) {
      return (data as List).map((e) => deserialize<_i37.TestEnum>(e)).toList()
          as dynamic;
    }
    if (t == List<int>) {
      return (data as List).map((e) => deserialize<int>(e)).toList() as dynamic;
    ...
    if (t == List<_i38.UuidValue>) {
      return (data as List).map((e) => deserialize<_i38.UuidValue>(e)).toList()
          as dynamic;
    }
    if (t == List<_i39.Citizen>) {
      return (data as List).map((e) => deserialize<_i39.Citizen>(e)).toList()
          as dynamic;
    }
    if (t == List<_i40.Address>) {
      return (data as List).map((e) => deserialize<_i40.Address>(e)).toList()
          as dynamic;
    }
    if (t == List<_i41.Post>) {
      return (data as List).map((e) => deserialize<_i41.Post>(e)).toList()
          as dynamic;
    }
    if (t == List<_i42.Company>) {
      return (data as List).map((e) => deserialize<_i42.Company>(e)).toList()
          as dynamic;
    }
    if (t == List<List<int>>) {
    ...
    if (t == _i1.getType<Map<String, _i43.SimpleData>?>()) {
      return (data != null
          ? (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i43.SimpleData>(v)))
          : null) as dynamic;
    ...
    if (t == _i1.getType<Map<String, _i43.SimpleData?>?>()) {
      return (data != null
          ? (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<_i43.SimpleData?>(v)))
          : null) as dynamic;
    }
    if (t == _i1.getType<Map<String, _i43.SimpleData?>?>()) {
      return (data != null
    ...
    if (t == List<_i44.Customer>) {
      return (data as List).map((e) => deserialize<_i44.Customer>(e)).toList()
          as dynamic;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i29.SimpleDataMap) {
      return 'SimpleDataMap';
    }
    if (data is _i30.SimpleDateTime) {
      return 'SimpleDateTime';
    }
    if (data is _i31.TestEnum) {
      return 'TestEnum';
    }
    if (data is _i32.Types) {
      return 'Types';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'SimpleDataMap') {
      return deserialize<_i29.SimpleDataMap>(data['data']);
    }
    if (data['className'] == 'SimpleDateTime') {
      return deserialize<_i30.SimpleDateTime>(data['data']);
    }
    if (data['className'] == 'TestEnum') {
      return deserialize<_i31.TestEnum>(data['data']);
    }
    if (data['className'] == 'Types') {
      return deserialize<_i32.Types>(data['data']);
    }
