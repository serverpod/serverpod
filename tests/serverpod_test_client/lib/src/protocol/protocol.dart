...
import 'package:serverpod_test_client/src/protocol/entities_with_relations/one_to_one/company.dart'
    as _i49;
import 'package:serverpod_test_client/src/custom_classes.dart' as _i50;
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i51;
import 'package:serverpod_auth_client/module.dart' as _i52;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i43.Customer>) {
      return (data as List).map((e) => deserialize<_i43.Customer>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i45.Order>) {
      return (data as List).map((e) => deserialize<_i45.Order>(e)).toList()
          as dynamic;
    }
    ...
    if (t == _i50.CustomClass) {
      return _i50.CustomClass.fromJson(data, this) as T;
    }
    if (t == _i51.ExternalCustomClass) {
      return _i51.ExternalCustomClass.fromJson(data, this) as T;
    }
    if (t == _i51.FreezedCustomClass) {
      return _i51.FreezedCustomClass.fromJson(data, this) as T;
    }
    if (t == _i1.getType<_i50.CustomClass?>()) {
      return (data != null ? _i50.CustomClass.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i51.ExternalCustomClass?>()) {
      return (data != null
          ? _i51.ExternalCustomClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i51.FreezedCustomClass?>()) {
      return (data != null
          ? _i51.FreezedCustomClass.fromJson(data, this)
          : null) as T;
    }
    try {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i50.CustomClass) {
      return 'CustomClass';
    }
    if (data is _i51.ExternalCustomClass) {
      return 'ExternalCustomClass';
    }
    if (data is _i51.FreezedCustomClass) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'CustomClass') {
      return deserialize<_i50.CustomClass>(data['data']);
    }
    if (data['className'] == 'ExternalCustomClass') {
      return deserialize<_i51.ExternalCustomClass>(data['data']);
    }
    if (data['className'] == 'FreezedCustomClass') {
      return deserialize<_i51.FreezedCustomClass>(data['data']);
    }
