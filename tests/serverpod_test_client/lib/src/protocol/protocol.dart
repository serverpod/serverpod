...
import 'object_with_postgis.dart' as _i158;
...
import 'package:serverpod_test_client/src/protocol/simple_data.dart' as _i197;
import 'package:serverpod_test_client/src/protocol/test_enum.dart' as _i198;
import 'package:serverpod_auth_client/serverpod_auth_client.dart' as _i199;
import 'package:serverpod_test_client/src/protocol/inheritance/polymorphism/parent.dart'
    as _i200;
import 'package:serverpod_test_client/src/protocol/types.dart' as _i201;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i158.ObjectWithPostgis) {
      return _i158.ObjectWithPostgis.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i158.ObjectWithPostgis?>()) {
      return (data != null ? _i158.ObjectWithPostgis.fromJson(data) : null)
          as T;
    }
    ...
    if (t == List<_i194.ModulePolymorphicChild>) {
      return (data as List)
              .map((e) => deserialize<_i194.ModulePolymorphicChild>(e))
              .toList()
          as T;
    }
    if (t == Map<String, _i194.ModulePolymorphicChild>) {
      return (data as Map).map(
            (k, v) => MapEntry(
              deserialize<String>(k),
              deserialize<_i194.ModulePolymorphicChild>(v),
            ),
          )
          as T;
    }
    ...
    if (t == List<_i194.ModuleClass>) {
      return (data as List)
              .map((e) => deserialize<_i194.ModuleClass>(e))
              .toList()
          as T;
    }
    if (t == Map<String, _i194.ModuleClass>) {
      return (data as Map).map(
            (k, v) => MapEntry(
              deserialize<String>(k),
              deserialize<_i194.ModuleClass>(v),
            ),
          )
          as T;
    }
    if (t == _i1.getType<(_i194.ModuleClass,)?>()) {
      return (data == null)
          ? null as T
          : (deserialize<_i194.ModuleClass>(((data as Map)['p'] as List)[0]),)
                as T;
    }
    if (t == List<int>) {
    ...
    if (t == _i1.getType<({_i194.ModuleClass value})?>()) {
      return (data == null)
          ? null as T
          : (
                  value: deserialize<_i194.ModuleClass>(
                    ((data as Map)['n'] as Map)['value'],
                  ),
                )
                as T;
    ...
    if (t == List<_i199.UserInfo>) {
      return (data as List).map((e) => deserialize<_i199.UserInfo>(e)).toList()
          as T;
    }
    if (t == Set<int>) {
      return (data as List).map((e) => deserialize<int>(e)).toSet() as T;
    ...
    if (t == _i1.getType<(int?, _i194.ProjectStreamingClass?)>()) {
      return (
            ((data as Map)['p'] as List)[0] == null
                ? null
                : deserialize<int>(data['p'][0]),
            ((data)['p'] as List)[1] == null
                ? null
                : deserialize<_i194.ProjectStreamingClass>(data['p'][1]),
          )
          as T;
    }
    if (t == Set<Set<int>>) {
    ...
    try {
      return _i194.Protocol().deserialize<T>(data, t);
    } on _i1.DeserializationTypeNotFoundException catch (_) {}
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i158.ObjectWithPostgis => 'ObjectWithPostgis',
      ...
      _i186.TestEnumStringified => 'TestEnumStringified',
      _i187.Types => 'Types',
      _i188.TypesList => 'TypesList',
      _i189.TypesMap => 'TypesMap',
      _i190.TypesRecord => 'TypesRecord',
      _i191.TypesSet => 'TypesSet',
      _i192.TypesSetRequired => 'TypesSetRequired',
      _i193.UniqueData => 'UniqueData',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    className = _i199.Protocol().getClassNameForObject(data);
    if (className != null) {
      return 'serverpod_auth.$className';
    }
    className = _i194.Protocol().getClassNameForObject(data);
    if (className != null) {
    ...
    if (data is List<_i199.UserInfo>) {
    ...
    if (data is (int?, _i194.ProjectStreamingClass?)) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ObjectWithPostgis') {
      return deserialize<_i158.ObjectWithPostgis>(data['data']);
    }
    ...
    if (dataClassName.startsWith('serverpod_auth.')) {
      ...
      return _i199.Protocol().deserializeByClassName(data);
    }
    if (dataClassName.startsWith('serverpod_test_module.')) {
      data['className'] = dataClassName.substring(22);
      return _i194.Protocol().deserializeByClassName(data);
    }
    ...
    if (dataClassName == 'List<serverpod_auth.UserInfo>') {
      return deserialize<List<_i199.UserInfo>>(data['data']);
    }
    if (dataClassName == 'List<SimpleData>?') {
      return deserialize<List<_i197.SimpleData>?>(data['data']);
    }
    ...
    if (dataClassName ==
      ...
      return deserialize<(int?, _i194.ProjectStreamingClass?)>(data['data']);
    }
    if (dataClassName ==
  ...
  Map<String, dynamic>? mapRecordToJson(Record? record) {
    ...
    if (record
        is ((int, String), {(_i197.SimpleData, double) namedSubRecord})) {
      return {
        "p": [
    ...
    if (record is (int?, _i194.ProjectStreamingClass?)) {
      return {
        "p": [
          record.$1,
          record.$2?.toJson(),
    ...
    if (record
        is (Map<String, int>, {bool flag, _i197.SimpleData simpleData})) {
      return {
        "p": [
          record.$1.toJson(),
        ],
    ...
    if (record is (_i194.ModuleClass,)) {
      return {
        "p": [
          record.$1.toJson(),
        ],
    ...
    if (record is ({_i194.ModuleClass value})) {
      return {
        "n": {
          "value": record.value,
        },
    ...
    try {
      return _i199.Protocol().mapRecordToJson(record);
    } catch (_) {}
    try {
      return _i194.Protocol().mapRecordToJson(record);
    } catch (_) {}
