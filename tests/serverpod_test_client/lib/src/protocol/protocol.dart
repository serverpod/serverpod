...
import 'defaults/uri/uri_default.dart' as _i35;
import 'defaults/uri/uri_default_mix.dart' as _i36;
import 'defaults/uri/uri_default_model.dart' as _i37;
import 'defaults/uri/uri_default_persist.dart' as _i38;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i35.UriDefault) {
      return _i35.UriDefault.fromJson(data) as T;
    }
    if (t == _i36.UriDefaultMix) {
      return _i36.UriDefaultMix.fromJson(data) as T;
    }
    if (t == _i37.UriDefaultModel) {
      return _i37.UriDefaultModel.fromJson(data) as T;
    }
    if (t == _i38.UriDefaultPersist) {
      return _i38.UriDefaultPersist.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i35.UriDefault?>()) {
      return (data != null ? _i35.UriDefault.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i36.UriDefaultMix?>()) {
      return (data != null ? _i36.UriDefaultMix.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i37.UriDefaultModel?>()) {
      return (data != null ? _i37.UriDefaultModel.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i38.UriDefaultPersist?>()) {
      return (data != null ? _i38.UriDefaultPersist.fromJson(data) : null) as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i35.UriDefault) {
      return 'UriDefault';
    }
    if (data is _i36.UriDefaultMix) {
      return 'UriDefaultMix';
    }
    if (data is _i37.UriDefaultModel) {
      return 'UriDefaultModel';
    }
    if (data is _i38.UriDefaultPersist) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'UriDefault') {
      return deserialize<_i35.UriDefault>(data['data']);
    }
    if (dataClassName == 'UriDefaultMix') {
      return deserialize<_i36.UriDefaultMix>(data['data']);
    }
    if (dataClassName == 'UriDefaultModel') {
      return deserialize<_i37.UriDefaultModel>(data['data']);
    }
    if (dataClassName == 'UriDefaultPersist') {
      return deserialize<_i38.UriDefaultPersist>(data['data']);
    }
