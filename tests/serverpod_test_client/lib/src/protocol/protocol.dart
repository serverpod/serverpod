...
import 'package:serverpod_test_client/src/protocol/entities_with_relations/post.dart'
    as _i36;
import 'package:serverpod_test_client/src/protocol/simple_data.dart' as _i37;
import 'package:serverpod_test_client/src/protocol/test_enum.dart' as _i38;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i33.SimpleDateTime>) {
      return (data as List)
          .map((e) => deserialize<_i33.SimpleDateTime>(e))
          .toList() as dynamic;
    }
    if (t == List<int>) {
      return (data as List).map((e) => deserialize<int>(e)).toList() as dynamic;
    }
    if (t == List<_i34.Citizen>) {
      return (data as List).map((e) => deserialize<_i34.Citizen>(e)).toList()
          as dynamic;
    }
    if (t == List<_i35.Address>) {
      return (data as List).map((e) => deserialize<_i35.Address>(e)).toList()
          as dynamic;
    }
    if (t == List<_i36.Post>) {
      return (data as List).map((e) => deserialize<_i36.Post>(e)).toList()
          as dynamic;
    }
    if (t == List<List<int>>) {
    ...
    if (t == _i1.getType<Map<String, _i37.SimpleData>?>()) {
      return (data != null
          ? (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i37.SimpleData>(v)))
          : null) as dynamic;
    ...
    if (t == _i1.getType<Map<String, _i37.SimpleData?>?>()) {
      return (data != null
          ? (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<_i37.SimpleData?>(v)))
          : null) as dynamic;
    }
    if (t == _i1.getType<Map<String, _i37.SimpleData?>?>()) {
      return (data != null
