...
import 'extra_data_simple.dart' as _i3;
...
import 'package:serverpod_test_client/src/protocol/simple_data.dart' as _i25;
import 'package:serverpod_test_client/src/protocol/test_enum.dart' as _i26;
import 'package:serverpod_test_client/src/custom_classes.dart' as _i27;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i3.ExtraDataSimple) {
      return _i3.ExtraDataSimple.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i3.ExtraDataSimple?>()) {
      return (data != null ? _i3.ExtraDataSimple.fromJson(data, this) : null)
          as T;
    }
    ...
    if (t == List<_i24.ByteData>) {
      return (data as List).map((e) => deserialize<_i24.ByteData>(e)).toList()
          as dynamic;
    }
    if (t == _i1.getType<List<_i24.ByteData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i24.ByteData>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<_i24.ByteData?>) {
      return (data as List).map((e) => deserialize<_i24.ByteData?>(e)).toList()
    ...
    if (t == List<_i23.TestEnum>) {
      return (data as List).map((e) => deserialize<_i23.TestEnum>(e)).toList()
          as dynamic;
    }
    if (t == List<_i23.TestEnum?>) {
      return (data as List).map((e) => deserialize<_i23.TestEnum?>(e)).toList()
    ...
    if (t == List<List<_i23.TestEnum>>) {
      return (data as List)
          .map((e) => deserialize<List<_i23.TestEnum>>(e))
          .toList() as dynamic;
    }
    ...
    if (t == Map<String, _i24.ByteData>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i24.ByteData>(v)))
          as dynamic;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i3.ExtraDataSimple) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'ExtraDataSimple') {
      return deserialize<_i3.ExtraDataSimple>(data['data']);
    }
