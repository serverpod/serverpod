...
import 'view/citizen_employment_view.dart' as _i48;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i48.CitizenEmploymentView) {
      return _i48.CitizenEmploymentView.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i48.CitizenEmploymentView?>()) {
      return (data != null
          ? _i48.CitizenEmploymentView.fromJson(data, this)
          : null) as T;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i48.CitizenEmploymentView) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'CitizenEmploymentView') {
      return deserialize<_i48.CitizenEmploymentView>(data['data']);
    }
