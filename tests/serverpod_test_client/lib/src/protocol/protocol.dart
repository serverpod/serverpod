...
import 'serverOnly/default_server_only_class.dart' as _i10;
import 'serverOnly/default_server_only_enum.dart' as _i11;
import 'serverOnly/not_server_only_class.dart' as _i12;
import 'serverOnly/not_server_only_enum.dart' as _i13;
import 'simple_data.dart' as _i14;
import 'simple_data_list.dart' as _i15;
import 'test_enum.dart' as _i16;
import 'types.dart' as _i17;
...
import 'package:serverpod_test_client/src/custom_classes.dart' as _i22;
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i23;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i10.DefaultServerOnlyClass) {
      return _i10.DefaultServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i11.DefaultServerOnlyEnum) {
      return _i11.DefaultServerOnlyEnum.fromJson(data) as T;
    }
    if (t == _i12.NotServerOnlyClass) {
      return _i12.NotServerOnlyClass.fromJson(data, this) as T;
    }
    if (t == _i13.NotServerOnlyEnum) {
      return _i13.NotServerOnlyEnum.fromJson(data) as T;
    }
    if (t == _i14.SimpleData) {
      return _i14.SimpleData.fromJson(data, this) as T;
    }
    if (t == _i15.SimpleDataList) {
      return _i15.SimpleDataList.fromJson(data, this) as T;
    }
    if (t == _i16.TestEnum) {
      return _i16.TestEnum.fromJson(data) as T;
    }
    if (t == _i17.Types) {
      return _i17.Types.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i10.DefaultServerOnlyClass?>()) {
      return (data != null
          ? _i10.DefaultServerOnlyClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i11.DefaultServerOnlyEnum?>()) {
      return (data != null ? _i11.DefaultServerOnlyEnum.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i12.NotServerOnlyClass?>()) {
      return (data != null
          ? _i12.NotServerOnlyClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i13.NotServerOnlyEnum?>()) {
      return (data != null ? _i13.NotServerOnlyEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i14.SimpleData?>()) {
      return (data != null ? _i14.SimpleData.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i15.SimpleDataList?>()) {
      return (data != null ? _i15.SimpleDataList.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i16.TestEnum?>()) {
      return (data != null ? _i16.TestEnum.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i17.Types?>()) {
      return (data != null ? _i17.Types.fromJson(data, this) : null) as T;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i18.SimpleData>) {
      return (data as List).map((e) => deserialize<_i18.SimpleData>(e)).toList()
          as dynamic;
    }
    if (t == _i1.getType<List<_i18.SimpleData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i18.SimpleData>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<_i18.SimpleData?>) {
      return (data as List)
          .map((e) => deserialize<_i18.SimpleData?>(e))
          .toList() as dynamic;
    }
    if (t == _i1.getType<List<_i18.SimpleData?>?>()) {
      return (data != null
    ...
    if (t == List<_i19.ByteData>) {
      return (data as List).map((e) => deserialize<_i19.ByteData>(e)).toList()
          as dynamic;
    }
    if (t == _i1.getType<List<_i19.ByteData>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i19.ByteData>(e)).toList()
          : null) as dynamic;
    }
    if (t == List<_i19.ByteData?>) {
      return (data as List).map((e) => deserialize<_i19.ByteData?>(e)).toList()
    ...
    if (t == List<_i18.TestEnum>) {
      return (data as List).map((e) => deserialize<_i18.TestEnum>(e)).toList()
          as dynamic;
    }
    if (t == List<_i18.TestEnum?>) {
      return (data as List).map((e) => deserialize<_i18.TestEnum?>(e)).toList()
    ...
    if (t == List<List<_i18.TestEnum>>) {
      return (data as List)
          .map((e) => deserialize<List<_i18.TestEnum>>(e))
          .toList() as dynamic;
    }
    if (t == Map<String, _i18.SimpleData>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i18.SimpleData>(v)))
          as dynamic;
    }
    ...
    if (t == Map<String, _i19.ByteData>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i19.ByteData>(v)))
          as dynamic;
    }
    ...
    if (t == Map<String, _i18.SimpleData?>) {
      return (data as Map).map((k, v) => MapEntry(
          deserialize<String>(k), deserialize<_i18.SimpleData?>(v))) as dynamic;
    }
    if (t == Map<String, String?>) {
      return (data as Map).map((k, v) =>
          MapEntry(deserialize<String>(k), deserialize<String?>(v))) as dynamic;
    ...
    if (t == Map<_i21.TestEnum, int>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
              deserialize<_i21.TestEnum>(e['k']), deserialize<int>(e['v']))))
          as dynamic;
    }
    if (t == Map<String, _i21.TestEnum>) {
      return (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i21.TestEnum>(v)))
          as dynamic;
    }
    ...
    if (t == _i1.getType<Map<String, _i20.SimpleData>?>()) {
      return (data != null
          ? (data as Map).map((k, v) =>
              MapEntry(deserialize<String>(k), deserialize<_i20.SimpleData>(v)))
          : null) as dynamic;
    ...
    if (t == _i1.getType<Map<String, _i20.SimpleData?>?>()) {
      return (data != null
          ? (data as Map).map((k, v) => MapEntry(
              deserialize<String>(k), deserialize<_i20.SimpleData?>(v)))
          : null) as dynamic;
    }
    if (t == _i1.getType<Map<String, _i20.SimpleData?>?>()) {
      return (data != null
    ...
    if (t == _i22.CustomClass) {
      return _i22.CustomClass.fromJson(data, this) as T;
    }
    if (t == _i23.ExternalCustomClass) {
      return _i23.ExternalCustomClass.fromJson(data, this) as T;
    }
    if (t == _i23.FreezedCustomClass) {
      return _i23.FreezedCustomClass.fromJson(data, this) as T;
    }
    if (t == _i1.getType<_i22.CustomClass?>()) {
      return (data != null ? _i22.CustomClass.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i23.ExternalCustomClass?>()) {
      return (data != null
          ? _i23.ExternalCustomClass.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i23.FreezedCustomClass?>()) {
      return (data != null
          ? _i23.FreezedCustomClass.fromJson(data, this)
          : null) as T;
    }
    try {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i22.CustomClass) {
      return 'CustomClass';
    }
    if (data is _i23.ExternalCustomClass) {
    ...
    if (data is _i10.DefaultServerOnlyClass) {
      return 'DefaultServerOnlyClass';
    }
    if (data is _i11.DefaultServerOnlyEnum) {
      return 'DefaultServerOnlyEnum';
    }
    if (data is _i12.NotServerOnlyClass) {
      return 'NotServerOnlyClass';
    }
    if (data is _i13.NotServerOnlyEnum) {
      return 'NotServerOnlyEnum';
    }
    if (data is _i14.SimpleData) {
      return 'SimpleData';
    }
    if (data is _i15.SimpleDataList) {
      return 'SimpleDataList';
    }
    if (data is _i16.TestEnum) {
      return 'TestEnum';
    }
    if (data is _i17.Types) {
      return 'Types';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'CustomClass') {
      return deserialize<_i22.CustomClass>(data['data']);
    }
    if (data['className'] == 'ExternalCustomClass') {
      return deserialize<_i23.ExternalCustomClass>(data['data']);
    }
    ...
    if (data['className'] == 'DefaultServerOnlyClass') {
      return deserialize<_i10.DefaultServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'DefaultServerOnlyEnum') {
      return deserialize<_i11.DefaultServerOnlyEnum>(data['data']);
    }
    if (data['className'] == 'NotServerOnlyClass') {
      return deserialize<_i12.NotServerOnlyClass>(data['data']);
    }
    if (data['className'] == 'NotServerOnlyEnum') {
      return deserialize<_i13.NotServerOnlyEnum>(data['data']);
    }
    if (data['className'] == 'SimpleData') {
      return deserialize<_i14.SimpleData>(data['data']);
    }
    if (data['className'] == 'SimpleDataList') {
      return deserialize<_i15.SimpleDataList>(data['data']);
    }
    if (data['className'] == 'TestEnum') {
      return deserialize<_i16.TestEnum>(data['data']);
    }
    if (data['className'] == 'Types') {
      return deserialize<_i17.Types>(data['data']);
    }
