...
import 'models_with_relations/one_to_many/implicit/book.dart' as _i84;
import 'models_with_relations/one_to_many/implicit/chapter.dart' as _i85;
...
import 'types_record.dart' as _i129;
import 'types_set.dart' as _i130;
import 'types_set_required.dart' as _i131;
...
import 'package:serverpod_test_client/src/protocol/simple_data.dart' as _i137;
import 'package:serverpod_test_client/src/protocol/test_enum.dart' as _i138;
import 'package:serverpod_auth_client/serverpod_auth_client.dart' as _i139;
import 'package:serverpod_test_client/src/protocol/types.dart' as _i140;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i84.Book) {
      return _i84.Book.fromJson(data) as T;
    }
    if (t == _i85.Chapter) {
      return _i85.Chapter.fromJson(data) as T;
    }
    if (t == _i86.Order) {
    ...
    if (t == _i109.Record) {
      return _i109.Record.fromJson(data) as T;
    }
    ...
    if (t == _i129.TypesRecord) {
      return _i129.TypesRecord.fromJson(data) as T;
    }
    if (t == _i130.TypesSet) {
      return _i130.TypesSet.fromJson(data) as T;
    }
    if (t == _i131.TypesSetRequired) {
      return _i131.TypesSetRequired.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i84.Book?>()) {
      return (data != null ? _i84.Book.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i85.Chapter?>()) {
      return (data != null ? _i85.Chapter.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i109.Record?>()) {
      return (data != null ? _i109.Record.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i129.TypesRecord?>()) {
      return (data != null ? _i129.TypesRecord.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i130.TypesSet?>()) {
      return (data != null ? _i130.TypesSet.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i131.TypesSetRequired?>()) {
      return (data != null ? _i131.TypesSetRequired.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<List<_i85.Chapter>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i85.Chapter>(e)).toList()
          : null) as T;
    }
    ...
    if (t == List<_i134.ModuleClass>) {
      return (data as List)
          .map((e) => deserialize<_i134.ModuleClass>(e))
          .toList() as T;
    }
    if (t == Map<String, _i134.ModuleClass>) {
      return (data as Map).map((k, v) => MapEntry(
          deserialize<String>(k), deserialize<_i134.ModuleClass>(v))) as T;
    }
    if (t == _i1.getType<(_i134.ModuleClass,)?>()) {
      return (data == null)
          ? null as T
          : (deserialize<_i134.ModuleClass>(((data as Map)['p'] as List)[0]),)
              as T;
    }
    if (t == List<int>) {
    ...
    if (t == Map<String, _i119.SimpleData>) {
      return (data as Map).map((k, v) => MapEntry(
          deserialize<String>(k), deserialize<_i119.SimpleData>(v))) as T;
    }
    ...
    if (t == Map<String, _i126.Types>) {
      return (data as Map).map((k, v) =>
          MapEntry(deserialize<String>(k), deserialize<_i126.Types>(v))) as T;
    }
    ...
    if (t == Map<_i126.Types, String>) {
      return Map.fromEntries((data as List).map((e) => MapEntry(
          deserialize<_i126.Types>(e['k']), deserialize<String>(e['v'])))) as T;
    }
    ...
    if (t == _i1.getType<(_i124.TestEnum,)?>()) {
      return (data == null)
          ? null as T
          : (deserialize<_i124.TestEnum>(((data as Map)['p'] as List)[0]),)
              as T;
    }
    if (t == _i1.getType<(_i125.TestEnumStringified,)?>()) {
      return (data == null)
          ? null as T
          : (
              deserialize<_i125.TestEnumStringified>(
    ...
    if (t == _i1.getType<(_i119.SimpleData,)?>()) {
      return (data == null)
          ? null as T
          : (deserialize<_i119.SimpleData>(((data as Map)['p'] as List)[0]),)
              as T;
    }
    if (t == _i1.getType<({_i119.SimpleData namedModel})?>()) {
      return (data == null)
          ? null as T
          : (
              namedModel: deserialize<_i119.SimpleData>(
                  ((data as Map)['n'] as Map)['namedModel']),
            ) as T;
    }
    if (t ==
        _i1.getType<(_i119.SimpleData, {_i119.SimpleData namedModel})?>()) {
      return (data == null)
          ? null as T
          : (
              deserialize<_i119.SimpleData>(((data as Map)['p'] as List)[0]),
              namedModel:
                  deserialize<_i119.SimpleData>(data['n']['namedModel']),
            ) as T;
    }
    if (t ==
    ...
    if (t ==
        _i1.getType<
            (
              (List<(_i119.SimpleData,)>,), {
              (
                _i119.SimpleData,
                Map<String, _i119.SimpleData>
              ) namedNestedRecord
            })?>()) {
      return (data == null)
          ? null as T
          : (
              deserialize<(List<(_i119.SimpleData,)>,)>(
                  ((data as Map)['p'] as List)[0]),
    ...
    if (t == _i1.getType<Set<_i124.TestEnum>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i124.TestEnum>(e)).toSet()
          : null) as T;
    }
    if (t == _i1.getType<Set<_i125.TestEnumStringified>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i125.TestEnumStringified>(e))
              .toSet()
    ...
    if (t == _i1.getType<Set<_i126.Types>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i126.Types>(e)).toSet()
          : null) as T;
    }
    if (t == _i1.getType<Set<Map<String, _i126.Types>>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<Map<String, _i126.Types>>(e))
              .toSet()
    ...
    if (t == _i1.getType<Set<List<_i126.Types>>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<List<_i126.Types>>(e)).toSet()
          : null) as T;
    }
    if (t == _i1.getType<Set<(int,)>?>()) {
      return (data != null
    ...
    if (t == List<_i139.UserInfo>) {
      return (data as List).map((e) => deserialize<_i139.UserInfo>(e)).toList()
          as T;
    }
    if (t == Set<int>) {
      return (data as List).map((e) => deserialize<int>(e)).toSet() as T;
    ...
    if (t == _i1.getType<(List<(_i119.SimpleData,)>,)>()) {
      return (
        deserialize<List<(_i119.SimpleData,)>>(((data as Map)['p'] as List)[0]),
      ) as T;
    }
    if (t == List<(_i119.SimpleData,)>) {
      return (data as List)
    ...
    if (t == _i1.getType<(_i119.SimpleData,)>()) {
      return (deserialize<_i119.SimpleData>(((data as Map)['p'] as List)[0]),)
          as T;
    }
    if (t == _i1.getType<(_i119.SimpleData,)>()) {
      return (deserialize<_i119.SimpleData>(((data as Map)['p'] as List)[0]),)
    ...
    if (t == _i1.getType<(_i119.SimpleData, Map<String, _i119.SimpleData>)>()) {
      return (
        deserialize<_i119.SimpleData>(((data as Map)['p'] as List)[0]),
        deserialize<Map<String, _i119.SimpleData>>(data['p'][1]),
      ) as T;
    }
    if (t == _i1.getType<Set<(int,)>?>()) {
      return (data != null
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i84.Book) {
      return 'Book';
    }
    if (data is _i85.Chapter) {
      return 'Chapter';
    }
    ...
    if (data is _i129.TypesRecord) {
      return 'TypesRecord';
    }
    if (data is _i130.TypesSet) {
      return 'TypesSet';
    }
    if (data is _i131.TypesSetRequired) {
    ...
    if (data is List<_i139.UserInfo>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Book') {
      return deserialize<_i84.Book>(data['data']);
    }
    if (dataClassName == 'Chapter') {
      return deserialize<_i85.Chapter>(data['data']);
    }
    ...
    if (dataClassName == 'Record') {
      return deserialize<_i109.Record>(data['data']);
    }
    ...
    if (dataClassName == 'List<serverpod_auth.UserInfo>') {
      return deserialize<List<_i139.UserInfo>>(data['data']);
    }
    if (dataClassName == 'List<SimpleData>?') {
      return deserialize<List<_i137.SimpleData>?>(data['data']);
    }
...
Map<String, dynamic>? mapRecordToJson(Record? record) {
  ...
  if (record is (_i134.ModuleClass,)) {
    return {
      "p": [
        record.$1,
      ],
  ...
  if (record is (_i125.TestEnumStringified,)) {
    return {
      "p": [
        record.$1,
      ],
  ...
  if (record is ({_i119.SimpleData namedModel})) {
    return {
      "n": {
  ...
  if (record is (_i119.SimpleData, {_i119.SimpleData namedModel})) {
    return {
      "p": [
        record.$1,
      ],
  ...
  if (record is (
    (List<(_i119.SimpleData,)>,), {
    (_i119.SimpleData, Map<String, _i119.SimpleData>) namedNestedRecord
  })) {
    return {
      "p": [
        mapRecordToJson(record.$1),
  ...
  if (record is (List<(_i119.SimpleData,)>,)) {
    return {
      "p": [
        record.$1,
      ],
  ...
  if (record is (_i119.SimpleData, Map<String, _i119.SimpleData>)) {
    return {
      "p": [
        record.$1,
        record.$2,
