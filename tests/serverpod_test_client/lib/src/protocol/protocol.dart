...
import 'server_only_default.dart' as _i191;
import 'session_auth_info.dart' as _i192;
import 'shared_model_container.dart' as _i193;
import 'shared_model_subclass.dart' as _i194;
import 'simple_data.dart' as _i195;
import 'simple_data_list.dart' as _i196;
import 'simple_data_map.dart' as _i197;
import 'simple_data_object.dart' as _i198;
import 'simple_date_time.dart' as _i199;
import 'subfolder/model_in_subfolder.dart' as _i200;
import 'test_enum.dart' as _i201;
import 'test_enum_default_serialization.dart' as _i202;
import 'test_enum_enhanced.dart' as _i203;
import 'test_enum_enhanced_by_name.dart' as _i204;
import 'test_enum_stringified.dart' as _i205;
import 'types.dart' as _i206;
import 'types_list.dart' as _i207;
import 'types_map.dart' as _i208;
import 'types_record.dart' as _i209;
import 'types_set.dart' as _i210;
import 'types_set_required.dart' as _i211;
import 'unique_data.dart' as _i212;
import 'unique_data_with_non_persist.dart' as _i213;
import 'upsert_test_model.dart' as _i214;
import 'package:serverpod_test_module_client/serverpod_test_module_client.dart'
    as _i215;
import 'dart:typed_data' as _i216;
import 'package:serverpod_test_shared/serverpod_test_shared.dart' as _i217;
import 'package:serverpod_test_client/src/protocol/simple_data.dart' as _i218;
import 'package:serverpod_test_client/src/protocol/test_enum.dart' as _i219;
import 'package:serverpod_auth_client/serverpod_auth_client.dart' as _i220;
...
class Protocol extends _i1.SerializationManager {
  ...
  static Map<Type, dynamic Function(dynamic, Protocol)> _buildDeserializers() {
    ...
    map[_i89.ExtendedAppException] = (data, protocol) =>
        _i89.ExtendedAppException.fromJson(data);
    map[_i90.BaseAppException] = (data, protocol) =>
        _i90.BaseAppException.fromJson(data);
    map[_i91.NotFoundException] = (data, protocol) =>
        _i91.NotFoundException.fromJson(data);
    map[_i91.ValidationException] = (data, protocol) =>
        _i91.ValidationException.fromJson(data);
    map[_i92.ParentClass] = (data, protocol) => _i92.ParentClass.fromJson(data);
    map[_i93.GrandparentClass] = (data, protocol) =>
        _i93.GrandparentClass.fromJson(data);
    map[_i94.ParentClassWithoutId] = (data, protocol) =>
        _i94.ParentClassWithoutId.fromJson(data);
    map[_i95.GrandparentClassWithId] = (data, protocol) =>
        _i95.GrandparentClassWithId.fromJson(data);
    map[_i96.ChildEntity] = (data, protocol) => _i96.ChildEntity.fromJson(data);
    map[_i97.BaseEntity] = (data, protocol) => _i97.BaseEntity.fromJson(data);
    map[_i98.ParentEntity] = (data, protocol) =>
        _i98.ParentEntity.fromJson(data);
    map[_i99.NonServerOnlyParentClass] = (data, protocol) =>
        _i99.NonServerOnlyParentClass.fromJson(data);
    map[_i100.ParentWithDefault] = (data, protocol) =>
        _i100.ParentWithDefault.fromJson(data);
    map[_i101.PolymorphicGrandChild] = (data, protocol) =>
        _i101.PolymorphicGrandChild.fromJson(data);
    map[_i102.PolymorphicChild] = (data, protocol) =>
        _i102.PolymorphicChild.fromJson(data);
    map[_i103.PolymorphicChildContainer] = (data, protocol) =>
        _i103.PolymorphicChildContainer.fromJson(data);
    map[_i104.ModulePolymorphicChildContainer] = (data, protocol) =>
        _i104.ModulePolymorphicChildContainer.fromJson(data);
    map[_i105.SimilarButNotParent] = (data, protocol) =>
        _i105.SimilarButNotParent.fromJson(data);
    map[_i106.PolymorphicParent] = (data, protocol) =>
        _i106.PolymorphicParent.fromJson(data);
    map[_i107.UnrelatedToPolymorphism] = (data, protocol) =>
        _i107.UnrelatedToPolymorphism.fromJson(data);
    map[_i108.SealedGrandChild] = (data, protocol) =>
        _i108.SealedGrandChild.fromJson(data);
    map[_i108.SealedChild] = (data, protocol) =>
        _i108.SealedChild.fromJson(data);
    map[_i109.SealedChildOnlyRequired] = (data, protocol) =>
        _i109.SealedChildOnlyRequired.fromJson(data);
    map[_i108.SealedOtherChild] = (data, protocol) =>
        _i108.SealedOtherChild.fromJson(data);
    map[_i110.CityWithLongTableName] = (data, protocol) =>
        _i110.CityWithLongTableName.fromJson(data);
    map[_i111.OrganizationWithLongTableName] = (data, protocol) =>
        _i111.OrganizationWithLongTableName.fromJson(data);
    map[_i112.PersonWithLongTableName] = (data, protocol) =>
        _i112.PersonWithLongTableName.fromJson(data);
    map[_i113.MaxFieldName] = (data, protocol) =>
        _i113.MaxFieldName.fromJson(data);
    map[_i114.LongImplicitIdField] = (data, protocol) =>
        _i114.LongImplicitIdField.fromJson(data);
    map[_i115.LongImplicitIdFieldCollection] = (data, protocol) =>
        _i115.LongImplicitIdFieldCollection.fromJson(data);
    map[_i116.RelationToMultipleMaxFieldName] = (data, protocol) =>
        _i116.RelationToMultipleMaxFieldName.fromJson(data);
    map[_i117.UserNote] = (data, protocol) => _i117.UserNote.fromJson(data);
    map[_i118.UserNoteCollection] = (data, protocol) =>
        _i118.UserNoteCollection.fromJson(data);
    map[_i119.UserNoteCollectionWithALongName] = (data, protocol) =>
        _i119.UserNoteCollectionWithALongName.fromJson(data);
    map[_i120.UserNoteWithALongName] = (data, protocol) =>
        _i120.UserNoteWithALongName.fromJson(data);
    map[_i121.MultipleMaxFieldName] = (data, protocol) =>
        _i121.MultipleMaxFieldName.fromJson(data);
    map[_i122.City] = (data, protocol) => _i122.City.fromJson(data);
    map[_i123.Organization] = (data, protocol) =>
        _i123.Organization.fromJson(data);
    map[_i124.Person] = (data, protocol) => _i124.Person.fromJson(data);
    map[_i125.BleedChild] = (data, protocol) => _i125.BleedChild.fromJson(data);
    map[_i126.BleedRoot] = (data, protocol) => _i126.BleedRoot.fromJson(data);
    map[_i127.Course] = (data, protocol) => _i127.Course.fromJson(data);
    map[_i128.Enrollment] = (data, protocol) => _i128.Enrollment.fromJson(data);
    map[_i129.Student] = (data, protocol) => _i129.Student.fromJson(data);
    map[_i130.ObjectUser] = (data, protocol) => _i130.ObjectUser.fromJson(data);
    map[_i131.ParentUser] = (data, protocol) => _i131.ParentUser.fromJson(data);
    map[_i132.Arena] = (data, protocol) => _i132.Arena.fromJson(data);
    map[_i133.Player] = (data, protocol) => _i133.Player.fromJson(data);
    map[_i134.Team] = (data, protocol) => _i134.Team.fromJson(data);
    map[_i135.Comment] = (data, protocol) => _i135.Comment.fromJson(data);
    map[_i136.Customer] = (data, protocol) => _i136.Customer.fromJson(data);
    map[_i137.Book] = (data, protocol) => _i137.Book.fromJson(data);
    map[_i138.Chapter] = (data, protocol) => _i138.Chapter.fromJson(data);
    map[_i139.Order] = (data, protocol) => _i139.Order.fromJson(data);
    map[_i140.Address] = (data, protocol) => _i140.Address.fromJson(data);
    map[_i141.Citizen] = (data, protocol) => _i141.Citizen.fromJson(data);
    map[_i142.Company] = (data, protocol) => _i142.Company.fromJson(data);
    map[_i143.Town] = (data, protocol) => _i143.Town.fromJson(data);
    map[_i144.Blocking] = (data, protocol) => _i144.Blocking.fromJson(data);
    map[_i145.Member] = (data, protocol) => _i145.Member.fromJson(data);
    map[_i146.Cat] = (data, protocol) => _i146.Cat.fromJson(data);
    map[_i147.Post] = (data, protocol) => _i147.Post.fromJson(data);
    map[_i148.ModuleDatatype] = (data, protocol) =>
        _i148.ModuleDatatype.fromJson(data);
    map[_i149.MyFeatureModel] = (data, protocol) =>
        _i149.MyFeatureModel.fromJson(data);
    map[_i150.MyTriggerType] = (data, protocol) =>
        _i150.MyTriggerType.fromJson(data);
    map[_i151.Nullability] = (data, protocol) =>
        _i151.Nullability.fromJson(data);
    map[_i152.ObjectFieldPersist] = (data, protocol) =>
        _i152.ObjectFieldPersist.fromJson(data);
    map[_i153.ObjectFieldScopes] = (data, protocol) =>
        _i153.ObjectFieldScopes.fromJson(data);
    map[_i154.ObjectWithBit] = (data, protocol) =>
        _i154.ObjectWithBit.fromJson(data);
    map[_i155.ObjectWithByteData] = (data, protocol) =>
        _i155.ObjectWithByteData.fromJson(data);
    map[_i156.ObjectWithCustomClass] = (data, protocol) =>
        _i156.ObjectWithCustomClass.fromJson(data);
    map[_i157.ObjectWithDuration] = (data, protocol) =>
        _i157.ObjectWithDuration.fromJson(data);
    map[_i158.ObjectWithDynamic] = (data, protocol) =>
        _i158.ObjectWithDynamic.fromJson(data);
    map[_i159.ObjectWithEnum] = (data, protocol) =>
        _i159.ObjectWithEnum.fromJson(data);
    map[_i160.ObjectWithEnumEnhanced] = (data, protocol) =>
        _i160.ObjectWithEnumEnhanced.fromJson(data);
    map[_i161.ObjectWithGeographyGeometryCollection] = (data, protocol) =>
        _i161.ObjectWithGeographyGeometryCollection.fromJson(data);
    map[_i162.ObjectWithGeographyLineString] = (data, protocol) =>
        _i162.ObjectWithGeographyLineString.fromJson(data);
    map[_i163.ObjectWithGeographyPoint] = (data, protocol) =>
        _i163.ObjectWithGeographyPoint.fromJson(data);
    map[_i164.ObjectWithGeographyPolygon] = (data, protocol) =>
        _i164.ObjectWithGeographyPolygon.fromJson(data);
    map[_i165.ObjectWithHalfVector] = (data, protocol) =>
        _i165.ObjectWithHalfVector.fromJson(data);
    map[_i166.ObjectWithIndex] = (data, protocol) =>
        _i166.ObjectWithIndex.fromJson(data);
    map[_i167.ObjectWithJsonb] = (data, protocol) =>
        _i167.ObjectWithJsonb.fromJson(data);
    map[_i168.ObjectWithJsonbClassLevel] = (data, protocol) =>
        _i168.ObjectWithJsonbClassLevel.fromJson(data);
    map[_i169.ObjectWithMaps] = (data, protocol) =>
        _i169.ObjectWithMaps.fromJson(data);
    map[_i170.ObjectWithNullableCustomClass] = (data, protocol) =>
        _i170.ObjectWithNullableCustomClass.fromJson(data);
    map[_i171.ObjectWithObject] = (data, protocol) =>
        _i171.ObjectWithObject.fromJson(data);
    map[_i172.ObjectWithParent] = (data, protocol) =>
        _i172.ObjectWithParent.fromJson(data);
    map[_i173.ObjectWithSealedClass] = (data, protocol) =>
        _i173.ObjectWithSealedClass.fromJson(data);
    map[_i174.ObjectWithSealedException] = (data, protocol) =>
        _i174.ObjectWithSealedException.fromJson(data);
    map[_i175.ObjectWithSelfParent] = (data, protocol) =>
        _i175.ObjectWithSelfParent.fromJson(data);
    map[_i176.ObjectWithSparseVector] = (data, protocol) =>
        _i176.ObjectWithSparseVector.fromJson(data);
    map[_i177.ObjectWithUuid] = (data, protocol) =>
        _i177.ObjectWithUuid.fromJson(data);
    map[_i178.ObjectWithVector] = (data, protocol) =>
        _i178.ObjectWithVector.fromJson(data);
    map[_i179.Record] = (data, protocol) => _i179.Record.fromJson(data);
    map[_i180.RelatedUniqueData] = (data, protocol) =>
        _i180.RelatedUniqueData.fromJson(data);
    map[_i181.ExceptionWithRequiredField] = (data, protocol) =>
        _i181.ExceptionWithRequiredField.fromJson(data);
    map[_i182.ModelWithRequiredField] = (data, protocol) =>
        _i182.ModelWithRequiredField.fromJson(data);
    map[_i183.ScopeNoneFields] = (data, protocol) =>
        _i183.ScopeNoneFields.fromJson(data);
    map[_i184.ScopeServerOnlyFieldChild] = (data, protocol) =>
        _i184.ScopeServerOnlyFieldChild.fromJson(data);
    map[_i185.ScopeServerOnlyField] = (data, protocol) =>
        _i185.ScopeServerOnlyField.fromJson(data);
    map[_i186.DefaultServerOnlyClass] = (data, protocol) =>
        _i186.DefaultServerOnlyClass.fromJson(data);
    map[_i187.DefaultServerOnlyEnum] = (data, protocol) =>
        _i187.DefaultServerOnlyEnum.fromJson(data);
    map[_i188.NotServerOnlyClass] = (data, protocol) =>
        _i188.NotServerOnlyClass.fromJson(data);
    map[_i189.NotServerOnlyEnum] = (data, protocol) =>
        _i189.NotServerOnlyEnum.fromJson(data);
    map[_i190.ServerOnlyClassField] = (data, protocol) =>
        _i190.ServerOnlyClassField.fromJson(data);
    map[_i191.ServerOnlyDefault] = (data, protocol) =>
        _i191.ServerOnlyDefault.fromJson(data);
    map[_i192.SessionAuthInfo] = (data, protocol) =>
        _i192.SessionAuthInfo.fromJson(data);
    map[_i193.SharedModelContainer] = (data, protocol) =>
        _i193.SharedModelContainer.fromJson(data);
    map[_i194.SharedModelSubclass] = (data, protocol) =>
        _i194.SharedModelSubclass.fromJson(data);
    map[_i195.SimpleData] = (data, protocol) => _i195.SimpleData.fromJson(data);
    map[_i196.SimpleDataList] = (data, protocol) =>
        _i196.SimpleDataList.fromJson(data);
    map[_i197.SimpleDataMap] = (data, protocol) =>
        _i197.SimpleDataMap.fromJson(data);
    map[_i198.SimpleDataObject] = (data, protocol) =>
        _i198.SimpleDataObject.fromJson(data);
    map[_i199.SimpleDateTime] = (data, protocol) =>
        _i199.SimpleDateTime.fromJson(data);
    map[_i200.ModelInSubfolder] = (data, protocol) =>
        _i200.ModelInSubfolder.fromJson(data);
    map[_i201.TestEnum] = (data, protocol) => _i201.TestEnum.fromJson(data);
    map[_i202.TestEnumDefaultSerialization] = (data, protocol) =>
        _i202.TestEnumDefaultSerialization.fromJson(data);
    map[_i203.TestEnumEnhanced] = (data, protocol) =>
        _i203.TestEnumEnhanced.fromJson(data);
    map[_i204.TestEnumEnhancedByName] = (data, protocol) =>
        _i204.TestEnumEnhancedByName.fromJson(data);
    map[_i205.TestEnumStringified] = (data, protocol) =>
        _i205.TestEnumStringified.fromJson(data);
    map[_i206.Types] = (data, protocol) => _i206.Types.fromJson(data);
    map[_i207.TypesList] = (data, protocol) => _i207.TypesList.fromJson(data);
    map[_i208.TypesMap] = (data, protocol) => _i208.TypesMap.fromJson(data);
    map[_i209.TypesRecord] = (data, protocol) =>
        _i209.TypesRecord.fromJson(data);
    map[_i210.TypesSet] = (data, protocol) => _i210.TypesSet.fromJson(data);
    map[_i211.TypesSetRequired] = (data, protocol) =>
        _i211.TypesSetRequired.fromJson(data);
    map[_i212.UniqueData] = (data, protocol) => _i212.UniqueData.fromJson(data);
    map[_i213.UniqueDataWithNonPersist] = (data, protocol) =>
        _i213.UniqueDataWithNonPersist.fromJson(data);
    map[_i214.UpsertTestModel] = (data, protocol) =>
        _i214.UpsertTestModel.fromJson(data);
    ...
    map[_i1.getType<_i89.ExtendedAppException?>()] = (data, protocol) =>
        (data != null ? _i89.ExtendedAppException.fromJson(data) : null);
    map[_i1.getType<_i90.BaseAppException?>()] = (data, protocol) =>
        (data != null ? _i90.BaseAppException.fromJson(data) : null);
    map[_i1.getType<_i91.NotFoundException?>()] = (data, protocol) =>
        (data != null ? _i91.NotFoundException.fromJson(data) : null);
    map[_i1.getType<_i91.ValidationException?>()] = (data, protocol) =>
        (data != null ? _i91.ValidationException.fromJson(data) : null);
    map[_i1.getType<_i92.ParentClass?>()] = (data, protocol) =>
        (data != null ? _i92.ParentClass.fromJson(data) : null);
    map[_i1.getType<_i93.GrandparentClass?>()] = (data, protocol) =>
        (data != null ? _i93.GrandparentClass.fromJson(data) : null);
    map[_i1.getType<_i94.ParentClassWithoutId?>()] = (data, protocol) =>
        (data != null ? _i94.ParentClassWithoutId.fromJson(data) : null);
    map[_i1.getType<_i95.GrandparentClassWithId?>()] = (data, protocol) =>
        (data != null ? _i95.GrandparentClassWithId.fromJson(data) : null);
    map[_i1.getType<_i96.ChildEntity?>()] = (data, protocol) =>
        (data != null ? _i96.ChildEntity.fromJson(data) : null);
    map[_i1.getType<_i97.BaseEntity?>()] = (data, protocol) =>
        (data != null ? _i97.BaseEntity.fromJson(data) : null);
    map[_i1.getType<_i98.ParentEntity?>()] = (data, protocol) =>
        (data != null ? _i98.ParentEntity.fromJson(data) : null);
    map[_i1.getType<_i99.NonServerOnlyParentClass?>()] = (data, protocol) =>
        (data != null ? _i99.NonServerOnlyParentClass.fromJson(data) : null);
    map[_i1.getType<_i100.ParentWithDefault?>()] = (data, protocol) =>
        (data != null ? _i100.ParentWithDefault.fromJson(data) : null);
    map[_i1.getType<_i101.PolymorphicGrandChild?>()] = (data, protocol) =>
        (data != null ? _i101.PolymorphicGrandChild.fromJson(data) : null);
    map[_i1.getType<_i102.PolymorphicChild?>()] = (data, protocol) =>
        (data != null ? _i102.PolymorphicChild.fromJson(data) : null);
    map[_i1.getType<_i103.PolymorphicChildContainer?>()] = (data, protocol) =>
        (data != null ? _i103.PolymorphicChildContainer.fromJson(data) : null);
    map[_i1.getType<_i104.ModulePolymorphicChildContainer?>()] =
        (data, protocol) => (data != null
        ? _i104.ModulePolymorphicChildContainer.fromJson(data)
        : null);
    map[_i1.getType<_i105.SimilarButNotParent?>()] = (data, protocol) =>
        (data != null ? _i105.SimilarButNotParent.fromJson(data) : null);
    map[_i1.getType<_i106.PolymorphicParent?>()] = (data, protocol) =>
        (data != null ? _i106.PolymorphicParent.fromJson(data) : null);
    map[_i1.getType<_i107.UnrelatedToPolymorphism?>()] = (data, protocol) =>
        (data != null ? _i107.UnrelatedToPolymorphism.fromJson(data) : null);
    map[_i1.getType<_i108.SealedGrandChild?>()] = (data, protocol) =>
        (data != null ? _i108.SealedGrandChild.fromJson(data) : null);
    map[_i1.getType<_i108.SealedChild?>()] = (data, protocol) =>
        (data != null ? _i108.SealedChild.fromJson(data) : null);
    map[_i1.getType<_i109.SealedChildOnlyRequired?>()] = (data, protocol) =>
        (data != null ? _i109.SealedChildOnlyRequired.fromJson(data) : null);
    map[_i1.getType<_i108.SealedOtherChild?>()] = (data, protocol) =>
        (data != null ? _i108.SealedOtherChild.fromJson(data) : null);
    map[_i1.getType<_i110.CityWithLongTableName?>()] = (data, protocol) =>
        (data != null ? _i110.CityWithLongTableName.fromJson(data) : null);
    map[_i1
        .getType<_i111.OrganizationWithLongTableName?>()] = (data, protocol) =>
        (data != null
        ? _i111.OrganizationWithLongTableName.fromJson(data)
        : null);
    map[_i1.getType<_i112.PersonWithLongTableName?>()] = (data, protocol) =>
        (data != null ? _i112.PersonWithLongTableName.fromJson(data) : null);
    map[_i1.getType<_i113.MaxFieldName?>()] = (data, protocol) =>
        (data != null ? _i113.MaxFieldName.fromJson(data) : null);
    map[_i1.getType<_i114.LongImplicitIdField?>()] = (data, protocol) =>
        (data != null ? _i114.LongImplicitIdField.fromJson(data) : null);
    map[_i1
        .getType<_i115.LongImplicitIdFieldCollection?>()] = (data, protocol) =>
        (data != null
        ? _i115.LongImplicitIdFieldCollection.fromJson(data)
        : null);
    map[_i1
        .getType<_i116.RelationToMultipleMaxFieldName?>()] = (data, protocol) =>
        (data != null
        ? _i116.RelationToMultipleMaxFieldName.fromJson(data)
        : null);
    map[_i1.getType<_i117.UserNote?>()] = (data, protocol) =>
        (data != null ? _i117.UserNote.fromJson(data) : null);
    map[_i1.getType<_i118.UserNoteCollection?>()] = (data, protocol) =>
        (data != null ? _i118.UserNoteCollection.fromJson(data) : null);
    map[_i1.getType<_i119.UserNoteCollectionWithALongName?>()] =
        (data, protocol) => (data != null
        ? _i119.UserNoteCollectionWithALongName.fromJson(data)
        : null);
    map[_i1.getType<_i120.UserNoteWithALongName?>()] = (data, protocol) =>
        (data != null ? _i120.UserNoteWithALongName.fromJson(data) : null);
    map[_i1.getType<_i121.MultipleMaxFieldName?>()] = (data, protocol) =>
        (data != null ? _i121.MultipleMaxFieldName.fromJson(data) : null);
    map[_i1.getType<_i122.City?>()] = (data, protocol) =>
        (data != null ? _i122.City.fromJson(data) : null);
    map[_i1.getType<_i123.Organization?>()] = (data, protocol) =>
        (data != null ? _i123.Organization.fromJson(data) : null);
    map[_i1.getType<_i124.Person?>()] = (data, protocol) =>
        (data != null ? _i124.Person.fromJson(data) : null);
    map[_i1.getType<_i125.BleedChild?>()] = (data, protocol) =>
        (data != null ? _i125.BleedChild.fromJson(data) : null);
    map[_i1.getType<_i126.BleedRoot?>()] = (data, protocol) =>
        (data != null ? _i126.BleedRoot.fromJson(data) : null);
    map[_i1.getType<_i127.Course?>()] = (data, protocol) =>
        (data != null ? _i127.Course.fromJson(data) : null);
    map[_i1.getType<_i128.Enrollment?>()] = (data, protocol) =>
        (data != null ? _i128.Enrollment.fromJson(data) : null);
    map[_i1.getType<_i129.Student?>()] = (data, protocol) =>
        (data != null ? _i129.Student.fromJson(data) : null);
    map[_i1.getType<_i130.ObjectUser?>()] = (data, protocol) =>
        (data != null ? _i130.ObjectUser.fromJson(data) : null);
    map[_i1.getType<_i131.ParentUser?>()] = (data, protocol) =>
        (data != null ? _i131.ParentUser.fromJson(data) : null);
    map[_i1.getType<_i132.Arena?>()] = (data, protocol) =>
        (data != null ? _i132.Arena.fromJson(data) : null);
    map[_i1.getType<_i133.Player?>()] = (data, protocol) =>
        (data != null ? _i133.Player.fromJson(data) : null);
    map[_i1.getType<_i134.Team?>()] = (data, protocol) =>
        (data != null ? _i134.Team.fromJson(data) : null);
    map[_i1.getType<_i135.Comment?>()] = (data, protocol) =>
        (data != null ? _i135.Comment.fromJson(data) : null);
    map[_i1.getType<_i136.Customer?>()] = (data, protocol) =>
        (data != null ? _i136.Customer.fromJson(data) : null);
    map[_i1.getType<_i137.Book?>()] = (data, protocol) =>
        (data != null ? _i137.Book.fromJson(data) : null);
    map[_i1.getType<_i138.Chapter?>()] = (data, protocol) =>
        (data != null ? _i138.Chapter.fromJson(data) : null);
    map[_i1.getType<_i139.Order?>()] = (data, protocol) =>
        (data != null ? _i139.Order.fromJson(data) : null);
    map[_i1.getType<_i140.Address?>()] = (data, protocol) =>
        (data != null ? _i140.Address.fromJson(data) : null);
    map[_i1.getType<_i141.Citizen?>()] = (data, protocol) =>
        (data != null ? _i141.Citizen.fromJson(data) : null);
    map[_i1.getType<_i142.Company?>()] = (data, protocol) =>
        (data != null ? _i142.Company.fromJson(data) : null);
    map[_i1.getType<_i143.Town?>()] = (data, protocol) =>
        (data != null ? _i143.Town.fromJson(data) : null);
    map[_i1.getType<_i144.Blocking?>()] = (data, protocol) =>
        (data != null ? _i144.Blocking.fromJson(data) : null);
    map[_i1.getType<_i145.Member?>()] = (data, protocol) =>
        (data != null ? _i145.Member.fromJson(data) : null);
    map[_i1.getType<_i146.Cat?>()] = (data, protocol) =>
        (data != null ? _i146.Cat.fromJson(data) : null);
    map[_i1.getType<_i147.Post?>()] = (data, protocol) =>
        (data != null ? _i147.Post.fromJson(data) : null);
    map[_i1.getType<_i148.ModuleDatatype?>()] = (data, protocol) =>
        (data != null ? _i148.ModuleDatatype.fromJson(data) : null);
    map[_i1.getType<_i149.MyFeatureModel?>()] = (data, protocol) =>
        (data != null ? _i149.MyFeatureModel.fromJson(data) : null);
    map[_i1.getType<_i150.MyTriggerType?>()] = (data, protocol) =>
        (data != null ? _i150.MyTriggerType.fromJson(data) : null);
    map[_i1.getType<_i151.Nullability?>()] = (data, protocol) =>
        (data != null ? _i151.Nullability.fromJson(data) : null);
    map[_i1.getType<_i152.ObjectFieldPersist?>()] = (data, protocol) =>
        (data != null ? _i152.ObjectFieldPersist.fromJson(data) : null);
    map[_i1.getType<_i153.ObjectFieldScopes?>()] = (data, protocol) =>
        (data != null ? _i153.ObjectFieldScopes.fromJson(data) : null);
    map[_i1.getType<_i154.ObjectWithBit?>()] = (data, protocol) =>
        (data != null ? _i154.ObjectWithBit.fromJson(data) : null);
    map[_i1.getType<_i155.ObjectWithByteData?>()] = (data, protocol) =>
        (data != null ? _i155.ObjectWithByteData.fromJson(data) : null);
    map[_i1.getType<_i156.ObjectWithCustomClass?>()] = (data, protocol) =>
        (data != null ? _i156.ObjectWithCustomClass.fromJson(data) : null);
    map[_i1.getType<_i157.ObjectWithDuration?>()] = (data, protocol) =>
        (data != null ? _i157.ObjectWithDuration.fromJson(data) : null);
    map[_i1.getType<_i158.ObjectWithDynamic?>()] = (data, protocol) =>
        (data != null ? _i158.ObjectWithDynamic.fromJson(data) : null);
    map[_i1.getType<_i159.ObjectWithEnum?>()] = (data, protocol) =>
        (data != null ? _i159.ObjectWithEnum.fromJson(data) : null);
    map[_i1.getType<_i160.ObjectWithEnumEnhanced?>()] = (data, protocol) =>
        (data != null ? _i160.ObjectWithEnumEnhanced.fromJson(data) : null);
    map[_i1.getType<_i161.ObjectWithGeographyGeometryCollection?>()] =
        (data, protocol) => (data != null
        ? _i161.ObjectWithGeographyGeometryCollection.fromJson(data)
        : null);
    map[_i1
        .getType<_i162.ObjectWithGeographyLineString?>()] = (data, protocol) =>
        (data != null
        ? _i162.ObjectWithGeographyLineString.fromJson(data)
        : null);
    map[_i1.getType<_i163.ObjectWithGeographyPoint?>()] = (data, protocol) =>
        (data != null ? _i163.ObjectWithGeographyPoint.fromJson(data) : null);
    map[_i1.getType<_i164.ObjectWithGeographyPolygon?>()] = (data, protocol) =>
        (data != null ? _i164.ObjectWithGeographyPolygon.fromJson(data) : null);
    map[_i1.getType<_i165.ObjectWithHalfVector?>()] = (data, protocol) =>
        (data != null ? _i165.ObjectWithHalfVector.fromJson(data) : null);
    map[_i1.getType<_i166.ObjectWithIndex?>()] = (data, protocol) =>
        (data != null ? _i166.ObjectWithIndex.fromJson(data) : null);
    map[_i1.getType<_i167.ObjectWithJsonb?>()] = (data, protocol) =>
        (data != null ? _i167.ObjectWithJsonb.fromJson(data) : null);
    map[_i1.getType<_i168.ObjectWithJsonbClassLevel?>()] = (data, protocol) =>
        (data != null ? _i168.ObjectWithJsonbClassLevel.fromJson(data) : null);
    map[_i1.getType<_i169.ObjectWithMaps?>()] = (data, protocol) =>
        (data != null ? _i169.ObjectWithMaps.fromJson(data) : null);
    map[_i1
        .getType<_i170.ObjectWithNullableCustomClass?>()] = (data, protocol) =>
        (data != null
        ? _i170.ObjectWithNullableCustomClass.fromJson(data)
        : null);
    map[_i1.getType<_i171.ObjectWithObject?>()] = (data, protocol) =>
        (data != null ? _i171.ObjectWithObject.fromJson(data) : null);
    map[_i1.getType<_i172.ObjectWithParent?>()] = (data, protocol) =>
        (data != null ? _i172.ObjectWithParent.fromJson(data) : null);
    map[_i1.getType<_i173.ObjectWithSealedClass?>()] = (data, protocol) =>
        (data != null ? _i173.ObjectWithSealedClass.fromJson(data) : null);
    map[_i1.getType<_i174.ObjectWithSealedException?>()] = (data, protocol) =>
        (data != null ? _i174.ObjectWithSealedException.fromJson(data) : null);
    map[_i1.getType<_i175.ObjectWithSelfParent?>()] = (data, protocol) =>
        (data != null ? _i175.ObjectWithSelfParent.fromJson(data) : null);
    map[_i1.getType<_i176.ObjectWithSparseVector?>()] = (data, protocol) =>
        (data != null ? _i176.ObjectWithSparseVector.fromJson(data) : null);
    map[_i1.getType<_i177.ObjectWithUuid?>()] = (data, protocol) =>
        (data != null ? _i177.ObjectWithUuid.fromJson(data) : null);
    map[_i1.getType<_i178.ObjectWithVector?>()] = (data, protocol) =>
        (data != null ? _i178.ObjectWithVector.fromJson(data) : null);
    map[_i1.getType<_i179.Record?>()] = (data, protocol) =>
        (data != null ? _i179.Record.fromJson(data) : null);
    map[_i1.getType<_i180.RelatedUniqueData?>()] = (data, protocol) =>
        (data != null ? _i180.RelatedUniqueData.fromJson(data) : null);
    map[_i1.getType<_i181.ExceptionWithRequiredField?>()] = (data, protocol) =>
        (data != null ? _i181.ExceptionWithRequiredField.fromJson(data) : null);
    map[_i1.getType<_i182.ModelWithRequiredField?>()] = (data, protocol) =>
        (data != null ? _i182.ModelWithRequiredField.fromJson(data) : null);
    map[_i1.getType<_i183.ScopeNoneFields?>()] = (data, protocol) =>
        (data != null ? _i183.ScopeNoneFields.fromJson(data) : null);
    map[_i1.getType<_i184.ScopeServerOnlyFieldChild?>()] = (data, protocol) =>
        (data != null ? _i184.ScopeServerOnlyFieldChild.fromJson(data) : null);
    map[_i1.getType<_i185.ScopeServerOnlyField?>()] = (data, protocol) =>
        (data != null ? _i185.ScopeServerOnlyField.fromJson(data) : null);
    map[_i1.getType<_i186.DefaultServerOnlyClass?>()] = (data, protocol) =>
        (data != null ? _i186.DefaultServerOnlyClass.fromJson(data) : null);
    map[_i1.getType<_i187.DefaultServerOnlyEnum?>()] = (data, protocol) =>
        (data != null ? _i187.DefaultServerOnlyEnum.fromJson(data) : null);
    map[_i1.getType<_i188.NotServerOnlyClass?>()] = (data, protocol) =>
        (data != null ? _i188.NotServerOnlyClass.fromJson(data) : null);
    map[_i1.getType<_i189.NotServerOnlyEnum?>()] = (data, protocol) =>
        (data != null ? _i189.NotServerOnlyEnum.fromJson(data) : null);
    map[_i1.getType<_i190.ServerOnlyClassField?>()] = (data, protocol) =>
        (data != null ? _i190.ServerOnlyClassField.fromJson(data) : null);
    map[_i1.getType<_i191.ServerOnlyDefault?>()] = (data, protocol) =>
        (data != null ? _i191.ServerOnlyDefault.fromJson(data) : null);
    map[_i1.getType<_i192.SessionAuthInfo?>()] = (data, protocol) =>
        (data != null ? _i192.SessionAuthInfo.fromJson(data) : null);
    map[_i1.getType<_i193.SharedModelContainer?>()] = (data, protocol) =>
        (data != null ? _i193.SharedModelContainer.fromJson(data) : null);
    map[_i1.getType<_i194.SharedModelSubclass?>()] = (data, protocol) =>
        (data != null ? _i194.SharedModelSubclass.fromJson(data) : null);
    map[_i1.getType<_i195.SimpleData?>()] = (data, protocol) =>
        (data != null ? _i195.SimpleData.fromJson(data) : null);
    map[_i1.getType<_i196.SimpleDataList?>()] = (data, protocol) =>
        (data != null ? _i196.SimpleDataList.fromJson(data) : null);
    map[_i1.getType<_i197.SimpleDataMap?>()] = (data, protocol) =>
        (data != null ? _i197.SimpleDataMap.fromJson(data) : null);
    map[_i1.getType<_i198.SimpleDataObject?>()] = (data, protocol) =>
        (data != null ? _i198.SimpleDataObject.fromJson(data) : null);
    map[_i1.getType<_i199.SimpleDateTime?>()] = (data, protocol) =>
        (data != null ? _i199.SimpleDateTime.fromJson(data) : null);
    map[_i1.getType<_i200.ModelInSubfolder?>()] = (data, protocol) =>
        (data != null ? _i200.ModelInSubfolder.fromJson(data) : null);
    map[_i1.getType<_i201.TestEnum?>()] = (data, protocol) =>
        (data != null ? _i201.TestEnum.fromJson(data) : null);
    map[_i1
        .getType<_i202.TestEnumDefaultSerialization?>()] = (data, protocol) =>
        (data != null
        ? _i202.TestEnumDefaultSerialization.fromJson(data)
        : null);
    map[_i1.getType<_i203.TestEnumEnhanced?>()] = (data, protocol) =>
        (data != null ? _i203.TestEnumEnhanced.fromJson(data) : null);
    map[_i1.getType<_i204.TestEnumEnhancedByName?>()] = (data, protocol) =>
        (data != null ? _i204.TestEnumEnhancedByName.fromJson(data) : null);
    map[_i1.getType<_i205.TestEnumStringified?>()] = (data, protocol) =>
        (data != null ? _i205.TestEnumStringified.fromJson(data) : null);
    map[_i1.getType<_i206.Types?>()] = (data, protocol) =>
        (data != null ? _i206.Types.fromJson(data) : null);
    map[_i1.getType<_i207.TypesList?>()] = (data, protocol) =>
        (data != null ? _i207.TypesList.fromJson(data) : null);
    map[_i1.getType<_i208.TypesMap?>()] = (data, protocol) =>
        (data != null ? _i208.TypesMap.fromJson(data) : null);
    map[_i1.getType<_i209.TypesRecord?>()] = (data, protocol) =>
        (data != null ? _i209.TypesRecord.fromJson(data) : null);
    map[_i1.getType<_i210.TypesSet?>()] = (data, protocol) =>
        (data != null ? _i210.TypesSet.fromJson(data) : null);
    map[_i1.getType<_i211.TypesSetRequired?>()] = (data, protocol) =>
        (data != null ? _i211.TypesSetRequired.fromJson(data) : null);
    map[_i1.getType<_i212.UniqueData?>()] = (data, protocol) =>
        (data != null ? _i212.UniqueData.fromJson(data) : null);
    map[_i1.getType<_i213.UniqueDataWithNonPersist?>()] = (data, protocol) =>
        (data != null ? _i213.UniqueDataWithNonPersist.fromJson(data) : null);
    map[_i1.getType<_i214.UpsertTestModel?>()] = (data, protocol) =>
        (data != null ? _i214.UpsertTestModel.fromJson(data) : null);
    ...
    map[List<_i96.ChildEntity>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i96.ChildEntity>(e))
        .toList();
    map[_i1.getType<List<_i96.ChildEntity>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i96.ChildEntity>(e))
              .toList()
        : null);
    map[List<_i102.PolymorphicChild>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i102.PolymorphicChild>(e))
        .toList();
    map[List<_i102.PolymorphicChild?>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i102.PolymorphicChild?>(e))
        .toList();
    map[Map<String, _i102.PolymorphicChild>] = (data, protocol) =>
        (data as Map).map(
          (k, v) => MapEntry(
            protocol.deserialize<String>(k),
            protocol.deserialize<_i102.PolymorphicChild>(v),
          ),
        );
    map[Map<String, _i102.PolymorphicChild?>] = (data, protocol) =>
        (data as Map).map(
    ...
    map[List<_i215.ModulePolymorphicChild>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i215.ModulePolymorphicChild>(e))
        .toList();
    map[Map<String, _i215.ModulePolymorphicChild>] = (data, protocol) =>
        (data as Map).map(
          (k, v) => MapEntry(
            protocol.deserialize<String>(k),
            protocol.deserialize<_i215.ModulePolymorphicChild>(v),
          ),
        );
    map[List<_i112.PersonWithLongTableName>] = (data, protocol) =>
        (data as List)
            .map((e) => protocol.deserialize<_i112.PersonWithLongTableName>(e))
            .toList();
    map[_i1.getType<List<_i112.PersonWithLongTableName>?>()] =
        (data, protocol) => (data != null
        ? (data as List)
              .map(
                (e) => protocol.deserialize<_i112.PersonWithLongTableName>(e),
              )
              .toList()
        : null);
    map[List<_i111.OrganizationWithLongTableName>] = (data, protocol) =>
        (data as List)
            .map(
              (e) =>
                  protocol.deserialize<_i111.OrganizationWithLongTableName>(e),
            )
            .toList();
    map[_i1.getType<List<_i111.OrganizationWithLongTableName>?>()] =
        (data, protocol) => (data != null
        ? (data as List)
              .map(
                (e) => protocol
              ...
              .toList()
        : null);
    map[List<_i114.LongImplicitIdField>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i114.LongImplicitIdField>(e))
        .toList();
    map[_i1.getType<List<_i114.LongImplicitIdField>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i114.LongImplicitIdField>(e))
              .toList()
        : null);
    map[List<_i121.MultipleMaxFieldName>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i121.MultipleMaxFieldName>(e))
        .toList();
    map[_i1.getType<List<_i121.MultipleMaxFieldName>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i121.MultipleMaxFieldName>(e))
              .toList()
        : null);
    map[List<_i117.UserNote>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i117.UserNote>(e))
        .toList();
    map[_i1.getType<List<_i117.UserNote>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i117.UserNote>(e))
              .toList()
        : null);
    map[List<_i120.UserNoteWithALongName>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i120.UserNoteWithALongName>(e))
        .toList();
    map[_i1.getType<List<_i120.UserNoteWithALongName>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i120.UserNoteWithALongName>(e))
              .toList()
        : null);
    map[List<_i124.Person>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i124.Person>(e))
        .toList();
    map[_i1.getType<List<_i124.Person>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i124.Person>(e))
              .toList()
        : null);
    map[List<_i123.Organization>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i123.Organization>(e))
        .toList();
    map[_i1.getType<List<_i123.Organization>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i123.Organization>(e))
              .toList()
        : null);
    map[List<_i128.Enrollment>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i128.Enrollment>(e))
        .toList();
    map[_i1.getType<List<_i128.Enrollment>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i128.Enrollment>(e))
              .toList()
        : null);
    map[List<_i133.Player>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i133.Player>(e))
        .toList();
    map[_i1.getType<List<_i133.Player>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i133.Player>(e))
              .toList()
        : null);
    map[List<_i139.Order>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i139.Order>(e))
        .toList();
    map[_i1.getType<List<_i139.Order>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i139.Order>(e))
              .toList()
        : null);
    map[List<_i138.Chapter>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i138.Chapter>(e))
        .toList();
    map[_i1.getType<List<_i138.Chapter>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i138.Chapter>(e))
              .toList()
        : null);
    map[List<_i135.Comment>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i135.Comment>(e))
        .toList();
    map[_i1.getType<List<_i135.Comment>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i135.Comment>(e))
              .toList()
        : null);
    map[List<_i144.Blocking>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i144.Blocking>(e))
        .toList();
    map[_i1.getType<List<_i144.Blocking>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i144.Blocking>(e))
              .toList()
        : null);
    map[List<_i146.Cat>] = (data, protocol) =>
        (data as List).map((e) => protocol.deserialize<_i146.Cat>(e)).toList();
    map[_i1.getType<List<_i146.Cat>?>()] = (data, protocol) => (data != null
        ? (data as List).map((e) => protocol.deserialize<_i146.Cat>(e)).toList()
        : null);
    map[List<_i215.ModuleClass>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i215.ModuleClass>(e))
        .toList();
    map[Map<String, _i215.ModuleClass>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<_i215.ModuleClass>(v),
      ),
    );
    map[_i1.getType<(_i215.ModuleClass,)?>()] = (data, protocol) =>
        (data == null)
        ? null
        : (
            protocol.deserialize<_i215.ModuleClass>(
    ...
    map[_i1.getType<List<int?>?>()] = (data, protocol) => (data != null
        ? (data as List).map((e) => protocol.deserialize<int?>(e)).toList()
        : null);
    map[List<_i195.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i195.SimpleData>(e))
        .toList();
    map[List<_i195.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i195.SimpleData>(e))
        .toList();
    map[_i1.getType<List<_i195.SimpleData>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i195.SimpleData>(e))
              .toList()
    ...
    map[_i1.getType<List<DateTime?>?>()] = (data, protocol) => (data != null
        ? (data as List).map((e) => protocol.deserialize<DateTime?>(e)).toList()
        : null);
    map[List<_i216.ByteData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i216.ByteData>(e))
        .toList();
    map[List<_i216.ByteData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i216.ByteData>(e))
        .toList();
    map[_i1.getType<List<_i216.ByteData>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i216.ByteData>(e))
              .toList()
    ...
    map[_i1.getType<Map<String, int?>?>()] = (data, protocol) => (data != null
        ...
        : null);
    map[_i217.CustomClassWithoutProtocolSerialization] = (data, protocol) =>
        _i217.CustomClassWithoutProtocolSerialization.fromJson(data);
    map[_i217.CustomClassWithProtocolSerialization] = (data, protocol) =>
        _i217.CustomClassWithProtocolSerialization.fromJson(data);
    map[_i217.CustomClassWithProtocolSerializationMethod] = (data, protocol) =>
        _i217.CustomClassWithProtocolSerializationMethod.fromJson(data);
    ...
    map[dynamic] = (data, protocol) =>
        protocol.deserializeDynamicFieldValue(data);
    map[List<_i201.TestEnum>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i201.TestEnum>(e))
        .toList();
    map[List<_i201.TestEnum?>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i201.TestEnum?>(e))
        .toList();
    map[List<List<_i201.TestEnum>>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<List<_i201.TestEnum>>(e))
        .toList();
    map[List<_i201.TestEnum>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i201.TestEnum>(e))
        .toList();
    map[List<_i203.TestEnumEnhanced>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i203.TestEnumEnhanced>(e))
        .toList();
    map[List<_i204.TestEnumEnhancedByName>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i204.TestEnumEnhancedByName>(e))
        .toList();
    map[List<String>] = (data, protocol) =>
        (data as List).map((e) => protocol.deserialize<String>(e)).toList();
    map[_i1.getType<List<String>?>()] = (data, protocol) => (data != null
        ? (data as List).map((e) => protocol.deserialize<String>(e)).toList()
        : null);
    map[Map<String, _i195.SimpleData>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<_i195.SimpleData>(v),
      ),
    );
    ...
    map[Map<String, _i216.ByteData>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<_i216.ByteData>(v),
      ),
    );
    ...
    map[_i1.getType<_i217.CustomClassWithoutProtocolSerialization?>()] =
        (data, protocol) => (data != null
        ? _i217.CustomClassWithoutProtocolSerialization.fromJson(data)
        : null);
    map[_i1.getType<_i217.CustomClassWithProtocolSerialization?>()] =
        (data, protocol) => (data != null
        ? _i217.CustomClassWithProtocolSerialization.fromJson(data)
        : null);
    map[_i1.getType<_i217.CustomClassWithProtocolSerializationMethod?>()] =
        (data, protocol) => (data != null
        ? _i217.CustomClassWithProtocolSerializationMethod.fromJson(data)
        : null);
    map[List<List<_i195.SimpleData>>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<List<_i195.SimpleData>>(e))
        .toList();
    map[List<_i195.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i195.SimpleData>(e))
        .toList();
    map[_i1.getType<List<List<_i195.SimpleData>>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<List<_i195.SimpleData>>(e))
              .toList()
    ...
    map[List<_i195.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i195.SimpleData>(e))
        .toList();
    map[Map<String, List<List<Map<int, _i195.SimpleData>>?>>] =
        (data, protocol) => (data as Map).map(
          (k, v) => MapEntry(
            protocol.deserialize<String>(k),
            protocol.deserialize<List<List<Map<int, _i195.SimpleData>>?>>(v),
          ),
        );
    map[List<List<Map<int, _i195.SimpleData>>?>] = (data, protocol) =>
        (data as List)
            .map(
              (e) => protocol.deserialize<List<Map<int, _i195.SimpleData>>?>(e),
            )
            .toList();
    map[List<Map<int, _i195.SimpleData>>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<Map<int, _i195.SimpleData>>(e))
        .toList();
    map[Map<int, _i195.SimpleData>] = (data, protocol) => Map.fromEntries(
      (data as List).map(
        (e) => MapEntry(
          protocol.deserialize<int>(e['k']),
          protocol.deserialize<_i195.SimpleData>(e['v']),
        ),
      ),
    );
    map[_i1.getType<List<Map<int, _i195.SimpleData>>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<Map<int, _i195.SimpleData>>(e))
              .toList()
    ...
    map[_i1.getType<Map<String, List<List<Map<int, _i195.SimpleData>>?>>?>()] =
        (data, protocol) => (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
    ...
    map[Map<String, Map<int, _i195.SimpleData>>] = (data, protocol) =>
        (data as Map).map(
          (k, v) => MapEntry(
            protocol.deserialize<String>(k),
            protocol.deserialize<Map<int, _i195.SimpleData>>(v),
          ),
        );
    map[Map<int, _i195.SimpleData>] = (data, protocol) => Map.fromEntries(
      (data as List).map(
    ...
    map[_i1.getType<Map<String, Map<int, _i195.SimpleData>>?>()] =
        (data, protocol) => (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
    ...
    map[List<_i108.SealedParent>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i108.SealedParent>(e))
        .toList();
    map[List<_i91.SealedAppException>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i91.SealedAppException>(e))
        .toList();
    map[_i1.getType<(bool,)?>()] = (data, protocol) => (data == null)
        ? null
        : (protocol.deserialize<bool>(((data as Map)['p'] as List)[0]),);
    map[List<_i217.SharedModel>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i217.SharedModel>(e))
        .toList();
    map[List<_i217.SharedModel?>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i217.SharedModel?>(e))
        .toList();
    map[List<_i217.SharedModel>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i217.SharedModel>(e))
        .toList();
    map[_i1.getType<List<_i217.SharedModel>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i217.SharedModel>(e))
              .toList()
        : null);
    map[Map<String, _i217.SharedModel>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<_i217.SharedModel>(v),
      ),
    );
    map[Map<String, _i217.SharedModel>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
    ...
    map[_i1.getType<Map<String, _i217.SharedModel>?>()] = (data, protocol) =>
        (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
        ...
        : null);
    map[Map<String, _i217.SharedSubclass>] = (data, protocol) =>
        (data as Map).map(
          (k, v) => MapEntry(
            protocol.deserialize<String>(k),
            protocol.deserialize<_i217.SharedSubclass>(v),
          ),
        );
    map[Set<_i217.SharedModel>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i217.SharedModel>(e))
        .toSet();
    map[Set<_i217.SharedModel>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i217.SharedModel>(e))
        .toSet();
    map[_i1.getType<Set<_i217.SharedModel>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i217.SharedModel>(e))
              .toSet()
        : null);
    map[List<_i205.TestEnumStringified>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i205.TestEnumStringified>(e))
        .toList();
    map[_i1.getType<List<_i205.TestEnumStringified>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i205.TestEnumStringified>(e))
              .toList()
    ...
    map[_i1.getType<(_i205.TestEnumStringified,)?>()] = (data, protocol) =>
        ...
        ? null
        : (
            protocol.deserialize<_i205.TestEnumStringified>(
              ((data as Map)['p'] as List)[0],
            ),
          );
    map[List<(_i205.TestEnumStringified,)>] = (data, protocol) => (data as List)
    ...
    map[_i1.getType<List<(_i205.TestEnumStringified,)>?>()] =
        (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<(_i205.TestEnumStringified,)>(e))
              .toList()
    ...
    map[_i1.getType<(_i151.Nullability,)?>()] = (data, protocol) =>
        ...
        ? null
        : (
            protocol.deserialize<_i151.Nullability>(
              ((data as Map)['p'] as List)[0],
            ),
          );
    map[_i1.getType<({_i205.TestEnumStringified value})?>()] =
        (data, protocol) => (data == null)
        ? null
        : (
            value: protocol.deserialize<_i205.TestEnumStringified>(
              ((data as Map)['n'] as Map)['value'],
            ),
          );
    map[List<({_i205.TestEnumStringified value})>] = (data, protocol) =>
        (data as List)
            .map(
              (e) =>
                  protocol.deserialize<({_i205.TestEnumStringified value})>(e),
            )
            .toList();
    map[_i1
        .getType<({_i205.TestEnumStringified value})>()] = (data, protocol) => (
      value: protocol.deserialize<_i205.TestEnumStringified>(
        ((data as Map)['n'] as Map)['value'],
      ),
    );
    map[_i1.getType<List<({_i205.TestEnumStringified value})>?>()] =
        (data, protocol) => (data != null
        ? (data as List)
              .map(
                (e) => protocol
                    .deserialize<({_i205.TestEnumStringified value})>(e),
              )
              .toList()
        : null);
    map[_i1
    ...
    map[_i1.getType<({_i215.ModuleClass value})?>()] = (data, protocol) =>
        (data == null)
        ? null
        : (
            value: protocol.deserialize<_i215.ModuleClass>(
              ((data as Map)['n'] as Map)['value'],
            ),
          );
    map[_i1.getType<({_i151.Nullability value})?>()] = (data, protocol) =>
        (data == null)
        ? null
        : (
            value: protocol.deserialize<_i151.Nullability>(
              ((data as Map)['n'] as Map)['value'],
            ),
          );
    map[Map<int, int>] = (data, protocol) => Map.fromEntries(
    ...
    map[List<_i201.TestEnum>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i201.TestEnum>(e))
        .toList();
    map[_i1.getType<List<_i201.TestEnum>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i201.TestEnum>(e))
              .toList()
        : null);
    map[List<_i206.Types>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i206.Types>(e))
        .toList();
    map[_i1.getType<List<_i206.Types>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i206.Types>(e))
              .toList()
        : null);
    map[List<Map<String, _i206.Types>>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<Map<String, _i206.Types>>(e))
        .toList();
    map[Map<String, _i206.Types>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<_i206.Types>(v),
      ),
    );
    map[_i1.getType<List<Map<String, _i206.Types>>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<Map<String, _i206.Types>>(e))
              .toList()
    ...
    map[List<List<_i206.Types>>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<List<_i206.Types>>(e))
        .toList();
    map[List<_i206.Types>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i206.Types>(e))
        .toList();
    map[_i1.getType<List<List<_i206.Types>>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<List<_i206.Types>>(e))
              .toList()
    ...
    map[List<(_i201.TestEnum,)>] = (data, protocol) => (data as List)
        ...
        .toList();
    map[_i1.getType<(_i201.TestEnum,)>()] = (data, protocol) => (
      protocol.deserialize<_i201.TestEnum>(((data as Map)['p'] as List)[0]),
    );
    map[_i1.getType<List<(_i201.TestEnum,)>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
    ...
    map[_i1.getType<Map<String, String>?>()] = (data, protocol) => (data != null
        ...
        : null);
    map[Map<_i216.ByteData, String>] = (data, protocol) => Map.fromEntries(
      (data as List).map(
        (e) => MapEntry(
          protocol.deserialize<_i216.ByteData>(e['k']),
          protocol.deserialize<String>(e['v']),
        ),
      ),
    );
    map[_i1.getType<Map<_i216.ByteData, String>?>()] = (data, protocol) =>
        (data != null
        ? Map.fromEntries(
            (data as List).map(
              (e) => MapEntry(
    ...
    map[_i1.getType<Map<BigInt, String>?>()] = (data, protocol) => (data != null
        ...
        : null);
    map[Map<_i201.TestEnum, String>] = (data, protocol) => Map.fromEntries(
      (data as List).map(
        (e) => MapEntry(
          protocol.deserialize<_i201.TestEnum>(e['k']),
          protocol.deserialize<String>(e['v']),
        ),
      ),
    );
    map[_i1.getType<Map<_i201.TestEnum, String>?>()] = (data, protocol) =>
        (data != null
        ? Map.fromEntries(
            (data as List).map(
              (e) => MapEntry(
        ...
        : null);
    map[Map<_i205.TestEnumStringified, String>] = (data, protocol) =>
        Map.fromEntries(
          (data as List).map(
            (e) => MapEntry(
              protocol.deserialize<_i205.TestEnumStringified>(e['k']),
              protocol.deserialize<String>(e['v']),
            ),
          ),
        );
    map[_i1.getType<Map<_i205.TestEnumStringified, String>?>()] =
        (data, protocol) => (data != null
        ? Map.fromEntries(
            (data as List).map(
              (e) => MapEntry(
        ...
        : null);
    map[Map<_i206.Types, String>] = (data, protocol) => Map.fromEntries(
      (data as List).map(
        (e) => MapEntry(
          protocol.deserialize<_i206.Types>(e['k']),
          protocol.deserialize<String>(e['v']),
        ),
      ),
    );
    map[_i1.getType<Map<_i206.Types, String>?>()] = (data, protocol) =>
        (data != null
        ? Map.fromEntries(
            (data as List).map(
              (e) => MapEntry(
        ...
        : null);
    map[Map<Map<_i206.Types, String>, String>] = (data, protocol) =>
        Map.fromEntries(
          (data as List).map(
            (e) => MapEntry(
              protocol.deserialize<Map<_i206.Types, String>>(e['k']),
              protocol.deserialize<String>(e['v']),
            ),
          ),
        );
    ...
    map[_i1.getType<Map<Map<_i206.Types, String>, String>?>()] =
        (data, protocol) => (data != null
        ? Map.fromEntries(
            (data as List).map(
              (e) => MapEntry(
    ...
    map[Map<List<_i206.Types>, String>] = (data, protocol) => Map.fromEntries(
      (data as List).map(
        (e) => MapEntry(
          protocol.deserialize<List<_i206.Types>>(e['k']),
          protocol.deserialize<String>(e['v']),
        ),
      ),
    );
    map[List<_i206.Types>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i206.Types>(e))
        .toList();
    map[_i1.getType<Map<List<_i206.Types>, String>?>()] = (data, protocol) =>
        (data != null
        ? Map.fromEntries(
            (data as List).map(
              (e) => MapEntry(
    ...
    map[_i1.getType<Map<String, _i216.ByteData>?>()] = (data, protocol) =>
        (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
    ...
    map[_i1.getType<Map<String, BigInt>?>()] = (data, protocol) => (data != null
        ...
        : null);
    map[Map<String, _i201.TestEnum>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<_i201.TestEnum>(v),
      ),
    );
    map[_i1.getType<Map<String, _i201.TestEnum>?>()] = (data, protocol) =>
        (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
        ...
        : null);
    map[Map<String, _i205.TestEnumStringified>] = (data, protocol) =>
        (data as Map).map(
          (k, v) => MapEntry(
            protocol.deserialize<String>(k),
            protocol.deserialize<_i205.TestEnumStringified>(v),
          ),
        );
    map[_i1.getType<Map<String, _i205.TestEnumStringified>?>()] =
        (data, protocol) => (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
    ...
    map[_i1.getType<Map<String, _i206.Types>?>()] = (data, protocol) =>
        (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
        ...
        : null);
    map[Map<String, Map<String, _i206.Types>>] = (data, protocol) =>
        (data as Map).map(
          (k, v) => MapEntry(
            protocol.deserialize<String>(k),
            protocol.deserialize<Map<String, _i206.Types>>(v),
          ),
        );
    map[Map<String, _i206.Types>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
    ...
    map[_i1.getType<Map<String, Map<String, _i206.Types>>?>()] =
        (data, protocol) => (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
    ...
    map[Map<String, List<_i206.Types>>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<List<_i206.Types>>(v),
      ),
    );
    map[List<_i206.Types>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i206.Types>(e))
        .toList();
    map[_i1.getType<Map<String, List<_i206.Types>>?>()] = (data, protocol) =>
        (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
    ...
    map[_i1.getType<(String,)?>()] = (data, protocol) => (data == null)
        ? null
        : (protocol.deserialize<String>(((data as Map)['p'] as List)[0]),);
    map[_i1.getType<(_i216.ByteData,)?>()] = (data, protocol) => (data == null)
        ? null
        : (
            protocol.deserialize<_i216.ByteData>(
              ((data as Map)['p'] as List)[0],
            ),
          );
    ...
    map[_i1.getType<(_i201.TestEnum,)?>()] = (data, protocol) => (data == null)
        ? null
        : (
            protocol.deserialize<_i201.TestEnum>(
              ((data as Map)['p'] as List)[0],
            ),
          );
    map[_i1.getType<(List<int>,)?>()] = (data, protocol) => (data == null)
    ...
    map[_i1.getType<(_i195.SimpleData,)?>()] = (data, protocol) =>
        ...
        ? null
        : (
            protocol.deserialize<_i195.SimpleData>(
              ((data as Map)['p'] as List)[0],
            ),
          );
    map[_i1.getType<({_i195.SimpleData namedModel})?>()] = (data, protocol) =>
        (data == null)
        ? null
        : (
            namedModel: protocol.deserialize<_i195.SimpleData>(
              ((data as Map)['n'] as Map)['namedModel'],
            ),
          );
    map[_i1.getType<(_i195.SimpleData, {_i195.SimpleData namedModel})?>()] =
        (data, protocol) => (data == null)
        ? null
        : (
            protocol.deserialize<_i195.SimpleData>(
    ...
    map[_i1
        .getType<
          (
            (List<(_i195.SimpleData,)>,), {
            (_i195.SimpleData, Map<String, _i195.SimpleData>) namedNestedRecord,
          })?
        >()] = (data, protocol) => (data == null)
        ? null
        : (
            protocol.deserialize<(List<(_i195.SimpleData,)>,)>(
              ((data as Map)['p'] as List)[0],
            ),
            namedNestedRecord: protocol
                .deserialize<(_i195.SimpleData, Map<String, _i195.SimpleData>)>(
                  data['n']['namedNestedRecord'],
                ),
          );
    ...
    map[_i1.getType<Set<String>?>()] = (data, protocol) => (data != null
        ? (data as List).map((e) => protocol.deserialize<String>(e)).toSet()
        : null);
    map[Set<_i216.ByteData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i216.ByteData>(e))
        .toSet();
    map[_i1.getType<Set<_i216.ByteData>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i216.ByteData>(e))
              .toSet()
        : null);
    ...
    map[_i1.getType<Set<BigInt>?>()] = (data, protocol) => (data != null
        ? (data as List).map((e) => protocol.deserialize<BigInt>(e)).toSet()
        : null);
    map[Set<_i201.TestEnum>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i201.TestEnum>(e))
        .toSet();
    map[_i1.getType<Set<_i201.TestEnum>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i201.TestEnum>(e))
              .toSet()
        : null);
    map[Set<_i205.TestEnumStringified>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i205.TestEnumStringified>(e))
        .toSet();
    map[_i1.getType<Set<_i205.TestEnumStringified>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i205.TestEnumStringified>(e))
              .toSet()
        : null);
    map[Set<_i206.Types>] = (data, protocol) =>
        (data as List).map((e) => protocol.deserialize<_i206.Types>(e)).toSet();
    map[_i1.getType<Set<_i206.Types>?>()] = (data, protocol) => (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i206.Types>(e))
              .toSet()
        : null);
    map[Set<Map<String, _i206.Types>>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<Map<String, _i206.Types>>(e))
        .toSet();
    map[Map<String, _i206.Types>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
    ...
    map[_i1.getType<Set<Map<String, _i206.Types>>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<Map<String, _i206.Types>>(e))
              .toSet()
    ...
    map[Set<List<_i206.Types>>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<List<_i206.Types>>(e))
        .toSet();
    map[List<_i206.Types>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i206.Types>(e))
        .toList();
    map[_i1.getType<Set<List<_i206.Types>>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<List<_i206.Types>>(e))
              .toSet()
    ...
    map[List<String>] = (data, protocol) =>
        (data as List).map((e) => protocol.deserialize<String>(e)).toList();
    map[List<_i218.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i218.SimpleData>(e))
        .toList();
    map[List<int>] = (data, protocol) =>
        (data as List).map((e) => protocol.deserialize<int>(e)).toList();
    ...
    map[List<_i218.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i218.SimpleData>(e))
        .toList();
    map[_i1.getType<List<_i218.SimpleData>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<_i218.SimpleData>(e))
              .toList()
    ...
    map[Map<_i219.TestEnum, int>] = (data, protocol) => Map.fromEntries(
      (data as List).map(
        (e) => MapEntry(
          protocol.deserialize<_i219.TestEnum>(e['k']),
          protocol.deserialize<int>(e['v']),
        ),
      ),
    );
    map[Map<String, _i219.TestEnum>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<_i219.TestEnum>(v),
      ),
    );
    map[Map<String, double>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
    ...
    map[Map<String, _i218.SimpleData>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
        protocol.deserialize<_i218.SimpleData>(v),
      ),
    );
    map[Map<String, _i218.SimpleData?>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
    ...
    map[_i1.getType<Map<String, _i218.SimpleData>?>()] = (data, protocol) =>
        (data != null
        ? (data as Map).map(
            (k, v) => MapEntry(
              protocol.deserialize<String>(k),
    ...
    map[dynamic] = (data, protocol) =>
        protocol.deserializeDynamicFieldValue(data);
    map[List<_i220.UserInfo>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i220.UserInfo>(e))
        .toList();
    map[Set<int>] = (data, protocol) =>
        (data as List).map((e) => protocol.deserialize<int>(e)).toSet();
    map[Set<_i218.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i218.SimpleData>(e))
        .toSet();
    map[List<Set<_i218.SimpleData>>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<Set<_i218.SimpleData>>(e))
        .toList();
    map[Set<_i218.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i218.SimpleData>(e))
        .toSet();
    ...
    map[_i1.getType<(int, _i218.SimpleData)>()] = (data, protocol) => (
      protocol.deserialize<int>(((data as Map)['p'] as List)[0]),
      protocol.deserialize<_i218.SimpleData>(data['p'][1]),
    );
    map[_i1.getType<(int, _i218.SimpleData)?>()] = (data, protocol) =>
        (data == null)
        ? null
    ...
    map[_i1.getType<({_i218.SimpleData data, int number})>()] =
        (data, protocol) => (
          data: protocol.deserialize<_i218.SimpleData>(
    ...
    map[_i1.getType<({_i218.SimpleData? data, int? number})>()] =
        (data, protocol) => (
          data: ((data as Map)['n'] as Map)['data'] == null
              ? null
              : protocol.deserialize<_i218.SimpleData>(data['n']['data']),
    ...
    map[_i1.getType<(int, {_i218.SimpleData data})>()] = (data, protocol) => (
      protocol.deserialize<int>(((data as Map)['p'] as List)[0]),
      data: protocol.deserialize<_i218.SimpleData>(data['n']['data']),
    );
    map[_i1.getType<(int, {_i218.SimpleData data})?>()] = (data, protocol) =>
        (data == null)
        ? null
    ...
    map[List<(int, _i218.SimpleData)>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<(int, _i218.SimpleData)>(e))
        .toList();
    map[_i1.getType<(int, _i218.SimpleData)>()] = (data, protocol) => (
      protocol.deserialize<int>(((data as Map)['p'] as List)[0]),
      protocol.deserialize<_i218.SimpleData>(data['p'][1]),
    ...
    map[Set<(int, _i218.SimpleData)>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<(int, _i218.SimpleData)>(e))
        .toSet();
    map[_i1.getType<(int, _i218.SimpleData)>()] = (data, protocol) => (
      protocol.deserialize<int>(((data as Map)['p'] as List)[0]),
    ...
    map[_i1.getType<Set<(int, _i218.SimpleData)>?>()] = (data, protocol) =>
        (data != null
        ? (data as List)
              .map((e) => protocol.deserialize<(int, _i218.SimpleData)>(e))
              .toSet()
    ...
    map[Map<String, (int, _i218.SimpleData)>] = (data, protocol) =>
        (data as Map).map(
          (k, v) => MapEntry(
            protocol.deserialize<String>(k),
            protocol.deserialize<(int, _i218.SimpleData)>(v),
          ),
        );
    map[_i1.getType<(int, _i218.SimpleData)>()] = (data, protocol) => (
      protocol.deserialize<int>(((data as Map)['p'] as List)[0]),
    ...
    map[Map<(String, int), (int, _i218.SimpleData)>] = (data, protocol) =>
        Map.fromEntries(
          (data as List).map(
            (e) => MapEntry(
              protocol.deserialize<(String, int)>(e['k']),
              protocol.deserialize<(int, _i218.SimpleData)>(e['v']),
            ),
          ),
        );
    ...
    map[_i1.getType<(int,)>()] = (data, protocol) =>
        (protocol.deserialize<int>(((data as Map)['p'] as List)[0]),);
    map[_i1.getType<({(_i218.SimpleData, double) namedSubRecord})>()] =
        (data, protocol) => (
          namedSubRecord: protocol.deserialize<(_i218.SimpleData, double)>(
            ((data as Map)['n'] as Map)['namedSubRecord'],
          ),
        );
    map[_i1.getType<(_i218.SimpleData, double)>()] = (data, protocol) => (
      protocol.deserialize<_i218.SimpleData>(((data as Map)['p'] as List)[0]),
    ...
    map[_i1.getType<({(_i218.SimpleData, double)? namedSubRecord})>()] =
        (data, protocol) => (
          namedSubRecord: ((data as Map)['n'] as Map)['namedSubRecord'] == null
              ? null
              : protocol.deserialize<(_i218.SimpleData, double)>(
    ...
    map[_i1.getType<(_i218.SimpleData, double)?>()] = (data, protocol) =>
        ...
        ? null
        : (
            protocol.deserialize<_i218.SimpleData>(
              ((data as Map)['p'] as List)[0],
            ),
            protocol.deserialize<double>(data['p'][1]),
          );
    map[_i1
        .getType<
          ((int, String), {(_i218.SimpleData, double) namedSubRecord})
        >()] = (data, protocol) => (
    ...
    map[List<((int, String), {(_i218.SimpleData, double) namedSubRecord})>] =
            ...
            .map(
              (e) =>
                  protocol.deserialize<
                    (
                      (int, String), {
                      (_i218.SimpleData, double) namedSubRecord,
                    })?
                  >(e),
            )
            .toList();
    ...
    map[_i1
        .getType<
          List<((int, String), {(_i218.SimpleData, double) namedSubRecord})?>?
        >()] = (data, protocol) => (data != null
        ? (data as List)
              .map(
                (e) =>
    ...
    map[_i1.getType<(int?, _i215.ProjectStreamingClass?)>()] =
        (data, protocol) => (
          ((data as Map)['p'] as List)[0] == null
              ? null
              : protocol.deserialize<int>(data['p'][0]),
          ((data)['p'] as List)[1] == null
              ? null
              : protocol.deserialize<_i215.ProjectStreamingClass>(data['p'][1]),
        );
    ...
    map[Set<Duration?>] = (data, protocol) =>
        (data as List).map((e) => protocol.deserialize<Duration?>(e)).toSet();
    map[List<_i222.Types>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i222.Types>(e))
        .toList();
    ...
    map[_i1
        .getType<
          (String, (Map<String, int>, {bool flag, _i218.SimpleData simpleData}))
        >()] = (data, protocol) => (
      protocol.deserialize<String>(((data as Map)['p'] as List)[0]),
      protocol.deserialize<
        (Map<String, int>, {bool flag, _i218.SimpleData simpleData})
      >(data['p'][1]),
    );
    map[_i1
        .getType<
      ...
      simpleData: protocol.deserialize<_i218.SimpleData>(
        data['n']['simpleData'],
      ),
    );
    ...
    map[List<(_i195.SimpleData,)>] = (data, protocol) => (data as List)
        ...
        .toList();
    map[_i1.getType<(_i195.SimpleData,)>()] = (data, protocol) => (
      protocol.deserialize<_i195.SimpleData>(((data as Map)['p'] as List)[0]),
    );
    map[_i1.getType<(_i195.SimpleData,)>()] = (data, protocol) => (
      protocol.deserialize<_i195.SimpleData>(((data as Map)['p'] as List)[0]),
    );
    map[_i1.getType<(_i195.SimpleData, Map<String, _i195.SimpleData>)>()] =
        (data, protocol) => (
          protocol.deserialize<_i195.SimpleData>(
            ((data as Map)['p'] as List)[0],
          ),
          protocol.deserialize<Map<String, _i195.SimpleData>>(data['p'][1]),
        );
    map[Map<String, _i195.SimpleData>] = (data, protocol) => (data as Map).map(
      (k, v) => MapEntry(
        protocol.deserialize<String>(k),
    ...
    map[_i1.getType<(int,)?>()] = (data, protocol) => (data == null)
        ? null
        : (protocol.deserialize<int>(((data as Map)['p'] as List)[0]),);
    map[_i217.CustomClass] = (data, protocol) =>
        _i217.CustomClass.fromJson(data);
    map[_i217.CustomClass2] = (data, protocol) =>
        _i217.CustomClass2.fromJson(data);
    map[_i217.CustomClassWithoutProtocolSerialization] = (data, protocol) =>
        _i217.CustomClassWithoutProtocolSerialization.fromJson(data);
    map[_i217.CustomClassWithProtocolSerialization] = (data, protocol) =>
        _i217.CustomClassWithProtocolSerialization.fromJson(data);
    map[_i217.CustomClassWithProtocolSerializationMethod] = (data, protocol) =>
        _i217.CustomClassWithProtocolSerializationMethod.fromJson(data);
    map[_i217.ProtocolCustomClass] = (data, protocol) =>
        _i217.ProtocolCustomClass.fromJson(data);
    map[_i217.ExternalCustomClass] = (data, protocol) =>
        _i217.ExternalCustomClass.fromJson(data);
    map[_i217.FreezedCustomClass] = (data, protocol) =>
        _i217.FreezedCustomClass.fromJson(data);
    map[_i1.getType<_i217.CustomClass?>()] = (data, protocol) =>
        (data != null ? _i217.CustomClass.fromJson(data) : null);
    map[_i1.getType<_i217.CustomClass2?>()] = (data, protocol) =>
        (data != null ? _i217.CustomClass2.fromJson(data) : null);
    map[_i1.getType<_i217.CustomClassWithoutProtocolSerialization?>()] =
        (data, protocol) => (data != null
        ? _i217.CustomClassWithoutProtocolSerialization.fromJson(data)
        : null);
    ...
    map[_i1.getType<_i217.CustomClassWithProtocolSerializationMethod?>()] =
        ...
        ? _i217.CustomClassWithProtocolSerializationMethod.fromJson(data)
        : null);
    map[_i1.getType<_i217.ProtocolCustomClass?>()] = (data, protocol) =>
        (data != null ? _i217.ProtocolCustomClass.fromJson(data) : null);
    map[_i1.getType<_i217.ExternalCustomClass?>()] = (data, protocol) =>
        (data != null ? _i217.ExternalCustomClass.fromJson(data) : null);
    map[_i1.getType<_i217.FreezedCustomClass?>()] = (data, protocol) =>
        (data != null ? _i217.FreezedCustomClass.fromJson(data) : null);
    map[List<int>] = (data, protocol) =>
        (data as List).map((e) => protocol.deserialize<int>(e)).toList();
    map[List<_i218.SimpleData>] = (data, protocol) => (data as List)
        .map((e) => protocol.deserialize<_i218.SimpleData>(e))
  ...
  T deserialize<T>(
    ...
    try {
      return _i220.Protocol().deserialize<T>(data, t);
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      _i217.CustomClass => 'CustomClass',
      _i217.CustomClass2 => 'CustomClass2',
      _i217.CustomClassWithoutProtocolSerialization =>
        'CustomClassWithoutProtocolSerialization',
      _i217.CustomClassWithProtocolSerialization =>
        'CustomClassWithProtocolSerialization',
      _i217.CustomClassWithProtocolSerializationMethod =>
        'CustomClassWithProtocolSerializationMethod',
      _i217.ProtocolCustomClass => 'ProtocolCustomClass',
      _i217.ExternalCustomClass => 'ExternalCustomClass',
      _i217.FreezedCustomClass => 'FreezedCustomClass',
      ...
      _i191.ServerOnlyDefault => 'ServerOnlyDefault',
      _i192.SessionAuthInfo => 'SessionAuthInfo',
      _i193.SharedModelContainer => 'SharedModelContainer',
      _i194.SharedModelSubclass => 'SharedModelSubclass',
      _i195.SimpleData => 'SimpleData',
      _i196.SimpleDataList => 'SimpleDataList',
      _i197.SimpleDataMap => 'SimpleDataMap',
      _i198.SimpleDataObject => 'SimpleDataObject',
      _i199.SimpleDateTime => 'SimpleDateTime',
      _i200.ModelInSubfolder => 'ModelInSubfolder',
      _i201.TestEnum => 'TestEnum',
      _i202.TestEnumDefaultSerialization => 'TestEnumDefaultSerialization',
      _i203.TestEnumEnhanced => 'TestEnumEnhanced',
      _i204.TestEnumEnhancedByName => 'TestEnumEnhancedByName',
      _i205.TestEnumStringified => 'TestEnumStringified',
      _i206.Types => 'Types',
      _i207.TypesList => 'TypesList',
      _i208.TypesMap => 'TypesMap',
      _i209.TypesRecord => 'TypesRecord',
      _i210.TypesSet => 'TypesSet',
      _i211.TypesSetRequired => 'TypesSetRequired',
      _i212.UniqueData => 'UniqueData',
      _i213.UniqueDataWithNonPersist => 'UniqueDataWithNonPersist',
      _i214.UpsertTestModel => 'UpsertTestModel',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      case _i217.CustomClass():
        return 'CustomClass';
      case _i217.CustomClass2():
        return 'CustomClass2';
      case _i217.CustomClassWithoutProtocolSerialization():
        return 'CustomClassWithoutProtocolSerialization';
      case _i217.CustomClassWithProtocolSerialization():
        return 'CustomClassWithProtocolSerialization';
      case _i217.CustomClassWithProtocolSerializationMethod():
        return 'CustomClassWithProtocolSerializationMethod';
      case _i217.ProtocolCustomClass():
        return 'ProtocolCustomClass';
      case _i217.ExternalCustomClass():
        return 'ExternalCustomClass';
      case _i217.FreezedCustomClass():
      ...
      case _i191.ServerOnlyDefault():
        return 'ServerOnlyDefault';
      case _i192.SessionAuthInfo():
        return 'SessionAuthInfo';
      case _i193.SharedModelContainer():
        return 'SharedModelContainer';
      case _i194.SharedModelSubclass():
        return 'SharedModelSubclass';
      case _i195.SimpleData():
        return 'SimpleData';
      case _i196.SimpleDataList():
        return 'SimpleDataList';
      case _i197.SimpleDataMap():
        return 'SimpleDataMap';
      case _i198.SimpleDataObject():
        return 'SimpleDataObject';
      case _i199.SimpleDateTime():
        return 'SimpleDateTime';
      case _i200.ModelInSubfolder():
        return 'ModelInSubfolder';
      case _i201.TestEnum():
        return 'TestEnum';
      case _i202.TestEnumDefaultSerialization():
        return 'TestEnumDefaultSerialization';
      case _i203.TestEnumEnhanced():
        return 'TestEnumEnhanced';
      case _i204.TestEnumEnhancedByName():
        return 'TestEnumEnhancedByName';
      case _i205.TestEnumStringified():
        return 'TestEnumStringified';
      case _i206.Types():
        return 'Types';
      case _i207.TypesList():
        return 'TypesList';
      case _i208.TypesMap():
        return 'TypesMap';
      case _i209.TypesRecord():
        return 'TypesRecord';
      case _i210.TypesSet():
        return 'TypesSet';
      case _i211.TypesSetRequired():
        return 'TypesSetRequired';
      case _i212.UniqueData():
        return 'UniqueData';
      case _i213.UniqueDataWithNonPersist():
        return 'UniqueDataWithNonPersist';
      case _i214.UpsertTestModel():
        return 'UpsertTestModel';
    }
    if (data is List<int>) {
      return 'List<int>';
    }
    if (data is List<_i218.SimpleData>) {
      return 'List<SimpleData>';
    }
    if (data is List<_i220.UserInfo>) {
    ...
    if (data is Set<_i218.SimpleData>) {
      return 'Set<SimpleData>';
    }
    if (data is List<Set<_i218.SimpleData>>) {
    ...
    if (data is (int?, _i215.ProjectStreamingClass?)) {
    ...
    className = _i220.Protocol().getClassNameForObject(data);
    if (className != null) {
      return className.contains('.') ? className : 'serverpod_auth.$className';
    }
    className = _i215.Protocol().getClassNameForObject(data);
    if (className != null) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'CustomClass') {
      return deserialize<_i217.CustomClass>(data['data']);
    }
    if (dataClassName == 'CustomClass2') {
      return deserialize<_i217.CustomClass2>(data['data']);
    }
    if (dataClassName == 'CustomClassWithoutProtocolSerialization') {
      return deserialize<_i217.CustomClassWithoutProtocolSerialization>(
        data['data'],
      );
    }
    if (dataClassName == 'CustomClassWithProtocolSerialization') {
      return deserialize<_i217.CustomClassWithProtocolSerialization>(
        data['data'],
      );
    }
    if (dataClassName == 'CustomClassWithProtocolSerializationMethod') {
      return deserialize<_i217.CustomClassWithProtocolSerializationMethod>(
        data['data'],
      );
    }
    if (dataClassName == 'ProtocolCustomClass') {
      return deserialize<_i217.ProtocolCustomClass>(data['data']);
    }
    if (dataClassName == 'ExternalCustomClass') {
      return deserialize<_i217.ExternalCustomClass>(data['data']);
    }
    if (dataClassName == 'FreezedCustomClass') {
      return deserialize<_i217.FreezedCustomClass>(data['data']);
    }
    ...
    if (dataClassName == 'ServerOnlyDefault') {
      return deserialize<_i191.ServerOnlyDefault>(data['data']);
    }
    if (dataClassName == 'SessionAuthInfo') {
      return deserialize<_i192.SessionAuthInfo>(data['data']);
    }
    if (dataClassName == 'SharedModelContainer') {
      return deserialize<_i193.SharedModelContainer>(data['data']);
    }
    if (dataClassName == 'SharedModelSubclass') {
      return deserialize<_i194.SharedModelSubclass>(data['data']);
    }
    if (dataClassName == 'SimpleData') {
      return deserialize<_i195.SimpleData>(data['data']);
    }
    if (dataClassName == 'SimpleDataList') {
      return deserialize<_i196.SimpleDataList>(data['data']);
    }
    if (dataClassName == 'SimpleDataMap') {
      return deserialize<_i197.SimpleDataMap>(data['data']);
    }
    if (dataClassName == 'SimpleDataObject') {
      return deserialize<_i198.SimpleDataObject>(data['data']);
    }
    if (dataClassName == 'SimpleDateTime') {
      return deserialize<_i199.SimpleDateTime>(data['data']);
    }
    if (dataClassName == 'ModelInSubfolder') {
      return deserialize<_i200.ModelInSubfolder>(data['data']);
    }
    if (dataClassName == 'TestEnum') {
      return deserialize<_i201.TestEnum>(data['data']);
    }
    if (dataClassName == 'TestEnumDefaultSerialization') {
      return deserialize<_i202.TestEnumDefaultSerialization>(data['data']);
    }
    if (dataClassName == 'TestEnumEnhanced') {
      return deserialize<_i203.TestEnumEnhanced>(data['data']);
    }
    if (dataClassName == 'TestEnumEnhancedByName') {
      return deserialize<_i204.TestEnumEnhancedByName>(data['data']);
    }
    if (dataClassName == 'TestEnumStringified') {
      return deserialize<_i205.TestEnumStringified>(data['data']);
    }
    if (dataClassName == 'Types') {
      return deserialize<_i206.Types>(data['data']);
    }
    if (dataClassName == 'TypesList') {
      return deserialize<_i207.TypesList>(data['data']);
    }
    if (dataClassName == 'TypesMap') {
      return deserialize<_i208.TypesMap>(data['data']);
    }
    if (dataClassName == 'TypesRecord') {
      return deserialize<_i209.TypesRecord>(data['data']);
    }
    if (dataClassName == 'TypesSet') {
      return deserialize<_i210.TypesSet>(data['data']);
    }
    if (dataClassName == 'TypesSetRequired') {
      return deserialize<_i211.TypesSetRequired>(data['data']);
    }
    if (dataClassName == 'UniqueData') {
      return deserialize<_i212.UniqueData>(data['data']);
    }
    if (dataClassName == 'UniqueDataWithNonPersist') {
      return deserialize<_i213.UniqueDataWithNonPersist>(data['data']);
    }
    if (dataClassName == 'UpsertTestModel') {
      return deserialize<_i214.UpsertTestModel>(data['data']);
    }
    if (dataClassName.startsWith('serverpod_auth.')) {
      data['className'] = dataClassName.substring(15);
      return _i220.Protocol().deserializeByClassName(data);
    }
    ...
    if (dataClassName == 'List<SimpleData>') {
      return deserialize<List<_i218.SimpleData>>(data['data']);
    }
    if (dataClassName == 'List<serverpod_auth.UserInfo>') {
      return deserialize<List<_i220.UserInfo>>(data['data']);
    }
    if (dataClassName == 'List<SimpleData>?') {
      return deserialize<List<_i218.SimpleData>?>(data['data']);
    }
    ...
    if (dataClassName == 'Set<SimpleData>') {
      return deserialize<Set<_i218.SimpleData>>(data['data']);
    }
    if (dataClassName == 'List<Set<SimpleData>>') {
      return deserialize<List<Set<_i218.SimpleData>>>(data['data']);
    }
    ...
    if (dataClassName ==
      ...
      return deserialize<(int?, _i215.ProjectStreamingClass?)>(data['data']);
    }
    if (dataClassName ==
  ...
  Map<String, dynamic>? mapRecordToJson(Record? record) {
    ...
    if (record is (int, _i218.SimpleData)) {
      return {
        "p": [
          record.$1,
          record.$2.toJson(),
    ...
    if (record is ({_i218.SimpleData data, int number})) {
      return {
        "n": {
    ...
    if (record is (int, {_i218.SimpleData data})) {
      return {
        "p": [
          record.$1,
        ],
    ...
    if (record is ({(_i218.SimpleData, double) namedSubRecord})) {
      return {
        "n": {
    ...
    if (record is (_i218.SimpleData, double)) {
      return {
        "p": [
          record.$1.toJson(),
          record.$2,
    ...
    if (record
        is ((int, String), {(_i218.SimpleData, double) namedSubRecord})) {
      return {
        "p": [
    ...
    if (record is (int?, _i215.ProjectStreamingClass?)) {
      return {
        "p": [
          record.$1,
          record.$2?.toJson(),
    ...
    if (record
        is (Map<String, int>, {bool flag, _i218.SimpleData simpleData})) {
      return {
        "p": [
          record.$1.toJson(),
        ],
    ...
    if (record is (_i215.ModuleClass,)) {
      return {
        "p": [
          record.$1.toJson(),
        ],
    ...
    if (record is (_i205.TestEnumStringified,)) {
      return {
        "p": [
          record.$1.toJson(),
        ],
    ...
    if (record is ({_i215.ModuleClass value})) {
      return {
        "n": {
          "value": record.value.toJson(),
        },
    ...
    if (record is (_i195.SimpleData, {_i195.SimpleData namedModel})) {
      return {
        "p": [
          record.$1.toJson(),
        ],
    ...
    if (record is (List<(_i195.SimpleData,)>,)) {
      return {
        "p": [
          mapContainerToJson(record.$1),
        ],
    ...
    if (record is (_i195.SimpleData, Map<String, _i195.SimpleData>)) {
      return {
        "p": [
          record.$1.toJson(),
          record.$2.toJson(),
    ...
    try {
      return _i220.Protocol().mapRecordToJson(record);
    } catch (_) {}
    try {
