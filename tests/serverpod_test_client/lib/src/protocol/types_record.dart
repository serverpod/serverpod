...
abstract class TypesRecord implements _i1.SerializableModel {
  ...
  factory TypesRecord.fromJson(Map<String, dynamic> jsonSerialization) {
    return TypesRecord(
      ...
      aNestedRecord:
          jsonSerialization['aNestedRecord'] == null
              ? null
              : _i6.Protocol().deserialize<
                ((int, String), {(int, String) namedNestedRecord})?
              >((jsonSerialization['aNestedRecord'] as Map<String, dynamic>)),
      aNestedContainers:
          jsonSerialization['aNestedContainers'] == null
              ? null
              : _i6.Protocol().deserialize<
                (
                  (List<(_i5.SimpleData,)>,), {
                  (_i5.SimpleData, Map<String, _i5.SimpleData>)
                  namedNestedRecord,
                })?
              >(
                (jsonSerialization['aNestedContainers']
                    as Map<String, dynamic>),
              ),
    );
  }
    ...
    return TypesRecord(
      ...
      aString:
          aString is (String,)?
              ...
              : (this.aString!.$1,),
      aByteData:
          aByteData is (_i2.ByteData,)?
              ? aByteData
              : this.aByteData == null
              ? null
              : (this.aByteData!.$1.clone(),),
      aDuration:
          aDuration is (Duration,)?
              ? aDuration
              : this.aDuration == null
              ? null
              : (this.aDuration!.$1,),
      aUuid:
          aUuid is (_i1.UuidValue,)?
              ? aUuid
              : this.aUuid == null
              ? null
              : (this.aUuid!.$1,),
      ...
      aSimpleData:
          aSimpleData is (_i5.SimpleData,)?
              ? aSimpleData
              : this.aSimpleData == null
              ? null
              : (this.aSimpleData!.$1.copyWith(),),
      aNamedModel:
          aNamedModel is ({_i5.SimpleData namedModel})?
              ? aNamedModel
