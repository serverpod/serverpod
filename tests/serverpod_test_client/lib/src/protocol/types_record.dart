...
abstract class TypesRecord
  ...
  factory TypesRecord.fromJson(Map<String, dynamic> jsonSerialization) {
    return TypesRecord(
      anInt: jsonSerialization['anInt'] == null
          ? null
          : _iza9lbb5.Protocol().deserialize<(int,)?>(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (anInt != null) 'anInt': _iza9lbb5.Protocol().mapRecordToJson(anInt),
      if (aBool != null) 'aBool': _iza9lbb5.Protocol().mapRecordToJson(aBool),
      if (aDouble != null)
        'aDouble': _iza9lbb5.Protocol().mapRecordToJson(aDouble),
      if (aDateTime != null)
        'aDateTime': _iza9lbb5.Protocol().mapRecordToJson(aDateTime),
      if (aString != null)
        'aString': _iza9lbb5.Protocol().mapRecordToJson(aString),
      if (aByteData != null)
        'aByteData': _iza9lbb5.Protocol().mapRecordToJson(aByteData),
      if (aDuration != null)
        'aDuration': _iza9lbb5.Protocol().mapRecordToJson(aDuration),
      if (aUuid != null) 'aUuid': _iza9lbb5.Protocol().mapRecordToJson(aUuid),
      if (aUri != null) 'aUri': _iza9lbb5.Protocol().mapRecordToJson(aUri),
      if (aBigInt != null)
        'aBigInt': _iza9lbb5.Protocol().mapRecordToJson(aBigInt),
      if (anEnum != null)
        'anEnum': _iza9lbb5.Protocol().mapRecordToJson(anEnum),
      if (aStringifiedEnum != null)
        'aStringifiedEnum': _iza9lbb5.Protocol().mapRecordToJson(
          aStringifiedEnum,
        ),
      if (aList != null) 'aList': _iza9lbb5.Protocol().mapRecordToJson(aList),
      if (aMap != null) 'aMap': _iza9lbb5.Protocol().mapRecordToJson(aMap),
      if (aSet != null) 'aSet': _iza9lbb5.Protocol().mapRecordToJson(aSet),
      if (aSimpleData != null)
        'aSimpleData': _iza9lbb5.Protocol().mapRecordToJson(aSimpleData),
      if (aNamedModel != null)
        'aNamedModel': _iza9lbb5.Protocol().mapRecordToJson(aNamedModel),
      if (aPositionalAndNamedModel != null)
        'aPositionalAndNamedModel': _iza9lbb5.Protocol().mapRecordToJson(
          aPositionalAndNamedModel,
        ),
      if (aNestedRecord != null)
        'aNestedRecord': _iza9lbb5.Protocol().mapRecordToJson(aNestedRecord),
      if (aNestedContainers != null)
        'aNestedContainers': _iza9lbb5.Protocol().mapRecordToJson(
          aNestedContainers,
        ),
    };
  }
