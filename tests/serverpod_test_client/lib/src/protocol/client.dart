...
import 'package:serverpod_test_client/src/protocol/object_with_object.dart'
    as _i11;
import 'package:serverpod_test_client/src/protocol/sample_view_list.dart'
    as _i12;
...
class _EndpointBasicDatabase extends _i1.EndpointRef {
  ...
  _i2.Future<void> createSampleView() => caller.callServerEndpoint<void>(
        'basicDatabase',
        'createSampleView',
        {},
      );

  _i2.Future<void> createSampleDataForView() => caller.callServerEndpoint<void>(
        'basicDatabase',
        'createSampleDataForView',
        {},
      );

  _i2.Future<void> deleteAllSampleDataForView() =>
      caller.callServerEndpoint<void>(
        'basicDatabase',
        'deleteAllSampleDataForView',
        {},
      );

  _i2.Future<void> deleteChildDataWithId(int id) =>
      caller.callServerEndpoint<void>(
        'basicDatabase',
  ...
  _i2.Future<_i12.SampleViewList?> readSampleView() =>
      caller.callServerEndpoint<_i12.SampleViewList?>(
        'basicDatabase',
        'readSampleView',
        {},
      );

  _i2.Future<int?> countSampleView() => caller.callServerEndpoint<int?>(
        'basicDatabase',
        'countSampleView',
        {},
      );
