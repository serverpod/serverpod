...
class _ObjectWithMapsImpl extends ObjectWithMaps {
  ...
  ObjectWithMaps copyWith({
    ...
    return ObjectWithMaps(
      dataMap:
          dataMap ??
          this.dataMap.map((key0, value0) => MapEntry(key0, value0.copyWith())),
      intMap:
          intMap ?? this.intMap.map((key0, value0) => MapEntry(key0, value0)),
      stringMap:
          stringMap ??
          this.stringMap.map((key0, value0) => MapEntry(key0, value0)),
      dateTimeMap:
          dateTimeMap ??
          this.dateTimeMap.map((key0, value0) => MapEntry(key0, value0)),
      byteDataMap:
          byteDataMap ??
      ...
      durationMap:
          durationMap ??
          this.durationMap.map((key0, value0) => MapEntry(key0, value0)),
      uuidMap:
          uuidMap ?? this.uuidMap.map((key0, value0) => MapEntry(key0, value0)),
      nullableDataMap:
          nullableDataMap ??
      ...
      nullableIntMap:
          nullableIntMap ??
          this.nullableIntMap.map((key0, value0) => MapEntry(key0, value0)),
      nullableStringMap:
          nullableStringMap ??
          this.nullableStringMap.map((key0, value0) => MapEntry(key0, value0)),
      nullableDateTimeMap:
          nullableDateTimeMap ??
      ...
      nullableUuidMap:
          nullableUuidMap ??
          this.nullableUuidMap.map((key0, value0) => MapEntry(key0, value0)),
      intIntMap:
          intIntMap ??
          this.intIntMap.map((key0, value0) => MapEntry(key0, value0)),
    );
  }
}
