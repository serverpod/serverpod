...
abstract class ObjectWithJsonb
  ...
  factory ObjectWithJsonb.fromJson(Map<String, dynamic> jsonSerialization) {
    return ObjectWithJsonb(
      ...
      notJsonb: _iza9lbb5.Protocol().deserialize<List<String>>(
        jsonSerialization['notJsonb'],
      ),
      jsonb: _iza9lbb5.Protocol().deserialize<List<String>>(
        jsonSerialization['jsonb'],
      ),
      jsonbMap: _iza9lbb5.Protocol().deserialize<Map<String, String>>(
        jsonSerialization['jsonbMap'],
      ),
      jsonbObject: _iza9lbb5.Protocol().deserialize<_i0zisc0t.SimpleData>(
        jsonSerialization['jsonbObject'],
      ),
      jsonbIndexed: _iza9lbb5.Protocol().deserialize<List<String>>(
        jsonSerialization['jsonbIndexed'],
      ),
      jsonbIndexedGin: _iza9lbb5.Protocol().deserialize<List<String>>(
        jsonSerialization['jsonbIndexedGin'],
      ),
      jsonbIndexedGinJsonbPath: _iza9lbb5.Protocol().deserialize<List<String>>(
        jsonSerialization['jsonbIndexedGinJsonbPath'],
      ),
      jsonbIndexedImplicitGin: _iza9lbb5.Protocol().deserialize<List<String>>(
  ...
  ObjectWithJsonb copyWith({
    ...
    List<String>? jsonbIndexedGinJsonbPath,
    List<String>? jsonbIndexedImplicitGin,
    List<String>? nullableJsonb = const _isc.$UndefinedList<String>(),
  });
  @override
...
class _ObjectWithJsonbImpl extends ObjectWithJsonb {
  ...
  ObjectWithJsonb copyWith({
    ...
    return ObjectWithJsonb(
      ...
      nullableJsonb: nullableJsonb is _isc.UndefinedSentinel
