...
abstract class OrderUuid
  ...
  factory OrderUuid.fromJson(Map<String, dynamic> jsonSerialization) {
    return OrderUuid(
      ...
      customer: jsonSerialization['customer'] == null
          ? null
          : _iza9lbb5.Protocol().deserialize<_iwdajoe0.CustomerInt>(
              jsonSerialization['customer'],
            ),
      comments: jsonSerialization['comments'] == null
          ? null
          : _iza9lbb5.Protocol().deserialize<List<_i7e4crca.CommentInt>>(
  ...
  OrderUuid copyWith({
    ...
    List<_i7e4crca.CommentInt>? comments =
        const _isc.$UndefinedList<_i7e4crca.CommentInt>(),
  });
  @override
...
class _UndefinedOrderUuid$customer extends _isc.UndefinedSentinel
