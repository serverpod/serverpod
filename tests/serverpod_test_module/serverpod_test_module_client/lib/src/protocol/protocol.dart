...
import 'ignored_endpoint_model.dart' as _i2;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    t ??= T;
    if (t == _i2.IgnoreEndpointModel) {
      return _i2.IgnoreEndpointModel.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i2.IgnoreEndpointModel?>()) {
      return (data != null ? _i2.IgnoreEndpointModel.fromJson(data) : null)
          as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i2.IgnoreEndpointModel) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'IgnoreEndpointModel') {
      return deserialize<_i2.IgnoreEndpointModel>(data['data']);
    }
