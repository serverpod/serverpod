...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      'authTest': _i2.AuthTestEndpoint()..initialize(server, 'authTest', null),
      ...
      'emailAccount':
          _i4.EmailAccountEndpoint()..initialize(server, 'emailAccount', null),
      ...
      'googleAccount':
          _i6.GoogleAccountEndpoint()
            ..initialize(server, 'googleAccount', null),
      'jwtRefresh':
          _i7.JwtRefreshEndpoint()..initialize(server, 'jwtRefresh', null),
      'passwordImportingEmailAccount':
          _i8.PasswordImportingEmailAccountEndpoint()
            ..initialize(server, 'passwordImportingEmailAccount', null),
      'userProfile':
          _i9.UserProfileEndpoint()..initialize(server, 'userProfile', null),
    };
      ...
      methodConnectors: {
        'createTestUser': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['authTest'] as _i2.AuthTestEndpoint)
        ...
        'createSasToken': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['authTest'] as _i2.AuthTestEndpoint)
                      .createSasToken(session, params['authUserId']),
        ),
        'deleteSasTokens': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['authTest'] as _i2.AuthTestEndpoint)
                      .deleteSasTokens(session, params['authUserId']),
        ),
        'createJwtToken': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['authTest'] as _i2.AuthTestEndpoint)
                      .createJwtToken(session, params['authUserId']),
        ),
        'deleteJwtRefreshTokens': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['authTest'] as _i2.AuthTestEndpoint)
                      .deleteJwtRefreshTokens(session, params['authUserId']),
        ),
        ...
        'getNewAuthUserId': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['emailAccountBackwardsCompatibilityTest']
                          as _i3.EmailAccountBackwardsCompatibilityTestEndpoint)
                      .getNewAuthUserId(session, userId: params['userId']),
        ),
        'deleteLegacyAuthData': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['emailAccountBackwardsCompatibilityTest']
                          as _i3.EmailAccountBackwardsCompatibilityTestEndpoint)
                      .deleteLegacyAuthData(session, userId: params['userId']),
        ),
      ...
      methodConnectors: {
        'login': _i1.MethodConnector(
          ...
          call:
              ...
              ) async => (endpoints['googleAccountBackwardsCompatibilityTest']
    ...
    connectors['userProfile'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'get': _i1.MethodConnector(
          ...
          call:
              (_i1.Session session, Map<String, dynamic> params) async =>
                  (endpoints['userProfile'] as _i9.UserProfileEndpoint).get(
                    session,
                  ),
        ),
      },
    );
    modules['serverpod_auth_bridge'] =
        _i11.Endpoints()..initializeEndpoints(server);
    modules['serverpod_auth_core'] =
        _i12.Endpoints()..initializeEndpoints(server);
    modules['serverpod_auth_idp'] =
        _i13.Endpoints()..initializeEndpoints(server);
    modules['serverpod_auth_migration'] =
        _i14.Endpoints()..initializeEndpoints(server);
