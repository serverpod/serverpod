...
-- ACTION ALTER TABLE
--
ALTER TABLE "serverpod_auth_idp_email_account_password_reset_request" ADD COLUMN "setPasswordChallengeId" uuid;
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_new_auth_test', '20251105092903219', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251105092903219', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_bridge', '20251105092831755', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251105092831755', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp', '20251105092721874', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251105092721874', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_migration
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20251105092847663', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251105092847663', "timestamp" = now();
