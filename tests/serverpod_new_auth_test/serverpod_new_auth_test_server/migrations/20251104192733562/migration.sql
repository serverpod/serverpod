...
-- ACTION DROP TABLE
--
DROP TABLE "serverpod_auth_idp_email_account_challenge" CASCADE;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_new_auth_test', '20251104192733562', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251104192733562', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20251104192714554', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251104192714554', "timestamp" = now();
