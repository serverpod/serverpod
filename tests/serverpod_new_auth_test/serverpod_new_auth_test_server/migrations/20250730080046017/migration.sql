...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_new_auth_test', '20250730080046017', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250730080046017', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_backwards_compatibility', '20250725084514469', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250725084514469', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20250730075807526', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250730075807526', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_email_account', '20250725091333105', now())
    ON CONFLICT ("module")
