...
class GreetingRepository {
  ...
  /// Emits [Greeting]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `Greeting.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<Greeting>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<GreetingTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<Greeting>(
      where: where?.call(Greeting.t),
      orderBy: orderBy?.call(Greeting.t),
      orderByList: orderByList?.call(Greeting.t),
      limit: limit,
