...
void main() {
  ...
  group('Given a custom class that does not implement ProtocolSerialization',
      () {
    test(
  ...
  group('Given a custom class that implements ProtocolSerialization', () {
    test(
      ...
      () async {
        ...
        final result =
            await client.customTypes.returnCustomClassWithProtocolSerialization(
          customClass,
        );
        expect(
          result.serverSideValue,
  ...
  group(
      'Given a custom class that does not implement ProtocolSerialization but has the "toJsonForProtocol" method',
      () {
    test(
      'with the "serverSideValue" field set when the method is called then the server returns the "serverSideValue"',
      () async {
    ...
    test(
      'with the "value" field set when the method is called then the server does not return the "value"',
      () async {
        final customClass = CustomClassWithProtocolSerializationMethod(
          value: 'value',
        );
