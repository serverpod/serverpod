...
-- Indexes
CREATE INDEX "serverpod_auth_jwt_refresh_token_last_updated_at" ON "serverpod_auth_jwt_refresh_token" USING btree ("lastUpdatedAt");
...
--
-- Foreign relations for "serverpod_auth_jwt_refresh_token" table
--
ALTER TABLE ONLY "serverpod_auth_jwt_refresh_token"
    ADD CONSTRAINT "serverpod_auth_jwt_refresh_token_fk_0"
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_jwt', '20250725091427383', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250725091427383', "timestamp" = now();
