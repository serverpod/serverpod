...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20251204060207322', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251204060207322', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_bridge', '20251204060147438', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251204060147438', "timestamp" = now();
