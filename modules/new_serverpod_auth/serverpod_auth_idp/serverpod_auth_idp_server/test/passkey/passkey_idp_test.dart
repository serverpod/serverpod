...
void main() {
  ...
  final passKeyIDP = PasskeyIDP(
    PasskeyIDPConfig(hostname: 'localhost'),
    ...
    (final sessionBuilder, final _) {
      ...
      setUp(() async {
        ...
        await PasskeyChallenge.db.insertRow(
          session,
          PasskeyChallenge(id: challengeId, challenge: _registrationChallenge),
        );
      });
      ...
      test(
        ...
        () async {
          ...
          expect(await PasskeyAccount.db.find(session), isEmpty);
        },
      );
    },
  );

  withServerpod('Given an `AuthUser` with a registered passkey,', (
    ...
    setUp(() async {
      ...
      await PasskeyChallenge.db.insertRow(
        session,
        PasskeyChallenge(id: loginChallengeId, challenge: _loginChallenge),
      );
    });
        ...
        await expectLater(
          () => passKeyIDP.login(
            ...
            request: PasskeyLoginRequest(
              ...
              authenticatorData: _loginAuthenticatorData,
              clientDataJSON:
                  (utf8.encode(jsonEncode(brokenClientDataJsonMap))).asByteData,
              signature: _signature,
            ),
          ),
          throwsA(
...
final _registrationChallenge =
    base64Decode('28GIVuuCS/5DG0LA1tNr+01+qWzMf8PfyBZNQPttXqY=').asByteData;
final _keyId = base64Decode('smRGEPLBiguLVdDctsYGBQ==').asByteData;
final _registrationClientDataJSON =
    base64Decode(
...
final _loginChallenge =
    base64Decode('tzDU2jDhlLCF3/hJSEFLZIi3M/xPf06twHtArTYQ5f8=').asByteData;
final _loginAuthenticatorData =
    base64Decode(
      'SZYN5YgOjGh0NBcPZHZgW4_krrmihjLHmVzzuoMdl2MdAAAAAA==',
    ).asByteData;
final _loginClientDataJSON =
    base64Decode(
