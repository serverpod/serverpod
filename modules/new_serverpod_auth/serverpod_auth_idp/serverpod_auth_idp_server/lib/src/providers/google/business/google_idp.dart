...
final class GoogleIDP {
  ...
  GoogleIDP._(this.config, this._tokenIssuer, this.utils, this.admin);
  ...
  factory GoogleIDP(
    ...
    final utils = GoogleIDPUtils(config: config);
    final admin = GoogleIDPAdmin(utils: utils);
    return GoogleIDP._(config, tokenIssuer, utils, admin);
  }
