...
import 'package:serverpod_auth_apple_account_client/serverpod_auth_apple_account_client.dart'
    as _i2;
...
class Protocol extends _i1.SerializationManager {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (className != null) {
      return 'serverpod_auth_apple_account.$className';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName.startsWith('serverpod_auth_apple_account.')) {
