...
import 'jwt/models/authentication_token_info.dart' as _i5;
import 'jwt/models/refresh_token_expired_exception.dart' as _i6;
import 'jwt/models/refresh_token_invalid_secret_exception.dart' as _i7;
import 'jwt/models/refresh_token_malformed_exception.dart' as _i8;
import 'jwt/models/refresh_token_not_found_exception.dart' as _i9;
import 'jwt/models/token_pair.dart' as _i10;
import 'profile/models/user_profile_model.dart' as _i11;
import 'session/models/auth_session_info.dart' as _i12;
import 'session/models/auth_success.dart' as _i13;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i5.AuthenticationTokenInfo) {
      return _i5.AuthenticationTokenInfo.fromJson(data) as T;
    }
    ...
    if (t == _i11.UserProfileModel) {
      return _i11.UserProfileModel.fromJson(data) as T;
    }
    if (t == _i12.AuthSessionInfo) {
      return _i12.AuthSessionInfo.fromJson(data) as T;
    }
    if (t == _i13.AuthSuccess) {
      return _i13.AuthSuccess.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i5.AuthenticationTokenInfo?>()) {
      return (data != null ? _i5.AuthenticationTokenInfo.fromJson(data) : null)
          as T;
    }
    ...
    if (t == _i1.getType<_i11.UserProfileModel?>()) {
      return (data != null ? _i11.UserProfileModel.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.AuthSessionInfo?>()) {
      return (data != null ? _i12.AuthSessionInfo.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i13.AuthSuccess?>()) {
      return (data != null ? _i13.AuthSuccess.fromJson(data) : null) as T;
    }
    if (t == Set<String>) {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i5.AuthenticationTokenInfo():
      ...
      case _i10.TokenPair():
        return 'TokenPair';
      case _i11.UserProfileModel():
        return 'UserProfileModel';
      case _i12.AuthSessionInfo():
        return 'AuthSessionInfo';
      case _i13.AuthSuccess():
        return 'AuthSuccess';
    }
    return null;
  }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'AuthenticationTokenInfo') {
      return deserialize<_i5.AuthenticationTokenInfo>(data['data']);
    }
    ...
    if (dataClassName == 'UserProfileModel') {
      return deserialize<_i11.UserProfileModel>(data['data']);
    }
    if (dataClassName == 'AuthSessionInfo') {
      return deserialize<_i12.AuthSessionInfo>(data['data']);
    }
    if (dataClassName == 'AuthSuccess') {
      return deserialize<_i13.AuthSuccess>(data['data']);
    }
    return super.deserializeByClassName(data);
  }
}
