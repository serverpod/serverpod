  ...
  withServerpod('Given an auth user with an authentication token,', (
    ...
    group('when calling `deleteRefreshTokens` with that refreshTokenId', () {
      ...
      test('then that token is deleted.', () async {
        final remainingTokens = await authenticationTokensAdmin
            .listAuthenticationTokens(session, authUserId: authUserId);
    ...
    test(
      ...
      () async {
        ...
        final deletedTokens = await authenticationTokensAdmin
            .deleteRefreshTokens(session, refreshTokenId: nonExistentId);
    ...
    test(
      ...
      () async {
        ...
        final deletedTokens = await authenticationTokensAdmin
            .deleteRefreshTokens(session, authUserId: nonExistentUserId);
    ...
    test(
      ...
      () async {
        final deletedTokens = await authenticationTokensAdmin
            .deleteRefreshTokens(session, method: 'non-existent-method');
  ...
  withServerpod(
    ...
    (final sessionBuilder, final endpoints) {
      ...
      test(
        ...
        () async {
          final tokens = await authenticationTokensAdmin
              .listAuthenticationTokens(session);
      ...
      test(
        ...
        () async {
          final tokens = await authenticationTokensAdmin
              .listAuthenticationTokens(session, offset: 50);
      ...
      test(
        ...
        () async {
          ...
          expect(tokens.map(((final t) => t.id)), [
  ...
  withServerpod(
    ...
    (final sessionBuilder, final endpoints) {
      ...
      test(
        ...
        () async {
          final deletedTokens = await authenticationTokensAdmin
              .deleteRefreshTokens(session, authUserId: firstUserAuthUserId);
      ...
      test(
        ...
        () async {
          await authenticationTokensAdmin.deleteRefreshTokens(session);
