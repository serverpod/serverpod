...
void main() {
  withServerpod('Given an `AuthUser` with a `UserProfile`,', (
  ...
  withServerpod('Given two `AuthUser`s with identical `UserProfile`s,', (
    final sessionBuilder,
    final endpoints,
  ) {
    final profileData = UserProfileData(
  ...
  withServerpod('Given two `AuthUser`s with unique `UserProfile`s,', (
    final sessionBuilder,
    final endpoints,
  ) {
