...
class UserInfoRepository {
  ...
  /// Emits [UserInfo]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `UserInfo.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<UserInfo>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<UserInfoTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<UserInfo>(
      where: where?.call(UserInfo.t),
      orderBy: orderBy?.call(UserInfo.t),
      orderByList: orderByList?.call(UserInfo.t),
      limit: limit,
