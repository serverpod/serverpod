...
class EmailCreateAccountRequestRepository {
  ...
  /// Emits [EmailCreateAccountRequest]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `EmailCreateAccountRequest.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<EmailCreateAccountRequest>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<EmailCreateAccountRequestTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<EmailCreateAccountRequest>(
      where: where?.call(EmailCreateAccountRequest.t),
      orderBy: orderBy?.call(EmailCreateAccountRequest.t),
      orderByList: orderByList?.call(EmailCreateAccountRequest.t),
      limit: limit,
