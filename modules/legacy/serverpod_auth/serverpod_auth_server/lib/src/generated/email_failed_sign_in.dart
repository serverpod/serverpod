...
class EmailFailedSignInRepository {
  ...
  /// Emits [EmailFailedSignIn]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `EmailFailedSignIn.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<EmailFailedSignIn>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<EmailFailedSignInTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<EmailFailedSignIn>(
      where: where?.call(EmailFailedSignIn.t),
      orderBy: orderBy?.call(EmailFailedSignIn.t),
      orderByList: orderByList?.call(EmailFailedSignIn.t),
      limit: limit,
