...
class UserImageRepository {
  ...
  /// Emits [UserImage]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `UserImage.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<UserImage>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<UserImageTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<UserImage>(
      where: where?.call(UserImage.t),
      orderBy: orderBy?.call(UserImage.t),
      orderByList: orderByList?.call(UserImage.t),
      limit: limit,
