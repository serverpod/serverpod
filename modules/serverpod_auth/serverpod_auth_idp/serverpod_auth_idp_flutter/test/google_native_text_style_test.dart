...
void main() {
  ...
  testWidgets(
    'Given a GoogleSignInNativeButton with no textStyle, '
    'when building the button, '
    'then it renders the default label without forcing a font family.',
    (tester) async {
  ...
  testWidgets(
    'Given a GoogleSignInNativeButton with a textStyle, '
    'when building the button, '
    'then the label merges it over the default font.',
    (tester) async {
      await tester.pumpWidget(
        const SignInButtonHost(
          child: GoogleSignInNativeButton(
