...
import 'twitch_auth_controller.dart';
import 'twitch_sign_in_button.dart';
import 'twitch_sign_in_style.dart';

export 'twitch_sign_in_button.dart';
export 'twitch_sign_in_style.dart';

/// A widget that provides Twitch Sign-In functionality for all platforms.
///
...
/// )
/// ```
class TwitchSignInWidget extends StatefulWidget {
  /// Controls the authentication state and behavior.
  ///
  /// If null, the widget creates and manages its own [TwitchAuthController].
  ...
  final TwitchAuthController? controller;
  ...
  /// Creates a Twitch Sign-In widget.
  const TwitchSignInWidget({
    this.controller,
    this.client,
    this.onAuthenticated,
    this.onError,
    this.scopes = TwitchAuthController.defaultScopes,
  ...
  @override
  State<TwitchSignInWidget> createState() => _TwitchSignInWidgetState();
}

class _TwitchSignInWidgetState extends State<TwitchSignInWidget> {
  late final TwitchAuthController _controller;
