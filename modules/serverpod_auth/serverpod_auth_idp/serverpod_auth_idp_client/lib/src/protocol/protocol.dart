...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<_i18.TwitchAccessTokenVerificationException?>()) {
      return (data != null
              ? _i18.TwitchAccessTokenVerificationException.fromJson(data)
              : null)
          as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'TwitchAccessTokenVerificationException') {
      return deserialize<_i18.TwitchAccessTokenVerificationException>(
        data['data'],
      );
    }
