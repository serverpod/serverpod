...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i9.GitHubAccessTokenVerificationException) {
      return _i9.GitHubAccessTokenVerificationException.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i9.GitHubAccessTokenVerificationException?>()) {
      return (data != null
              ? _i9.GitHubAccessTokenVerificationException.fromJson(data)
              : null)
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i9.GitHubAccessTokenVerificationException =>
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i9.GitHubAccessTokenVerificationException():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'GitHubAccessTokenVerificationException') {
      return deserialize<_i9.GitHubAccessTokenVerificationException>(
        data['data'],
      );
    }
