...
class Protocol extends _i1.SerializationManager {
  ...
  static Map<Type, dynamic Function(dynamic, Protocol)> _buildDeserializers() {
    ...
    map[_i11.FirebaseEmailNotVerifiedException] = (data, protocol) =>
        _i11.FirebaseEmailNotVerifiedException.fromJson(data);
    map[_i12.FirebaseIdTokenVerificationException] = (data, protocol) =>
        _i12.FirebaseIdTokenVerificationException.fromJson(data);
    map[_i13.GitHubAccessTokenVerificationException] = (data, protocol) =>
        _i13.GitHubAccessTokenVerificationException.fromJson(data);
    map[_i14.GoogleIdTokenVerificationException] = (data, protocol) =>
        _i14.GoogleIdTokenVerificationException.fromJson(data);
    map[_i15.MicrosoftAccessTokenVerificationException] = (data, protocol) =>
        _i15.MicrosoftAccessTokenVerificationException.fromJson(data);
    map[_i16.PasskeyChallengeExpiredException] = (data, protocol) =>
        _i16.PasskeyChallengeExpiredException.fromJson(data);
    map[_i17.PasskeyChallengeNotFoundException] = (data, protocol) =>
        _i17.PasskeyChallengeNotFoundException.fromJson(data);
    map[_i18.PasskeyLoginRequest] = (data, protocol) =>
        _i18.PasskeyLoginRequest.fromJson(data);
    map[_i19.PasskeyPublicKeyNotFoundException] = (data, protocol) =>
        _i19.PasskeyPublicKeyNotFoundException.fromJson(data);
    map[_i20.PasskeyRegistrationRequest] = (data, protocol) =>
    ...
    map[_i1.getType<_i10.FacebookAccessTokenVerificationException?>()] =
        ...
        ? _i10.FacebookAccessTokenVerificationException.fromJson(data)
        : null);
    map[_i1.getType<_i11.FirebaseEmailNotVerifiedException?>()] =
        (data, protocol) => (data != null
        ? _i11.FirebaseEmailNotVerifiedException.fromJson(data)
        : null);
    map[_i1.getType<_i12.FirebaseIdTokenVerificationException?>()] =
        (data, protocol) => (data != null
        ? _i12.FirebaseIdTokenVerificationException.fromJson(data)
        : null);
    map[_i1.getType<_i13.GitHubAccessTokenVerificationException?>()] =
        (data, protocol) => (data != null
        ? _i13.GitHubAccessTokenVerificationException.fromJson(data)
        : null);
    map[_i1.getType<_i14.GoogleIdTokenVerificationException?>()] =
        (data, protocol) => (data != null
        ? _i14.GoogleIdTokenVerificationException.fromJson(data)
        : null);
    map[_i1.getType<_i15.MicrosoftAccessTokenVerificationException?>()] =
        (data, protocol) => (data != null
        ? _i15.MicrosoftAccessTokenVerificationException.fromJson(data)
        : null);
    map[_i1.getType<_i16.PasskeyChallengeExpiredException?>()] =
        (data, protocol) => (data != null
        ? _i16.PasskeyChallengeExpiredException.fromJson(data)
        : null);
    map[_i1.getType<_i17.PasskeyChallengeNotFoundException?>()] =
        (data, protocol) => (data != null
        ? _i17.PasskeyChallengeNotFoundException.fromJson(data)
        : null);
    map[_i1.getType<_i18.PasskeyLoginRequest?>()] = (data, protocol) =>
        (data != null ? _i18.PasskeyLoginRequest.fromJson(data) : null);
    map[_i1.getType<_i19.PasskeyPublicKeyNotFoundException?>()] =
        (data, protocol) => (data != null
        ? _i19.PasskeyPublicKeyNotFoundException.fromJson(data)
        : null);
    map[_i1.getType<_i20.PasskeyRegistrationRequest?>()] = (data, protocol) =>
        (data != null ? _i20.PasskeyRegistrationRequest.fromJson(data) : null);
    map[_i1.getType<({_i21.ByteData challenge, _i1.UuidValue id})>()] =
        (data, protocol) => (
          challenge: protocol.deserialize<_i21.ByteData>(
