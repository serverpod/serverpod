...
class SecretChallengeRepository {
  ...
  /// Emits [SecretChallenge]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `SecretChallenge.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<SecretChallenge>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<SecretChallengeTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<SecretChallenge>(
      where: where?.call(SecretChallenge.t),
      orderBy: orderBy?.call(SecretChallenge.t),
      orderByList: orderByList?.call(SecretChallenge.t),
      limit: limit,
