...
class FacebookAccountRepository {
  ...
  /// Emits [FacebookAccount]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `FacebookAccount.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<FacebookAccount>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<FacebookAccountTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<FacebookAccount>(
      where: where?.call(FacebookAccount.t),
      orderBy: orderBy?.call(FacebookAccount.t),
      orderByList: orderByList?.call(FacebookAccount.t),
      limit: limit,
