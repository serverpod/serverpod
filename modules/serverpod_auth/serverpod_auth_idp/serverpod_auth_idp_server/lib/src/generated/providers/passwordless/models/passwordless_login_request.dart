...
abstract class PasswordlessLoginRequest
  ...
  static PasswordlessLoginRequestInclude include({
    ...
    return PasswordlessLoginRequestInclude._(
      challenge: challenge,
...
class PasswordlessLoginRequestTable extends _i1.Table<_i1.UuidValue?> {
  ...
  _i2.SecretChallengeTable get loginChallenge {
    ...
    _loginChallenge = _i1.createRelationTable(
      ...
      field: PasswordlessLoginRequest.t.loginChallengeId,
      foreignField: _i2.SecretChallenge.t.id,
      tableRelation: tableRelation,
      createTable: (foreignTableRelation) =>
          _i2.SecretChallengeTable(tableRelation: foreignTableRelation),
...
class PasswordlessLoginRequestInclude extends _i1.IncludeObject {
  PasswordlessLoginRequestInclude._({
    _i2.SecretChallengeInclude? challenge,
    _i2.SecretChallengeInclude? loginChallenge,
  }) {
...
class PasswordlessLoginRequestRepository {
  ...
  final detachRow = const PasswordlessLoginRequestDetachRowRepository._();
...
class PasswordlessLoginRequestAttachRowRepository {
  ...
  /// Creates a relation between the given [PasswordlessLoginRequest] and [SecretChallenge]
  /// by setting the [PasswordlessLoginRequest]'s foreign key `loginChallengeId` to refer to the [SecretChallenge].
  Future<void> loginChallenge(
    ...
    await session.db.updateRow<PasswordlessLoginRequest>(
      $passwordlessLoginRequest,
      columns: [PasswordlessLoginRequest.t.loginChallengeId],
      transaction: transaction,
    );
  }
}

class PasswordlessLoginRequestDetachRowRepository {
  const PasswordlessLoginRequestDetachRowRepository._();

  /// Detaches the relation between this [PasswordlessLoginRequest] and the [SecretChallenge] set in `loginChallenge`
  /// by setting the [PasswordlessLoginRequest]'s foreign key `loginChallengeId` to `null`.
  ///
