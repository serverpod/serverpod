...
class PasskeyChallengeRepository {
  ...
  /// Emits [PasskeyChallenge]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `PasskeyChallenge.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<PasskeyChallenge>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<PasskeyChallengeTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<PasskeyChallenge>(
      where: where?.call(PasskeyChallenge.t),
      orderBy: orderBy?.call(PasskeyChallenge.t),
      orderByList: orderByList?.call(PasskeyChallenge.t),
      limit: limit,
