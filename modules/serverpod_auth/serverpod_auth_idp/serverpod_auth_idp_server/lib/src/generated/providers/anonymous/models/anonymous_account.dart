...
class AnonymousAccountRepository {
  ...
  /// Emits [AnonymousAccount]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `AnonymousAccount.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<AnonymousAccount>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<AnonymousAccountTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<AnonymousAccount>(
      where: where?.call(AnonymousAccount.t),
      orderBy: orderBy?.call(AnonymousAccount.t),
      orderByList: orderByList?.call(AnonymousAccount.t),
      limit: limit,
