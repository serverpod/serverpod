...
class _UndefinedUserProfileImage$userProfile extends _is.UndefinedSentinel
...
class _UserProfileImageImpl extends UserProfileImage {
  ...
  UserProfileImage copyWith({
    ...
    return UserProfileImage(
      ...
      userProfile: userProfile is _is.UndefinedSentinel
...
class UserProfileImageRepository {
  ...
  /// Emits [UserProfileImage]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `UserProfileImage.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<UserProfileImage>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<UserProfileImageTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<UserProfileImage>(
      where: where?.call(UserProfileImage.t),
      orderBy: orderBy?.call(UserProfileImage.t),
      orderByList: orderByList?.call(UserProfileImage.t),
      limit: limit,
