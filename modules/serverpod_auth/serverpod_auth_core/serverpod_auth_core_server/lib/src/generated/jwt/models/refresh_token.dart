...
class RefreshTokenRepository {
  ...
  /// Emits [RefreshToken]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `RefreshToken.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<RefreshToken>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<RefreshTokenTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<RefreshToken>(
      where: where?.call(RefreshToken.t),
      orderBy: orderBy?.call(RefreshToken.t),
      orderByList: orderByList?.call(RefreshToken.t),
      limit: limit,
