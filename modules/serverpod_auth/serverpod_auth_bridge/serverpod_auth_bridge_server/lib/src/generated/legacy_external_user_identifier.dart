...
class LegacyExternalUserIdentifierRepository {
  ...
  /// Emits [LegacyExternalUserIdentifier]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `LegacyExternalUserIdentifier.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<LegacyExternalUserIdentifier>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<LegacyExternalUserIdentifierTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<LegacyExternalUserIdentifier>(
      where: where?.call(LegacyExternalUserIdentifier.t),
      orderBy: orderBy?.call(LegacyExternalUserIdentifier.t),
      orderByList: orderByList?.call(LegacyExternalUserIdentifier.t),
      limit: limit,
