  ...
  group('Given password hash', () {
    ...
    test(
      ...
      () async {
        ...
        var passwordHash = PasswordHash(
          await PasswordHash.legacyHash(password, salt, email: email),
          legacySalt: salt,
          legacyEmail: email,
        );
    ...
    test(
      ...
      () async {
        ...
        var passwordHash = PasswordHash(
          await PasswordHash.legacyHash('hunter2', salt, email: email),
          legacySalt: salt,
          legacyEmail: email,
        );
    ...
    test(
      ...
      () async {
        ...
        var passwordHash = PasswordHash(
          await PasswordHash.legacyHash(password, 'first salt', email: email),
          legacySalt: 'second salt',
          legacyEmail: email,
        );
