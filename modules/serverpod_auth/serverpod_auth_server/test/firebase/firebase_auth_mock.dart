...
class FirebaseAuthBackendMock {
  ...
  FirebaseAuthBackendMock({required this.userJson});

  /// Returns Firebase Mock Authentication Token
  http.Response _getAuthenticationToken(http.Request request) {
  ...
  http.Response _getUsersByLocaleId(http.Request request) {
  ...
  Future<http.Response> onHttpCall(http.Request request) async {
