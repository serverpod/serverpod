...
import '../endpoints/facebook_endpoint.dart' as _i5;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['facebook'] = _i1.EndpointConnector(
      name: 'facebook',
      endpoint: endpoints['facebook']!,
      methodConnectors: {
        'authenticateWithAccessToken': _i1.MethodConnector(
          name: 'authenticateWithAccessToken',
          params: {
            'userAccessToken': _i1.ParameterDescription(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['facebook'] as _i5.FacebookEndpoint)
