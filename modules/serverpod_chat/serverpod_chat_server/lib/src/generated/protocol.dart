...
class Protocol extends SerializationManager {
  ...
  Protocol() {
    ...
    constructors['serverpod_chat_server.ChatMessageAttachmentUploadDescription'] = (Map<String, dynamic> serialization) => ChatMessageAttachmentUploadDescription.fromSerialization(serialization);
    constructors['serverpod_chat_server.ChatReadMessage'] = (Map<String, dynamic> serialization) => ChatReadMessage.fromSerialization(serialization);
    constructors['serverpod_chat_server.ChatMessageAttachment'] = (Map<String, dynamic> serialization) => ChatMessageAttachment.fromSerialization(serialization);
    ...
    constructors['serverpod_chat_server.ChatRequestMessageChunk'] = (Map<String, dynamic> serialization) => ChatRequestMessageChunk.fromSerialization(serialization);
    ...
    tableClassMapping['serverpod_chat_read_message'] = 'serverpod_chat_server.ChatReadMessage';
