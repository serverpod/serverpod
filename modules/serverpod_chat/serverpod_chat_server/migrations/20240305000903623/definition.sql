...
--
<<<<<<< HEAD:examples/chat/chat_server/migrations/20240115074255879/definition.sql
...
CREATE TABLE "serverpod_chat_message" (
    ...
    "attachments" json
>>>>>>> 40df32941178c65b126bfe6e67dc5ebe258fa2d6:modules/serverpod_chat/serverpod_chat_server/migrations/20240305000903623/definition.sql
);
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_chat', '20240305000903623', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240305000903623', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth', '20240305000854756', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240305000854756', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod', '20240305000845978', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240305000845978', "timestamp" = now();
