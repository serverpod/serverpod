...
void main() {
  testWidgets(
    ...
    MockChatController mockController = MockChatController();
    ChatMessage mockMessage = ChatMessage(
    ...
    when(() => mockController.messages).thenReturn(
      <ChatMessage>[mockMessage, mockMessage, mockMessage],
    );
    ...
    Finder leadingFinder = find.text('Intro text');
