...
class PushNotificationRepository {
  ...
  /// Emits [PushNotification]s matching the given query parameters every time the
  ...
  /// to that set. Pass [Table] instances such as `PushNotification.t`.
  ///
  ...
  /// });
  /// ```
  _ida.Stream<List<PushNotification>> watch(
    _is.DatabaseSession session, {
    _is.WhereExpressionBuilder<PushNotificationTable>? where,
    int? limit,
    int? offset,
    ...
    return session.db.watch<PushNotification>(
      where: where?.call(PushNotification.t),
      orderBy: orderBy?.call(PushNotification.t),
      orderByList: orderByList?.call(PushNotification.t),
      limit: limit,
