...
import 'package:serverpod_push_core_server/src/generated/protocol.dart'
    as _i281krv3;
...
abstract class PushSendResult
  ...
  factory PushSendResult.fromJson(Map<String, dynamic> jsonSerialization) {
    return PushSendResult(
      target: _i281krv3.Protocol().deserialize<_i0dvde7a.PushDeviceTarget>(
      ...
      retryAfter: jsonSerialization['retryAfter'] == null
          ? null
          : _is.DurationJsonExtension.fromJson(jsonSerialization['retryAfter']),
    );
  }
