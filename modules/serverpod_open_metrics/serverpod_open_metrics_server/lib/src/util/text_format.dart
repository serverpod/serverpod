...
class OpenMetricsTextFormat {
  ...
  /// The content type for Prometheus text format (default).
  /// @deprecated Use prometheusContentType or openMetricsContentType instead
  static const String contentType = prometheusContentType;

  /// Export a registry's metrics to OpenMetrics or Prometheus text format.
  ///
  /// [registry] The metric registry to export.
  /// [format] The format to use (defaults to Prometheus 0.0.4 for backward compatibility).
  ///
  /// Returns a string in the specified text exposition format.
