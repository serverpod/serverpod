...
import 'email_account_password_reset_request.dart' as _i5;
import 'email_account_request.dart' as _i6;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  static final List<_i2.TableDefinition> targetTableDefinitions = [
    _i2.TableDefinition(
      ...
      indexes: [
        ...
        _i2.IndexDefinition(
          indexName: 'serverpod_auth_email_account_email_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
    ...
    _i2.TableDefinition(
      ...
      indexes: [
        ...
        _i2.IndexDefinition(
          indexName:
              'serverpod_auth_email_account_password_reset_request_code_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
    ...
    _i2.TableDefinition(
      ...
      indexes: [
        ...
        _i2.IndexDefinition(
          indexName: 'serverpod_auth_email_account_request_email_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
  ...
  T deserialize<T>(
    ...
    if (t == _i5.EmailAccountPasswordResetRequest) {
      return _i5.EmailAccountPasswordResetRequest.fromJson(data) as T;
    }
    if (t == _i6.EmailAccountRequest) {
      return _i6.EmailAccountRequest.fromJson(data) as T;
    }
    if (t == _i1.getType<_i4.EmailAccount?>()) {
      return (data != null ? _i4.EmailAccount.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i5.EmailAccountPasswordResetRequest?>()) {
      return (data != null
          ? _i5.EmailAccountPasswordResetRequest.fromJson(data)
          : null) as T;
    }
    if (t == _i1.getType<_i6.EmailAccountRequest?>()) {
      return (data != null ? _i6.EmailAccountRequest.fromJson(data) : null)
          as T;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i5.EmailAccountPasswordResetRequest) {
      return 'EmailAccountPasswordResetRequest';
    }
    if (data is _i6.EmailAccountRequest) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'EmailAccountPasswordResetRequest') {
      return deserialize<_i5.EmailAccountPasswordResetRequest>(data['data']);
    }
    if (dataClassName == 'EmailAccountRequest') {
      return deserialize<_i6.EmailAccountRequest>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i5.EmailAccountPasswordResetRequest:
        return _i5.EmailAccountPasswordResetRequest.t;
      case _i6.EmailAccountRequest:
        return _i6.EmailAccountRequest.t;
    }
    return null;
  }
