...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('chat', '20250701070140322', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250701070140322', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_chat', '20250701070124910', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250701070124910', "timestamp" = now();
