...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('chat', '20240405235551990', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240405235551990', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_chat', '20240405235523806', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240405235523806', "timestamp" = now();
