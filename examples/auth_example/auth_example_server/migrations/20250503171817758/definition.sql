...
--
-- Class AnonymousAuth as table serverpod_anonymous_auth
--
...
--
-- Class AnonymousFailedSignIn as table serverpod_anonymous_failed_sign_in
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('auth_example', '20250503171817758', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250503171817758', "timestamp" = now();
