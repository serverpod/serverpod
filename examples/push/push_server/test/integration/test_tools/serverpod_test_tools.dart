...
import 'package:push_server/src/generated/greetings/greeting.dart' as _i1xkj0q9;
import 'package:serverpod/serverpod.dart' as _is;
import 'package:serverpod_test/serverpod_test.dart' as _ist;
import 'package:push_server/src/generated/protocol.dart';
import 'package:push_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _PushTestEndpoint pushTest;
}
...
class _GreetingEndpoint {
  ...
  _ida.Future<_i1xkj0q9.Greeting> hello(
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_i1xkj0q9.Greeting>);
...
class _PushTestEndpoint {
  ...
  _ida.Future<String> queueStatus(
    _ist.TestSessionBuilder sessionBuilder,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
  ...
  _ida.Future<String> scheduleDelayedPing(
    ...
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _ist.InternalTestSessionBuilder).internalBuild(
            endpoint: 'pushTest',
            method: 'scheduleDelayedPing',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'pushTest',
          methodName: 'scheduleDelayedPing',
          parameters: _ist.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
  ...
  _ida.Future<String> authorizedSend(
    _ist.TestSessionBuilder sessionBuilder,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
